...
class GwAdminButton:
    ...
    def create_project_data_schema(self, project_name_schema=None, project_descript=None, project_type=None,
        ...
        if self.rdb_import_data.isChecked():
            ...
            if self.locale != 'en_EN' or self.project_epsg != '25831':
                msg = ("This functionality is only allowed with the locality 'en_EN' and SRID 25831."
                        ...
                        if self.dev_commit == 'TRUE':
                            if str(sub_folder) > '31100':
                                ...
                                if self._process_folder(self.folderUpdates + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep + str(
                                    ...
                                    if status is False:
                                        return False
                                elif self._process_folder(self.folderUpdates + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep, 'EN'):
                        ...
                        if self.dev_commit == 'TRUE':
                            if str(sub_folder) > '31100':
                                if self._process_folder(self.sql_dir + os.sep + str(project_type) + os.sep + 'updates' + os.sep + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep + str(self.locale + os.sep), '') is True:
                                    ...
                                    if status is False:
                                        return False
                                elif self._process_folder(self.sql_dir + os.sep + str(project_type) + os.sep + 'updates' + os.sep + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep + 'EN', '') is True:
                        ...
                        if self.dev_commit == 'TRUE':
                            if str(sub_folder) > str(self.project_version).replace('.', '') and str(sub_folder) > '31100':
                                ...
                                if self._process_folder(self.folderUpdates + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep + str(self.locale + os.sep), '') is True:
                                    ...
                                    if status is False:
                                        return False
                                elif self._process_folder(self.folderUpdates + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep, 'en_EN') is True:
                                    status = self._execute_files(self.folderUpdates + folder +
                                                               os.sep + sub_folder + os.sep + 'i18n' + os.sep + 'en_EN', True)
                                    if status is False:
                                        return False
                    ...
                    if new_project:
                        if str(sub_folder) <= '31100':
                            ...
                            if self._process_folder(
                                ...
                                if status is False:
                                    return False
                            elif self._process_folder(self.folderUpdates + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep, 'en_EN') is False:
                                status = self._execute_files(self.folderUpdates + folder +
                                                           os.sep + sub_folder + os.sep + 'i18n' + os.sep + 'en_EN', True)
                                if status is False:
                                    return False
                    ...
                    if new_project:
                        if str(sub_folder) <= '31100':
                            ...
                            if self._process_folder(
                                ...
                                if status is False:
                                    return False
                            elif self._process_folder(self.sql_dir + os.sep + str(project_type) + os.sep + os.sep + 'updates' + os.sep + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep, 'en_EN') is True:
                                status = self._execute_files(self.sql_dir + os.sep + str(project_type) + os.sep + os.sep + 'updates' +
                                                           os.sep + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep + 'en_EN' + os.sep, True)
                                if status is False:
                                    return False
                    ...
                    if self.dev_commit == 'TRUE':
                        ...
                        if self._process_folder(
                            ...
                            status = self._execute_files(self.folderUpdatesApi + folder + os.sep +
                                                       sub_folder + os.sep + 'i18n' + os.sep + 'en_EN' + os.sep, True)
                            if status is False:
                                return False
                        ...
                        if str(sub_folder) <= str(self.plugin_version).replace('.', ''):
                            ...
                            if self._process_folder(
                                ...
                                if status is False:
                                    ...
                                    'en_EN') is True:
                                status = self._execute_files(
                                    self.folderUpdatesApi + folder + os.sep + sub_folder + os.sep + 'i18n' + os.sep + 'en_EN' + os.sep,
                                    True)
                                if status is False:
                                    return False
                            if self._process_folder(self.sql_dir + os.sep + 'api' + os.sep,
                        ...
                        if str(sub_folder) > str(self.project_version).replace('.', ''):
                            ...
                            if self._process_folder(
                                ...
                                if status is False:
                                    ...
                                    'en_EN') is True:
                                status = self._execute_files(self.folderUpdatesApi + folder + os.sep +
                                                           sub_folder + os.sep + 'i18n' + os.sep + 'en_EN' + os.sep,
                                                           True)
                                if status is False:
                                    return False
                            if self._process_folder(self.sql_dir + os.sep + 'api' + os.sep,
    ...
    def create_project_data_schema(self, project_name_schema=None, project_descript=None, project_type=None,
        ...
        status = True
        if exec_last_process:
            status = self._execute_last_process(new_project=True, schema_name=project_name_schema, srid=project_srid,
                                                schema_type=self.schema_type, locale=project_locale)
    ...
    def _manage_user_params(self):
        ...
        composers_path_vdef = os.path.normpath(os.path.normpath(folder_name + os.sep + os.pardir)) + os.sep + \
            'resources' + os.sep + 'templates' + os.sep + 'qgiscomposer' + os.sep + 'en_EN'
