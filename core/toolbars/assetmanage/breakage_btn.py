...
class GwAmBreakageButton(GwAction):
    ...
    def assignation(self):
        ...
        self.dlg_assignation = AssignationUi(self)
    ...
    def _manage_hidden_form_leaks(self):
        ...
        try:
            ...
            config_path = tools_qt.get_text(self.dlg_assignation, self.dlg_assignation.data_config_file)
