...
class GwGo2Epa:
    ...
    def load_user_values(self):
        ...
        self.result_name = tools_gw.get_config_parser('btn_go2epa', 'go2epa_RESULT_NAME')
        self.dlg_go2epa.txt_result_name.setText(self.result_name)
        self.file_inp = tools_gw.get_config_parser('btn_go2epa', 'go2epa_FILE_INP')
        self.dlg_go2epa.txt_file_inp.setText(self.file_inp)
        self.file_rpt = tools_gw.get_config_parser('btn_go2epa', 'go2epa_FILE_RPT')
        self.dlg_go2epa.txt_file_rpt.setText(self.file_rpt)

        value = tools_gw.get_config_parser('btn_go2epa', 'go2epa_chk_NETWORK_GEOM')
    ...
    def sector_selection(self, tableleft, tableright, field_id_left, field_id_right, aql=""):
        ...
        if tableleft == 'cat_dscenario':
            ...
            tools_qt.set_widget_text(dlg_psector_sel, dlg_psector_sel.lbl_filter,
                                   tools_qt.tr('Filter by: Dscenario name', context_name='labels', aux_context='ui_message'))
            tools_qt.set_widget_text(dlg_psector_sel, dlg_psector_sel.lbl_unselected,
                                   tools_qt.tr('Unselected dscenarios', context_name='labels', aux_context='ui_message'))
            tools_qt.set_widget_text(dlg_psector_sel, dlg_psector_sel.lbl_selected,
                                   tools_qt.tr('Selected dscenarios', context_name='labels', aux_context='ui_message'))
