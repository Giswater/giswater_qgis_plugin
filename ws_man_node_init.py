...
class ManNodeDialog(ParentDialog):   
    ...
    def set_tabs_visibility(self):
        ...
        if layer.name() =="Dipòsit" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 0):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Central elevadora" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 1):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Captació" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 2):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Comptador de control" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 3):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Unió" :
        ...
        if layer.name() =="Pou" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 5):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Reducció" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 6):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Boca d'incendis" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 7):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Vàlvua" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 8):
                    self.tab_main.removeTab(i) 
        if layer.name() =="Pou de connexió" :
            for i in xrange(13,-1,-1):
                if (i != 11) & (i != 10) & (i != 5):
                    self.tab_main.removeTab(i) 