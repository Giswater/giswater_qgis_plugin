...
<qgis styleCategories="Symbology|Labeling" version="3.40.1-Bratislava" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="singleSymbol" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol force_rhr="0" frame_rate="10" alpha="1" type="line" clip_to_extent="1" is_animated="0" name="0">
        ...
        <layer class="FilledLine" locked="0" id="{6eeef8b9-fd8d-4cd5-86d7-500efb9b7377}" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="round" name="capstyle"/>
            <Option type="QString" value="246,254,99,255,rgb:0.96470588235294119,0.99607843137254903,0.38823529411764707,1" name="color"/>
          ...
          <symbol force_rhr="0" frame_rate="10" alpha="1" type="fill" clip_to_extent="1" is_animated="0" name="@0@0">
            ...
            <layer class="SimpleFill" locked="0" id="{52d450ec-ac0a-43c7-8d99-2312a90f28ed}" pass="0" enabled="1">
              <Option type="Map">
        ...
        <layer class="MarkerLine" locked="0" id="{5d9a5a7c-5136-4927-8d08-8745d927b488}" pass="0" enabled="1">
          <Option type="Map">
          ...
          <symbol force_rhr="0" frame_rate="10" alpha="1" type="marker" clip_to_extent="1" is_animated="0" name="@0@1">
            ...
            <layer class="SimpleMarker" locked="0" id="{a0ee7e75-6033-46ca-9336-9aad25918d4b}" pass="0" enabled="1">
              <Option type="Map">
                ...
                <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
                <Option type="QString" value="MM" name="offset_unit"/>
                <Option type="QString" value="65,65,8,255,hsv:0.16666666666666666,0.87058823529411766,0.25490196078431371,1" name="outline_color"/>
                <Option type="QString" value="solid" name="outline_style"/>
                <Option type="QString" value="0.15" name="outline_width"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" frame_rate="10" alpha="1" type="line" clip_to_extent="1" is_animated="0" name="">
        ...
        <layer class="SimpleLine" locked="0" id="{94eba9a5-3038-49ee-ace7-3faaf62e1c0e}" pass="0" enabled="1">
          <Option type="Map">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" polygonPlacementFlags="2" offsetUnits="MM" yOffset="0" repeatDistanceUnits="MM" layerType="LineGeometry" maximumDistance="0" quadOffset="4" placementFlags="10" overrunDistance="0" rotationUnit="AngleDegrees" lineAnchorType="0" priority="0" rotationAngle="0" distUnits="MM" lineAnchorTextPoint="CenterOfText" xOffset="0" preserveRotation="1" distMapUnitScale="3x:0,0,0,0,0,0" placement="2" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" lineAnchorPercent="0.5" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" allowDegraded="0" geometryGenerator="" offsetType="0" prioritization="PreferCloser" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="3" overlapHandling="PreventOverlap" centroidWhole="0" lineAnchorClipping="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" geometryGeneratorEnabled="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
