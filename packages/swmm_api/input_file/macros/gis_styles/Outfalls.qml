...
<qgis version="3.38.1-Grenoble" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" referencescale="-1" type="singleSymbol">
    <symbols>
      <symbol force_rhr="0" is_animated="0" name="0" alpha="1" clip_to_extent="1" frame_rate="10" type="marker">
        ...
        <layer locked="0" id="{e4767d81-791b-485a-964b-0cc982756a75}" pass="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option name="outline_color" value="112,33,33,255,hsv:0,0.70588235294117652,0.4392156862745098,1" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" is_animated="0" name="" alpha="1" clip_to_extent="1" frame_rate="10" type="marker">
        ...
        <layer locked="0" id="{fdba6b92-8408-4f4a-ac1b-20f067bba065}" pass="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement overlapHandling="PreventOverlap" yOffset="0" maximumDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" allowDegraded="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" maxCurvedCharAngleIn="25" maximumDistance="0" preserveRotation="1" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" overrunDistance="0" repeatDistance="0" priority="5" centroidInside="0" rotationAngle="0" repeatDistanceUnits="MM" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" xOffset="0" maxCurvedCharAngleOut="-25" prioritization="PreferCloser" offsetUnits="MM" dist="3" lineAnchorClipping="0" geometryGeneratorEnabled="0" geometryGenerator="" quadOffset="4" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" lineAnchorTextPoint="CenterOfText" rotationUnit="AngleDegrees" distUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" placementFlags="10" layerType="PointGeometry" lineAnchorType="0"/>
