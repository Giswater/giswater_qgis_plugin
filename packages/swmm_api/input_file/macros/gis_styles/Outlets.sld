    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#dda0dd</se:SvgParameter>
            ...
            <se:Stroke>
              <se:GraphicStroke>
                <se:Graphic>
                  <!--Parametric SVG-->
                  <se:ExternalGraphic>
                    <se:OnlineResource xlink:href="__XX__/obj_outlet.svg?fill=%23ffffff&amp;fill-opacity=1&amp;outline=%23000000&amp;outline-opacity=1&amp;outline-width=4" xlink:type="simple"/>
                    <se:Format>image/svg+xml</se:Format>
                  </se:ExternalGraphic>
                  <!--Plain SVG fallback, no parameters-->
                  <se:ExternalGraphic>
                    <se:OnlineResource xlink:href="obj_outlet.svg" xlink:type="simple"/>
                    <se:Format>image/svg+xml</se:Format>
                  </se:ExternalGraphic>
...
\n%2
\nOffset=%3 m%4', Name, "OUTLETS.curve_type", "OUTLETS.offset", if("OUTLETS.has_flap_gate", '\nFlapGate', '')) not implemented yet-->Placeholder</se:Label>
            <se:Font>
