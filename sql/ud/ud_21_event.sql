...
ALTER TABLE "SCHEMA_NAME"."event_x_storage" ADD FOREIGN KEY ("node_id") REFERENCES "SCHEMA_NAME"."node" ("node_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_outfall" ADD FOREIGN KEY ("node_id") REFERENCES "SCHEMA_NAME"."node" ("node_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_conduit" ADD FOREIGN KEY ("arc_id") REFERENCES "SCHEMA_NAME"."arc" ("arc_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_gate" ADD FOREIGN KEY ("element_id") REFERENCES "SCHEMA_NAME"."element" ("element_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_pump" ADD FOREIGN KEY ("element_id") REFERENCES "SCHEMA_NAME"."element" ("element_id") ON DELETE RESTRICT ON UPDATE CASCADE;
