...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        ...
        -- FEATURE INSERT
        INSERT INTO connec VALUES (NEW.connec_id, NEW.top_elev, NEW."ymax", NEW.connecat_id, NEW.sector_id, NEW."state", NEW.annotation, NEW."observ", NEW."comment", NEW.rotation,
