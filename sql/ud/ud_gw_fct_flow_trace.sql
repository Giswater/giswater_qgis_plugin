...
BEGIN
    ...
    SELECT node_id INTO exists_id FROM "SCHEMA_NAME".anl_flow_trace_node WHERE node_id = node_id_arg;

    -- Compute proceed
    IF NOT FOUND THEN
    
        -- Update value
        INSERT INTO "SCHEMA_NAME".anl_flow_trace_node VALUES(node_id_arg);
        ...
        LOOP
            ...
            -- Insert into tables
            INSERT INTO "SCHEMA_NAME".anl_flow_trace_arc VALUES(rec_table.arc_id);
