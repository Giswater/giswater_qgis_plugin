...
-- ----------------------------
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('CURVE','JUNCTION','JUNCTION', 'man_junction', 'inp_junction', 'event_x_junction');
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('REDUCTION','JUNCTION','JUNCTION', 'man_junction', 'inp_junction', 'event_x_junction');
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('LUVE','JUNCTION','JUNCTION', 'man_junction', 'inp_junction', 'event_x_junction');
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('ADAPTATION','JUNCTION','JUNCTION', 'man_junction', 'inp_junction', 'event_x_junction');
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('JUNCTION','JUNCTION','JUNCTION', 'man_junction',  'inp_junction', 'event_x_junction');
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('ENDLINE','JUNCTION','JUNCTION', 'man_junction', 'inp_junction', 'event_x_junction');
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('X','JUNCTION', 'JUNCTION','man_junction', 'inp_junction', 'event_x_junction');
...
INSERT INTO "SCHEMA_NAME"."node_type" VALUES ('FL-CONTR.VALVE','VALVE', 'VALVE', 'man_valve', 'inp_valve', 'event_x_valve');
