...
-- DROP FUNCTION IF EXISTS "SCHEMA_NAME".gw_fct_delete_node(character varying);
...
--			Compare pipes
			IF
				myRecord1.arccat_id = myRecord2.arccat_id AND
				myRecord1.epa_type  = myRecord2.epa_type  AND
				myRecord1.sector_id = myRecord2.sector_id
			THEN
