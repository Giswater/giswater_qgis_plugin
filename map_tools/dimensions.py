...
class Dimensions(ParentMapTool):
    ...
    def __init__(self, iface, settings, action, index_action):
        ...
        super(Dimensions, self).__init__(iface, settings, action, index_action)
    ...
    def activate(self):
        ...
        message = "Test122"
        self.controller.show_info(message, context_name='ui_message' )
        self.dlg = DimensionsForm()
        message = "Test1"
        self.controller.show_info(message, context_name='ui_message' )
        #utils_giswater.setDialog(self.dlg)

        self.btn_snapping = self.dlg.findChild(QPushButton,"btn_snapping") 
        message = "Test2"
        self.controller.show_info(message, context_name='ui_message' )
        self.btn_snapping.clicked.connect(self.test)
        message = "Test3"
        self.controller.show_info(message, context_name='ui_message' )
