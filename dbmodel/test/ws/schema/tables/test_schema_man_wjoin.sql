...
-- Check column types
SELECT col_type_is('man_wjoin', 'connec_id', 'int4', 'Column connec_id should be int4');
SELECT col_type_is('man_wjoin', 'top_floor', 'int4', 'Column top_floor should be int4');
...
SELECT fk_ok('man_wjoin', 'connec_id', 'connec', 'connec_id', 'FK connec_id → connec.connec_id');
