...
SELECT fk_ok('element_x_link', 'element_id', 'element', 'element_id', 'FK element_id → element.element_id');
SELECT fk_ok('element_x_link', 'link_id', 'link', 'link_id', 'FK link_id → link.link_id');
