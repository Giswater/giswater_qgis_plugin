...
-- Check column types
SELECT col_type_is('element_x_arc', 'element_id', 'varchar(16)', 'Column element_id should be varchar(16)');
SELECT col_type_is('element_x_arc', 'arc_id', 'varchar(16)', 'Column arc_id should be varchar(16)');
