...
SELECT fk_ok('element_x_arc', 'arc_id', 'arc', 'arc_id', 'FK arc_id → arc.arc_id');
SELECT fk_ok('element_x_arc', 'element_id', 'element', 'element_id', 'FK element_id → element.element_id');
