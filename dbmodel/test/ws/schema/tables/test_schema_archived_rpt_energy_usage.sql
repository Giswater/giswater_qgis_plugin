...
-- Check column types
SELECT col_type_is('archived_rpt_energy_usage', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('archived_rpt_energy_usage', 'result_id', 'varchar(30)', 'Column result_id should be varchar(30)');
SELECT col_type_is('archived_rpt_energy_usage', 'nodarc_id', 'varchar(16)', 'Column nodarc_id should be varchar(16)');
