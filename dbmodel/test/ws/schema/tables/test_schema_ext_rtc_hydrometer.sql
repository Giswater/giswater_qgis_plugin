...
SELECT columns_are(
    'ext_rtc_hydrometer',
    ARRAY[
        'hydrometer_id', 'code', 'customer_name', 'address', 'house_number', 'id_number',
        'start_date', 'hydro_number', 'identif', 'state_id', 'expl_id', 'hydrometer_customer_code',
        'plot_code', 'priority_id', 'catalog_id', 'category_id', 'crm_number', 'muni_id',
        'address1', 'address2', 'address3', 'address2_1', 'address2_2', 'address2_3',
        'm3_volume', 'hydro_man_date', 'end_date', 'update_date', 'shutdown_date', 'is_waterbal',
        'link', 'customer_code'
    ],
...
-- Check column types
SELECT col_type_is('ext_rtc_hydrometer', 'hydrometer_id', 'int4', 'Column hydrometer_id should be int4');
...
SELECT col_type_is('ext_rtc_hydrometer', 'state_id', 'int2', 'Column state_id should be int2');
SELECT col_type_is('ext_rtc_hydrometer', 'expl_id', 'int4', 'Column expl_id should be int4');
...
SELECT col_type_is('ext_rtc_hydrometer', 'priority_id', 'int4', 'Column priority_id should be int4');
SELECT col_type_is('ext_rtc_hydrometer', 'catalog_id', 'int4', 'Column catalog_id should be int4');
SELECT col_type_is('ext_rtc_hydrometer', 'category_id', 'int4', 'Column category_id should be int4');
SELECT col_type_is('ext_rtc_hydrometer', 'crm_number', 'int4', 'Column crm_number should be int4');
SELECT col_type_is('ext_rtc_hydrometer', 'muni_id', 'int4', 'Column muni_id should be int4');
...
SELECT col_type_is('ext_rtc_hydrometer', 'm3_volume', 'float8', 'Column m3_volume should be float8');
...
SELECT col_type_is('ext_rtc_hydrometer', 'is_waterbal', 'bool', 'Column is_waterbal should be bool');
