...
-- Check column types
SELECT col_type_is('inp_pump', 'node_id', 'int4', 'Column node_id should be int4');
...
SELECT col_type_is('inp_pump', 'energy_price', 'float8', 'Column energy_price should be float8');
...
SELECT fk_ok('inp_pump', 'node_id', 'node', 'node_id', 'FK node_id → node.node_id');
SELECT fk_ok('inp_pump', 'pattern_id', 'inp_pattern', 'pattern_id', 'FK pattern_id → inp_pattern.pattern_id');
SELECT fk_ok('inp_pump', 'energy_pattern_id', 'inp_pattern', 'pattern_id', 'FK energy_pattern_id → inp_pattern.pattern_id');
