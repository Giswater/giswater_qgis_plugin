...
SELECT columns_are(
    'temp_csv',
    ARRAY[
        'id', 'fid', 'cur_user', 'source', 'csv1', 'csv2',
        'csv3', 'csv4', 'csv5', 'csv6', 'csv7', 'csv8',
        'csv9', 'csv10', 'csv11', 'csv12', 'csv13', 'csv14',
        'csv15', 'csv16', 'csv17', 'csv18', 'csv19', 'csv20',
        'csv21', 'csv22', 'csv23', 'csv24', 'csv25', 'csv26',
        'csv27', 'csv28', 'csv29', 'csv30', 'csv31', 'csv32',
        'csv33', 'csv34', 'csv35', 'csv36', 'csv37', 'csv38',
        'csv39', 'csv40', 'tstamp'
    ],
...
-- Check column types
SELECT col_type_is('temp_csv', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('temp_csv', 'fid', 'int4', 'Column fid should be int4');
...
SELECT fk_ok('temp_csv', 'fid', 'sys_fprocess', 'fid', 'FK fid → sys_fprocess.fid');
