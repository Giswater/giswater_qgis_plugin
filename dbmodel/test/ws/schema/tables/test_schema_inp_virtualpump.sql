...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'effic_curve_id', 'energy_price', 'energy_pattern_id', 'pump_type'
    ],
    'Table inp_virtualpump should have the correct columns'
);

-- Check column types
SELECT col_type_is('inp_virtualpump', 'arc_id', 'int4', 'Column arc_id should be int4');
...
SELECT col_type_is('inp_virtualpump', 'energy_price', 'float8', 'Column energy_price should be float8');
...
SELECT fk_ok('inp_virtualpump', 'curve_id', 'inp_curve', 'id', 'FK curve_id → inp_curve.id');
SELECT fk_ok('inp_virtualpump', 'pattern_id', 'inp_pattern', 'pattern_id', 'FK pattern_id → inp_pattern.pattern_id');
SELECT fk_ok('inp_virtualpump', 'energy_pattern_id', 'inp_pattern', 'pattern_id', 'FK energy_pattern_id → inp_pattern.pattern_id');
SELECT fk_ok('inp_virtualpump', 'arc_id', 'arc', 'arc_id', 'FK arc_id → arc.arc_id');
