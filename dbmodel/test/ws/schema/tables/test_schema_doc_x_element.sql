...
-- Check column types
SELECT col_type_is('doc_x_element', 'doc_id', 'int4', 'Column doc_id should be int4');
...
SELECT fk_ok('doc_x_element', 'element_id', 'element', 'element_id', 'FK element_id → element.element_id');
SELECT fk_ok('doc_x_element', 'doc_id', 'doc', 'id', 'FK doc_id → doc.id');
