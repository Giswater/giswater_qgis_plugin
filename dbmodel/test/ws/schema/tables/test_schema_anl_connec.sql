...
SELECT col_type_is('anl_connec', 'connec_id', 'integer', 'Column connec_id should be integer');
...
SELECT col_type_is('anl_connec', 'connec_id_aux', 'integer', 'Column connec_id_aux should be integer');
