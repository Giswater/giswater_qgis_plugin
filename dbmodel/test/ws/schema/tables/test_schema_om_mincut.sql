...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'modification_date', 'chlorine', 'turbidity', 'minsector_id', 'reagent_lot', 'equipment_code', 'polygon_the_geom', 'modification_user', 'shutoff_required'
    ],
...
SELECT col_type_is('om_mincut', 'shutoff_required', 'boolean', 'Column shutoff_required should be boolean');
