...
SELECT col_type_is('plan_reh_result_arc', 'arc_id', 'varchar(16)', 'Column arc_id should be varchar(16)');
SELECT col_type_is('plan_reh_result_arc', 'node_1', 'varchar(16)', 'Column node_1 should be varchar(16)');
SELECT col_type_is('plan_reh_result_arc', 'node_2', 'varchar(16)', 'Column node_2 should be varchar(16)');
