...
-- Check column types
SELECT col_type_is('rpt_energy_usage', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('rpt_energy_usage', 'result_id', 'varchar(30)', 'Column result_id should be varchar(30)');
SELECT col_type_is('rpt_energy_usage', 'nodarc_id', 'varchar(16)', 'Column nodarc_id should be varchar(16)');
...
SELECT fk_ok('rpt_energy_usage', 'result_id', 'rpt_cat_result', 'result_id', 'FK result_id → rpt_cat_result.result_id');
