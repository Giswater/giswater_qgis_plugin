...
SELECT columns_are(
    'omzone',
    ARRAY[
        'omzone_id', 'code', 'name', 'descript', 'omzone_type', 'muni_id',
        'expl_id', 'macroomzone_id', 'link', 'lock_level', 'active', 'the_geom',
        'created_at', 'created_by', 'updated_at', 'updated_by', 'addparam', 'graphconfig',
        'stylesheet', 'sector_id'
    ],
