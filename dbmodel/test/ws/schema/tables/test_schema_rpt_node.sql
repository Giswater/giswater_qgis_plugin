...
-- Check column types
SELECT col_type_is('rpt_node', 'id', 'int4', 'Column id should be int4');
...
SELECT col_type_is('rpt_node', 'other', 'varchar(100)', 'Column other should be varchar(100)');
SELECT col_type_is('rpt_node', 'time', 'varchar(100)', 'Column time should be varchar(100)');
