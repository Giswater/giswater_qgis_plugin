...
SELECT columns_are(
    'config_visit_class',
    ARRAY[
        'id', 'idval', 'descript', 'active', 'ismultifeature', 'ismultievent',
        'feature_type', 'sys_role', 'visit_type', 'param_options', 'formname', 'tablename',
        'ui_tablename', 'parent_id', 'inherit_values'
    ],
...
SELECT fk_ok('config_visit_class', 'sys_role', 'sys_role', 'id', 'FK sys_role → sys_role.id');
