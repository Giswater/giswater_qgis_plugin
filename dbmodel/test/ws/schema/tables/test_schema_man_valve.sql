...
SELECT columns_are(
    'man_valve',
    ARRAY[
        'node_id', 'closed', 'broken', 'buried', 'irrigation_indicator', 'pressure_entry',
...
SELECT col_type_is('man_valve', 'closed', 'bool', 'Column closed should be bool');
SELECT col_type_is('man_valve', 'broken', 'bool', 'Column broken should be bool');
...
SELECT col_type_is('man_valve', 'exit_code', 'int4', 'Column exit_code should be int4');
...
SELECT col_type_is('man_valve', 'ordinarystatus', 'int2', 'Column ordinarystatus should be int2');
...
SELECT col_type_is('man_valve', 'to_arc', 'int4', 'Column to_arc should be int4');
...
SELECT fk_ok('man_valve', 'cat_valve2', 'cat_node', 'id', 'FK cat_valve2 → cat_node.id');
