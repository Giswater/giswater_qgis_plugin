...
SELECT columns_are(
    'macrodma',
    ARRAY[
        'macrodma_id', 'code', 'name', 'descript', 'expl_id', 'lock_level',
...
-- Check column types
SELECT col_type_is('macrodma', 'macrodma_id', 'int4', 'Column macrodma_id should be int4');
...
SELECT col_type_is('macrodma', 'expl_id', 'int4[]', 'Column expl_id should be int4[]');
SELECT col_type_is('macrodma', 'lock_level', 'int4', 'Column lock_level should be int4');
SELECT col_type_is('macrodma', 'active', 'bool', 'Column active should be bool');
...
SELECT col_type_is('macrodma', 'addparam', 'json', 'Column addparam should be json');
SELECT col_type_is('macrodma', 'sector_id', 'int4[]', 'Column sector_id should be int4[]');
SELECT col_type_is('macrodma', 'muni_id', 'int4[]', 'Column muni_id should be int4[]');
SELECT col_type_is('macrodma', 'stylesheet', 'json', 'Column stylesheet should be json');
SELECT col_type_is('macrodma', 'link', 'text', 'Column link should be text');
