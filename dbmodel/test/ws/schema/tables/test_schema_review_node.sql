...
SELECT columns_are(
    'review_node',
    ARRAY[
        'node_id', 'top_elev', 'depth', 'nodecat_id', 'annotation', 'observ',
        'review_obs', 'expl_id', 'the_geom', 'field_checked', 'is_validated', 'field_date'
    ],
    'Table review_node should have the correct columns'
);

-- Check column types
SELECT col_type_is('review_node', 'node_id', 'int4', 'Column node_id should be int4');
...
SELECT col_type_is('review_node', 'nodecat_id', 'varchar(30)', 'Column nodecat_id should be varchar(30)');
...
SELECT col_type_is('review_node', 'expl_id', 'int4', 'Column expl_id should be int4');
SELECT col_type_is('review_node', 'the_geom', 'geometry(point, SRID_VALUE)', 'Column the_geom should be geometry(point, SRID_VALUE)');
SELECT col_type_is('review_node', 'field_checked', 'bool', 'Column field_checked should be bool');
SELECT col_type_is('review_node', 'is_validated', 'int4', 'Column is_validated should be int4');
