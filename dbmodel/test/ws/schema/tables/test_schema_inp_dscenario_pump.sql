...
-- Check column types
SELECT col_type_is('inp_dscenario_pump', 'dscenario_id', 'int4', 'Column dscenario_id should be int4');
SELECT col_type_is('inp_dscenario_pump', 'node_id', 'int4', 'Column node_id should be int4');
...
SELECT col_type_is('inp_dscenario_pump', 'energy_price', 'float8', 'Column energy_price should be float8');
...
SELECT fk_ok('inp_dscenario_pump', 'dscenario_id', 'cat_dscenario', 'dscenario_id', 'FK dscenario_id → cat_dscenario.dscenario_id');
SELECT fk_ok('inp_dscenario_pump', 'curve_id', 'inp_curve', 'id', 'FK curve_id → inp_curve.id');
SELECT fk_ok('inp_dscenario_pump', 'node_id', 'inp_pump', 'node_id', 'FK node_id → inp_pump.node_id');
SELECT fk_ok('inp_dscenario_pump', 'pattern_id', 'inp_pattern', 'pattern_id', 'FK pattern_id → inp_pattern.pattern_id');
SELECT fk_ok('inp_dscenario_pump', 'energy_pattern_id', 'inp_pattern', 'pattern_id', 'FK energy_pattern_id → inp_pattern.pattern_id');
