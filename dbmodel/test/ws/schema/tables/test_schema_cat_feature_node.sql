...
SELECT columns_are(
    'cat_feature_node',
    ARRAY[
        'id', 'epa_default', 'num_arcs', 'choose_hemisphere', 'isarcdivide', 'graph_delimiter',
        'isprofilesurface', 'double_geom'
    ],
...
SELECT fk_ok('cat_feature_node', 'id', 'cat_feature', 'id', 'FK id → cat_feature.id');
