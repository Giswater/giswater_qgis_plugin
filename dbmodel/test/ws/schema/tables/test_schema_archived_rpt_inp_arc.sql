...
-- Check column types
SELECT col_type_is('archived_rpt_inp_arc', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('archived_rpt_inp_arc', 'result_id', 'varchar(30)', 'Column result_id should be varchar(30)');
SELECT col_type_is('archived_rpt_inp_arc', 'arc_id', 'varchar(16)', 'Column arc_id should be varchar(16)');
SELECT col_type_is('archived_rpt_inp_arc', 'node_1', 'varchar(16)', 'Column node_1 should be varchar(16)');
SELECT col_type_is('archived_rpt_inp_arc', 'node_2', 'varchar(16)', 'Column node_2 should be varchar(16)');
...
SELECT col_type_is('archived_rpt_inp_arc', 'status', 'varchar(18)', 'Column status should be varchar(18)');
SELECT col_type_is('archived_rpt_inp_arc', 'the_geom', 'geometry(linestring, SRID_VALUE)', 'Column the_geom should be geometry(linestring, SRID_VALUE)');
...
SELECT col_type_is('archived_rpt_inp_arc', 'dma_id', 'int4', 'Column dma_id should be int4');
SELECT col_type_is('archived_rpt_inp_arc', 'presszone_id', 'text', 'Column presszone_id should be text');
SELECT col_type_is('archived_rpt_inp_arc', 'dqa_id', 'int4', 'Column dqa_id should be int4');
SELECT col_type_is('archived_rpt_inp_arc', 'minsector_id', 'int4', 'Column minsector_id should be int4');
