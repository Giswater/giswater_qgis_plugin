...
SELECT col_type_is('rpt_inp_node', 'node_id', 'character varying(16)', 'Column node_id should be character varying(16)');
...
SELECT col_type_is('rpt_inp_node', 'nodeparent', 'character varying(16)', 'Column nodeparent should be character varying(16)');
...
SELECT col_type_is('rpt_inp_node', 'presszone_id', 'text', 'Column presszone_id should be text');
