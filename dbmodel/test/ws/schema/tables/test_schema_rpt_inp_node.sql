...
SELECT col_type_is('rpt_inp_node', 'demand', 'float8', 'Column demand should be float8');
...
SELECT col_type_is('rpt_inp_node', 'pattern_id', 'varchar(16)', 'Column pattern_id should be varchar(16)');
SELECT col_type_is('rpt_inp_node', 'addparam', 'text', 'Column addparam should be text');
SELECT col_type_is('rpt_inp_node', 'nodeparent', 'varchar(16)', 'Column nodeparent should be varchar(16)');
SELECT col_type_is('rpt_inp_node', 'arcposition', 'int2', 'Column arcposition should be int2');
SELECT col_type_is('rpt_inp_node', 'dma_id', 'int4', 'Column dma_id should be int4');
SELECT col_type_is('rpt_inp_node', 'presszone_id', 'int4', 'Column presszone_id should be int4');
SELECT col_type_is('rpt_inp_node', 'dqa_id', 'int4', 'Column dqa_id should be int4');
SELECT col_type_is('rpt_inp_node', 'minsector_id', 'int4', 'Column minsector_id should be int4');
