...
-- Check column types
SELECT col_type_is('cat_brand_model', 'id', 'varchar(50)', 'Column id should be varchar(50)');
...
SELECT fk_ok('cat_brand_model', 'catbrand_id', 'cat_brand', 'id', 'FK catbrand_id → cat_brand.id');
