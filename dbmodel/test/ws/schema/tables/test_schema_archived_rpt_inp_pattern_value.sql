...
SELECT columns_are(
    ...
    ARRAY[
        'id', 'result_id', 'dma_id', 'pattern_id', 'idrow', 'factor_1',
        'factor_2', 'factor_3', 'factor_4', 'factor_5', 'factor_6', 'factor_7',
        'factor_8', 'factor_9', 'factor_10', 'factor_11', 'factor_12', 'factor_13',
        'factor_14', 'factor_15', 'factor_16', 'factor_17', 'factor_18', 'user_name'
    ],
    'Table archived_rpt_inp_pattern_value should have the correct columns'
);

-- Check column types
SELECT col_type_is('archived_rpt_inp_pattern_value', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('archived_rpt_inp_pattern_value', 'result_id', 'varchar(16)', 'Column result_id should be varchar(16)');
SELECT col_type_is('archived_rpt_inp_pattern_value', 'dma_id', 'int4', 'Column dma_id should be int4');
SELECT col_type_is('archived_rpt_inp_pattern_value', 'pattern_id', 'varchar(16)', 'Column pattern_id should be varchar(16)');
SELECT col_type_is('archived_rpt_inp_pattern_value', 'idrow', 'int4', 'Column idrow should be int4');
