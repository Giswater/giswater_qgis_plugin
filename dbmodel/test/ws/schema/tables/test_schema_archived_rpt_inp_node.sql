...
-- Check column types
SELECT col_type_is('archived_rpt_inp_node', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('archived_rpt_inp_node', 'result_id', 'varchar(30)', 'Column result_id should be varchar(30)');
SELECT col_type_is('archived_rpt_inp_node', 'node_id', 'varchar(16)', 'Column node_id should be varchar(16)');
...
SELECT col_type_is('archived_rpt_inp_node', 'sector_id', 'int4', 'Column sector_id should be int4');
...
SELECT col_type_is('archived_rpt_inp_node', 'demand', 'float8', 'Column demand should be float8');
SELECT col_type_is('archived_rpt_inp_node', 'the_geom', 'geometry(point, SRID_VALUE)', 'Column the_geom should be geometry(point, SRID_VALUE)');
SELECT col_type_is('archived_rpt_inp_node', 'expl_id', 'int4', 'Column expl_id should be int4');
SELECT col_type_is('archived_rpt_inp_node', 'pattern_id', 'varchar(16)', 'Column pattern_id should be varchar(16)');
SELECT col_type_is('archived_rpt_inp_node', 'addparam', 'text', 'Column addparam should be text');
SELECT col_type_is('archived_rpt_inp_node', 'nodeparent', 'varchar(16)', 'Column nodeparent should be varchar(16)');
SELECT col_type_is('archived_rpt_inp_node', 'arcposition', 'int2', 'Column arcposition should be int2');
SELECT col_type_is('archived_rpt_inp_node', 'dma_id', 'int4', 'Column dma_id should be int4');
SELECT col_type_is('archived_rpt_inp_node', 'presszone_id', 'text', 'Column presszone_id should be text');
SELECT col_type_is('archived_rpt_inp_node', 'dqa_id', 'int4', 'Column dqa_id should be int4');
SELECT col_type_is('archived_rpt_inp_node', 'minsector_id', 'int4', 'Column minsector_id should be int4');
SELECT col_type_is('archived_rpt_inp_node', 'age', 'int4', 'Column age should be int4');

-- Check foreign keys
SELECT has_fk('archived_rpt_inp_node', 'Table archived_rpt_inp_node should have foreign keys');

SELECT fk_ok('archived_rpt_inp_node', 'result_id', 'rpt_cat_result', 'result_id', 'FK result_id → rpt_cat_result.result_id');
