...
SELECT columns_are(
    'arc_add',
    ARRAY[
        'arc_id', 'result_id', 'flow_max', 'flow_min', 'flow_avg', 'vel_max',
...
-- Check column types
SELECT col_type_is('arc_add', 'arc_id', 'int4', 'Column arc_id should be int4');
...
SELECT col_type_is('arc_add', 'mincut_connecs', 'int4', 'Column mincut_connecs should be int4');
SELECT col_type_is('arc_add', 'mincut_hydrometers', 'int4', 'Column mincut_hydrometers should be int4');
...
SELECT col_type_is('arc_add', 'pipe_capacity', 'float8', 'Column pipe_capacity should be float8');
SELECT col_type_is('arc_add', 'mincut_impact_topo', 'json', 'Column mincut_impact_topo should be json');
SELECT col_type_is('arc_add', 'mincut_impact_hydro', 'json', 'Column mincut_impact_hydro should be json');

-- Check foreign keys
SELECT has_fk('arc_add', 'Table arc_add should have foreign keys');

SELECT fk_ok('arc_add', 'arc_id', 'arc', 'arc_id', 'FK arc_id → arc.arc_id');
