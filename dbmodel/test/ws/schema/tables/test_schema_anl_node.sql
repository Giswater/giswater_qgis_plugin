...
SELECT col_type_is('anl_node', 'node_id', 'integer', 'Column node_id should be integer');
...
SELECT col_type_is('anl_node', 'node_id_aux', 'integer', 'Column node_id_aux should be integer');
...
SELECT col_type_is('anl_node', 'arc_id', 'integer', 'Column arc_id should be integer');
