...
-- Check column types
SELECT col_type_is('selector_mincut_result', 'result_id', 'int4', 'Column result_id should be int4');
...
SELECT fk_ok('selector_mincut_result', 'result_id', 'om_mincut', 'id', 'FK result_id → om_mincut.id');
