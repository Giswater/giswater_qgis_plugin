...
SELECT columns_are(
    'node',
    ARRAY[
        'node_id', 'code', 'sys_code', 'top_elev', 'custom_top_elev', 'depth',
        'feature_type', 'nodecat_id', 'epa_type', 'state', 'state_type', 'arc_id',
        ...
        'ownercat_id', 'accessibility', 'om_state', 'conserv_state', 'access_type', 'placement_type',
        'brand_id', 'model_id', 'serial_number', 'asset_id', 'adate', 'adescript',
...
SELECT col_type_is('node', 'top_elev', 'numeric(12,4)', 'Column top_elev should be numeric(12,4)');
SELECT col_type_is('node', 'custom_top_elev', 'numeric(12,4)', 'Column custom_top_elev should be numeric(12,4)');
SELECT col_type_is('node', 'depth', 'numeric(12,4)', 'Column depth should be numeric(12,4)');
...
SELECT col_type_is('node', 'supplyzone_id', 'int4', 'Column supplyzone_id should be int4');
SELECT col_type_is('node', 'presszone_id', 'int4', 'Column presszone_id should be int4');
SELECT col_type_is('node', 'dma_id', 'int4', 'Column dma_id should be int4');
SELECT col_type_is('node', 'dqa_id', 'int4', 'Column dqa_id should be int4');
...
SELECT col_type_is('node', 'soilcat_id', 'varchar(30)', 'Column soilcat_id should be varchar(30)');
...
SELECT col_type_is('node', 'fluid_type', 'varchar(50)', 'Column fluid_type should be varchar(50)');
SELECT col_type_is('node', 'staticpressure', 'numeric(12,3)', 'Column staticpressure should be numeric(12,3)');
...
SELECT col_type_is('node', 'descript', 'varchar(254)', 'Column descript should be varchar(254)');
...
SELECT col_type_is('node', 'accessibility', 'int2', 'Column accessibility should be int2');
SELECT col_type_is('node', 'om_state', 'text', 'Column om_state should be text');
...
SELECT col_type_is('node', 'placement_type', 'text', 'Column placement_type should be text');
...
SELECT col_type_is('node', 'expl_visibility', 'int4[]', 'Column expl_visibility should be int4[]');
...
SELECT fk_ok('node', 'arc_id', 'arc', 'arc_id', 'FK arc_id → arc.arc_id');
SELECT fk_ok('node', 'dma_id', 'dma', 'dma_id', 'FK dma_id → dma.dma_id');
SELECT fk_ok('node', 'dqa_id', 'dqa', 'dqa_id', 'FK dqa_id → dqa.dqa_id');
...
SELECT fk_ok('node', 'presszone_id', 'presszone', 'presszone_id', 'FK presszone_id → presszone.presszone_id');
...
SELECT fk_ok('node', 'supplyzone_id', 'supplyzone', 'supplyzone_id', 'FK supplyzone_id → supplyzone.supplyzone_id');
...
SELECT fk_ok('node', 'fluid_type', 'man_type_fluid', 'fluid_type', 'FK fluid_type → man_type_fluid.fluid_type');
