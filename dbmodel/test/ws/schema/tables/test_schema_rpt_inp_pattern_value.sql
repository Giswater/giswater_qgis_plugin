...
-- Check column types
SELECT col_type_is('rpt_inp_pattern_value', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('rpt_inp_pattern_value', 'result_id', 'varchar(100)', 'Column result_id should be varchar(100)');
SELECT col_type_is('rpt_inp_pattern_value', 'dma_id', 'int4', 'Column dma_id should be int4');
SELECT col_type_is('rpt_inp_pattern_value', 'pattern_id', 'varchar(16)', 'Column pattern_id should be varchar(16)');
SELECT col_type_is('rpt_inp_pattern_value', 'idrow', 'int4', 'Column idrow should be int4');
...
SELECT fk_ok('rpt_inp_pattern_value', 'dma_id', 'dma', 'dma_id', 'FK dma_id → dma.dma_id');
SELECT fk_ok('rpt_inp_pattern_value', 'result_id', 'rpt_cat_result', 'result_id', 'FK result_id → rpt_cat_result.result_id');
