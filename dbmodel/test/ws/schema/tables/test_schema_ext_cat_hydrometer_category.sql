...
-- Check foreign keys
SELECT has_fk('ext_cat_hydrometer_category', 'Table ext_cat_hydrometer_category should have foreign keys');

SELECT fk_ok('ext_cat_hydrometer_category', 'pattern_id', 'inp_pattern', 'pattern_id', 'FK pattern_id → inp_pattern.pattern_id');
