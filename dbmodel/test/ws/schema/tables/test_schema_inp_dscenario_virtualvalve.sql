...
SELECT columns_are(
    ...
    ARRAY[
        'dscenario_id', 'arc_id', 'valve_type', 'diameter', 'setting', 'curve_id', 'minorloss', 'status', 'init_quality'
    ],
...
SELECT col_type_is('inp_dscenario_virtualvalve', 'arc_id', 'integer', 'Column arc_id should be integer');
