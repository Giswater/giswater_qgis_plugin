...
SELECT columns_are(
    'node_add',
    ARRAY[
        'node_id', 'demand_max', 'demand_min', 'demand_avg', 'press_max', 'press_min',
        'press_avg', 'head_max', 'head_min', 'head_avg', 'quality_max', 'quality_min',
        'quality_avg', 'result_id', 'flow_max', 'flow_min', 'flow_avg', 'vel_max',
        'vel_min', 'vel_avg'
    ],
