...
SELECT col_type_is('anl_arc_x_node', 'arc_id', 'character varying(16)', 'Column arc_id should be varchar(16)');
SELECT col_type_is('anl_arc_x_node', 'node_id', 'character varying(16)', 'Column node_id should be varchar(16)');
