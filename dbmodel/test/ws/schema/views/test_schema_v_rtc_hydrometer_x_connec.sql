...
SELECT col_type_is('v_rtc_hydrometer_x_connec', 'plot_code', 'varchar(100)', 'Column plot_code should be varchar(100)');
...
SELECT col_type_is('v_rtc_hydrometer_x_connec', 'm3_volume', 'float8', 'Column m3_volume should be float8');
...
SELECT col_type_is('v_rtc_hydrometer_x_connec', 'is_operative', 'bool', 'Column is_operative should be bool');
SELECT col_type_is('v_rtc_hydrometer_x_connec', 'shutdown_date', 'date', 'Column shutdown_date should be date');
