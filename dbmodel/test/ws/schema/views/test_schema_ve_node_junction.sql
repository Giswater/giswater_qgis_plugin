...
SELECT col_type_is('ve_node_junction', 'supplyzone_type', 'varchar(16)', 'Column supplyzone_type should be varchar(16)');
SELECT col_type_is('ve_node_junction', 'presszone_id', 'int4', 'Column presszone_id should be int4');
SELECT col_type_is('ve_node_junction', 'presszone_type', 'varchar(16)', 'Column presszone_type should be varchar(16)');
...
SELECT col_type_is('ve_node_junction', 'dma_type', 'varchar(16)', 'Column dma_type should be varchar(16)');
...
SELECT col_type_is('ve_node_junction', 'dqa_type', 'varchar(16)', 'Column dqa_type should be varchar(16)');
...
SELECT col_type_is('ve_node_junction', 'omzone_type', 'varchar(16)', 'Column omzone_type should be varchar(16)');
