...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'sector_id', 'expl_id', 'state', 'annotation', 'soilcat_id', 'y1',
...
SELECT col_type_is('v_plan_result_arc', 'arc_type', 'varchar', 'Column arc_type should be varchar');
...
SELECT col_type_is('v_plan_result_arc', 'bulk', 'numeric', 'Column bulk should be numeric');
...
SELECT col_type_is('v_plan_result_arc', 'other_budget', 'numeric(12,2)', 'Column other_budget should be numeric(12,2)');
