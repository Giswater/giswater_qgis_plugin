...
SELECT col_type_is('v_plan_arc', 'arc_type', 'varchar(30)', 'Column arc_type should be varchar(30)');
...
SELECT col_type_is('v_plan_arc', 'y1', 'numeric(12,4)', 'Column y1 should be numeric(12,4)');
SELECT col_type_is('v_plan_arc', 'y2', 'numeric(12,4)', 'Column y2 should be numeric(12,4)');
...
SELECT col_type_is('v_plan_arc', 'bulk', 'numeric(12,4)', 'Column bulk should be numeric(12,4)');
...
SELECT col_type_is('v_plan_arc', 'other_budget', 'numeric(12,2)', 'Column other_budget should be numeric(12,2)');
