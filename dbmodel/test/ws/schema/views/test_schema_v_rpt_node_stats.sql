...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'top_elev', 'demand_max', 'demand_min', 'demand_avg', 'head_max', 'head_min',
        'head_avg', 'press_max', 'press_min', 'press_avg', 'quality_units', 'quality_max',
        'quality_min', 'quality_avg', 'the_geom'
    ],
