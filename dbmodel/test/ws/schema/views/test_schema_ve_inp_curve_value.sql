...
SELECT col_type_is('ve_inp_curve_value', 'x_value', 'numeric(12,4)', 'Column x_value should be numeric(12,4)');
SELECT col_type_is('ve_inp_curve_value', 'y_value', 'numeric(12,4)', 'Column y_value should be numeric(12,4)');
