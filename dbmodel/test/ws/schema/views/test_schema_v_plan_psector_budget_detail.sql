...
SELECT col_type_is('v_plan_psector_budget_detail', 'y1', 'numeric(12,4)', 'Column y1 should be numeric(12,4)');
SELECT col_type_is('v_plan_psector_budget_detail', 'y2', 'numeric(12,4)', 'Column y2 should be numeric(12,4)');
