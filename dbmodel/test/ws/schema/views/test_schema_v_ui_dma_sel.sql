...
SELECT col_type_is('v_ui_dma_sel', 'macrodma', 'varchar(100)', 'Column macrodma should be varchar(100)');
...
SELECT col_type_is('v_ui_dma_sel', 'avg_press', 'numeric', 'Column avg_press should be numeric');
SELECT col_type_is('v_ui_dma_sel', 'pattern_id', 'varchar(16)', 'Column pattern_id should be varchar(16)');
SELECT col_type_is('v_ui_dma_sel', 'effc', 'float8', 'Column effc should be float8');
...
SELECT col_type_is('v_ui_dma_sel', 'created_at', 'timestamp with time zone', 'Column created_at should be timestamp with time zone');
SELECT col_type_is('v_ui_dma_sel', 'created_by', 'varchar(50)', 'Column created_by should be varchar(50)');
SELECT col_type_is('v_ui_dma_sel', 'updated_at', 'timestamp with time zone', 'Column updated_at should be timestamp with time zone');
SELECT col_type_is('v_ui_dma_sel', 'updated_by', 'varchar(50)', 'Column updated_by should be varchar(50)');
