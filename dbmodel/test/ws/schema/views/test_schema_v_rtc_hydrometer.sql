...
SELECT col_type_is('v_rtc_hydrometer', 'customer_code', 'varchar(30)', 'Column customer_code should be varchar(30)');
...
SELECT col_type_is('v_rtc_hydrometer', 'plot_code', 'varchar(100)', 'Column plot_code should be varchar(100)');
...
SELECT col_type_is('v_rtc_hydrometer', 'm3_volume', 'float8', 'Column m3_volume should be float8');
