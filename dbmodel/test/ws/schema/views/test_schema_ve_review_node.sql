...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'review_obs', 'expl_id', 'the_geom', 'field_date', 'field_checked', 'is_validated'
    ],
...
SELECT col_type_is('ve_review_node', 'depth', 'numeric(12,3)', 'Column depth should be numeric(12,3)');
