...
SELECT col_type_is('ve_node_bypass_register', 'sector_type', 'varchar(16)', 'Column sector_type should be varchar(16)');
SELECT col_type_is('ve_node_bypass_register', 'supplyzone_id', 'int4', 'Column supplyzone_id should be int4');
SELECT col_type_is('ve_node_bypass_register', 'supplyzone_type', 'varchar(16)', 'Column supplyzone_type should be varchar(16)');
SELECT col_type_is('ve_node_bypass_register', 'presszone_id', 'int4', 'Column presszone_id should be int4');
SELECT col_type_is('ve_node_bypass_register', 'presszone_type', 'varchar(16)', 'Column presszone_type should be varchar(16)');
...
SELECT col_type_is('ve_node_bypass_register', 'dma_type', 'varchar(16)', 'Column dma_type should be varchar(16)');
...
SELECT col_type_is('ve_node_bypass_register', 'dqa_type', 'varchar(16)', 'Column dqa_type should be varchar(16)');
...
SELECT col_type_is('ve_node_bypass_register', 'omzone_type', 'varchar(16)', 'Column omzone_type should be varchar(16)');
