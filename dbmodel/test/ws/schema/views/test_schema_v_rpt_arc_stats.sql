...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'arccat_id', 'flow_max', 'flow_min', 'flow_avg', 'vel_max', 'vel_min',
        'vel_avg', 'headloss_max', 'headloss_min', 'setting_max', 'setting_min', 'reaction_max',
        'reaction_min', 'ffactor_max', 'ffactor_min', 'length', 'tot_headloss_max', 'tot_headloss_min',
        'diameter', 'the_geom'
    ],
