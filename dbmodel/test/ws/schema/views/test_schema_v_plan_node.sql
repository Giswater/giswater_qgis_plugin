...
SELECT col_type_is('v_plan_node', 'node_type', 'varchar(30)', 'Column node_type should be varchar(30)');
SELECT col_type_is('v_plan_node', 'top_elev', 'numeric(12,4)', 'Column top_elev should be numeric(12,4)');
SELECT col_type_is('v_plan_node', 'elev', 'numeric', 'Column elev should be numeric');
