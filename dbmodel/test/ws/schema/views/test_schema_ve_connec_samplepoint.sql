...
SELECT col_type_is('ve_connec_samplepoint', 'supplyzone_type', 'varchar(16)', 'Column supplyzone_type should be varchar(16)');
SELECT col_type_is('ve_connec_samplepoint', 'presszone_id', 'int4', 'Column presszone_id should be int4');
SELECT col_type_is('ve_connec_samplepoint', 'presszone_type', 'varchar(16)', 'Column presszone_type should be varchar(16)');
...
SELECT col_type_is('ve_connec_samplepoint', 'dma_type', 'varchar', 'Column dma_type should be varchar');
...
SELECT col_type_is('ve_connec_samplepoint', 'dqa_type', 'varchar(16)', 'Column dqa_type should be varchar(16)');
