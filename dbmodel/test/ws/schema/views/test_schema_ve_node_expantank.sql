...
SELECT col_type_is('ve_node_expantank', 'dataquality', 'int4', 'Column dataquality should be int4');
SELECT col_type_is('ve_node_expantank', 'dataquality_obs', 'int4[]', 'Column dataquality_obs should be int4[]');
