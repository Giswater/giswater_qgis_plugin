...
SELECT trigger_is('config_visit_parameter', 'gw_trg_typevalue_fk_insert', 'gw_trg_typevalue_fk');
SELECT trigger_is('config_visit_parameter', 'gw_trg_typevalue_fk_update', 'gw_trg_typevalue_fk');
...
SELECT has_check('config_visit_parameter', 'Table config_visit_parameter should have check constraints');
