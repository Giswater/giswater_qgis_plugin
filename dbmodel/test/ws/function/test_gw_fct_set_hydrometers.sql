...
SELECT is(
    ...
    "data":{"action":"INSERT", "hydrometers":[
        {"code":"TEST_H001", "hydro_number":"12345", "feature_id":3001, "link":"http://test.com",
...
SELECT is(
    ...
    "data":{"action":"INSERT", "hydrometers":[
        ...
        {"code":"TEST_H003", "hydro_number":"12347", "featuer_id":3003, "state_id":1, "catalog_id":1, "category_id":1, "priority_id":1, "exploitation":1}
    ]}}$$)::JSON)->>'status',
    'Accepted',
...
-- Test 5: Update single hydrometer
SELECT is(
    (gw_fct_set_hydrometers($${"client":{"device":5, "infoType":1, "lang":"ES"},
...
-- Test 8: Update multiple hydrometers
SELECT is(
    (gw_fct_set_hydrometers($${"client":{"device":5, "infoType":1, "lang":"ES"},
    "data":{"action":"UPDATE", "hydrometers":[
...
-- Test 9: Delete single hydrometer
SELECT is(
    (gw_fct_set_hydrometers($${"client":{"device":5, "infoType":1, "lang":"ES"},
...
-- Test 11: Delete multiple hydrometers
SELECT is(
    (gw_fct_set_hydrometers($${"client":{"device":5, "infoType":1, "lang":"ES"},
    "data":{"action":"DELETE", "hydrometers":[
        {"code":"TEST_H002"},
...
-- Test 12: REPLACE action (delete all and insert new ones)
...
-- Test 13: Verify old hydrometers were deleted
SELECT is(
...
-- Test 14: Verify new hydrometers were inserted
SELECT is(
