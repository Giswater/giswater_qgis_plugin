...
SELECT is (
    ...
    "pageInfo":{}, "selectionMode":"wholeSelection","parameters":{"arcSearchNodes":"0.5"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_anl_arc_no_startend_node with aux_params and tableName : ve_inp_pipe returns status "Accepted"'
);

SELECT is (
    (gw_fct_anl_arc_no_startend_node($${"client":{"device":4, "lang":"en_US", "infoType":1, "epsg":25831},
    "form":{}, "feature":{"tableName":"ve_inp_virtualpump", "featureType":"ARC", "id":[]}, "data":{"filterFields":{},
    "pageInfo":{}, "selectionMode":"wholeSelection","parameters":{"arcSearchNodes":"0.5"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_anl_arc_no_startend_node with aux_params and tableName : ve_inp_virtualpump returns status "Accepted"'
);
