...
SELECT is(
    ...
    "v_om_mincut_valve", "v_om_mincut_node", "v_om_mincut_connec", "v_om_mincut_arc", "ve_node", "ve_connec", "ve_arc", "ve_link",
    "ve_pol_connec", "ve_pol_node", "ve_dimensions", "ve_inp_reservoir", "ve_inp_tank", "ve_inp_inlet", "ve_inp_junction",
    "ve_inp_shortpipe", "ve_inp_valve", "ve_inp_pump", "ve_inp_connec", "ve_inp_pipe", "ve_inp_virtualvalve",
    "ve_inp_virtualpump", "v_rpt_node", "v_rpt_node", "v_rpt_arc", "v_plan_psector_connec", "v_plan_psector_node", "v_plan_psector_arc",
