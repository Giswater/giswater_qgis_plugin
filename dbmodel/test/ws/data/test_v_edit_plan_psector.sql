...
INSERT INTO v_edit_plan_psector ( "name", descript, priority, text1, text2, observ, rotation, "scale", atlas_id, gexpenses, vat, other, the_geom, expl_id, psector_type, active, ext_code, status, text3, text4, text5, text6, num_value, workcat_id, parent_id)
