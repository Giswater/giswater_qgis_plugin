...
UPDATE v_edit_inp_pattern SET active = false WHERE pattern_id = '-901';
SELECT is((SELECT active FROM v_edit_inp_pattern WHERE pattern_id = '-901'), false, 'UPDATE: v_edit_inp_pattern -901 was updated');
SELECT is((SELECT active FROM inp_pattern WHERE pattern_id = '-901'), false, 'UPDATE: inp_pattern -901 was updated');
