...
SELECT gw_fct_anl_arc_duplicated($${"client":{"device":4, "infoType":1, "lang":"ES"},
"form":{},"feature":{"tableName":"v_edit_arc", "id":[132,133]}, "data":{"filterFields":{}, "pageInfo":{}, "selectionMode":"previousSelection",
"parameters":{"checkType":"finalNodes"}}}$$)::JSON

-- gw_fct_anl_arc_length
SELECT gw_fct_anl_arc_length($${"client":{"device":4, "infoType":1, "lang":"ES"}, "form":{},"feature":{"tableName":"v_edit_arc", 
"featureType":"ARC", "id":[132,133]}, "data":{"selectionMode":"previousSelection","parameters":{"arcLength":"3"}}}$$)::JSON
...
"feature":{"tableName":"v_edit_arc", "id":[132,133]}, "data":{"selectionMode":"previousSelection","parameters":{}}}$$);
