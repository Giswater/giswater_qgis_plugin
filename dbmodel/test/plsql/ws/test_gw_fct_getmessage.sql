...
VALUES(2, 'Test Message: Feature is out of exploitation, feature_id: %feature_id%', 'Take a look on your map and use the approach of the exploitations!', 1, true, 'utils', 'core');

INSERT INTO sys_message
(id, error_message, hint_message, log_level, show_user, project_type, source)
VALUES(3, 'Test Message: Feature is out of exploitation, feature_id: %feature_id%', 'Take a look on your map and use the approach of the exploitations!', 2, true, 'utils', 'core');

INSERT INTO sys_message
(id, error_message, hint_message, log_level, show_user, project_type, source)
VALUES(4, 'Test Message: Feature is out of exploitation, feature_id: %feature_id%', 'Take a look on your map and use the approach of the exploitations!', 3, true, 'utils', 'core');

INSERT INTO sys_message
(id, error_message, hint_message, log_level, show_user, project_type, source)
VALUES(5, 'Test Message: Feature is out of exploitation, feature_id: %feature_id%', 'Take a look on your map and use the approach of the exploitations!', 0, true, 'utils', 'core');


-- insert function
INSERT INTO sys_function
(id, function_name, project_type, function_type)
VALUES (100, 'gw_test_function', 'utils', 'trigger');


SELECT is(
    (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
    "data":{"message":"2", "function":"100","parameters":null, "variables":"value", "is_process":true}}$$)::JSON)->'message'->>'text',
...
SELECT is(
    (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
    "data":{"message":"2", "function":"100","parameters":{"expl_id": 1}, "variables":"value", "is_process":true}}$$)::JSON)->'message'->>'text',
    'Error in message parameters',
...
SELECT is (
    (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
    "data":{"message":"2", "function":"100","parameters":{"feature_id": 1, "expl_id": 2}, "variables":"value", "is_process":true}}$$)::JSON)->'message'->>'text',
    'Error in message parameters',
...
SELECT is (
    (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
    "data":{"message":"6", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":true}}$$)::JSON)->'body'->'data'->'info'->>'text',
...
-- Test JSON response when function does not exist
    SELECT is(
        (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
            "data":{"message":"2", "function":"200","parameters":{"feature_id": 1}, "variables":"value", "is_process":true}}$$)::JSON)->'message'->>'text',
...
-- is_process = true
    ...
    SELECT throws_ok(
        'SELECT (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
            "data":{"message":"2", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":true}}$$))',
            'GW001',
    ...
    SELECT throws_ok(
        'SELECT (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
            "data":{"message":"3", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":true}}$$))',
            'GW002',
            'Function: [gw_test_function] - TEST MESSAGE: FEATURE IS OUT OF EXPLOITATION, FEATURE_ID: 1. HINT: TAKE A LOOK ON YOUR MAP AND USE THE APPROACH OF THE EXPLOITATIONS! - value',
    ...
    SELECT is (
        (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
        "data":{"message":"4", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":true}}$$)::JSON)->'body'->'data'->'info'->>'text',
    ...
    SELECT is (
        (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
        "data":{"message":"5", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":true}}$$)::JSON)->>'text',
        'TEST MESSAGE: FEATURE IS OUT OF EXPLOITATION, FEATURE_ID: 1',
...
--v_debug = true
    ...
    SELECT is (
        (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
        "data":{"message":"4", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":false}}$$)::JSON)->'body'->'data'->'info'->>'text',
        'Function: gw_test_function - TEST MESSAGE: FEATURE IS OUT OF EXPLOITATION, FEATURE_ID: 1. HINT: TAKE A LOOK ON YOUR MAP AND USE THE APPROACH OF THE EXPLOITATIONS!.',
    ...
    SELECT is (
        (gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
        "data":{"message":"5", "function":"100","parameters":{"feature_id": 1}, "variables":"value", "is_process":false}}$$)::JSON)->'body'->'data'->'info'->>'text',
        'Function: gw_test_function - TEST MESSAGE: FEATURE IS OUT OF EXPLOITATION, FEATURE_ID: 1. HINT: TAKE A LOOK ON YOUR MAP AND USE THE APPROACH OF THE EXPLOITATIONS!.',
