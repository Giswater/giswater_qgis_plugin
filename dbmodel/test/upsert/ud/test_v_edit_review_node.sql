...
INSERT INTO v_edit_review_node (node_id, top_elev, ymax, node_type, matcat_id, nodecat_id, step_pp, step_fe, step_replace, cover, annotation, observ, review_obs, expl_id, the_geom, field_date, field_checked, is_validated)
VALUES('-901', 0, 0, '', '', '', 0, 0, 0, '', '', '', '', 0, null, null, false, 0);
