...
(gully_id, code, top_elev, ymax, sandbox, matcat_id, gully_type, sys_type, gullycat_id, cat_gully_matcat, units, groove, groove_height, groove_length, siphon, connec_arccat_id, connec_length, connec_depth, connec_matcat_id, connec_y1, connec_y2, grate_width, grate_length, arc_id, epa_type, inp_type, state, state_type, expl_id, macroexpl_id, sector_id, macrosector_id, drainzone_id, dma_id, macrodma_id, annotation, observ, "comment", soilcat_id, function_type, category_type, fluid_type, location_type, workcat_id, workcat_id_end, workcat_id_plan, buildercat_id, builtdate, enddate, ownercat_id, muni_id, postcode, district_id, streetname, postnumber, postcomplement, streetname2, postnumber2, postcomplement2, region_id, province_id, descript, svg, rotation, link, verified, undelete, "label", label_x, label_y, label_rotation, publish, inventory, uncertain, num_value, pjoint_id, pjoint_type, asset_id, gullycat2_id, units_placement, expl_id2, is_operative, adate, adescript, siphon_type, odorflap, placement_type, tstamp, insert_user, lastupdate, lastupdate_user, the_geom)
