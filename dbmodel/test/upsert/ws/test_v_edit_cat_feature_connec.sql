...
UPDATE v_edit_cat_feature_connec SET epa_default = 'JUNCTION' WHERE id = '999001';
SELECT is((SELECT epa_default FROM v_edit_cat_feature_connec WHERE id = '999001'), 'JUNCTION', 'UPDATE: v_edit_cat_feature_connec 999001 was updated');
...
DELETE FROM v_edit_cat_feature_connec WHERE id = '999001';
SELECT is((SELECT count(*)::integer FROM v_edit_cat_feature_connec WHERE id = '999001'), 0, 'DELETE: v_edit_cat_feature_connec 999001 was deleted');
