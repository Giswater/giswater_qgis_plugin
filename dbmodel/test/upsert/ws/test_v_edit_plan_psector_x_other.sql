...
UPDATE v_edit_plan_psector_x_other SET unit = 'updated unit' WHERE id = -901;
SELECT is((SELECT unit FROM v_edit_plan_psector_x_other WHERE id = -901), 'updated unit', 'UPDATE: v_edit_plan_psector_x_other -901 was updated');
SELECT is((SELECT unit FROM plan_psector_x_connec WHERE id = -901), 'updated unit', 'UPDATE: plan_psector_x_connec -901 was updated');
