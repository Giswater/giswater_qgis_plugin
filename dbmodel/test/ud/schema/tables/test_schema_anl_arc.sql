...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'elev1', 'elev2', 'dma_id', 'addparam', 'sector_id', 'drainzone_id',
        'dwfzone_id', 'omunit_id', 'state_type'
    ],
...
SELECT col_type_is('anl_arc', 'drainzone_id', 'int4', 'Column drainzone_id should be int4');
SELECT col_type_is('anl_arc', 'dwfzone_id', 'int4', 'Column dwfzone_id should be int4');
SELECT col_type_is('anl_arc', 'omunit_id', 'int4', 'Column omunit_id should be int4');
...
SELECT fk_ok('anl_arc', 'dwfzone_id', 'dwfzone', 'dwfzone_id', 'FK dwfzone_id → dwfzone.dwfzone_id');
SELECT fk_ok('anl_arc', 'drainzone_id', 'drainzone', 'drainzone_id', 'FK drainzone_id → drainzone.drainzone_id');
