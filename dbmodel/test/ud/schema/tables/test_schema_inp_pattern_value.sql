...
SELECT columns_are(
    'inp_pattern_value',
    ARRAY[
        'pattern_id', 'factor_1', 'factor_2', 'factor_3', 'factor_4', 'factor_5',
        'factor_6', 'factor_7', 'factor_8', 'factor_9', 'factor_10', 'factor_11',
        'factor_12', 'factor_13', 'factor_14', 'factor_15', 'factor_16', 'factor_17',
        'factor_18', 'factor_19', 'factor_20', 'factor_21', 'factor_22', 'factor_23',
        'factor_24'
    ],
...
SELECT col_type_is('inp_pattern_value', 'factor_19', 'numeric(12,4)', 'Column factor_19 should be numeric(12,4)');
SELECT col_type_is('inp_pattern_value', 'factor_20', 'numeric(12,4)', 'Column factor_20 should be numeric(12,4)');
SELECT col_type_is('inp_pattern_value', 'factor_21', 'numeric(12,4)', 'Column factor_21 should be numeric(12,4)');
SELECT col_type_is('inp_pattern_value', 'factor_22', 'numeric(12,4)', 'Column factor_22 should be numeric(12,4)');
SELECT col_type_is('inp_pattern_value', 'factor_23', 'numeric(12,4)', 'Column factor_23 should be numeric(12,4)');
SELECT col_type_is('inp_pattern_value', 'factor_24', 'numeric(12,4)', 'Column factor_24 should be numeric(12,4)');
