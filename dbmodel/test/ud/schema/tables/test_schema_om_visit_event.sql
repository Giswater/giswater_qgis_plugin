...
SELECT col_type_is('om_visit_event', 'position_id', 'int4', 'Column position_id should be int4');
...
SELECT fk_ok('om_visit_event', 'position_id', 'node', 'node_id', 'FK position_id → node.node_id');
