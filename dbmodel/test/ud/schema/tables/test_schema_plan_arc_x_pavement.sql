...
-- Check column types
SELECT col_type_is('plan_arc_x_pavement', 'id', 'int4', 'Column id should be int4');
SELECT col_type_is('plan_arc_x_pavement', 'arc_id', 'int4', 'Column arc_id should be int4');
...
SELECT fk_ok('plan_arc_x_pavement', 'pavcat_id', 'cat_pavement', 'id', 'FK pavcat_id → cat_pavement.id');
SELECT fk_ok('plan_arc_x_pavement', 'arc_id', 'arc', 'arc_id', 'FK arc_id → arc.arc_id');
