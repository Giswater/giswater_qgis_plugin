...
SELECT columns_are(
    'cat_soil',
    ARRAY[
        'id', 'descript', 'link', 'y_param', 'b', 'trenchlining',
        'm3exc_cost', 'm3fill_cost', 'm3excess_cost', 'm2trenchl_cost', 'active', 'code'
    ],
...
SELECT fk_ok('cat_soil', 'm2trenchl_cost', 'plan_price', 'id', 'FK m2trenchl_cost → plan_price.id');
SELECT fk_ok('cat_soil', 'm3exc_cost', 'plan_price', 'id', 'FK m3exc_cost → plan_price.id');
SELECT fk_ok('cat_soil', 'm3excess_cost', 'plan_price', 'id', 'FK m3excess_cost → plan_price.id');
SELECT fk_ok('cat_soil', 'm3fill_cost', 'plan_price', 'id', 'FK m3fill_cost → plan_price.id');
