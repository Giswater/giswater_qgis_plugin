...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'code', 'cat_geom1', 'top_elev', 'elev', 'ymax', 'state_type',
        'sector_id', 'addparam', 'drainzone_id', 'dwfzone_id', 'dma_id'
    ],
...
SELECT col_type_is('anl_node', 'drainzone_id', 'int4', 'Column drainzone_id should be int4');
SELECT col_type_is('anl_node', 'dwfzone_id', 'int4', 'Column dwfzone_id should be int4');
...
SELECT fk_ok('anl_node', 'dwfzone_id', 'dwfzone', 'dwfzone_id', 'FK dwfzone_id → dwfzone.dwfzone_id');
SELECT fk_ok('anl_node', 'drainzone_id', 'drainzone', 'drainzone_id', 'FK drainzone_id → drainzone.drainzone_id');
