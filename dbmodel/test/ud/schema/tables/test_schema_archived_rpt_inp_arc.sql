...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'age', 'max_flow', 'time_days', 'time_hour', 'max_veloc', 'mfull_flow',
        'mfull_depth', 'max_shear', 'max_hr', 'max_slope', 'day_max', 'time_max',
        'min_shear', 'day_min', 'time_min', 'poll_id', 'both_ends', 'upstream',
        'dnstream', 'hour_nflow', 'hour_limit', 'percent', 'num_startup', 'min_flow',
        'avg_flow', 'max_flow_pumping', 'vol_ltr', 'powus_kwh', 'timoff_min', 'timoff_max',
        'length_flowclass', 'dry', 'up_dry', 'down_dry', 'sub_crit', 'sub_crit_1',
        'up_crit', 'down_crit', 'froud_numb', 'flow_chang'
    ],
