...
SELECT columns_are(
    'review_audit_node',
    ARRAY[
        'id', 'node_id', 'old_top_elev', 'new_top_elev', 'old_ymax', 'new_ymax',
        'old_node_type', 'new_node_type', 'old_matcat_id', 'new_matcat_id', 'old_nodecat_id', 'new_nodecat_id',
...
SELECT col_type_is('review_audit_node', 'old_ymax', 'numeric(12,3)', 'Column old_ymax should be numeric(12,3)');
SELECT col_type_is('review_audit_node', 'new_ymax', 'numeric(12,3)', 'Column new_ymax should be numeric(12,3)');
SELECT col_type_is('review_audit_node', 'old_node_type', 'varchar(18)', 'Column old_node_type should be varchar(18)');
SELECT col_type_is('review_audit_node', 'new_node_type', 'varchar(18)', 'Column new_node_type should be varchar(18)');
SELECT col_type_is('review_audit_node', 'old_matcat_id', 'varchar(30)', 'Column old_matcat_id should be varchar(30)');
SELECT col_type_is('review_audit_node', 'new_matcat_id', 'varchar(30)', 'Column new_matcat_id should be varchar(30)');
