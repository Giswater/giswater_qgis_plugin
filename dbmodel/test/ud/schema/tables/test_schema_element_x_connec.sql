...
SELECT fk_ok('element_x_connec', 'connec_id', 'connec', 'connec_id', 'FK connec_id → connec.connec_id');
SELECT fk_ok('element_x_connec', 'element_id', 'element', 'element_id', 'FK element_id → element.element_id');
