...
SELECT columns_are(
    'cat_dwf',
    ARRAY[
        'id', 'idval', 'startdate', 'enddate', 'observ', 'active',
        'expl_id', 'log'
    ],
...
SELECT col_type_is('cat_dwf', 'startdate', 'timestamp without time zone', 'Column startdate should be timestamp without time zone');
SELECT col_type_is('cat_dwf', 'enddate', 'timestamp without time zone', 'Column enddate should be timestamp without time zone');
...
SELECT fk_ok('cat_dwf', 'expl_id', 'exploitation', 'expl_id', 'FK expl_id → exploitation.expl_id');
