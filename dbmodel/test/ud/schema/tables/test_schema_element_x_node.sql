...
SELECT fk_ok('element_x_node', 'node_id', 'node', 'node_id', 'FK node_id → node.node_id');
SELECT fk_ok('element_x_node', 'element_id', 'element', 'element_id', 'FK element_id → element.element_id');
