...
SELECT col_type_is('archived_psector_link_traceability', 'the_geom', 'USER-DEFINED', 'Column the_geom should be geometry(linestring, 25831)');
SELECT col_type_is('archived_psector_link_traceability', 'exit_topelev', 'double precision', 'Column exit_topelev should be float8');
SELECT col_type_is('archived_psector_link_traceability', 'exit_elev', 'numeric', 'Column exit_elev should be numeric(12,3)');
...
SELECT col_type_is('archived_psector_link_traceability', 'expl_visibility', 'int2', 'Column expl_visibility should be int2');
