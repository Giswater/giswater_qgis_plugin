...
SELECT col_type_is('archived_psector_link', 'presszone_id', 'integer', 'Column presszone_id should be integer');
SELECT col_type_is('archived_psector_link', 'dqa_id', 'integer', 'Column dqa_id should be integer');
SELECT col_type_is('archived_psector_link', 'minsector_id', 'integer', 'Column minsector_id should be integer');
SELECT col_type_is('archived_psector_link', 'expl_visibility', 'smallint[]', 'Column expl_visibility should be smallint[]');
SELECT col_type_is('archived_psector_link', 'epa_type', 'varchar(16)', 'Column epa_type should be varchar(16)');
...
SELECT col_type_is('archived_psector_link', 'updated_at', 'timestamp', 'Column updated_at should be timestamp');
...
SELECT col_type_is('archived_psector_link', 'supplyzone_id', 'integer', 'Column supplyzone_id should be integer');
SELECT col_type_is('archived_psector_link', 'n_hydrometer', 'integer', 'Column n_hydrometer should be integer');
