...
SELECT col_type_is('ext_scada_x_data', 'value_type', 'int4', 'Column value_type should be int4');
SELECT col_type_is('ext_scada_x_data', 'value_status', 'int4', 'Column value_status should be int4');
SELECT col_type_is('ext_scada_x_data', 'value_state', 'int4', 'Column value_state should be int4');
SELECT col_type_is('ext_scada_x_data', 'data_type', 'text', 'Column data_type should be text');
