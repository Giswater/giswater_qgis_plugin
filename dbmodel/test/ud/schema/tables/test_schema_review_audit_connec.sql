...
SELECT col_type_is('review_audit_connec', 'old_y1', 'numeric(12,3)', 'Column old_y1 should be numeric(12,3)');
SELECT col_type_is('review_audit_connec', 'new_y1', 'numeric(12,3)', 'Column new_y1 should be numeric(12,3)');
SELECT col_type_is('review_audit_connec', 'old_y2', 'numeric(12,3)', 'Column old_y2 should be numeric(12,3)');
SELECT col_type_is('review_audit_connec', 'new_y2', 'numeric(12,3)', 'Column new_y2 should be numeric(12,3)');
SELECT col_type_is('review_audit_connec', 'old_connec_type', 'varchar(18)', 'Column old_connec_type should be varchar(18)');
SELECT col_type_is('review_audit_connec', 'new_connec_type', 'varchar(18)', 'Column new_connec_type should be varchar(18)');
SELECT col_type_is('review_audit_connec', 'old_matcat_id', 'varchar(30)', 'Column old_matcat_id should be varchar(30)');
SELECT col_type_is('review_audit_connec', 'new_matcat_id', 'varchar(30)', 'Column new_matcat_id should be varchar(30)');
