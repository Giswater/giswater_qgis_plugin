...
SELECT col_type_is('config_param_system', 'isenabled', 'bool', 'Column isenabled should be bool');
SELECT col_type_is('config_param_system', 'layoutorder', 'int4', 'Column layoutorder should be int4');
SELECT col_type_is('config_param_system', 'project_type', 'varchar', 'Column project_type should be varchar');
SELECT col_type_is('config_param_system', 'dv_isparent', 'bool', 'Column dv_isparent should be bool');
SELECT col_type_is('config_param_system', 'isautoupdate', 'bool', 'Column isautoupdate should be bool');
...
SELECT col_type_is('config_param_system', 'ismandatory', 'bool', 'Column ismandatory should be bool');
SELECT col_type_is('config_param_system', 'iseditable', 'bool', 'Column iseditable should be bool');
SELECT col_type_is('config_param_system', 'dv_orderby_id', 'bool', 'Column dv_orderby_id should be bool');
SELECT col_type_is('config_param_system', 'dv_isnullvalue', 'bool', 'Column dv_isnullvalue should be bool');
