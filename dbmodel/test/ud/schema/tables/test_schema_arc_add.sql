...
SELECT columns_are(
    'arc_add',
    ARRAY[
        'arc_id', 'result_id', 'max_flow', 'max_veloc', 'mfull_flow', 'mfull_depth',
        'manning_veloc', 'manning_flow', 'dwf_minflow', 'dwf_maxflow', 'dwf_minvel', 'dwf_maxvel',
        'conduit_capacity'
    ],
...
SELECT col_type_is('arc_add', 'dwf_maxflow', 'numeric(12,3)', 'Column dwf_maxflow should be numeric(12,3)');
