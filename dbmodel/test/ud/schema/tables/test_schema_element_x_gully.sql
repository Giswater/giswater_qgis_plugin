...
SELECT fk_ok('element_x_gully', 'element_id', 'element', 'element_id', 'FK element_id → element.element_id');
SELECT fk_ok('element_x_gully', 'gully_id', 'gully', 'gully_id', 'FK gully_id → gully.gully_id');
