...
SELECT columns_are(
    ...
    ARRAY[
        'id', 'result_id', 'rg_id', 'form_type', 'intvl', 'scf',
        'rgage_type', 'timser_id', 'fname', 'sta', 'units', 'the_geom',
        'expl_id', 'muni_id'
    ],
...
-- Check column types
SELECT col_type_is('archived_rpt_inp_raingage', 'id', 'int8', 'Column id should be int8');
...
SELECT col_type_is('archived_rpt_inp_raingage', 'the_geom', 'geometry(point, SRID_VALUE)', 'Column the_geom should be geometry(point, SRID_VALUE)');
SELECT col_type_is('archived_rpt_inp_raingage', 'expl_id', 'int4', 'Column expl_id should be int4');
SELECT col_type_is('archived_rpt_inp_raingage', 'muni_id', 'int4', 'Column muni_id should be int4');
