...
SELECT columns_are(
    ...
    ARRAY[
        'dscenario_id', 'pattern_id', 'factor_1', 'factor_2', 'factor_3', 'factor_4',
...
SELECT col_type_is('inp_dscenario_pattern_value', 'factor_19', 'numeric(12,4)', 'Column factor_19 should be numeric(12,4)');
SELECT col_type_is('inp_dscenario_pattern_value', 'factor_20', 'numeric(12,4)', 'Column factor_20 should be numeric(12,4)');
SELECT col_type_is('inp_dscenario_pattern_value', 'factor_21', 'numeric(12,4)', 'Column factor_21 should be numeric(12,4)');
SELECT col_type_is('inp_dscenario_pattern_value', 'factor_22', 'numeric(12,4)', 'Column factor_22 should be numeric(12,4)');
SELECT col_type_is('inp_dscenario_pattern_value', 'factor_23', 'numeric(12,4)', 'Column factor_23 should be numeric(12,4)');
SELECT col_type_is('inp_dscenario_pattern_value', 'factor_24', 'numeric(12,4)', 'Column factor_24 should be numeric(12,4)');
