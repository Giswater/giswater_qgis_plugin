...
-- Check table
SELECT has_table('archived_rpt_subcatchment'::name, 'Table archived_rpt_subcatchment should exist');
...
-- Check column types
SELECT col_type_is('archived_rpt_subcatchment', 'id', 'int8', 'Column id should be int8');
