...
-- Check column types
SELECT col_type_is('selector_rpt_compare_tstep', 'resultdate', 'varchar(16)', 'Column resultdate should be varchar(16)');
SELECT col_type_is('selector_rpt_compare_tstep', 'resulttime', 'varchar(12)', 'Column resulttime should be varchar(12)');
