...
SELECT columns_are(
    'ext_rtc_hydrometer',
    ARRAY[
        'hydrometer_id', 'code', 'hydrometer_category', 'customer_name', 'address', 'house_number',
        'id_number', 'cat_hydrometer_id', 'start_date', 'hydro_number', 'identif', 'state_id',
        'expl_id', 'hydrometer_customer_code', 'plot_code', 'priority_id', 'catalog_id', 'category_id',
        'crm_number', 'muni_id', 'address1', 'address2', 'address3', 'address2_1',
        'address2_2', 'address2_3', 'm3_volume', 'hydro_man_date', 'end_date', 'update_date',
...
SELECT col_type_is('ext_rtc_hydrometer', 'hydrometer_category', 'text', 'Column hydrometer_category should be text');
...
SELECT col_type_is('ext_rtc_hydrometer', 'cat_hydrometer_id', 'text', 'Column cat_hydrometer_id should be text');
...
SELECT col_type_is('ext_rtc_hydrometer', 'plot_code', 'int4', 'Column plot_code should be int4');
...
SELECT col_type_is('ext_rtc_hydrometer', 'm3_volume', 'int4', 'Column m3_volume should be int4');
