...
SELECT col_type_is('anl_arc', 'nodecat_id', 'varchar(30)', 'Column nodecat_id should be varchar(30)');
SELECT col_type_is('anl_arc', 'state', 'integer', 'Column state should be integer');
SELECT col_type_is('anl_arc', 'num_arc', 'integer', 'Column num_arc should be integer');
SELECT col_type_is('anl_arc', 'node_id_aux', 'varchar(16)', 'Column node_id_aux should be varchar(16)');
SELECT col_type_is('anl_arc', 'nodecat_id_aux', 'varchar(30)', 'Column nodecat_id_aux should be varchar(30)');
...
SELECT col_type_is('anl_arc', 'the_geom', 'geometry(point, 25831)', 'Column the_geom should be geometry(point, 25831)');
SELECT col_type_is('anl_arc', 'arc_distance', 'numeric(12,3)', 'Column arc_distance should be numeric(12,3)');
...
SELECT col_type_is('anl_arc', 'total_distance', 'numeric(12,3)', 'Column total_distance should be numeric(12,3)');
...
SELECT col_type_is('anl_arc', 'top_elev', 'float8', 'Column top_elev should be float8');
SELECT col_type_is('anl_arc', 'elev', 'float8', 'Column elev should be float8');
SELECT col_type_is('anl_arc', 'ymax', 'float8', 'Column ymax should be float8');
SELECT col_type_is('anl_arc', 'state_type', 'integer', 'Column state_type should be integer');
