...
-- check indexes
SELECT has_index('config_visit_parameter_action', 'config_visit_parameter_action_pkey', ARRAY['parameter_id1','parameter_id2','action_type'], 'Table config_visit_parameter_action should have index on parameter_id1, parameter_id2, action_type');
