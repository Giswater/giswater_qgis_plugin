...
SELECT columns_are(
    'cat_work',
    ARRAY[
        'id', 'descript', 'link', 'workid_key1', 'workid_key2', 'builtdate',
        'workcost', 'active'
    ],
...
-- Check column types
SELECT col_type_is('cat_work', 'id', 'varchar(255)', 'Column id should be varchar(255)');
...
SELECT col_type_is('cat_work', 'active', 'bool', 'Column active should be bool');
