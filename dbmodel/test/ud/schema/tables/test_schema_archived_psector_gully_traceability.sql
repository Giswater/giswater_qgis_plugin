...
-- Check check types
SELECT col_type_is('archived_psector_gully_traceability', 'id', 'serial4', 'Column id should be serial4');
SELECT col_type_is('archived_psector_gully_traceability', 'psector_id', 'interger', 'Column psector_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'link_id', 'interger', 'Column link_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'gully_id', 'interger', 'Column gully_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'sector_id', 'interger', 'Column sector_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'dma_id', 'interger', 'Column dma_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'muni_id', 'interger', 'Column muni_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'postnumber', 'interger', 'Column postnumber should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'postnumber2', 'interger', 'Column postnumber2 should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'verified', 'interger', 'Column verified should be interger');
SELECT col_type_is('archived_psector_gully_traceability', 'rotation', 'numeric(6,3)', 'Column rotation should be numeric(6,3)');
SELECT col_type_is('archived_psector_gully_traceability', 'the_geom', 'geometry', 'Column the_geom should be geometry');
...
SELECT col_type_is('archived_psector_gully_traceability', 'expl_id', 'interger', 'Column expl_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'pjoint_id', 'interger', 'Column pjoint_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'district_id', 'interger', 'Column district_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'drainzone_id', 'interger', 'Column drainzone_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'minsector_id', 'interger', 'Column minsector_id should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'dwfzone_id', 'interger', 'Column dwfzone_id should be interger');
SELECT col_type_is('archived_psector_gully_traceability', 'datasource', 'interger', 'Column datasource should be interger');
SELECT col_type_is('archived_psector_gully_traceability', 'omunit_id', 'interger', 'Column omunit_id should be interger');
SELECT col_type_is('archived_psector_gully_traceability', 'lock_level', 'interger', 'Column lock_level should be interger');
...
SELECT col_type_is('archived_psector_gully_traceability', 'expl_visibility', 'interger', 'Column expl_visibility should be interger');
