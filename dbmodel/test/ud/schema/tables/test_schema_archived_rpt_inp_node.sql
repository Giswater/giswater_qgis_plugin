...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'addparam', 'parent', 'arcposition', 'fusioned_node', 'age', 'hour_flood',
        'max_rate', 'flooding_time_days', 'flooding_time_hour', 'tot_flood', 'max_ponded', 'hour_surch',
        'max_height', 'min_depth', 'max_latinf', 'max_totinf', 'inflow_time_days', 'inflow_time_hour',
        'latinf_vol', 'totinf_vol', 'flow_balance_error', 'other_info', 'aver_depth', 'max_depth',
        'max_hgl', 'depth_time_days', 'depth_time_hour', 'flow_freq', 'avg_flow', 'max_flow',
        'total_vol', 'poll_id', 'value', 'aver_vol', 'avg_full', 'ei_loss',
        'max_vol', 'max_full', 'storagevol_time_days', 'storagevol_time_hour', 'max_out'
    ],
...
SELECT col_type_is('archived_rpt_inp_node', 'node_id', 'int4', 'Column node_id should be int4');
...
SELECT col_type_is('archived_rpt_inp_node', 'latinf_vol', 'numeric(12,4)', 'Column latinf_vol should be numeric(12,4)');
