...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'macrosector_id', 'expl_id', 'muni_id', 'graphconfig', 'stylesheet', 'lock_level',
        'link', 'the_geom', 'addparam', 'created_at', 'created_by', 'updated_at',
        'updated_by'
    ],
...
SELECT col_type_is('ve_sector', 'sector_type', 'varchar(50)', 'Column sector_type should be varchar(50)');
