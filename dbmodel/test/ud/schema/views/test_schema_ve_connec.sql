...
SELECT col_type_is('ve_connec', 'drainzone_type', 'varchar(30)', 'Column drainzone_type should be varchar(30)');
...
SELECT col_type_is('ve_connec', 'dwfzone_type', 'varchar(30)', 'Column dwfzone_type should be varchar(30)');
