...
SELECT col_type_is('v_plan_result_node', 'node_type', 'text', 'Column node_type should be text');
SELECT col_type_is('v_plan_result_node', 'top_elev', 'numeric(12,3)', 'Column top_elev should be numeric(12,3)');
SELECT col_type_is('v_plan_result_node', 'elev', 'numeric(12,3)', 'Column elev should be numeric(12,3)');
