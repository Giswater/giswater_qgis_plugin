...
SELECT col_type_is('ve_gully_pgully', 'sector_type', 'varchar(16)', 'Column sector_type should be varchar(16)');
SELECT col_type_is('ve_gully_pgully', 'drainzone_id', 'int4', 'Column drainzone_id should be int4');
SELECT col_type_is('ve_gully_pgully', 'drainzone_type', 'varchar(16)', 'Column drainzone_type should be varchar(16)');
...
SELECT col_type_is('ve_gully_pgully', 'dwfzone_type', 'varchar(16)', 'Column dwfzone_type should be varchar(16)');
...
SELECT col_type_is('ve_gully_pgully', 'omzone_type', 'varchar(16)', 'Column omzone_type should be varchar(16)');
