...
SELECT col_type_is('ve_review_audit_arc', 'old_y1', 'float8', 'Column old_y1 should be float8');
SELECT col_type_is('ve_review_audit_arc', 'new_y1', 'float8', 'Column new_y1 should be float8');
SELECT col_type_is('ve_review_audit_arc', 'old_y2', 'float8', 'Column old_y2 should be float8');
SELECT col_type_is('ve_review_audit_arc', 'new_y2', 'float8', 'Column new_y2 should be float8');
SELECT col_type_is('ve_review_audit_arc', 'old_arc_type', 'varchar(18)', 'Column old_arc_type should be varchar(18)');
SELECT col_type_is('ve_review_audit_arc', 'new_arc_type', 'varchar(18)', 'Column new_arc_type should be varchar(18)');
SELECT col_type_is('ve_review_audit_arc', 'old_matcat_id', 'varchar(30)', 'Column old_matcat_id should be varchar(30)');
SELECT col_type_is('ve_review_audit_arc', 'new_matcat_id', 'varchar(30)', 'Column new_matcat_id should be varchar(30)');
