...
SELECT col_type_is('ve_link', 'drainzone_type', 'varchar(16)', 'Column drainzone_type should be varchar(16)');
...
SELECT col_type_is('ve_link', 'dwfzone_type', 'varchar(16)', 'Column dwfzone_type should be varchar(16)');
