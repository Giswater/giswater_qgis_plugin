...
SELECT col_type_is('ve_node_junction', 'drainzone_type', 'varchar(30)', 'Column drainzone_type should be varchar(30)');
...
SELECT col_type_is('ve_node_junction', 'dwfzone_type', 'varchar(30)', 'Column dwfzone_type should be varchar(30)');
...
SELECT col_type_is('ve_node_junction', 'has_access', 'bool', 'Column has_access should be bool');
