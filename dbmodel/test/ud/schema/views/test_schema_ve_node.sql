...
SELECT col_type_is('ve_node', 'top_elev', 'numeric(12,3)', 'Column top_elev should be numeric(12,3)');
SELECT col_type_is('ve_node', 'custom_top_elev', 'numeric(12,3)', 'Column custom_top_elev should be numeric(12,3)');
SELECT col_type_is('ve_node', 'sys_top_elev', 'numeric(12,3)', 'Column sys_top_elev should be numeric(12,3)');
SELECT col_type_is('ve_node', 'ymax', 'numeric(12,3)', 'Column ymax should be numeric(12,3)');
SELECT col_type_is('ve_node', 'sys_ymax', 'numeric', 'Column sys_ymax should be numeric');
SELECT col_type_is('ve_node', 'elev', 'numeric(12,3)', 'Column elev should be numeric(12,3)');
SELECT col_type_is('ve_node', 'custom_elev', 'numeric(12,3)', 'Column custom_elev should be numeric(12,3)');
SELECT col_type_is('ve_node', 'sys_elev', 'numeric(12,3)', 'Column sys_elev should be numeric(12,3)');
SELECT col_type_is('ve_node', 'sys_type', 'varchar(30)', 'Column sys_type should be varchar(30)');
SELECT col_type_is('ve_node', 'node_type', 'text', 'Column node_type should be text');
SELECT col_type_is('ve_node', 'matcat_id', 'varchar(16)', 'Column matcat_id should be varchar(16)');
...
SELECT col_type_is('ve_node', 'sector_type', 'varchar(16)', 'Column sector_type should be varchar(16)');
SELECT col_type_is('ve_node', 'drainzone_id', 'int4', 'Column drainzone_id should be int4');
SELECT col_type_is('ve_node', 'drainzone_type', 'varchar(16)', 'Column drainzone_type should be varchar(16)');
SELECT col_type_is('ve_node', 'drainzone_outfall', 'int4[]', 'Column drainzone_outfall should be int4[]');
SELECT col_type_is('ve_node', 'dwfzone_id', 'int4', 'Column dwfzone_id should be int4');
SELECT col_type_is('ve_node', 'dwfzone_type', 'varchar(16)', 'Column dwfzone_type should be varchar(16)');
SELECT col_type_is('ve_node', 'dwfzone_outfall', 'int4[]', 'Column dwfzone_outfall should be int4[]');
...
SELECT col_type_is('ve_node', 'omunit_id', 'int4', 'Column omunit_id should be int4');
...
SELECT col_type_is('ve_node', 'soilcat_id', 'varchar(16)', 'Column soilcat_id should be varchar(16)');
...
SELECT col_type_is('ve_node', 'fluid_type', 'int4', 'Column fluid_type should be int4');
...
SELECT col_type_is('ve_node', 'descript', 'text', 'Column descript should be text');
...
SELECT col_type_is('ve_node', 'om_state', 'int4', 'Column om_state should be int4');
SELECT col_type_is('ve_node', 'access_type', 'text', 'Column access_type should be text');
SELECT col_type_is('ve_node', 'placement_type', 'varchar(50)', 'Column placement_type should be varchar(50)');
...
SELECT col_type_is('ve_node', 'unconnected', 'bool', 'Column unconnected should be bool');
...
SELECT col_type_is('ve_node', 'inp_type', 'varchar(16)', 'Column inp_type should be varchar(16)');
SELECT col_type_is('ve_node', 'result_id', 'text', 'Column result_id should be text');
SELECT col_type_is('ve_node', 'max_depth', 'numeric(12,2)', 'Column max_depth should be numeric(12,2)');
SELECT col_type_is('ve_node', 'max_height', 'numeric(12,2)', 'Column max_height should be numeric(12,2)');
SELECT col_type_is('ve_node', 'flooding_rate', 'numeric(12,2)', 'Column flooding_rate should be numeric(12,2)');
SELECT col_type_is('ve_node', 'flooding_vol', 'numeric(12,2)', 'Column flooding_vol should be numeric(12,2)');
SELECT col_type_is('ve_node', 'sector_style', 'text', 'Column sector_style should be text');
SELECT col_type_is('ve_node', 'omzone_style', 'text', 'Column omzone_style should be text');
SELECT col_type_is('ve_node', 'drainzone_style', 'text', 'Column drainzone_style should be text');
SELECT col_type_is('ve_node', 'dwfzone_style', 'text', 'Column dwfzone_style should be text');
SELECT col_type_is('ve_node', 'lock_level', 'int4', 'Column lock_level should be int4');
SELECT col_type_is('ve_node', 'expl_visibility', 'int2[]', 'Column expl_visibility should be int2[]');
...
SELECT col_type_is('ve_node', 'treatment_type', 'int4', 'Column treatment_type should be int4');
SELECT col_type_is('ve_node', 'has_treatment', 'bool', 'Column has_treatment should be bool');
