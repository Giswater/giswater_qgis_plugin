...
SELECT col_type_is('ve_node', 'drainzone_type', 'varchar(30)', 'Column drainzone_type should be varchar(30)');
...
SELECT col_type_is('ve_node', 'dwfzone_type', 'varchar(30)', 'Column dwfzone_type should be varchar(30)');
