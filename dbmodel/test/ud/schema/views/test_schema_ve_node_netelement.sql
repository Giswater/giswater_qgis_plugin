...
SELECT col_type_is('ve_node_netelement', 'top_elev', 'numeric(12,3)', 'Column top_elev should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'custom_top_elev', 'numeric(12,3)', 'Column custom_top_elev should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'sys_top_elev', 'numeric(12,3)', 'Column sys_top_elev should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'ymax', 'numeric(12,3)', 'Column ymax should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'sys_ymax', 'numeric', 'Column sys_ymax should be numeric');
SELECT col_type_is('ve_node_netelement', 'elev', 'numeric(12,3)', 'Column elev should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'custom_elev', 'numeric(12,3)', 'Column custom_elev should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'sys_elev', 'numeric(12,3)', 'Column sys_elev should be numeric(12,3)');
SELECT col_type_is('ve_node_netelement', 'sys_type', 'varchar(30)', 'Column sys_type should be varchar(30)');
SELECT col_type_is('ve_node_netelement', 'node_type', 'text', 'Column node_type should be text');
SELECT col_type_is('ve_node_netelement', 'matcat_id', 'varchar(16)', 'Column matcat_id should be varchar(16)');
...
SELECT col_type_is('ve_node_netelement', 'sector_type', 'varchar(16)', 'Column sector_type should be varchar(16)');
SELECT col_type_is('ve_node_netelement', 'drainzone_id', 'int4', 'Column drainzone_id should be int4');
SELECT col_type_is('ve_node_netelement', 'drainzone_type', 'varchar(16)', 'Column drainzone_type should be varchar(16)');
SELECT col_type_is('ve_node_netelement', 'drainzone_outfall', 'int4[]', 'Column drainzone_outfall should be int4[]');
SELECT col_type_is('ve_node_netelement', 'dwfzone_id', 'int4', 'Column dwfzone_id should be int4');
SELECT col_type_is('ve_node_netelement', 'dwfzone_type', 'varchar(16)', 'Column dwfzone_type should be varchar(16)');
SELECT col_type_is('ve_node_netelement', 'dwfzone_outfall', 'int4[]', 'Column dwfzone_outfall should be int4[]');
...
SELECT col_type_is('ve_node_netelement', 'omunit_id', 'int4', 'Column omunit_id should be int4');
...
SELECT col_type_is('ve_node_netelement', 'soilcat_id', 'varchar(16)', 'Column soilcat_id should be varchar(16)');
...
SELECT col_type_is('ve_node_netelement', 'fluid_type', 'int4', 'Column fluid_type should be int4');
...
SELECT col_type_is('ve_node_netelement', 'descript', 'text', 'Column descript should be text');
...
SELECT col_type_is('ve_node_netelement', 'om_state', 'int4', 'Column om_state should be int4');
SELECT col_type_is('ve_node_netelement', 'access_type', 'text', 'Column access_type should be text');
SELECT col_type_is('ve_node_netelement', 'placement_type', 'varchar(50)', 'Column placement_type should be varchar(50)');
...
SELECT col_type_is('ve_node_netelement', 'unconnected', 'bool', 'Column unconnected should be bool');
...
SELECT col_type_is('ve_node_netelement', 'inp_type', 'varchar(16)', 'Column inp_type should be varchar(16)');
SELECT col_type_is('ve_node_netelement', 'result_id', 'text', 'Column result_id should be text');
SELECT col_type_is('ve_node_netelement', 'max_depth', 'numeric(12,2)', 'Column max_depth should be numeric(12,2)');
SELECT col_type_is('ve_node_netelement', 'max_height', 'numeric(12,2)', 'Column max_height should be numeric(12,2)');
SELECT col_type_is('ve_node_netelement', 'flooding_rate', 'numeric(12,2)', 'Column flooding_rate should be numeric(12,2)');
SELECT col_type_is('ve_node_netelement', 'flooding_vol', 'numeric(12,2)', 'Column flooding_vol should be numeric(12,2)');
SELECT col_type_is('ve_node_netelement', 'sector_style', 'text', 'Column sector_style should be text');
SELECT col_type_is('ve_node_netelement', 'omzone_style', 'text', 'Column omzone_style should be text');
SELECT col_type_is('ve_node_netelement', 'drainzone_style', 'text', 'Column drainzone_style should be text');
SELECT col_type_is('ve_node_netelement', 'dwfzone_style', 'text', 'Column dwfzone_style should be text');
SELECT col_type_is('ve_node_netelement', 'lock_level', 'int4', 'Column lock_level should be int4');
SELECT col_type_is('ve_node_netelement', 'expl_visibility', 'int2[]', 'Column expl_visibility should be int2[]');
...
SELECT col_type_is('ve_node_netelement', 'treatment_type', 'int4', 'Column treatment_type should be int4');
SELECT col_type_is('ve_node_netelement', 'has_treatment', 'bool', 'Column has_treatment should be bool');
