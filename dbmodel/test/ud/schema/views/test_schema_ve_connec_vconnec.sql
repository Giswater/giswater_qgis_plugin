...
SELECT col_type_is('ve_connec_vconnec', 'drainzone_type', 'varchar(16)', 'Column drainzone_type should be varchar(16)');
...
SELECT col_type_is('ve_connec_vconnec', 'dwfzone_type', 'varchar(16)', 'Column dwfzone_type should be varchar(16)');
