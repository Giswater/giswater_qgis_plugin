...
SELECT col_type_is('ve_review_connec', 'y1', 'numeric(12,3)', 'Column y1 should be numeric(12,3)');
SELECT col_type_is('ve_review_connec', 'y2', 'numeric(12,3)', 'Column y2 should be numeric(12,3)');
SELECT col_type_is('ve_review_connec', 'connec_type', 'text', 'Column connec_type should be text');
SELECT col_type_is('ve_review_connec', 'matcat_id', 'varchar(30)', 'Column matcat_id should be varchar(30)');
