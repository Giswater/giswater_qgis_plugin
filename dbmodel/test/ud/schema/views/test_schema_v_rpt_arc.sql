...
-- Check column types
SELECT col_type_is('v_rpt_arc', 'id', 'int8', 'Column id should be int8');
...
SELECT col_type_is('v_rpt_arc', 'flow', 'float8', 'Column flow should be float8');
SELECT col_type_is('v_rpt_arc', 'velocity', 'float8', 'Column velocity should be float8');
SELECT col_type_is('v_rpt_arc', 'fullpercent', 'float8', 'Column fullpercent should be float8');
SELECT col_type_is('v_rpt_arc', 'resultdate', 'varchar(16)', 'Column resultdate should be varchar(16)');
SELECT col_type_is('v_rpt_arc', 'resulttime', 'varchar(12)', 'Column resulttime should be varchar(12)');
