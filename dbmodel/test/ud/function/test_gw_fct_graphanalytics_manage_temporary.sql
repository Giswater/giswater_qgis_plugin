...
SELECT is (
    (gw_fct_graphanalytics_manage_temporary($${"data":{"action":"CREATE", "fct_name":"DRAINZONE", "use_psector":"false"}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_graphanalytics_manage_temporary (DRAINZONE) CREATE with use_psector false returns status "Accepted"'
);
...
SELECT is (
    (gw_fct_graphanalytics_manage_temporary($${"data":{"action":"DROP", "fct_name":"DRAINZONE"}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_graphanalytics_manage_temporary (DRAINZONE) DROP returns status "Accepted"'
);
...
SELECT is (
    (gw_fct_graphanalytics_manage_temporary($${"data":{"action":"CREATE", "fct_name":"DRAINZONE", "use_psector":"true"}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_graphanalytics_manage_temporary (DRAINZONE) CREATE with use_psector true returns status "Accepted"'
);
