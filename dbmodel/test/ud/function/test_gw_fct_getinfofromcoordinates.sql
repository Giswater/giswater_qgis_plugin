...
SELECT is(
    ...
    "ve_pol_node", "ve_pol_gully", "ve_pol_connec", "ve_dimensions", "ve_element", "ve_inp_junction", "ve_inp_outfall", "ve_inp_divider",
    "ve_inp_storage", "ve_inp_netgully", "ve_inp_conduit", "ve_inp_virtual", "ve_inp_pump", "ve_inp_weir", "ve_inp_outlet",
    "ve_inp_orifice", "ve_inp_gully", "vi_gully2node", "ve_inp_frorifice", "ve_inp_froutlet", "ve_inp_frpump",
    "ve_inp_frweir", "ve_plan_psector", "v_plan_current_psector", "v_plan_psector_connec", "v_plan_psector_gully", "v_plan_psector_link",
