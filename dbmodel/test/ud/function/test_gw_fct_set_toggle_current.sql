...
SELECT is (
    (gw_fct_set_toggle_current('{"data":{"type": "hydrology", "id": "1"}}')::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_set_toggle_current hydrology with id value returns status "Accepted"'
);

SELECT is (
    (gw_fct_set_toggle_current('{"data":{"type": "hydrology"}}')::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_set_toggle_current hydrology returns status "Accepted"'
);

SELECT is (
    (gw_fct_set_toggle_current('{"data":{"type": "dwf", "id": "1"}}')::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_set_toggle_current dwf with id value returns status "Accepted"'
);

SELECT is (
    (gw_fct_set_toggle_current('{"data":{"type": "dwf"}}')::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_set_toggle_current dwf returns status "Accepted"'
);
