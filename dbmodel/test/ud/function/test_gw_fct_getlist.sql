...
SELECT is (
    ...
    "feature":{},
    "data":{"tableName":"tbl_inp_dscenario_junction", "filterFields":{"node_id":{"value":"74","filterSign":"="}}, "pageInfo":{}}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_getlist($${"client":{"device":4, "lang":"es_ES", "infoType":1, "epsg":25831}, "form":{},
    "feature":{},
    "data":{"tableName":"tbl_connection_downstream", "filterFields":{"node_id":{"value":"74","filterSign":"="}}, "pageInfo":{}}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_getlist($${"client":{"device":4, "lang":"es_ES", "infoType":1, "epsg":25831}, "form":{},
    "feature":{},
    "data":{"tableName":"tbl_element_x_node", "filterFields":{"node_id":{"value":"74","filterSign":"="}}, "pageInfo":{}}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_getlist($${"client":{"device":4, "lang":"es_ES", "infoType":1, "epsg":25831}, "form":{},
    "feature":{},
    "data":{"tableName":"tbl_event_x_node", "filterFields":{"node_id":{"value":"74","filterSign":"="},
...
SELECT is (
    (gw_fct_getlist($${"client":{"device":4, "lang":"es_ES", "infoType":1, "epsg":25831}, "form":{},
    "feature":{},
    "data":{"tableName":"tbl_doc_x_node", "filterFields":{"node_id":{"value":"74","filterSign":"="}}, "pageInfo":{}}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_getlist($${"client":{"device":4, "lang":"es_ES", "infoType":1, "epsg":25831}, "form":{},
    "feature": {},
    "data":{"tableName":"ve_cat_hydrology", "filterFields":{"limit": -1, "name": {"filterSign":"ILIKE", "value":""}, "active": {"filterSign":"=", "value":"true"}}, "pageInfo":{}}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    ...
    "data":{"tableName":"cat_work", "filterFields":{"limit": -1, "id": {"filterSign":"ILIKE", "value":""}}, "pageInfo":{}}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_getlist($${"client":{"device":4, "lang":"", "infoType":1, "epsg":25831}, "form":{}, "feature":{},
