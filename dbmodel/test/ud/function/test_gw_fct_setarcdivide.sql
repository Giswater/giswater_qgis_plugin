...
INSERT INTO ve_arc_conduit (arc_id, code, node_1, nodetype_1, y1, custom_y1, elev1, custom_elev1, sys_elev1, sys_y1, r1, z1, node_2, nodetype_2, y2, custom_y2, elev2, custom_elev2, sys_elev2, sys_y2, r2, z2, slope, arc_type, sys_type, arccat_id, matcat_id, cat_shape, cat_geom1, cat_geom2, cat_width, cat_area, epa_type, state, state_type, expl_id, macroexpl_id, sector_id, macrosector_id, drainzone_id, annotation, gis_length, custom_length, inverted_slope, observ, "comment", omzone_id, macroomzone_id, soilcat_id, function_type, category_type, fluid_type, location_type, workcat_id, workcat_id_end, workcat_id_plan, builtdate, enddate, ownercat_id, muni_id, postcode, district_id, streetname, postnumber, postcomplement, streetname2, postnumber2, postcomplement2, region_id, province_id, descript, link, verified, undelete, "label", label_x, label_y, label_rotation, publish, inventory, uncertain, num_value, asset_id, pavcat_id, parent_id, expl_id2, is_operative, adate, adescript, visitability, tstamp, insert_user, lastupdate, lastupdate_user, the_geom, inp_type, bottom_mat)
