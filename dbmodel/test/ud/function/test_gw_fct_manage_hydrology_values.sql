...
SELECT is(
    (gw_fct_manage_hydrology_values($${"client":{"device":4, "lang":"nl_NL", "infoType":1, "epsg":25831}, 
    "form":{}, "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, 
    "parameters":{"target":"1", "sector":"0", "action":"DELETE-COPY", "copyFrom":"1"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_manage_hydrology_values with sector > 0 and action > DELETE-COPY returns status "Accepted"'
);
...
SELECT is(
    (gw_fct_manage_hydrology_values($${"client":{"device":4, "lang":"nl_NL", "infoType":1, "epsg":25831}, 
    "form":{}, "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, 
    "parameters":{"target":"1", "sector":"0", "action":"KEEP-COPY", "copyFrom":"1"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_manage_hydrology_values with sector > 0 and action > KEEP-COPY returns status "Accepted"'
);
...
SELECT is(
    (gw_fct_manage_hydrology_values($${"client":{"device":4, "lang":"nl_NL", "infoType":1, "epsg":25831}, 
    "form":{}, "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, 
    "parameters":{"target":"1", "sector":"0", "action":"DELETE-ONLY", "copyFrom":"1"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_manage_hydrology_values with sector > 0 and action > DELETE-ONLY returns status "Accepted"'
);
...
SELECT is(
    (gw_fct_manage_hydrology_values($${"client":{"device":4, "lang":"nl_NL", "infoType":1, "epsg":25831}, 
    "form":{}, "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, 
    "parameters":{"target":"1", "sector":"-999", "action":"DELETE-COPY", "copyFrom":"1"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_manage_hydrology_values with sector > -999 and action > DELETE-COPY returns status "Accepted"'
);
...
SELECT is(
    (gw_fct_manage_hydrology_values($${"client":{"device":4, "lang":"nl_NL", "infoType":1, "epsg":25831}, 
    "form":{}, "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, 
    "parameters":{"target":"1", "sector":"-999", "action":"KEEP-COPY", "copyFrom":"1"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_manage_hydrology_values with sector > -999 and action > KEEP-COPY returns status "Accepted"'
);
...
SELECT is(
    (gw_fct_manage_hydrology_values($${"client":{"device":4, "lang":"nl_NL", "infoType":1, "epsg":25831}, 
    "form":{}, "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, 
    "parameters":{"target":"1", "sector":"-999", "action":"DELETE-ONLY", "copyFrom":"1"}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_manage_hydrology_values with sector > -999 and action > DELETE-ONLY returns status "Accepted"'
);
