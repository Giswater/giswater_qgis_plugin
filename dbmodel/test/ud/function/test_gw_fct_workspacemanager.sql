...
SELECT is (
    ...
    "data":{"filterFields":{}, "pageInfo":{}, "action":"INFO", "id":"1"}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    ...
    "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, "action":"TOGGLE", "id": "1"}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_workspacemanager($${"client":{"device":4, "lang":"", "infoType":1, "epsg":25831}, "form":{}, "feature":{},
    "data":{"filterFields":{}, "pageInfo":{}, "action":"UPDATE", "name":"test1_0", "descript":null, "private":"True", "id": "1"}}$$)::JSON)->>'status',
    'Accepted',
...
SELECT is (
    (gw_fct_workspacemanager($${"client":{"device":4, "lang":"", "infoType":1, "epsg":25831}, "form":{},
    "feature":{}, "data":{"filterFields":{}, "pageInfo":{}, "action":"DELETE", "id": "1"}}$$)::JSON)->>'status',
    'Accepted',
