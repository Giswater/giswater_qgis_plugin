...
SELECT is (
    ...
    'Failed',
    'Check if gw_fct_anl_arc_intersection with tablename > v_edit_arc returns status "Failed" for basic user'
);
...
SELECT is (
    ...
    "pageInfo":{}, "selectionMode":"wholeSelection","parameters":{}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_anl_arc_intersection with tablename > v_edit_arc returns status "Accepted" for om user'
);
...
SELECT is (
    ...
    "pageInfo":{}, "selectionMode":"wholeSelection","parameters":{}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_anl_arc_intersection with tablename > v_edit_arc returns status "Accepted" for edit user'
);
...
SELECT is (
    ...
    "pageInfo":{}, "selectionMode":"wholeSelection","parameters":{}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_anl_arc_intersection with tablename > v_edit_arc returns status "Accepted" for epa user'
);
...
SELECT is (
    ...
    "pageInfo":{}, "selectionMode":"wholeSelection","parameters":{}, "aux_params":null}}$$)::JSON)->>'status',
    'Accepted',
    'Check if gw_fct_anl_arc_intersection with tablename > v_edit_arc returns status "Accepted" for plan user'
);
