...
SELECT is((SELECT count(*)::integer FROM ve_macrosector WHERE macrosector_id = -901), 1, 'INSERT: ve_macrosector -901 was inserted');
SELECT is((SELECT count(*)::integer FROM macrosector WHERE macrosector_id = -901), 1, 'INSERT: macrosector -901 was inserted');

UPDATE ve_macrosector SET descript = 'updated descript' WHERE macrosector_id = -901;
SELECT is((SELECT descript FROM ve_macrosector WHERE macrosector_id = -901), 'updated descript', 'UPDATE: ve_macrosector -901 was updated');
SELECT is((SELECT descript FROM macrosector WHERE macrosector_id = -901), 'updated descript', 'UPDATE: macrosector -901 was updated');

DELETE FROM ve_macrosector WHERE macrosector_id = -901;
SELECT is((SELECT count(*)::integer FROM ve_macrosector WHERE macrosector_id = -901), 0, 'DELETE: ve_macrosector -901 was deleted');
