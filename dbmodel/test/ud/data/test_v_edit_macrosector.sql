...
VALUES(-901, 'sector_901', -901, 'sector_project_ud', 0, true, NULL, '2025-02-04 14:54:56.592', 'postgres', NULL, NULL, NULL, NULL, '{"use":[{"nodeParent":"", "toArc":[]}], "ignore":[], "forceClosed":[]}'::json, NULL);
