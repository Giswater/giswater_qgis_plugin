...
(connec_id, code, sys_code, customer_code, top_elev, y1, y2, conneccat_id, connec_type, sys_type, matcat_id, state, state_type, expl_id, macroexpl_id, sector_id, macrosector_id, drainzone_id, demand, connec_depth, connec_length, arc_id, annotation, observ, "comment", omzone_id, macroomzone_id, soilcat_id, function_type, category_type, fluid_type, location_type, workcat_id, workcat_id_end, builtdate, enddate, ownercat_id, muni_id, postcode, district_id, streetname, postnumber, postcomplement, streetname2, postnumber2, postcomplement2, region_id, province_id, descript, svg, rotation, link, verified, "label", label_x, label_y, label_rotation, accessibility, diagonal, publish, inventory, uncertain, num_value, pjoint_id, pjoint_type, created_at, created_by, updated_at, updated_by, the_geom, workcat_id_plan, asset_id, expl_id2, is_operative, adate, adescript, plot_code, placement_type)
