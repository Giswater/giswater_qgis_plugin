...
INSERT INTO audit_cat_param_user VALUES ('inp_options_damplimit', 'epaoptions', null, 'role_epa', NULL, 'DAMPLIMIT', 'Damp limit:', NULL, NULL, true, 4, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '0.00', 'grl_hyd_4', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_file', 'epaoptions', null, 'role_epa', NULL, 'FILE','File:', NULL, NULL, true, 13, 6, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, 'file', 'grl_reports_13', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('inp_options_specific_gravity', 'epaoptions', null , 'role_epa', NULL, 'SPECIFIC_GRAVITY', 'Specific gravety:', NULL, NULL, true, 4, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '1.00', 'grl_hyd_4', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_flow', 'epaoptions', null, 'role_epa', NULL, 'FLOW', 'Flow:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 7, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_energy', 'epaoptions', null, 'role_epa', NULL, 'ENERGY', 'Energy:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 4, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_pagesize', 'epaoptions', null, 'role_epa', NULL, 'PAGESIZE', 'Pagesize:', NULL, NULL, true, 14, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'integer', 'text', true, NULL, NULL, 'grl_reports_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_status', 'epaoptions', null, 'role_epa', NULL, 'STATUS', 'Status:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesnofull''', NULL, true, 14, 7, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_times_duration', 'epaoptions', null, 'role_epa', NULL, 'DURATION', 'Duration:', NULL, NULL, true, 11, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'integer', 'text', true, '{"minValue":0.001, "maxValue":100}', '24', 'grl_date_11', '[\d]+:[0-5][0-9]:[0-5][0-9]');
...
INSERT INTO audit_cat_param_user VALUES ('inp_options_emitter_exponent', 'epaoptions', null, 'role_epa', NULL, 'EMITTER_EXPONENT', 'Emitter exponent:', NULL, NULL, true, 3, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '0.5', 'grl_hyd_3', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_demand_multiplier', 'epaoptions', null, 'role_epa', NULL, 'DEMAND_MULTIPLIER', 'Demand multiplier:', NULL, NULL, true, 1, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '1.00', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_maxcheck', 'epaoptions', null, 'role_epa', NULL, 'MAXCHECK', 'Max check:', NULL, NULL, true, 3, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '10.00', 'grl_hyd_3', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_trials', 'epaoptions', null, 'role_epa', NULL, 'TRIALS', 'Trials:', NULL, NULL, true, 3, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '40.00', 'grl_hyd_3', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_viscosity', 'epaoptions', null, 'role_epa', NULL, 'VISCOSITY', 'Viscosity:', NULL, NULL, true, 3, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '1.00', 'grl_hyd_3', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('inp_options_rtc_coefficient', 'epaoptions', null, 'role_epa', NULL, 'RTC_COEFFICIENT', 'Coefficient:', NULL, NULL, true, 10, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_crm_10', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('inp_times_rule_timestep', 'epaoptions', null, 'role_epa', NULL, 'RULE_TIMESTEP', 'Rule timestep:', NULL, NULL, true, 12, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_12', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_times_report_timestep', 'epaoptions', null, 'role_epa', NULL, 'REPORT_TIMESTEP', 'Report timestep:', NULL, NULL, true, 11, 7, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_11', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_times_report_start', 'epaoptions', null, 'role_epa', NULL, 'REPORT_START', 'Report start:', NULL, NULL, true, 12, 7, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_12', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_times_quality_timestep', 'epaoptions', null, 'role_epa', NULL, 'QUALITY_TIMESTEP', 'Quality timestep:', NULL, NULL, true, 11, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_11', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_report_f_factor', 'epaoptions', null, 'role_epa', NULL, 'F_FACTOR', 'F Factor:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_times_hydraulic_timestep', 'epaoptions', null, 'role_epa', NULL, 'HYDRAULIC_TIMESTEP', 'Hydraulic timestemp:', NULL, NULL, true, 12, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, '{"minValue":0.001, "maxValue":100}', '0:30', 'grl_date_12', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_times_pattern_start', 'epaoptions', null, 'role_epa', NULL, 'PATTERN_START', 'Pattern start:', NULL, NULL, true, 12, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_12', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_times_pattern_timestep', 'epaoptions', null, 'role_epa', NULL, 'PATTERN_TIMESTEP', 'Pattern timestep:', NULL, NULL, true, 11, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_11', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_times_start_clocktime', 'epaoptions', null, 'role_epa', NULL, 'START_CLOCKTIME', 'Start clocktime:', NULL, NULL, true, 11, 8, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_date_11', '[\d]+:[0-5][0-9]:[0-5][0-9]');
INSERT INTO audit_cat_param_user VALUES ('inp_report_elevation', 'epaoptions', null, 'role_epa', NULL, 'ELEVATION', 'Elevation:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_unbalanced_n', 'epaoptions', null, 'role_epa', NULL, 'UNBALANCED_N', 'Unbalanced n:', NULL, NULL, true, 4, 6, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '40.00', 'grl_hyd_4', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_checkfreq', 'epaoptions', null, 'role_epa', NULL, 'CHECKFREQ', 'Check frequency:', NULL, NULL, true, 4, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '2.00', 'grl_hyd_4', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_head', 'epaoptions', null, 'role_epa', NULL, 'HEAD', 'Head:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 8, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_length', 'epaoptions', null, 'role_epa', NULL, 'LENGTH', 'Length:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 9, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_links', 'epaoptions', null, 'role_epa', NULL, 'LINKS', 'Links:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 10, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_summary', 'epaoptions', null, 'role_epa', NULL, 'SUMMARY', 'Summary:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 8, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_velocity', 'epaoptions', null, 'role_epa', NULL, 'VELOCITY', 'Velocity:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 9, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('inp_options_hydraulics', 'epaoptions', null, 'role_epa', NULL, 'HYDRAULICS', 'Hydraulics:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_opti_hyd''', NULL, true, 3, 7, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'USE', 'grl_hyd_3', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_units', 'epaoptions', null, 'role_epa', NULL, 'UNITS', 'Units:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_opti_units''', NULL, true, 1, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'LPS', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_reaction', 'epaoptions', null, 'role_epa', NULL, 'REACTION', 'Reaction:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_setting', 'epaoptions', null, 'role_epa', NULL, 'SETTING', 'Setting:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 6, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_rtc_enabled', 'epaoptions', null, 'role_epa', NULL, 'RTC_ENABLED', 'CRM values', NULL, NULL, true, 9, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'boolean', 'check', true, NULL, 'FALSE', 'grl_crm_9', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('inp_options_hydraulics_fname', 'epaoptions', null, 'role_epa', NULL, 'HYDRAULICS_FNAME', 'Hydraulics fname:', NULL, NULL, true, 4, 7, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, 'name', 'grl_hyd_4', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_accuracy', 'epaoptions', null, 'role_epa', NULL, 'ACCURACY', 'Accuracy:', NULL, NULL, true, 3, 4, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '0.001', 'grl_hyd_3', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_tolerance', 'epaoptions', null, 'role_epa', NULL, 'TOLERANCE', 'Tolerance:', NULL, NULL, true, 4, 4, 'ws', NULL, NULL, NULL, NULL, NULL, 'float', 'text', true, '{"minValue":0.001, "maxValue":100}', '0.01', 'grl_hyd_4', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_demand', 'epaoptions', null, 'role_epa', NULL, 'DEMAND', 'Demand:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_diameter', 'epaoptions', null, 'role_epa', NULL, 'DIAMETER', 'Diameter:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_nodes', 'epaoptions', null, 'role_epa', NULL, 'NODES', 'Nodes:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_pressure', 'epaoptions', null, 'role_epa', NULL, 'PRESSURE', 'Pressure:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_quality', 'epaoptions', null, 'role_epa', NULL, 'QUALITY', 'Quality:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 4, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_14', NULL);
