...
INSERT INTO audit_cat_param_user VALUES ('inp_report_f_factor', 'epaoptions', NULL, 'role_epa', NULL, 'F-FACTOR', 'F Factor:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 2, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'combo', 'text', true, NULL, 'PRECISION 4', 'grl_reports_17', NULL, false);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_energy', 'epaoptions', NULL, 'role_epa', NULL, 'ENERGY', 'Energy:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 4, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL, false);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_elevation', 'epaoptions', NULL, 'role_epa', NULL, 'ELEVATION', 'Elevation:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL, false);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_file', 'epaoptions', NULL, 'role_epa', NULL, 'FILE', 'File:', NULL, NULL, true, 13, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'text', true, NULL, NULL, 'grl_reports_17', NULL, false);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_reaction', 'epaoptions', NULL, 'role_epa', NULL, 'REACTION', 'Reaction:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 5, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_18', NULL, false);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_setting', 'epaoptions', NULL, 'role_epa', NULL, 'SETTING', 'Setting:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 6, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_18', NULL, false);
...
INSERT INTO audit_cat_param_user VALUES ('inp_report_demand', 'epaoptions', NULL, 'role_epa', NULL, 'DEMAND', 'Demand:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 1, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL, false);
INSERT INTO audit_cat_param_user VALUES ('inp_report_diameter', 'epaoptions', NULL, 'role_epa', NULL, 'DIAMETER', 'Diameter:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 13, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL, false);
INSERT INTO audit_cat_param_user VALUES ('inp_report_pressure', 'epaoptions', NULL, 'role_epa', NULL, 'PRESSURE', 'Pressure:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 3, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_18', NULL, false);
INSERT INTO audit_cat_param_user VALUES ('inp_report_quality', 'epaoptions', NULL, 'role_epa', NULL, 'QUALITY', 'Quality:', 'SELECT idval AS id, idval FROM inp_typevalue WHERE typevalue=''inp_value_yesno''', NULL, true, 14, 4, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, 'YES', 'grl_reports_18', NULL, false);
