...
INSERT INTO audit_cat_param_user VALUES ('inp_options_pattern', 'epaoptions', NULL, 'role_epa', NULL, 'PATTERN', 'Pattern:', 'SELECT pattern_id AS id, pattern_id AS idval FROM inp_pattern', NULL, true, 2, 2, 'ws', NULL, NULL, NULL, NULL, NULL, 'text', 'combo', true, NULL, NULL, 'grl_general_2', NULL, NULL, NULL, NULL, NULL, NULL);
