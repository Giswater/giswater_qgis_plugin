...
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('nodeisert_arcendpoint', 'FALSE', 'boolean', 'edit', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('orphannode_delete', 'false', 'boolean', NULL, NULL, 'Orphan node delete:', NULL, NULL, true, 13, 6, 'utils', false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('nodetype_change_enabled', 'FALSE', 'boolean', NULL, NULL, 'nodetype_change_enabled', NULL, NULL, true, 13, 12, 'utils', false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('samenode_init_end_control', 'true', NULL, NULL, NULL, 'Arc same node init end control:', NULL, NULL, true, 13, 2, 'utils', false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('audit_function_control', 'TRUE', 'boolean', NULL, NULL, 'audit_function_control', NULL, NULL, false, NULL, NULL, NULL, false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('insert_double_geometry', 'false', 'boolean', NULL, NULL, 'Double geometry enabled:', NULL, NULL, true, 13, 5, 'utils', false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('buffer_value', '3.0', 'double precision', NULL, NULL, 'Double geometry enabled:', NULL, NULL, true, 13, 5, 'utils', false, false, 'double', 'spinbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('node_proximity_control', 'true', 'boolean', NULL, NULL, 'Node proximity control:', NULL, NULL, true, 13, 3, 'utils', false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('arc_searchnodes_control', 'true', 'boolean', NULL, NULL, 'Arc searchnodes buffer:', NULL, NULL, true, 13, 1, 'utils', false, false, 'boolean', 'checkbox', NULL);
INSERT INTO config_param_system (parameter, value, data_type, context, descript, label, dv_querytext, dv_filterbyfield, isenabled, layout_id, layout_order, project_type, dv_isparent, isautoupdate, datatype, widgettype, tooltip) VALUES ('connec_proximity_control', 'true', 'boolean', NULL, NULL,'Connec proximity control:', NULL, NULL, true, 13, 4, 'utils', false, false, 'boolean', 'checkbox', NULL);
