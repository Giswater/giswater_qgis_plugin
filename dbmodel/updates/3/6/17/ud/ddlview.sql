...
AS SELECT inp_subcatchment.hydrology_id,
   ...
   FROM inp_subcatchment,  config_param_user,  selector_sector
   WHERE inp_subcatchment.sector_id = selector_sector.sector_id AND selector_sector.cur_user = "current_user"()::text 
   AND inp_subcatchment.hydrology_id = config_param_user.value::integer AND config_param_user.cur_user::text = "current_user"()::text 
