...
UPDATE config_form_fields SET layoutname='lyt_general_3', layoutorder=3, web_layoutorder=3, widgetcontrols='{"setMultiline":false, "labelPosition":"top"}'::json WHERE formname='generic' AND formtype='psector' AND columnname='psector_type' AND tabname='tab_general';
