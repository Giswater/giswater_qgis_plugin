...
DROP TRIGGER IF EXISTS gw_trg_edit_arc_pumppipe ON "ud_project".ve_arc_pumppipe;
CREATE TRIGGER gw_trg_edit_arc_pumppipe INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_arc_pumppipe FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_arc('PUMP-PIPE');     

DROP TRIGGER IF EXISTS gw_trg_edit_arc_conduit ON "ud_project".ve_arc_conduit;
CREATE TRIGGER gw_trg_edit_arc_conduit INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_arc_conduit FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_arc('CONDUIT');   

DROP TRIGGER IF EXISTS gw_trg_edit_arc_siphon ON "ud_project".ve_arc_siphon;
CREATE TRIGGER gw_trg_edit_arc_siphon INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_arc_siphon FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_arc('SIPHON'); 

DROP TRIGGER IF EXISTS gw_trg_edit_arc_varc ON "ud_project".ve_arc_varc;
CREATE TRIGGER gw_trg_edit_arc_varc INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_arc_varc FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_arc('VARC'); 

DROP TRIGGER IF EXISTS gw_trg_edit_arc_waccel ON "ud_project".ve_arc_waccel;
CREATE TRIGGER gw_trg_edit_arc_waccel INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_arc_waccel FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_arc('WACCEL'); 

DROP TRIGGER IF EXISTS gw_trg_edit_connec ON "ud_project".ve_connec;
CREATE TRIGGER gw_trg_edit_connec INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_connec FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_connec('CONNEC');

DROP TRIGGER IF EXISTS gw_trg_edit_gully ON "ud_project".ve_gully;
CREATE TRIGGER gw_trg_edit_gully INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_gully FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_gully(gully);

DROP TRIGGER IF EXISTS gw_trg_edit_man_gully_pol ON "ud_project".ve_pol_gully;
CREATE TRIGGER gw_trg_edit_man_gully_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_pol_gully FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_man_gully_pol();


DROP TRIGGER IF EXISTS gw_trg_edit_node_chamber ON "ud_project".ve_node_chamber;
CREATE TRIGGER gw_trg_edit_node_chamber INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_chamber FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('CHAMBER');     

DROP TRIGGER IF EXISTS gw_trg_edit_node_weir ON "ud_project".ve_node_weir;
CREATE TRIGGER gw_trg_edit_node_weir INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_weir FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('WEIR');

DROP TRIGGER IF EXISTS gw_trg_edit_node_pumpstation ON "ud_project".ve_node_pumpstation;
CREATE TRIGGER gw_trg_edit_node_pumpstation INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_pumpstation FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('PUMP-STATION');

DROP TRIGGER IF EXISTS gw_trg_edit_node_register ON "ud_project".ve_node_register;
CREATE TRIGGER gw_trg_edit_node_register INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_register FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('REGISTER');  

DROP TRIGGER IF EXISTS gw_trg_edit_node_change ON "ud_project".ve_node_change;
CREATE TRIGGER gw_trg_edit_node_change INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_change FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('CHANGE');  

DROP TRIGGER IF EXISTS gw_trg_edit_node_vnode ON "ud_project".ve_node_vnode;
CREATE TRIGGER gw_trg_edit_node_vnode INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_vnode FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('VNODE');

DROP TRIGGER IF EXISTS gw_trg_edit_node_junction ON "ud_project".ve_node_junction;
CREATE TRIGGER gw_trg_edit_node_junction INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_junction FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('JUNCTION');

DROP TRIGGER IF EXISTS gw_trg_edit_node_highpoint ON "ud_project".ve_node_highpoint;
CREATE TRIGGER gw_trg_edit_node_highpoint INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_highpoint FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('HIGHPOINT');   

DROP TRIGGER IF EXISTS gw_trg_edit_node_circmanhole ON "ud_project".ve_node_circmanhole;
CREATE TRIGGER gw_trg_edit_node_circmanhole INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_circmanhole FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('CIRC-MANHOLE');   

DROP TRIGGER IF EXISTS gw_trg_edit_node_rectmanhole ON "ud_project".ve_node_rectmanhole;
CREATE TRIGGER gw_trg_edit_node_rectmanhole INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_rectmanhole FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('RECT-MANHOLE');
     
DROP TRIGGER IF EXISTS gw_trg_edit_node_netelement ON "ud_project".ve_node_netelement;
CREATE TRIGGER gw_trg_edit_node_netelement INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_netelement FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('NETELEMENT');

DROP TRIGGER IF EXISTS gw_trg_edit_node_netgully ON "ud_project".ve_node_netgully;
CREATE TRIGGER gw_trg_edit_node_netgully INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_netgully FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('NETGULLY'); 

DROP TRIGGER IF EXISTS gw_trg_edit_node_sandbox ON "ud_project".ve_node_sandbox;
CREATE TRIGGER gw_trg_edit_node_sandbox INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_sandbox FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('SANDBOX'); 

DROP TRIGGER IF EXISTS gw_trg_edit_node_outfall ON "ud_project".ve_node_outfall;
CREATE TRIGGER gw_trg_edit_node_outfall INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_outfall FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('OUTFALL'); 

DROP TRIGGER IF EXISTS gw_trg_edit_node_overflowstorage ON "ud_project".ve_node_overflowstorage;
CREATE TRIGGER gw_trg_edit_node_overflowstorage INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_overflowstorage FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('OWERFLOW-STORAGE'); 


DROP TRIGGER IF EXISTS gw_trg_edit_node_sewerstorage ON "ud_project".ve_node_sewerstorage;
CREATE TRIGGER gw_trg_edit_node_sewerstorage INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_sewerstorage FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('SEWER-STORAGE');

DROP TRIGGER IF EXISTS gw_trg_edit_node_valve ON "ud_project".ve_node_valve;
CREATE TRIGGER gw_trg_edit_node_valve INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_valve FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('VALVE');

DROP TRIGGER IF EXISTS gw_trg_edit_node_jump ON "ud_project".ve_node_jump;
CREATE TRIGGER gw_trg_edit_node_jump INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_jump FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('JUMP');

DROP TRIGGER IF EXISTS gw_trg_edit_node_wwtp ON "ud_project".ve_node_wwtp;
CREATE TRIGGER gw_trg_edit_node_wwtp INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node_wwtp FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node('WWTP');

DROP TRIGGER IF EXISTS gw_trg_edit_man_storage_pol ON "ud_project".ve_pol_storage;
CREATE TRIGGER gw_trg_edit_man_storage_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_pol_storage FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_man_node_pol('man_storage_pol');

DROP TRIGGER IF EXISTS gw_trg_edit_man_netgully_pol ON "ud_project".ve_pol_netgully;
CREATE TRIGGER gw_trg_edit_man_netgully_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_pol_netgully FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_man_node_pol('man_netgully_pol');

DROP TRIGGER IF EXISTS gw_trg_edit_man_chamber_pol ON "ud_project".ve_pol_chamber;
CREATE TRIGGER gw_trg_edit_man_chamber_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_pol_chamber FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_man_node_pol('man_chamber_pol');

DROP TRIGGER IF EXISTS gw_trg_edit_man_wwtp_pol ON "ud_project".ve_pol_wwtp;
CREATE TRIGGER gw_trg_edit_man_wwtp_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_pol_wwtp FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_man_node_pol('man_wwtp_pol');

DROP TRIGGER IF EXISTS gw_trg_edit_node ON "ud_project".ve_node;
CREATE TRIGGER gw_trg_edit_node INSTEAD OF INSERT OR DELETE OR UPDATE ON "ud_project".ve_node
FOR EACH ROW EXECUTE PROCEDURE "ud_project".gw_trg_edit_node();
