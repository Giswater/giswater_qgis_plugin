...
INSERT INTO audit_cat_function VALUES (2690, 'gw_trg_topocontrol_node_after', 'utils', 'trigger function', NULL, NULL, NULL, 'Trigger to manage the insertion of state 2 nodes over state 1 nodes', 'role_edit', false, false, null, true);