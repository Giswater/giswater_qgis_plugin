...
INSERT INTO audit_cat_table VALUES ('om_visit_type', 'O&M', 'Catalog of visit types', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_class', 'O&M', 'Catalog of visit classes', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_class_x_parameter', 'O&M', 'Table that relates visit parameters with visit classes', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_lot', 'O&M', 'Table with all lots that took place', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_lot_x_arc', 'O&M', 'Table of arcs related to lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_lot_x_node', 'O&M', 'Table of nodes related to lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_lot_x_connec', 'O&M', 'Table of connecs related to lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('selector_lot', 'Selector', 'Selector of lots', 'role_basic', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('cat_team', 'Catalog', 'Catalog of teams', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_team_x_user', 'O&M', 'Table that relates users with teams', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_filetype_x_extension', 'O&M', 'Catalog of diferent filetypes and their extensions used in visits', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_lot_x_user', 'O&M', 'Table that saves information about works made by a user in relation to one lot', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_visit_arc_singlevent', 'O&M', 'Editable view that saves visits to arcs and its event data', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_visit_connec_singlevent', 'O&M', 'Editable view that saves visits to connecs and its event data', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_visit_node_singlevent', 'O&M', 'Editable view that saves visits to nodes and its event data', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('audit_cat_column', 'System', 'Catalog of columns', 'role_admin', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('edit_typevalue', 'value domain', 'Value domain of edit tables', 'role_admin', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_plan_node_cost', 'User interface view', 'User interface view for nodes and its prices', 'role_master', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_plan_arc_cost', 'User interface view', 'User interface view for nodes and its prices', 'role_master', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vp_basic_arc', 'Auxiliar view', 'Auxiliar view for arcs with id and type', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vp_basic_node', 'Auxiliar view', 'Auxiliar view for nodes with id and type', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vp_basic_connec', 'Auxiliar view', 'Auxiliar view for connecs with id and type', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vp_epa_arc', 'Auxiliar view', 'Auxiliar view for arcs with id, type and epa view', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vp_epa_node', 'Auxiliar view', 'Auxiliar view for nodes with id, type and epa view', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ext_hydrometer_category_x_pattern', 'external table', 'Table that related hydrometer category with its pattern', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ext_cat_period_type', 'external table', 'Catalog of different types of periods', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('plan_typevalue', 'value domain', 'Value domain of plan tables', 'role_admin', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_typevalue', 'value domain', 'Value domain of om tables', 'role_admin', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('plan_psector_x_connec', 'masterplan', 'Table of connecs related to plan sectors', 'role_master', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_event_x_arc', 'User interface view', 'User interface view for arcs related to its events', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_event_x_connec', 'User interface view', 'User interface view for connecs related to its events', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_event_x_node', 'User interface view', 'User interface view for nodes related to its events', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_hydroval_x_connec', 'User interface view', 'User interface view for connecs related to its hydrometer and data', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_doc', 'User interface view', 'User interface view for docs', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_arc', 'Editable view', 'Editable view for arcs', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_node', 'Editable view', 'Editable view for nodes', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_connec', 'Editable view', 'Editable view for conncs', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ext_timeseries', 'external table', 'Table of timeseries', 'role_edit', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ext_workorder_class', 'external table', 'Table of workorders related to its classes', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ext_workorder_type', 'external table', 'Table of workorders related to its types', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('om_visit_class_x_wo', 'O&M', 'Table of visit classes related to its workorders', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ext_workorder', 'external table', 'External table of workorders', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('typevalue_fk', 'System', NULL, 'role_admin', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vi_parent_arc', 'Hydraulic input data', 'Parent table of arcs filtered by inp selector', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('vi_parent_node', 'Hydraulic input data', 'Parent table of nodes filtered by inp selector', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_rtc_period_dma', 'Real time control', 'View of the relation between dma and period', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_rtc_period_node', 'Real time control', 'View of the relation between node and period', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_rtc_period_pjoint', 'Real time control', NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_plan_psector_arc_affect', 'masterplan', 'View with arcs which will be removed by a psector', 'role_master', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_plan_psector_arc_current', 'masterplan', 'View with arcs which will be affected by a psector but they remain untouched', 'role_master', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_plan_psector_arc_planif', 'masterplan', 'View with arcs which will be new in a psector', 'role_master', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_ui_om_visit_lot', 'User interface view', 'User interface view for lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_res_lot_x_user', 'O&M', 'View with the results of a work realised by a user in relation with one lot', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_lot_x_arc', 'O&M', 'View that relates arcs and lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_lot_x_node', 'O&M', 'View that relates nodes and lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('ve_lot_x_connec', 'O&M', 'View that relates connecs and lots', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('v_visit_lot_user', 'O&M', 'View for lots and users', 'role_om', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
INSERT INTO audit_cat_table VALUES ('cat_manager', 'admin', 'Catalog of management divisions', 'role_admin', 0, NULL, NULL, 0, NULL, NULL, NULL, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
