...
DELETE FROM config_param_system WHERE parameter='expl_layer';
DELETE FROM config_param_system WHERE parameter='expl_field_code';
DELETE FROM config_param_system WHERE parameter='expl_field_name';
DELETE FROM config_param_system WHERE parameter='scale_zoom';
...
DELETE FROM config_param_system WHERE parameter='street_layer';
DELETE FROM config_param_system WHERE parameter='street_field_code';
DELETE FROM config_param_system WHERE parameter='street_field_name';
DELETE FROM config_param_system WHERE parameter='portal_layer';
DELETE FROM config_param_system WHERE parameter='portal_field_code';
DELETE FROM config_param_system WHERE parameter='portal_field_number';
DELETE FROM config_param_system WHERE parameter='portal_field_postal';
DELETE FROM config_param_system WHERE parameter='street_field_expl';
