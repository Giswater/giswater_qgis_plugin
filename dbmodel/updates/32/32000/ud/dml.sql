...
INSERT INTO audit_cat_param_user VALUES ('inp_options_flow_routing', 'epaoptions', NULL, 'role_epa', NULL, 'FLOW_ROUTING', 'inp_options_flow_routing:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_fr''', NULL, true, 1, 2, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'DYNWAVE', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_flow_units', 'epaoptions', NULL, 'role_epa', NULL, 'FLOW_UNITS', 'inp_options_flow_units:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_fu''', NULL, true, 1, 1, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'CMS', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_ignore_quality', 'epaoptions', NULL, 'role_epa', NULL, 'IGNORE_QUALITY', 'inp_options_ignore_quality:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 2, 9, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'NO', 'grl_general_2', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_ignore_rainfall', 'epaoptions', NULL, 'role_epa', NULL, 'IGNORE_RAINFALL', 'inp_options_ignore_rainfall:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 2, 5, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'NO', 'grl_general_2', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_ignore_routing', 'epaoptions', NULL, 'role_epa', NULL, 'IGNORE_ROUTING', 'inp_options_ignore_routing:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 2, 8, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'NO', 'grl_general_2', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_ignore_snowmelt', 'epaoptions', NULL, 'role_epa', NULL, 'IGNORE_SNOWMELT', 'inp_options_ignore_snowmelt:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 2, 6, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'NO', 'grl_general_2', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_link_offsets', 'epaoptions', NULL, 'role_epa', NULL, 'LINK_OFFSETS', 'inp_options_link_offsets:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_lo''', NULL, true, 1, 3, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'ELEVATION', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_min_slope', 'epaoptions', NULL, 'role_epa', NULL, 'MIN_SLOPE', 'inp_options_min_slope:', NULL, NULL, true, 1, 29, 'ud', NULL, NULL, NULL, NULL, NULL, 'float', 'linetext', true, NULL, '0.00', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_rtc_period_id', 'epaoptions', NULL, 'role_epa', NULL, 'RTC_PERIOD_ID', 'inp_options_rtc_period_id:', NULL, NULL, true, 9, 36, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, NULL, 'grl_crm_9', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_skip_steady_state', 'epaoptions', NULL, 'role_epa', NULL, 'SKIP_STEADY_STATE', 'inp_options_skip_steady_state:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 1, 10, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'NO', 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_variable_step', 'epaoptions', NULL, 'role_epa', NULL, 'VARIABLE_STEP', 'inp_options_variable_step:', NULL, NULL, true, 1, 25, 'ud', NULL, NULL, NULL, NULL, NULL, 'float', 'linetext', true, NULL, NULL, 'grl_general_1', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_input', 'epaoptions', NULL, 'role_epa', NULL, 'INPUT', 'inp_report_input:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 17, 1, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_lat_flow_tol', 'epaoptions', NULL, 'role_epa', NULL, 'LAT_FLOW_TOL', 'inp_options_lat_flow_tol:', NULL, NULL, true, 11, 35, 'ud', NULL, NULL, NULL, NULL, NULL, 'integer', 'linetext', true, NULL, '5', 'grl_dyn_11', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_continuity', 'epaoptions', NULL, 'role_epa', NULL, 'CONTINUITY', 'inp_report_continuity:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 17, 2, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_links', 'epaoptions', NULL, 'role_epa', NULL, 'LINKS', 'inp_report_links:', NULL, NULL, true, 18, 7, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, 'ALL', 'grl_reports_18', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_normal_flow_limited', 'epaoptions', NULL, 'role_epa', NULL, 'NORMAL_FLOW_LIMITED', 'inp_options_normal_flow_limited:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_nfl''', NULL, true, 12, 27, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'BOTH', 'grl_dyn_12', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_sys_flow_tol', 'epaoptions', NULL, 'role_epa', NULL, 'SYS_FLOW_TOL', 'inp_options_sys_flow_tol:', NULL, NULL, true, 14, 34, 'ud', NULL, NULL, NULL, NULL, NULL, 'integer', 'linetext', true, NULL, '5', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_infiltration', 'epaoptions', NULL, 'role_epa', NULL, 'INFILTRATION', 'inp_options_infiltration:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_in''', NULL, true, 2, 37, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'HORTON', 'grl_general_2', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_subcatchments', 'epaoptions', NULL, 'role_epa', NULL, 'SUBCATCHMENTS', 'inp_report_subcatchments:', NULL, NULL, true, 18, 5, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, 'ALL', 'grl_reports_18', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_nodes', 'epaoptions', NULL, 'role_epa', NULL, 'NODES', 'inp_report_nodes:', NULL, NULL, true, 18, 6, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, 'ALL', 'grl_reports_18', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_flowstats', 'epaoptions', NULL, 'role_epa', NULL, 'FLOWSTATS', 'inp_report_flowstats:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 17, 3, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_dry_days', 'epaoptions', NULL, 'role_epa', NULL, 'DRY_DAYS', 'inp_options_dry_days:', NULL, NULL, true, 13, 19, 'ud', NULL, NULL, NULL, NULL, NULL, 'integer', 'linetext', true, NULL, '10', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_dry_step', 'epaoptions', NULL, 'role_epa', NULL, 'DRY_STEP', 'inp_options_dry_step:', NULL, NULL, true, 13, 22, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '01:00:00', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_end_date', 'epaoptions', NULL, 'role_epa', NULL, 'END_DATE', 'inp_options_end_date:', NULL, NULL, true, 13, 13, 'ud', NULL, NULL, NULL, NULL, NULL, 'date', 'datetime', true, NULL, '01/02/2017', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_end_time', 'epaoptions', NULL, 'role_epa', NULL, 'END_TIME', 'inp_options_end_time:', NULL, NULL, true, 13, 14, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '00:00:00', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_force_main_equation', 'epaoptions', NULL, 'role_epa', NULL, 'FORCE_MAIN_EQUATION', 'inp_options_force_main_equation:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_fme''', NULL, true, 11, 4, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'H-W', 'grl_dyn_11', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_head_tolerance', 'epaoptions', NULL, 'role_epa', NULL, 'HEAD_TOLERANCE', 'inp_options_head_tolerance:', NULL, NULL, true, 11, 33, 'ud', NULL, NULL, NULL, NULL, NULL, 'float', 'linetext', true, NULL, '0.000', 'grl_dyn_11', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_max_trials', 'epaoptions', NULL, 'role_epa', NULL, 'MAX_TRIALS', 'inp_options_max_trials:', NULL, NULL, true, 12, 32, 'ud', NULL, NULL, NULL, NULL, NULL, 'integer', 'linetext', true, NULL, '0', 'grl_dyn_12', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_inertial_damping', 'epaoptions', NULL, 'role_epa', NULL, 'INERTIAL_DAMPING', 'inp_options_inertial_damping:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_options_id''', NULL, true, 11, 26, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'NONE', 'grl_dyn_11', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_lengthening_step', 'epaoptions', NULL, 'role_epa', NULL, 'LENGTHENING_STEP', 'inp_options_lengthening_step:', NULL, NULL, true, 11, 24, 'ud', NULL, NULL, NULL, NULL, NULL, 'float', 'linetext', true, NULL, 'demo', 'grl_dyn_11', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_min_surfarea', 'epaoptions', NULL, 'role_epa', NULL, 'MIN_SURFAREA', 'inp_options_min_surfarea:', NULL, NULL, true, 12, 28, 'ud', NULL, NULL, NULL, NULL, NULL, 'float', 'linetext', true, NULL, '0.00', 'grl_dyn_12', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_report_start_date', 'epaoptions', NULL, 'role_epa', NULL, 'REPORT_START_DATE', 'inp_options_report_start_date:', NULL, NULL, true, 13, 15, 'ud', NULL, NULL, NULL, NULL, NULL, 'date', 'datetime', true, NULL, '01/01/2017', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_routing_step', 'epaoptions', NULL, 'role_epa', NULL, 'ROUTING_STEP', 'inp_options_routing_step:', NULL, NULL, true, 14, 23, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '00:00:02', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_report_start_time', 'epaoptions', NULL, 'role_epa', NULL, 'REPORT_START_TIME', 'inp_options_report_start_time:', NULL, NULL, true, 13, 16, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '00:00:00', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_report_step', 'epaoptions', NULL, 'role_epa', NULL, 'REPORT_STEP', 'inp_options_report_step:', NULL, NULL, true, 13, 20, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '00:05:00', 'grl_date_13', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_start_date', 'epaoptions', NULL, 'role_epa', NULL, 'START_DATE', 'inp_options_start_date:', NULL, NULL, true, 14, 11, 'ud', NULL, NULL, NULL, NULL, NULL, 'date', 'datetime', true, NULL, '01/01/2017', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_start_time', 'epaoptions', NULL, 'role_epa', NULL, 'START_TIME', 'inp_options_start_time:', NULL, NULL, true, 14, 12, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '00:00:00', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_sweep_end', 'epaoptions', NULL, 'role_epa', NULL, 'SWEEP_END', 'inp_options_sweep_end:', NULL, NULL, true, 14, 18, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '12/31', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_sweep_start', 'epaoptions', NULL, 'role_epa', NULL, 'SWEEP_START', 'inp_options_sweep_start:', NULL, NULL, true, 14, 17, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '01/01', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_tempdir', 'epaoptions', NULL, 'role_epa', NULL, 'TEMPDIR', 'inp_options_tempdir:', NULL, NULL, true, 14, 31, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, NULL, 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_options_wet_step', 'epaoptions', NULL, 'role_epa', NULL, 'WET_STEP', 'inp_options_wet_step:', NULL, NULL, true, 14, 21, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'linetext', true, NULL, '00:05:00', 'grl_date_14', NULL);
INSERT INTO audit_cat_param_user VALUES ('inp_report_controls', 'epaoptions', NULL, 'role_epa', NULL, 'CONTROLS', 'inp_report_controls:', 'SELECT idval as id, idval FROM inp_typevalue WHERE typevalue = ''inp_value_yesno''', NULL, true, 17, 4, 'ud', NULL, NULL, NULL, NULL, NULL, 'string', 'combo', true, NULL, 'YES', 'grl_reports_17', NULL);
