...
UNION
 SELECT inp_orifice.arc_id,
    ...
    inp_orifice.geom1::text,
    inp_orifice.geom2::text, 
    inp_orifice.geom3::text, 
    inp_orifice.geom4::text,
    null, 
    null
...
UNION
 SELECT rpt_inp_arc.arc_id,
    inp_typevalue.idval AS shape,
    inp_flwreg_orifice.geom1::text, 
    inp_flwreg_orifice.geom2::text, 
    inp_flwreg_orifice.geom3::text, 
    inp_flwreg_orifice.geom4::text,
    null,
    null   
   FROM inp_selector_result, rpt_inp_arc
...
UNION
 SELECT rpt_inp_arc.arc_id,
    ...
    inp_flwreg_weir.geom1::text,
    inp_flwreg_weir.geom2::text,
    inp_flwreg_weir.geom3::text, 
    inp_flwreg_weir.geom4::text,
    null,
    null
   FROM inp_selector_result,
    rpt_inp_arc
...
drop view SCHEMA_NAME.vi_dividers;
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_dividers AS 
 SELECT rpt_inp_node.node_id,
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_node
     JOIN SCHEMA_NAME.inp_divider ON rpt_inp_node.node_id::text = inp_divider.node_id::text
...
UNION
 SELECT rpt_inp_node.node_id,
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_node
     JOIN SCHEMA_NAME.inp_divider ON rpt_inp_node.node_id::text = inp_divider.node_id::text
     LEFT JOIN SCHEMA_NAME.inp_typevalue ON inp_typevalue.id::text = inp_divider.divider_type::text
  WHERE inp_typevalue.typevalue::text = 'inp_typevalue_divider'::text AND inp_divider.divider_type::text = 'TABULAR_DIVIDER'::text AND rpt_inp_node.result_id::text = inp_selector_result.result_id::text AND inp_selector_result.cur_user = "current_user"()::text
UNION
 SELECT rpt_inp_node.node_id,
    rpt_inp_node.elev,
    inp_divider.arc_id,
  ...
  DROP VIEW SCHEMA_NAME.vi_outfalls;
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_outfalls AS 
 SELECT rpt_inp_node.node_id,
    rpt_inp_node.elev,
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_node
     JOIN SCHEMA_NAME.inp_outfall ON inp_outfall.node_id::text = rpt_inp_node.node_id::text
...
UNION
 SELECT rpt_inp_node.node_id,
  ...
  WHERE inp_typevalue.typevalue::text = 'inp_typevalue_outfall'::text AND inp_outfall.outfall_type::text = 'TIDAL_OUTFALL'::text 
...
UNION
 ...
 DROP VIEW SCHEMA_NAME.vi_storage;
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_storage AS 
 SELECT rpt_inp_node.node_id,
    rpt_inp_node.elev,
    rpt_inp_node.ymax,
    inp_storage.y0,
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_node
     JOIN SCHEMA_NAME.inp_storage ON rpt_inp_node.node_id::text = inp_storage.node_id::text
...
UNION
 SELECT rpt_inp_node.node_id,
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_node
     JOIN SCHEMA_NAME.inp_storage ON rpt_inp_node.node_id::text = inp_storage.node_id::text
     LEFT JOIN SCHEMA_NAME.inp_typevalue ON inp_typevalue.id::text = inp_storage.storage_type::text
  WHERE inp_typevalue.typevalue::text = 'inp_typevalue_storage'::text AND inp_storage.storage_type::text = 'TABULAR_STORAGE'::text 
  AND rpt_inp_node.result_id::text = inp_selector_result.result_id::text AND inp_selector_result.cur_user = "current_user"()::text;
   

   DROP VIEW SCHEMA_NAME.vi_outlets;
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_outlets AS 
 SELECT rpt_inp_arc.arc_id,
    rpt_inp_arc.node_1,
    rpt_inp_arc.node_2,
    inp_outlet."offset",
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_arc
     JOIN SCHEMA_NAME.inp_outlet ON rpt_inp_arc.arc_id::text = inp_outlet.arc_id::text
...
UNION
 SELECT rpt_inp_arc.arc_id,
   ...
   FROM SCHEMA_NAME.inp_selector_result, SCHEMA_NAME.rpt_inp_arc
     JOIN SCHEMA_NAME.inp_flwreg_outlet ON rpt_inp_arc.flw_code::text = concat(inp_flwreg_outlet.node_id, '_', inp_flwreg_outlet.to_arc, '_out_', inp_flwreg_outlet.flwreg_id)
...
DROP VIEW SCHEMA_NAME.vi_patterns;
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_patterns AS 
...
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_infiltration AS 
 SELECT v_edit_subcatchment.subc_id,
    ...
    null::float AS other5
   FROM SCHEMA_NAME.v_edit_subcatchment
   JOIN SCHEMA_NAME.cat_hydrology ON cat_hydrology.hydrology_id = v_edit_subcatchment.hydrology_id
...
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_raingages AS 
 SELECT v_edit_raingage.rg_id,
    ...
    null as other2,
    null as other3
   FROM SCHEMA_NAME.v_edit_raingage
     LEFT JOIN SCHEMA_NAME.inp_typevalue ON inp_typevalue.id::text = v_edit_raingage.rgage_type::text
  WHERE inp_typevalue.typevalue::text = 'inp_typevalue_raingage'::text AND rgage_type='TIMESERIES_RAIN'
  UNION
  SELECT v_edit_raingage.rg_id,
    v_edit_raingage.form_type,
    v_edit_raingage.intvl,
...
CREATE OR REPLACE VIEW SCHEMA_NAME.vi_lid_controls AS 
 SELECT inp_lid_control.lidco_id,
   ...
   FROM SCHEMA_NAME.inp_lid_control
   LEFT JOIN SCHEMA_NAME.inp_typevalue ON inp_typevalue.id::text = inp_lid_control.lidco_type::text
