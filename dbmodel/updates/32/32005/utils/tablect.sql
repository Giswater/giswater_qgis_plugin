...
--ADD
ALTER TABLE man_addfields_value DROP CONSTRAINT IF EXISTS man_addfields_value_unique CASCADE;
ALTER TABLE man_addfields_value ADD CONSTRAINT man_addfields_value_unique UNIQUE(feature_id, parameter_id);
  
ALTER TABLE sys_feature_cat DROP CONSTRAINT IF EXISTS sys_feature_cat_unique CASCADE;
ALTER TABLE sys_feature_cat ADD CONSTRAINT sys_feature_cat_unique UNIQUE(id, type);
