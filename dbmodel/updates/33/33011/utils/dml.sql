...
--31/10/2019
UPDATE audit_cat_function SET istoolbox=FALSE, sys_role_id ='role_om'
WHERE id=2710;
...
"dvQueryText":"SELECT expl_id as id, name as idval FROM exploitation WHERE active IS TRUE order by 2", "selectedId":"1"},
