...
'{"node":{"nullElevBuffer":100, "ceroElevBuffer":100}, "pipe":{"diameter":"160"}, "junction":{"defaultDemand":"0.001"}, "tank":{"distVirtualReservoir":0.01}, "pressGroup":{"status":"ACTIVE", "forceStatus":"ACTIVE"}, 
"pumpStation":{"status":"CLOSED", "forceStatus":"CLOSED"}, "PRV":{"status":"ACTIVE", "forceStatus":"ACTIVE"}, "reservoir":{"switch2Junction":["ETAP", "POU", "CAPTACIO"]}}',
...
INSERT INTO audit_cat_param_user VALUES 
('inp_options_advancedsettings', 'hidden_value', 'Advanced parameters to create epanet models', 'role_epa', NULL, NULL, 'Advances settings', NULL, NULL, true, NULL, NULL, 'ws', false, NULL, NULL, NULL, 
false, 'text', 'linetext', true, null,
'{"status":"false", "parameters":{"valve":{"minorloss":0.2}, "reservoir":{"addElevation":1}, "pipe":{}, "tank":{"addElevation":1}, "pump":{"length":0.3, "diameter":100, "roughness":{"H-W":100, "D-W":0.5, "M-W":0.011}}}}',
NULL, NULL, TRUE, NULL, NULL, NULL, NULL, FALSE)
ON conflict (id) DO NOTHING;
...
VALUES (2798, 'gw_fct_pg2epa_advancedsettings', 'utils', 'function','Parameters for advanced user', 
'role_epa', false, false;

INSERT INTO audit_cat_function(id, function_name, project_type, function_type, descript, sys_role_id, isdeprecated, istoolbox)
VALUES (2800, 'gw_fct_pg2epa_buildup_transport', 'utils', 'function','Function to generate supply models oriented to manage olumes of water and water quality', 
'role_epa', false, false;