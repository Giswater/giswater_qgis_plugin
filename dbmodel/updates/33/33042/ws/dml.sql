...
UPDATE inp_typevalue SET idval = 'CONNEC ESTIMATED (PJOINT)', id= '15' WHERE id = '14' AND typevalue = 'inp_value_patternmethod';
INSERT INTO inp_typevalue VALUES ('inp_value_patternmethod', '14', 'UNIQUE ESTIMATED (PJOINT)', NULL, '{"DemandType":1}');
INSERT INTO inp_typevalue VALUES ('inp_value_patternmethod', '14', 'DMA ESTIMATED (PJOINT)', NULL, '{"DemandType":1}');


UPDATE inp_typevalue SET idval = 'UNIQUE PERIOD (NODE)', id = '21' WHERE id = '22' AND typevalue = 'inp_value_patternmethod';
UPDATE inp_typevalue SET idval = 'DMA PERIOD (NODE)', id = '22' WHERE id = '23' AND typevalue = 'inp_value_patternmethod';
UPDATE inp_typevalue SET idval = 'HYDRO PERIOD (NODE)', id = '23' WHERE id = '24' AND typevalue = 'inp_value_patternmethod';
