...
'{"arc":"SELECT	arc_id AS arc_id, arccat_id as catalog, concat((100*slope)::numeric(12,2),''%-'',gis_length::numeric(12,2),''m'') as dimensions , arc_id as code FROM v_edit_arc",
"node":"SELECT node_id AS node_id, elevation as top_elev, elev, depth AS depth, code AS code FROM v_edit_node"}',
