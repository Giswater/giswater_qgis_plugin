...
SELECT plan_psector.psector_id,
   ...
   FROM config_param_user, plan_psector
LEFT JOIN ( SELECT sum(v_plan_psector_x_arc.total_budget) AS suma,
     ...
     LEFT JOIN ( SELECT sum(v_plan_psector_x_other.total_budget) AS suma,
       ...
       WHERE config_param_user.cur_user = "current_user"()::text and parameter = 'plan_psector_vdefault' and value::integer = plan_psector.psector_id;
