...
"dvquerytext":"Select id as id, id as idval FROM cat_arc WHERE id IS NOT NULL"}]');
...
'[{"widgetname":"muni_id", "label":"Arc catalog:", "widgettype":"combo","datatype":"text","layoutorder":1,
