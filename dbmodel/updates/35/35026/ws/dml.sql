...
INSERT INTO inp_typevalue VALUES ('inp_options_dscenario_priority', '0', 'REMOVE ALL BASE DEMANDS & PAT.');
UPDATE inp_typevalue SET idval ='OVERWRITE BASE DEMANDS & PAT.' WHERE typevalue ='inp_options_dscenario_priority' and id='1';
UPDATE inp_typevalue SET idval ='JOIN BASE DEMANDS & PAT.' WHERE typevalue ='inp_options_dscenario_priority' and id='2';
