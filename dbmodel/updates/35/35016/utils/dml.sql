...
UPDATE config_form_tableview SET columnindex=0, width = 120 WHERE location_type = 'epa_toolbar' AND tablename = 'v_ui_rpt_cat_result' and columnname = 'result_id';
UPDATE config_form_tableview SET columnindex=7, width = 600 WHERE location_type = 'epa_toolbar' AND tablename = 'v_ui_rpt_cat_result' and columnname = 'rpt_stats';
