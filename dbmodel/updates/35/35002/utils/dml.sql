...
INSERT INTO config_function(id, function_name, returnmanager)
...
"polygon":{"style":"unique", "values":{"width":3, "color":[255,1,1], "transparency":0.5}}}}') ON CONFLICT (id) DO NOTHING;
...
--2020/12/10
INSERT INTO sys_function VALUES (3014, 'gw_fct_setcsv','utils','function','json','json','Insert values into temp_csv','role_edit', NULL) ON CONFLICT (id) DO NOTHING;
