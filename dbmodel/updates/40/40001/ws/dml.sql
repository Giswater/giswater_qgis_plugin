...
INSERT INTO cat_feature (id, feature_class, feature_type, parent_layer, child_layer, active) VALUES ('FRVALVE', 'FLOWREG', 'ELEMENT', 'v_edit_element', 've_elem_frvalve', true) ON CONFLICT (id) DO NOTHING;
