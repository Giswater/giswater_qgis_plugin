...
UPDATE config_form_fields SET formname='v_edit_link', formtype='form_feature', columnname='connecat_id', tabname='tab_none' WHERE formname='v_edit_link' AND formtype='form_feature' AND columnname='connecat_id' AND tabname='tab_none';
