...
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_manager', 'tab_curves', 'Curves', 'Curves', 'role_baisc', NULL, NULL, 0, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_manager', 'tab_patterns', 'Patterns', 'Patterns', 'role_baisc', NULL, NULL, 1, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_manager', 'tab_timeseries', 'Timeseries', 'Timeseries', 'role_baisc', NULL, NULL, 2, '{5}');
...
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_manager', 'tab_lids', 'Lids', 'Lids', 'role_baisc', NULL, NULL, 4, '{5}');
...
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_lids', 'tab_surface', 'Surface', 'Surface', 'role_baisc', NULL, NULL, 0, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_lids', 'tab_soil', 'Soil', 'Soil', 'role_baisc', NULL, NULL, 1, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_lids', 'tab_drainmat', 'Drainage Mat', 'Drainage Mat', 'role_baisc', NULL, NULL, 2, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_lids', 'tab_pavement', 'Pavement', 'Pavement', 'role_baisc', NULL, NULL, 3, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_lids', 'tab_storage', 'Storage', 'Storage', 'role_baisc', NULL, NULL, 4, '{5}');
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('nvo_lids', 'tab_drain', 'Drain', 'Drain', 'role_baisc', NULL, NULL, 5, '{5}');
...
INSERT INTO config_form_fields (formname,formtype,tabname,columnname,layoutname,layoutorder,"datatype",widgettype,"label",tooltip,placeholder,isparent,iseditable,isautoupdate,isfilter,dv_querytext,widgetcontrols,hidden)
	VALUES ('v_ui_drainzone','form_feature','tab_none','expl_id','lyt_data_1',10,'text','text','expl_id','expl_id','1',false,true,false,false,'SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL','{"setMultiline":false}'::json,false);
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=6, "datatype"='boolean', widgettype='check', "label"='undelete', tooltip='undelete', placeholder=NULL, ismandatory=false, isparent=false, iseditable=true, isautoupdate=false, isfilter=false, dv_querytext=NULL, dv_orderby_id=NULL, dv_isnullvalue=NULL, dv_parent_id=NULL, dv_querytext_filterc=NULL, stylesheet=NULL, widgetcontrols='{"setMultiline":false}'::json, widgetfunction=NULL, linkedobject=NULL, hidden=false, web_layoutorder=NULL WHERE formname='v_ui_drainzone' AND formtype='form_feature' AND columnname='undelete' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=10, "datatype"='text', widgettype='text', "label"='expl_id', tooltip='expl_id', placeholder='1', ismandatory=false, isparent=false, iseditable=true, isautoupdate=false, isfilter=false, dv_querytext='SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL', dv_orderby_id=NULL, dv_isnullvalue=NULL, dv_parent_id=NULL, dv_querytext_filterc=NULL, stylesheet=NULL, widgetcontrols='{"setMultiline":false}'::json, widgetfunction=NULL, linkedobject=NULL, hidden=false, web_layoutorder=NULL WHERE formname='v_ui_drainzone' AND formtype='form_feature' AND columnname='expl_id' AND tabname='tab_none';
...
INSERT INTO config_form_fields VALUES('v_ui_macrosector', 'form_feature', 'tab_none', 'undelete', 'lyt_data_1', 5, 'boolean', 'check', 'undelete', 'undelete', NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, NULL);
...
INSERT INTO config_form_fields VALUES('v_ui_sector', 'form_feature', 'tab_none', 'undelete', 'lyt_data_1', 7, 'boolean', 'check', 'undelete', 'undelete', NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, NULL);
...
INSERT INTO config_form_fields VALUES('v_ui_dwfzone', 'form_feature', 'tab_none', 'undelete', 'lyt_data_1', 6, 'boolean', 'check', 'undelete', 'undelete', NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, '{"setMultiline":false}'::json, NULL, NULL, false, NULL);
...
INSERT INTO config_form_tabs (formname, tabname, "label", tooltip, sys_role, tabfunction, tabactions, orderby, device) VALUES('psector', 'tab_relations_gully', 'Gully', 'Gully', 'role_baisc', NULL, NULL, 0, '{5}');
...
INSERT INTO config_form_list (listname, query_text, device, listtype, listclass, vdefault, addparam) VALUES('relations_gully_results', 'SELECT id, gully_id, arc_id, state, doable::TEXT FROM plan_psector_x_gully', 5, 'tab', 'list', '{"orderBy":"1", "orderType": "DESC"}'::json, '{
  "enableGlobalFilter": false,
  "enableStickyHeader": true,
  "positionToolbarAlertBanner": "bottom",
  "enableGrouping": false,
