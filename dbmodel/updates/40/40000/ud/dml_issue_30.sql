...
ELSE 0 END as feature_id, ''GULLY'' as type, gratecat_id as featurecat,the_geom, expl_id FROM gully', info_msg='All features with id integer.', function_name='[gw_fct_om_check_data]' WHERE fid=542;
