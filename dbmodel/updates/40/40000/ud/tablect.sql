...
ALTER TABLE rpt_arc ALTER COLUMN arc_id TYPE integer USING arc_id::integer;
ALTER TABLE rpt_arcflow_sum ALTER COLUMN arc_id TYPE integer USING arc_id::integer;
ALTER TABLE rpt_arcpolload_sum ALTER COLUMN arc_id TYPE integer USING arc_id::integer;
...
ALTER TABLE rpt_nodeinflow_sum ALTER COLUMN node_id TYPE integer USING node_id::integer;
ALTER TABLE rpt_nodesurcharge_sum ALTER COLUMN node_id TYPE integer USING node_id::integer;
ALTER TABLE rpt_outfallflow_sum ALTER COLUMN node_id TYPE integer USING node_id::integer;
ALTER TABLE rpt_outfallload_sum ALTER COLUMN node_id TYPE integer USING node_id::integer;
ALTER TABLE rpt_storagevol_sum ALTER COLUMN node_id TYPE integer USING node_id::integer;
ALTER TABLE rpt_summary_node ALTER COLUMN node_id TYPE integer USING node_id::integer;
