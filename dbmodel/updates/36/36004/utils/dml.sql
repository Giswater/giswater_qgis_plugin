...
VALUES(3240, 'It''s not possible to configure thid node as mapzone header, cause this type of node that can''t be a header of', 'Select different parent node.', 2, true, 'utils', 'core');

INSERT INTO sys_message(id, error_message, hint_message, log_level, show_user, project_type, "source")
VALUES(3242, 'It''s not possible to configure this node as mapzone header, cause it''s not an operative nor planified node', 'Select different parent node.', 2, true, 'utils', 'core');
