...
GRANT UPDATE, REFERENCES, DELETE, SELECT, TRIGGER, INSERT, TRUNCATE ON TABLE rpt_arc TO role_admin WITH GRANT OPTION;
GRANT UPDATE, REFERENCES, DELETE, SELECT, TRIGGER, INSERT, TRUNCATE ON TABLE rpt_node TO role_admin WITH GRANT OPTION;
