...
AS SELECT dqa.dqa_id,
   ...
   FROM selector_expl,
    dqa
  WHERE dqa.expl_id::integer = selector_expl.expl_id::integer OR dqa.expl_id2::integer = selector_expl.expl_id::integer AND selector_expl.cur_user = "current_user"()::text;
...
AS SELECT presszone.presszone_id,
   ...
   FROM selector_expl,
    presszone
  WHERE presszone.expl_id::integer = selector_expl.expl_id::integer OR presszone.expl_id2::integer = selector_expl.expl_id::integer AND selector_expl.cur_user = "current_user"()::text;
