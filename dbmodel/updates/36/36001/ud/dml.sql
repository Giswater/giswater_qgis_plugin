...
INSERT INTO config_form_fields (formname, formtype, tabname,  columnname, layoutname, layoutorder,  widgettype, tooltip, ismandatory, isparent, iseditable, isautoupdate, widgetcontrols, widgetfunction, isfilter, linkedobject)
    VALUES ('ve_epa_junction', 'form_feature', 'epa', 'manage_treatment', 'lyt_epa_1', 1, 'button', 'Manage treatment', false, false, true, false, '{"saveValue":false, "filterSign":"=", "text":"TREA"}', '{"functionName": "open_epa_dlg", "module": "info", "parameters":{"ui": "GwInfoEpaTreatmentUi", "uiName": "info_epa_treatment", "tableviews": [{"tbl": "tbl_treatment", "view": "v_edit_inp_treatment"}, {"tbl": "tbl_dscenario_treatment", "view": "v_edit_inp_dscenario_treatment"}]}}', false, '');
INSERT INTO config_form_fields (formname, formtype, tabname,  columnname, layoutname, layoutorder,  widgettype, tooltip, ismandatory, isparent, iseditable, isautoupdate, widgetcontrols, widgetfunction, isfilter, linkedobject)
    VALUES ('ve_epa_junction', 'form_feature', 'epa', 'manage_inflows', 'lyt_epa_1', 2, 'button', 'Manage inflows', false, false, true, false, '{"saveValue":false, "filterSign":"=", "text":"INFL"}', '{"functionName": "open_epa_dlg", "module": "info", "parameters":{"ui": "GwInfoEpaInflowsUi", "uiName": "info_epa_inflows", "tableviews": [{"tbl": "tbl_inflows", "view": "v_edit_inp_inflows"}, {"tbl": "tbl_dscenario_inflows", "view": "v_edit_inp_dscenario_inflows"}]}}', false, '');
INSERT INTO config_form_fields (formname, formtype, tabname,  columnname, layoutname, layoutorder,  widgettype, tooltip, ismandatory, isparent, iseditable, isautoupdate, widgetcontrols, widgetfunction, isfilter, linkedobject)
    VALUES ('ve_epa_junction', 'form_feature', 'epa', 'manage_inflows_poll', 'lyt_epa_1', 3, 'button', 'Manage inflows-pollutants', false, false, true, false, '{"saveValue":false, "filterSign":"=", "text":"POLL"}', '{"functionName": "open_epa_dlg", "module": "info", "parameters":{"ui": "GwInfoEpaInflowsPollUi", "uiName": "info_epa_inflows_poll", "tableviews": [{"tbl": "tbl_inflows_poll", "view": "v_edit_inp_inflows_poll"}, {"tbl": "tbl_dscenario_inflows_poll", "view": "v_edit_inp_dscenario_inflows_poll"}]}}', false, '');
INSERT INTO config_form_fields (formname, formtype, tabname,  columnname, layoutname, layoutorder,  widgettype, tooltip, ismandatory, isparent, iseditable, isautoupdate, widgetcontrols, widgetfunction, isfilter, linkedobject)
    VALUES ('ve_epa_junction', 'form_feature', 'epa', 'manage_dwf', 'lyt_epa_1', 4, 'button', 'Manage DWF', false, false, true, false, '{"saveValue":false, "filterSign":"=", "text":"DWF"}', '{"functionName": "open_epa_dlg", "module": "info", "parameters":{"ui": "GwInfoEpaDwfUi", "uiName": "info_epa_dwf", "widgets": ["dwfscenario_id", "node_id", "value", "pat1", "pat2", "pat3", "pat4"], "widgetsTablename": "v_edit_inp_dwf", "tableviews": [{"tbl": "tbl_dscenario_inflows", "view": "v_edit_inp_dscenario_inflows"}]}}', false, '');
INSERT INTO config_form_fields (formname, formtype, tabname,  columnname, layoutname, layoutorder,  widgettype, tooltip, ismandatory, isparent, iseditable, isautoupdate, widgetcontrols, widgetfunction, isfilter, linkedobject)
    VALUES ('ve_epa_junction', 'form_feature', 'epa', 'manage_flowreg', 'lyt_epa_1', 5, 'button', 'Manage flow regulator', false, false, true, false, '{"saveValue":false, "filterSign":"=", "text":"FREG"}', '{"functionName": "open_epa_dlg", "module": "info", "parameters":{"ui": "GwInfoEpaFlowRegulatorUi", "uiName": "info_epa_flow_regulator", "tableviews": [{"tbl": "tbl_pump", "view": "v_edit_inp_flwreg_pump"}, {"tbl": "tbl_weir", "view": "v_edit_inp_flwreg_weir"}, {"tbl": "tbl_outlet", "view": "v_edit_inp_flwreg_outlet"}, {"tbl": "tbl_orifice", "view": "v_edit_inp_flwreg_orifice"}, {"tbl": "tbl_dscenario_pump", "view": "v_edit_inp_dscenario_flwreg_pump"}, {"tbl": "tbl_dscenario_weir", "view": "v_edit_inp_dscenario_flwreg_outlet"}, {"tbl": "tbl_dscenario_outlet", "view": "v_edit_inp_dscenario_flwreg_orifice"}]}}', false, '');
