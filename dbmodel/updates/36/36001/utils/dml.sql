...
VALUES('edit_link_check_arcdint', '{"status":false , "dint":250}', 'If true, inserted links could not connect to arcs with dint bigger or equal to the configured', 'Links check arc dint', NULL, NULL, false, NULL, 'utils', NULL, NULL, 'json', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
