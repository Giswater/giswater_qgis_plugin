...
SELECT gw_fct_admin_manage_fields($${"data":{"action":"ADD","table":"psector", "column":"tstamp", "dataType":"timestamp", "isUtils":"True"}}$$);
SELECT gw_fct_admin_manage_fields($${"data":{"action":"ADD","table":"psector", "column":"insert_user", "dataType":"varchar(15)", "isUtils":"True"}}$$);
SELECT gw_fct_admin_manage_fields($${"data":{"action":"ADD","table":"psector", "column":"lastupdate", "dataType":"timestamp", "isUtils":"True"}}$$);
SELECT gw_fct_admin_manage_fields($${"data":{"action":"ADD","table":"psector", "column":"lastupdate_user", "dataType":"varchar(15)", "isUtils":"True"}}$$);
