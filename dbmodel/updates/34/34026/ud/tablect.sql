...
ALTER TABLE inp_transects_value DROP CONSTRAINT inp_transects_pkey;
ALTER TABLE inp_transects_value DROP CONSTRAINT inp_transects_tsect_id_fkey;
ALTER TABLE inp_transects DROP CONSTRAINT inp_transects_id_pkey;
