...
CREATE TRIGGER gw_trg_vi_tanks INSTEAD OF INSERT OR UPDATE OR DELETE ON vi_tanks
FOR EACH ROW EXECUTE PROCEDURE gw_trg_vi('vi_tanks');

CREATE TRIGGER gw_trg_vi_valves INSTEAD OF INSERT OR UPDATE OR DELETE ON vi_valves
FOR EACH ROW EXECUTE PROCEDURE gw_trg_vi('vi_valves');
