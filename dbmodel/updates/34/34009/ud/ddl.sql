...
ALTER TABLE selector_inp_hydrology DROP CONSTRAINT inp_selector_hydrology_hydrology_id_cur_user;
ALTER TABLE selector_inp_hydrology DROP CONSTRAINT inp_selector_hydrology_pkey;
...
ALTER TABLE selector_rpt_compare_tstep DROP CONSTRAINT rpt_selector_timestep_compare_pkey;
...
ALTER TABLE selector_rpt_main_tstep DROP CONSTRAINT rpt_selector_timestep_pkey;
