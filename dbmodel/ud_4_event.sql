...
"id" int8 DEFAULT nextval('"SCHEMA_NAME".event_x_gully'::regclass) NOT NULL,
"event_id" int8,
...
ALTER TABLE "SCHEMA_NAME"."event_x_gully" ADD FOREIGN KEY ("event_id") REFERENCES "SCHEMA_NAME"."event" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_gully" ADD FOREIGN KEY ("gully_id") REFERENCES "SCHEMA_NAME"."gully" ("gully_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
CREATE SEQUENCE "SCHEMA_NAME".event_gully_x_picture_seq
  START WITH 1
  INCREMENT BY 1
  NO MINVALUE
  NO MAXVALUE
...
"date" timestamp(6) DEFAULT now(),
"user" varchar(16) COLLATE "default",
"comment" varchar(512) COLLATE "default",CONSTRAINT event_node_x_picture_pkey PRIMARY KEY (id)
)WITH (OIDS=FALSE);
...
"date" timestamp(6) DEFAULT now(),
"user" varchar(16) COLLATE "default",
"comment" varchar(512) COLLATE "default",CONSTRAINT event_arc_x_picture_pkey PRIMARY KEY (id)
)WITH (OIDS=FALSE);
...
CREATE TABLE "SCHEMA_NAME"."event_gully_x_picture" (
"id" int8 DEFAULT nextval('"SCHEMA_NAME".event_gully_x_picture'::regclass) NOT NULL,
"gully_id" varchar(16) COLLATE "default",
"path" varchar(512) COLLATE "default",
"date" timestamp(6) DEFAULT now(),
"user" varchar(16) COLLATE "default",
"comment" varchar(512) COLLATE "default",
CONSTRAINT event_gully_x_picture_pkey PRIMARY KEY (id)
) WITH (OIDS=FALSE);
...
ALTER TABLE "SCHEMA_NAME"."event_gully_x_picture" ADD FOREIGN KEY ("gully_id") REFERENCES "SCHEMA_NAME"."gully" ("gully_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_gully_x_picture" ADD FOREIGN KEY ("user") REFERENCES "SCHEMA_NAME"."adm_list_user" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
