...
BEGIN
	...
	IF project_type_aux='UD' THEN
		...
		LOOP
			...
			location_type, workcat_id, workcat_id_end, builtdate, enddate, ownercat_id, rotation, link, verified,
			...
			rec_element.observ, rec_element.comment, rec_element.function_type, rec_element.category_type, rec_element.location_type,
