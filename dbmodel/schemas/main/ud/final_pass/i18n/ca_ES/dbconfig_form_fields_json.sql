...
UPDATE config_form_fields AS t SET widgetcontrols = v.text::json FROM (
	VALUES
	('btn_accept', 'generic', 'form_visit', 'tab_data', '{"setMultiline":false,"text":"Acceptar"}'),
    ('btn_apply', 'generic', 'form_visit', 'tab_file', '{"setMultiline":false,"text":"Aplicar"}'),
    ('btn_cancel', 'generic', 'form_visit', 'tab_file', '{"setMultiline":false,"text":"Cancel·lar"}'),
    ...
    ('btn_cancel', 'gully', 'form_feature', 'tab_none', '{"text":"Cancel·lar"}'),
