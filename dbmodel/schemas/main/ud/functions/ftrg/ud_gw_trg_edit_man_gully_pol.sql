...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO polygon (sys_type, the_geom, feature_id, featurecat_id, trace_featuregeom, state) 
		SELECT sys_type, NEW.the_geom, NEW.feature_id, gully_type, NEW.trace_featuregeom, state
