...
UPDATE config_form_fields AS t SET widgetcontrols = v.text::json FROM (
    ...
    ('cancel', 'element_manager', 'form_element', 'tab_none', '{"saveValue":false,"text":"Cerrar"}'),
    ('create', 'element_manager', 'form_element', 'tab_none', '{"saveValue":false,"text":"Crear"}'),
    ('delete', 'element_manager', 'form_element', 'tab_none', '{"onContextMenu":"Delete","saveValue":false,"text":"Borrar"}'),
    ...
    ('cancel', 'mincut_manager', 'form_mincut', 'tab_none', '{"saveValue":false,"text":"Cerrar"}'),
    ('cancel_mincut', 'mincut_manager', 'form_mincut', 'tab_none', '{"onContextMenu":"Cancel mincut","saveValue":false,"text":"Cancelar corte de red"}'),
    ('delete', 'mincut_manager', 'form_mincut', 'tab_none', '{"onContextMenu":"Delete mincut","saveValue":false,"text":"Borrar corte"}')
