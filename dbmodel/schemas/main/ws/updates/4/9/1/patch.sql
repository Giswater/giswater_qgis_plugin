...
INSERT INTO sys_style (layername, styleconfig_id, styletype, stylevalue, active) VALUES('Mincut offline result valve', 101, 'qml', '<!DOCTYPE qgis PUBLIC ''http://mrcc.com/qgis.dtd'' ''SYSTEM''>
...
UPDATE config_function
	SET "style"='{
  "style": {
    "Mincut offline result valve": {
      "style": "qml",
      "id": "101"
    },
    "Mincut offline result connec": {
      "style": "categorized",
      "field": "minsector_id",
      "width": 2,
      "transparency": 0.5
    },
    "Mincut offline result arc": {
      "style": "categorized",
      "field": "minsector_id",
      "width": 2,
      "transparency": 0.5
