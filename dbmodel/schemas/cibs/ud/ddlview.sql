...
FROM v_hydrometer
    JOIN cibs.cat_hydrometer_state ON cat_hydrometer_state.id = v_hydrometer.state_id
...
FROM v_hydrometer_data
    ...
    LEFT JOIN cibs.cat_hydrometer ON cat_hydrometer.id::bigint = v_hydrometer.catalog_id::bigint
    JOIN connec ON connec.customer_code::text = v_hydrometer.customer_code::text
