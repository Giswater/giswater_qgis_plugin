...
INSERT INTO node_type  VALUES ('FL-CONTR.VALVE', 'VALVE', 'VALVE', 'man_valve', 'inp_valve', true, true, 2, true, 'Flow control valve', NULL);
INSERT INTO node_type  VALUES ('SHUTOFF-VALVE', 'VALVE', 'SHORTPIPE', 'man_valve', 'inp_shortpipe', true, true, 2, true, 'Shutoff valve', NULL);
INSERT INTO node_type  VALUES ('TANK', 'TANK', 'TANK', 'man_tank', 'inp_tank', true, true, 2, true, 'Tank', NULL);
INSERT INTO node_type  VALUES ('GREEN-VALVE', 'VALVE', 'JUNCTION', 'man_valve', 'inp_junction', true, true, 2, true, 'Green valve', NULL);
INSERT INTO node_type  VALUES ('OUTFALL-VALVE', 'VALVE', 'JUNCTION', 'man_valve', 'inp_junction', true, true, 2, true, 'Outfall valve', NULL);
INSERT INTO node_type  VALUES ('GEN-PURP.VALVE', 'VALVE', 'VALVE', 'man_valve', 'inp_valve', true, true, 2, true, 'General purpose valve', NULL);
...
INSERT INTO node_type  VALUES ('PR-SUSTA.VALVE', 'VALVE', 'VALVE', 'man_valve', 'inp_valve', true, true, 2, true, 'Pressure sustainer valve', NULL);
INSERT INTO node_type  VALUES ('PR-REDUC.VALVE', 'VALVE', 'VALVE', 'man_valve', 'inp_valve', true, true, 2, true, 'Pressure reduction valve', NULL);
INSERT INTO node_type  VALUES ('PR-BREAK.VALVE', 'VALVE', 'VALVE', 'man_valve', 'inp_valve', true, true, 2, true, 'Pressure break valve', NULL);
...
INSERT INTO node_type  VALUES ('VALVE-REGISTER', 'REGISTER', 'JUNCTION', 'man_register', 'inp_junction', true, true, 2, true, 'Valve register', NULL);
INSERT INTO node_type  VALUES ('WATER-CONNECTION', 'NETWJOIN', 'JUNCTION', 'man_netwjoin', 'inp_junction', true, true, 2, true, 'Water connection', NULL);
INSERT INTO node_type  VALUES ('FLEXUNION', 'FLEXUNION', 'JUNCTION', 'man_flexunion', 'inp_junction', true, true, 2, true, 'Flex union', NULL);
INSERT INTO node_type  VALUES ('PRESSURE-METER', 'METER', 'JUNCTION', 'man_meter', 'inp_junction', true, true, 2, true, 'Pressure meter', NULL);
...
INSERT INTO node_type  VALUES ('BYPASS-REGISTER', 'REGISTER', 'JUNCTION', 'man_register', 'inp_junction', true, true, 2, true, 'Bypass-register', NULL);
INSERT INTO node_type  VALUES ('CURVE', 'JUNCTION', 'JUNCTION', 'man_junction', 'inp_junction', true, true, 2, true, 'Curve', NULL);
INSERT INTO node_type  VALUES ('CONTROL-REGISTER', 'REGISTER', 'VALVE', 'man_register', 'inp_valve', true, true, 2, true, 'Control register', NULL);
...
INSERT INTO node_type  VALUES ('AIR-VALVE', 'VALVE', 'JUNCTION', 'man_valve', 'inp_junction', true, true, 2, true, 'Air valve', NULL);
INSERT INTO node_type  VALUES ('CHECK-VALVE', 'VALVE', 'SHORTPIPE', 'man_valve', 'inp_shortpipe', true, true, 2, true, 'Check valve', NULL);
INSERT INTO node_type  VALUES ('FLOWMETER', 'METER', 'JUNCTION', 'man_meter', 'inp_junction', true, true, 2, true, 'Flow meter', NULL);
INSERT INTO node_type  VALUES ('THROTTLE-VALVE', 'VALVE', 'VALVE', 'man_valve', 'inp_valve', true, true, 2, true, 'Throttle-valve', NULL);
