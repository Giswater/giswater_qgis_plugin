...
ALTER VIEW v_edit_node ALTER state SET DEFAULT 1;
ALTER VIEW v_edit_node ALTER verified SET DEFAULT 'TO REVIEW';

ALTER VIEW v_edit_arc ALTER state SET DEFAULT 1;
...
ALTER VIEW v_edit_connec ALTER state SET DEFAULT 1;
ALTER VIEW v_edit_connec ALTER verified SET DEFAULT 'TO REVIEW';

ALTER TABLE element ALTER COLUMN state SET DEFAULT 1;
