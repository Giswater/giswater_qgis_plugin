...
- La columna price ha de ser tipus número amb dos decimals.
- Pots triar un catàleg per els preus importats assignant-lo a Import label.
- Atenció: el fitxer csv ha de tenir una fila de capçalera','role_master');
...
- Els camps Observ i Comment són opcionals.
- Atenció: el fitxer csv ha de tenir una fila de capçalera', 'role_admin');
