...
--
-- Data for Name: value_state; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: value_state_type; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: edit_typevalue; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: om_typevalue; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: doc_type; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: plan_typevalue; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: config_csv; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: sys_message; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: cat_feature; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--

INSERT INTO cat_feature VALUES ('CONNEC', 'CONNEC', 'CONNEC', 'Ctrl+C', 'v_edit_connec', 've_connec_connec', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VCONNEC', 'CONNEC', 'CONNEC', NULL, 'v_edit_connec', 've_connec_vconnec', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('CONDUIT', 'CONDUIT', 'ARC', 'D', 'v_edit_arc', 've_arc_conduit', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('PUMP_PIPE', 'CONDUIT', 'ARC', NULL, 'v_edit_arc', 've_arc_pump_pipe', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('HIGHPOINT', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_highpoint', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('REGISTER', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_register', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('CHANGE', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_change', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VIRTUAL_NODE', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_virtual_node', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('OUTFALL', 'OUTFALL', 'NODE', 'Alt+O', 'v_edit_node', 've_node_outfall', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('JUNCTION', 'JUNCTION', 'NODE', 'Alt+J', 'v_edit_node', 've_node_junction', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('GULLY', 'GULLY', 'GULLY', NULL, 'v_edit_gully', 've_gully_gully', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('PGULLY', 'GULLY', 'GULLY', NULL, 'v_edit_gully', 've_gully_pgully', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VGULLY', 'GULLY', 'GULLY', NULL, 'v_edit_gully', 've_gully_vgully', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('SIPHON', 'SIPHON', 'ARC', 'S', 'v_edit_arc', 've_arc_siphon', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('WACCEL', 'WACCEL', 'ARC', 'W', 'v_edit_arc', 've_arc_waccel', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('VARC', 'VARC', 'ARC', 'A', 'v_edit_arc', 've_arc_varc', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('CIRC_MANHOLE', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_circ_manhole', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('JUMP', 'WJUMP', 'NODE', NULL, 'v_edit_node', 've_node_jump', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('RECT_MANHOLE', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_rect_manhole', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('SANDBOX', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_sandbox', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('WWTP', 'WWTP', 'NODE', 'Alt+P', 'v_edit_node', 've_node_wwtp', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('VALVE', 'VALVE', 'NODE', 'Alt+V', 'v_edit_node', 've_node_valve', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('NETGULLY', 'NETGULLY', 'NODE', 'Alt+Y', 'v_edit_node', 've_node_netgully', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('NETELEMENT', 'NETELEMENT', 'NODE', 'Alt+N', 'v_edit_node', 've_node_netelement', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('NETINIT', 'NETINIT', 'NODE', 'Alt+I', 'v_edit_node', 've_node_netinit', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('CHAMBER', 'CHAMBER', 'NODE', 'Alt+H', 'v_edit_node', 've_node_chamber', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('WEIR', 'CHAMBER', 'NODE', NULL, 'v_edit_node', 've_node_weir', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('SEWER_STORAGE', 'STORAGE', 'NODE', NULL, 'v_edit_node', 've_node_sewer_storage', NULL, NULL, true, false, NULL);
...
--
-- Data for Name: cat_feature_arc; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--

INSERT INTO cat_feature_arc VALUES ('CONDUIT', 'CONDUIT', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('SIPHON', 'SIPHON', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('WACCEL', 'WACCEL', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('VARC', 'VARC', 'VIRTUAL');
INSERT INTO cat_feature_arc VALUES ('PUMP_PIPE', 'CONDUIT', 'CONDUIT');


--
-- Data for Name: cat_feature_connec; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--

INSERT INTO cat_feature_connec VALUES ('CONNEC', 'CONNEC', '{"activated":false,"value":1}');
INSERT INTO cat_feature_connec VALUES ('VCONNEC', 'CONNEC', '{"activated":false,"value":1}');


--
-- Data for Name: cat_feature_gully; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: cat_feature_node; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
...
--
-- Data for Name: element_type; Type: TABLE DATA; Schema: ud_dev_35041_en; Owner: -
--
