...
UPDATE config_form_fields SET formname = 've_node_diposit_desbordament' WHERE formname LIKE 've_node_owerflow_storage';
UPDATE config_form_fields SET formname = 've_node_presa' WHERE formname LIKE 've_node_weir';
