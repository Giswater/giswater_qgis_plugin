...
INSERT INTO value_state VALUES (1, 'OPERATIVO', NULL);
...
INSERT INTO edit_typevalue VALUES ('value_review_status', '3', 'Datos modificados', 'Cambios en los datos, no en la geometría', NULL);
INSERT INTO edit_typevalue VALUES ('value_review_validation', '0', 'Rechazado', NULL, NULL);
INSERT INTO edit_typevalue VALUES ('value_review_validation', '1', 'Aceptado', NULL, NULL);
...
INSERT INTO om_typevalue VALUES ('mincut_cause', '2', 'Planificado', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_class', '1', 'Cierre de red', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_class', '2', 'Cierre de acometidas', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_class', '3', 'Cierre de abonados', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_state', '1', 'En proceso', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_state', '2', 'Finalizado', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_state', '0', 'Planificado', NULL, NULL);
INSERT INTO om_typevalue VALUES ('mincut_state', '3', 'Cancelado', NULL, NULL);
...
INSERT INTO om_typevalue VALUES ('visit_status', '4', 'Finalizada', NULL, NULL);
...
INSERT INTO om_typevalue VALUES ('visit_param_type', 'INSPECCION', 'INSPECCION', NULL, '{"go2plan":false}');
INSERT INTO om_typevalue VALUES ('visit_param_type', 'REHABILITACION', 'REHABILITACION', NULL, '{"go2plan":false}');
INSERT INTO om_typevalue VALUES ('visit_param_type', 'RECONSTRUCCION', 'RECONSTRUCCION', NULL, '{"go2plan":false}');
INSERT INTO om_typevalue VALUES ('visit_param_type', 'OTROS', 'OTROS', NULL, '{"go2plan":false}');
...
INSERT INTO doc_type VALUES ('TRABAJO', NULL);
INSERT INTO doc_type VALUES ('OTROS', NULL);
...
INSERT INTO plan_typevalue VALUES ('value_priority', '2', 'MEDIA', NULL, NULL);
INSERT INTO plan_typevalue VALUES ('value_priority', '3', 'BAJA', NULL, NULL);
INSERT INTO plan_typevalue VALUES ('psector_type', '1', 'Planificado', NULL, NULL);
INSERT INTO plan_typevalue VALUES ('result_type', '1', 'Reconstrucción', NULL, NULL);
INSERT INTO plan_typevalue VALUES ('result_type', '2', 'Rehabilitación', NULL, NULL);
...
- Atencion: el fichero csv debe tener una fila de encabezado', 'gw_fct_import_dbprices', true, 1, NULL);
...
INSERT INTO config_csv VALUES (236, 'Importar campos adicionales', 'The csv file must containts next columns on same position: 
...
INSERT INTO config_csv VALUES (235, 'Importar elementos', 'The csv file must containts next columns on same position:
...
INSERT INTO cat_feature VALUES ('ACOMETIDA', 'WJOIN', 'CONNEC', NULL, 'v_edit_connec', 've_connec_acometida', 'Acometida', NULL, true, true, NULL);
...
INSERT INTO cat_feature VALUES ('UNION', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_union', 'Unión', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VALVULA_SOST_PR', 'VALVE', 'NODE', NULL, 'v_edit_node', 've_node_valvula_sost_pr', 'Válvula sostenedora de presión', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VALVULA_CIERRE', 'VALVE', 'NODE', NULL, 'v_edit_node', 've_node_valvula_cierre', 'Válvula de cierre', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('DEPOSITO', 'TANK', 'NODE', NULL, 'v_edit_node', 've_node_deposito', 'Depósito', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VALVULA_ACCEL', 'VALVE', 'NODE', NULL, 'v_edit_node', 've_node_valvula_accel', 'Válvula acelaración', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('T', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_t', 'Unión donde convergen 3 tuberías', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('X', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_x', 'Unión donde convergen 4 tuberías', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('VALVULA_AIRE', 'VALVE', 'NODE', NULL, 'v_edit_node', 've_node_valvula_aire', 'Válvula de aire', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('ADAPTACION', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_adaptacion', 'Adaptación', NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('TAP', 'JUNCTION', 'NODE', 'Alt+T', 'v_edit_node', 've_node_tap', NULL, NULL, NULL, true, NULL);
INSERT INTO cat_feature VALUES ('FUENTE_ORNAMENTAL', 'FOUNTAIN', 'CONNEC', NULL, 'v_edit_connec', 've_connec_fuente_ornamental', 'Fuente ornamental', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('FUENTE', 'TAP', 'CONNEC', NULL, 'v_edit_connec', 've_connec_fuente', 'Fuente de agua', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('BOCA_RIEGO', 'GREENTAP', 'CONNEC', NULL, 'v_edit_connec', 've_connec_boca_riego', 'Boca de riego', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('VARC', 'VARC', 'ARC', 'A', 'v_edit_arc', 've_arc_varc', 'Sección virtual de una tuberia. Se usa para conectar arcos y nodos cuando existe un polígono', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('POZO_CAPTACION', 'WATERWELL', 'NODE', NULL, 'v_edit_node', 've_node_pozo_captacion', 'Pozo de captación', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('PUNTO_MOSTREO', 'NETSAMPLEPOINT', 'NODE', NULL, 'v_edit_node', 've_node_punto_mostreo', 'Punto de mostreo', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('ELEMENTO_RED', 'NETELEMENT', 'NODE', NULL, 'v_edit_node', 've_node_elemento_red', 'Elemento de red', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('ESTACION_TRATAMIENTO', 'WTP', 'NODE', NULL, 'v_edit_node', 've_node_estacion_tratamiento', 'Estación de tratamiento', NULL, true, false, NULL);
...
INSERT INTO cat_feature VALUES ('REDUCCION', 'REDUCTION', 'NODE', NULL, 'v_edit_node', 've_node_reduccion', 'Reducción', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('BOMBEO', 'PUMP', 'NODE', NULL, 'v_edit_node', 've_node_bombeo', 'Bombeo', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('CAPTACION', 'SOURCE', 'NODE', NULL, 'v_edit_node', 've_node_captacion', 'Captación', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('POZO_ACCESO', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_pozo_acceso', 'Pozo de acceso para inspección', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('REGISTRO', 'REGISTER', 'NODE', NULL, 'v_edit_node', 've_node_registro', 'Registro', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('REGISTRO_CONTROL', 'REGISTER', 'NODE', NULL, 'v_edit_node', 've_node_registro_control', 'Registro de control', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('REGISTRO_BYPASS', 'REGISTER', 'NODE', NULL, 'v_edit_node', 've_node_registro_bypass', 'Registro de bypass', NULL, true, false, NULL);
...
INSERT INTO cat_feature VALUES ('ACOMETIDA_TOPO', 'NETWJOIN', 'NODE', NULL, 'v_edit_node', 've_node_acometida_topo', 'Acometida connectada a la red', NULL, true, false, NULL);
...
INSERT INTO cat_feature VALUES ('MEDIDOR', 'METER', 'NODE', NULL, 'v_edit_node', 've_node_medidor', 'Medidor', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('CALDERIN_EXPANSION', 'EXPANSIONTANK', 'NODE', NULL, 'v_edit_node', 've_node_calderin_expansion', 'Calderín de expansión', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('MEDIDOR_PRESION', 'METER', 'NODE', NULL, 'v_edit_node', 've_node_medidor_presion', 'Medidor de pressión', NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('RECLORADOR', 'NETELEMENT', 'NODE', NULL, 'v_edit_node', 've_node_reclorador', 'Elemento reclorador', NULL, true, false, NULL);
...
INSERT INTO cat_feature_connec VALUES ('ACOMETIDA', 'WJOIN', '{"activated":false,"value":1}', 'JUNCTION');
INSERT INTO cat_feature_connec VALUES ('FUENTE_ORNAMENTAL', 'FOUNTAIN', '{"activated":false,"value":1}', 'JUNCTION');
INSERT INTO cat_feature_connec VALUES ('FUENTE', 'TAP', '{"activated":false,"value":1}', 'JUNCTION');
INSERT INTO cat_feature_connec VALUES ('BOCA_RIEGO', 'GREENTAP', '{"activated":false,"value":1}', 'JUNCTION');
INSERT INTO cat_feature_connec VALUES ('ACOMETIDA_FICTICIA', 'WJOIN', '{"activated":false,"value":1}', 'JUNCTION');
...
INSERT INTO cat_feature_node VALUES ('ADAPTACION', 'JUNCTION', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
...
INSERT INTO cat_feature_node VALUES ('UNION', 'JUNCTION', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
...
INSERT INTO cat_feature_node VALUES ('REGISTRO_BYPASS', 'REGISTER', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('REGISTRO_VALVULA', 'REGISTER', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('ELEMENTO_RED', 'NETELEMENT', 'JUNCTION', 2, true, true, 'DQA', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CALDERIN_EXPANSION', 'EXPANSIONTANK', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
...
INSERT INTO cat_feature_node VALUES ('MEDIDOR_PRESION', 'METER', 'JUNCTION', 2, true, true, 'DMA', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('HIDRANTE', 'HYDRANT', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('POZO_ACCESO', 'MANHOLE', 'RESERVOIR', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('PUNTO_MOSTREO', 'NETSAMPLEPOINT', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('BOMBEO', 'PUMP', 'PUMP', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('REDUCCION', 'REDUCTION', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CAPTACION', 'SOURCE', 'RESERVOIR', 2, true, true, 'SECTOR', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('DEPOSITO', 'TANK', 'TANK', 9, true, true, 'SECTOR', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('ACOMETIDA_TOPO', 'NETWJOIN', 'JUNCTION', 2, true, true, 'NONE', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('POZO_CAPTACION', 'WATERWELL', 'JUNCTION', 2, true, true, 'SECTOR', false, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('ESTACION_TRATAMIENTO', 'WTP', 'RESERVOIR', 2, true, true, 'SECTOR', false, '{"activated":false,"value":1}');
