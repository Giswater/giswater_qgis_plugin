...
INSERT INTO cat_feature VALUES ('ACOMETIDA_FICTICIA', 'CONNEC', 'CONNEC', NULL, 'v_edit_connec', 've_connec_acometida_ficticia', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('CONDUCTO', 'CONDUIT', 'ARC', NULL, 'v_edit_arc', 've_arc_conducto', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('IMPULSION', 'CONDUIT', 'ARC', NULL, 'v_edit_arc', 've_arc_impulsion', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('PUNTO_ALTO', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_punto_alto', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('REGISTRO', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_registro', NULL, NULL, true, true, NULL);
INSERT INTO cat_feature VALUES ('CAMBIO_SECCION', 'JUNCTION', 'NODE', NULL, 'v_edit_node', 've_node_cambio_seccion', NULL, NULL, true, true, NULL);
...
INSERT INTO cat_feature VALUES ('SIFON', 'SIPHON', 'ARC', NULL, 'v_edit_arc', 've_arc_sifon', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('RAPIDO', 'WACCEL', 'ARC', NULL, 'v_edit_arc', 've_arc_rapido', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('FICTICIO', 'VARC', 'ARC', NULL, 'v_edit_arc', 've_arc_ficticio', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('POZO_CIRCULAR', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_pozo_circular', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('SALTO', 'WJUMP', 'NODE', NULL, 'v_edit_node', 've_node_salto', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('POZO_RECTANGULAR', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_pozo_rectangular', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('ARQUETA_ARENAL', 'MANHOLE', 'NODE', NULL, 'v_edit_node', 've_node_arqueta_arenal', NULL, NULL, true, false, NULL);
...
INSERT INTO cat_feature VALUES ('SUMIDERO_TOPO', 'NETGULLY', 'NODE', NULL, 'v_edit_node', 've_node_sumidero_topo', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('ELEMENTO_TOPO', 'NETELEMENT', 'NODE', NULL, 'v_edit_node', 've_node_elemento_topo', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('INICIO', 'NETINIT', 'NODE', NULL, 'v_edit_node', 've_node_inicio', NULL, NULL, true, false, NULL);
INSERT INTO cat_feature VALUES ('CAMERA', 'CHAMBER', 'NODE', NULL, 'v_edit_node', 've_node_camera', NULL, NULL, true, false, NULL);
...
INSERT INTO cat_feature_arc VALUES ('IMPULSION', 'CONDUIT', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('SIFON', 'SIPHON', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('RAPIDO', 'WACCEL', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('FICTICIO', 'VARC', 'OUTLET');
...
INSERT INTO cat_feature_connec VALUES ('ACOMETIDA_FICTICIA', 'CONNEC', '{"activated":false,"value":1}');
...
INSERT INTO cat_feature_node VALUES ('PUNTO_ALTO', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('REGISTRO', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CAMBIO_SECCION', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('NODO_FICTICIO', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('SALTO', 'WJUMP', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('POZO_RECTANGULAR', 'MANHOLE', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('ARQUETA_ARENAL', 'MANHOLE', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
...
INSERT INTO cat_feature_node VALUES ('DESAGUE', 'OUTFALL', 'OUTFALL', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('SUMIDERO_TOPO', 'NETGULLY', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('UNION', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
