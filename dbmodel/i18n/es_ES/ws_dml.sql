...
UPDATE config_form_fields SET formname = 've_node_valvula_control_fl' WHERE formname LIKE 've_node_fl_contr_valve';
...
UPDATE config_form_fields SET formname = 've_node_valvula_control' WHERE formname LIKE 've_node_check_valve';
