...
--
-- Data for Name: value_state; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: value_state_type; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: edit_typevalue; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: om_typevalue; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: doc_type; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: plan_typevalue; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: config_csv; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: sys_message; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: cat_feature; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
...
--
-- Data for Name: cat_feature_arc; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--

INSERT INTO cat_feature_arc VALUES ('CONDUIT', 'CONDUIT', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('SIPHON', 'SIPHON', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('ACCELERATEUR_EAU', 'WACCEL', 'CONDUIT');
INSERT INTO cat_feature_arc VALUES ('ARC_VIRTUEL', 'VARC', 'VIRTUAL');
INSERT INTO cat_feature_arc VALUES ('POMPE_TUYAU', 'CONDUIT', 'CONDUIT');


--
-- Data for Name: cat_feature_connec; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--

INSERT INTO cat_feature_connec VALUES ('CONNEXION', 'CONNEC', '{"activated":false,"value":1}');


--
-- Data for Name: cat_feature_gully; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--

INSERT INTO cat_feature_gully VALUES ('DEVERSOIR', 'GULLY', '{"activated":false,"value":1}', 'GULLY');
INSERT INTO cat_feature_gully VALUES ('POLYGON_CANIVEAU', 'GULLY', '{"activated":false,"value":1}', 'GULLY');


--
-- Data for Name: cat_feature_node; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--

INSERT INTO cat_feature_node VALUES ('REGARD_CIRC', 'MANHOLE', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('POINTHAUT', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('COMPTEUR', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CHANGE', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('NOEUD_VIRTUEL', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('SAUT', 'WJUMP', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('REGARD_RECT', 'MANHOLE', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('SANDBOX', 'MANHOLE', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('USINE_RETRAITEMENT', 'WWTP', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('VALVE', 'VALVE', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CHUTE', 'OUTFALL', 'OUTFALL', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CANIVEAU_TOPO', 'NETGULLY', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('JONCTION', 'JUNCTION', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('ELEMENT_RESEAU', 'NETELEMENT', 'JUNCTION', 2, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('INIT_RESEAU', 'NETINIT', 'JUNCTION', 1, true, true, NULL, 0, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('CHAMBRE', 'CHAMBER', 'STORAGE', 2, true, true, NULL, 2, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('SEUIL', 'CHAMBER', 'JUNCTION', 2, true, true, NULL, 2, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('BASSIN_RETENTION', 'STORAGE', 'STORAGE', 2, true, true, NULL, 2, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('BASSIN_DEBORDEMENT', 'STORAGE', 'STORAGE', 2, true, true, NULL, 2, '{"activated":false,"value":1}');
INSERT INTO cat_feature_node VALUES ('STATION_POMPAGE', 'CHAMBER', 'STORAGE', 2, true, true, NULL, 2, '{"activated":false,"value":1}');


--
-- Data for Name: element_type; Type: TABLE DATA; Schema: ud_dev_35041_fr; Owner: -
--
