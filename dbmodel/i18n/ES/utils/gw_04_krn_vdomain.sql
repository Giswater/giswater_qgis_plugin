...
- Puedes escoger un catálogo para los precios importados asignandolo a Import label.
- Atención: el fichero csv debe tener una fila de encabezado', 'role_master');
...
- Atención: el fichero csv debe tener una fila de encabezado', 'role_admin');
