...
UPDATE cat_feature SET type = 'arc', parent_layer = 'v_edit_arc', child_layer = concat('ve_',lower(cat_feature.feature_type),'_', REPLACE(REPLACE(lower(id), '.', ''), '-','')), active=TRUE WHERE feature_type = 'ARC';
UPDATE cat_feature SET type = 'node', parent_layer = 'v_edit_node', child_layer = concat('ve_',lower(cat_feature.feature_type),'_', REPLACE(REPLACE(lower(id), '.', ''), '-','')), active=TRUE WHERE feature_type = 'NODE';
UPDATE cat_feature SET type = 'connec', parent_layer = 'v_edit_connec', child_layer = concat('ve_',lower(cat_feature.feature_type),'_', REPLACE(REPLACE(lower(id), '.', ''), '-','')), active=TRUE WHERE feature_type = 'CONNEC';
