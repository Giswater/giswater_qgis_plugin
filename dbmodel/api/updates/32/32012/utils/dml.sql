...
UPDATE cat_feature SET type = 'node', parent_layer = 'v_edit_node', child_layer = concat('ve_',lower(cat_feature.feature_type),'_', REPLACE(REPLACE(lower(id), '.', ''), '-','')) WHERE feature_type = 'NODE';
UPDATE cat_feature SET type = 'connec', parent_layer = 'v_edit_connec', child_layer = concat('ve_',lower(cat_feature.feature_type),'_', REPLACE(REPLACE(lower(id), '.', ''), '-',''))  WHERE feature_type = 'CONNEC';
