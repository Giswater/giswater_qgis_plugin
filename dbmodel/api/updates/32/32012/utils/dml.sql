...
UPDATE cat_feature SET type = 'arc', parent_layer = 've_arc', child_layer = concat('ve_',lower(cat_feature.feature_type),'_',lower(id)) WHERE feature_type = 'ARC';
UPDATE cat_feature SET type = 'node', parent_layer = 've_node', child_layer = concat('ve_',lower(cat_feature.feature_type),'_',lower(id)) WHERE feature_type = 'NODE';
UPDATE cat_feature SET type = 'connec', parent_layer = 've_connec', child_layer = concat('ve_',lower(cat_feature.feature_type),'_',lower(id)) WHERE feature_type = 'CONNEC';
