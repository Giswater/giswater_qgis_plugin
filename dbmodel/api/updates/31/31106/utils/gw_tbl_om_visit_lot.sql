...
CREATE TABLE ws_sample.om_visit_lot
(
...
CREATE TABLE ws_sample.om_visit_lot_x_arc( 
  lot_id integer,
  arc_id varchar (16),
  status integer,
  constraint om_visit_lot_x_arc_pkey PRIMARY KEY (lot_id, arc_id));

  CREATE TABLE ws_sample.om_visit_lot_x_node( 
  lot_id integer,
  node_id varchar (16),
  status integer,
  constraint om_visit_lot_x_node_pkey PRIMARY KEY (lot_id, node_id));

  CREATE TABLE ws_sample.om_visit_lot_x_connec( 
  lot_id integer,
