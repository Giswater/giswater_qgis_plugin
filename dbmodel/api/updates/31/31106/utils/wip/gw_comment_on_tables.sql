...
COMMENT ON TABLE ws_sample.config_api_form_actions IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
...
COMMENT ON TABLE ws_sample.config_api_form_fields IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
...
COMMENT ON TABLE ws_sample.config_api_images IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
...
COMMENT ON TABLE ws_sample.config_api_list IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
...
COMMENT ON TABLE ws_sample.config_api_message IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
With this table api messages are configured';


COMMENT ON TABLE ws_sample.config_api_visit IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
...
COMMENT ON TABLE ws_sample.config_api_form_tabs IS 
'INSTRUCIONS TO WORK WITH THIS TABLE:
