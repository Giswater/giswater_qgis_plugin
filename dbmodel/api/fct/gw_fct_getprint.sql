...
-- Create tabs array
	...
	SELECT gw_api_get_formfields( 'printGeneric', 'form', 'data', null, null, null, null, 'SELECT', null, 9, null) INTO v_fields; -- 'SELECT' parameter used on line 190 of gw_api_get_formfields
