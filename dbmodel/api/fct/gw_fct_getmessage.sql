...
DROP FUNCTION IF EXISTS SCHEMA_NAME.gw_api_getmessage (json, integer);
CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_getmessage(p_data json, p_message integer)
  RETURNS json AS
$BODY$

/*EXAMPLE:
SELECT SCHEMA_NAME.gw_fct_getmessage($${"featureType":"visit", "idName":"visit_id", "id":"2001"}$$, 30)
*/
