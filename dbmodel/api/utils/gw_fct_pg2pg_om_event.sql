CREATE OR REPLACE FUNCTION "SCHEMA_NAME"."gw_fct_pg2pg_om_event"(table_aux varchar, tabletype_aux varchar, visitcat_aux int4) RETURNS pg_catalog.void AS $BODY$
...
BEGIN
    ...
    FOR rec_table IN EXECUTE v_sql
        ...
        ELSIF tabletype_aux='node' THEN 
                INSERT INTO om_visit (startdate, enddate, visitcat_id, user_name) VALUES(rec_table.pg2pg_date, rec_table.pg2pg_date, 1, current_user) RETURNING id INTO id_last;
        ...
        INSERT INTO om_visit_event (visit_id, parameter_id, value, tstamp) VALUES (id_last, rec_table.parameter_id, rec_table.pg2pg_value, rec_table.pg2pg_date);        
