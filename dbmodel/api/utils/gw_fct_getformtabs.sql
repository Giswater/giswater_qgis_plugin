CREATE OR REPLACE FUNCTION "arbrat_viari"."gw_fct_getformtabs"(layer_id varchar, table_id varchar, id varchar, editable bool, device int4, user_id varchar, lang varchar) RETURNS pg_catalog.json AS $BODY$
DECLARE
