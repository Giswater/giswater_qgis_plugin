CREATE OR REPLACE FUNCTION "arbrat_viari"."gw_fct_inserteventphoto"(visit_id int8, event_id int8, hash varchar, url text, compass float8) RETURNS pg_catalog.json AS $BODY$
DECLARE
