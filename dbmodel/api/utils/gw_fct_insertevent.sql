CREATE OR REPLACE FUNCTION "arbrat_viari"."gw_fct_insertevent"(ext_code varchar, visit_id int4, position_id varchar, position_value float8, parameter_id varchar, value_arg varchar, value2 int4, geom1 float8, geom2 float8, geom3 float8, text_arg text) RETURNS pg_catalog.json AS $BODY$
DECLARE
