CREATE OR REPLACE FUNCTION "arbrat_viari"."gw_fct_upsertvisit_mod"(x float8, y float8, srid_arg int4, element_type varchar, id varchar, device int4, visitcat_id_aux int4, cur_user varchar) RETURNS pg_catalog.json AS $BODY$
DECLARE
