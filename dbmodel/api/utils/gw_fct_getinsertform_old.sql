CREATE OR REPLACE FUNCTION "SCHEMA_NAME"."gw_fct_getinsertform_old"(table_id varchar, lang varchar, id varchar, formtodisplay json) RETURNS pg_catalog.json AS $BODY$
DECLARE
