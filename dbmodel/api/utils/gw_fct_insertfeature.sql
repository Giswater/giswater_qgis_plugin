CREATE OR REPLACE FUNCTION "arbrat_viari"."gw_fct_insertfeature"(layer_id varchar, table_id varchar, srid int4, the_geom varchar, insert_data json) RETURNS pg_catalog.json AS $BODY$
DECLARE
