CREATE OR REPLACE FUNCTION "SCHEMA_NAME"."gw_fct_getinfofromcoordinates"(p_x float8, p_y float8, p_epsg int4, p_active_layer text, p_visible_layer text, p_editable_layer text, p_device int4, p_info_type int4, p_lang varchar) RETURNS pg_catalog.json AS $BODY$
DECLARE
...
--  Get element
    ...
    LOOP
        ...
        RAISE NOTICE 'v_layer % v_id % v_idname %', v_layer, v_id, v_idname;
