...
INSERT INTO config_web_forms VALUES (2, 'v_ui_element_x_node', 'SELECT element_id as sys_id, element_id, elementcat_id FROM v_ui_element_x_node', 2);
INSERT INTO config_web_forms VALUES (3, 'v_ui_element_x_node', 'SELECT element_id as sys_id, element_id, elementcat_id FROM v_ui_element_x_node', 3);
...
INSERT INTO config_web_forms VALUES (17, 'v_ui_om_visit_x_arc', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_arc', 2);
INSERT INTO config_web_forms VALUES (18, 'v_ui_om_visit_x_arc', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_arc', 3);
INSERT INTO config_web_forms VALUES (20, 'v_ui_om_visit_x_connec', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_connec', 2);
INSERT INTO config_web_forms VALUES (21, 'v_ui_om_visit_x_connec', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_connec', 3);
INSERT INTO config_web_forms VALUES (23, 'v_ui_om_visit_x_gully', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_gully', 2);
INSERT INTO config_web_forms VALUES (19, 'v_ui_om_visit_x_connec', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_connec', 1);
INSERT INTO config_web_forms VALUES (24, 'v_ui_om_visit_x_gully', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_gully', 3);
INSERT INTO config_web_forms VALUES (38, 'v_ui_arc_x_relations', 'SELECT feature_id as sys_id, x as sys_x, y as sys_y, featurecat_id  FROM v_ui_arc_x_relations', 2);
INSERT INTO config_web_forms VALUES (39, 'v_ui_arc_x_relations', 'SELECT feature_id as sys_id, x as sys_x, y as sys_y, featurecat_id  FROM v_ui_arc_x_relations', 3);
INSERT INTO config_web_forms VALUES (37, 'v_ui_arc_x_relations', 'SELECT feature_id as sys_id, x as sys_x, y as sys_y, featurecat_id  FROM v_ui_arc_x_relations', 1);
...
INSERT INTO config_web_forms VALUES (1, 'v_ui_element_x_node', 'SELECT element_id as sys_id, element_id, elementcat_id FROM v_ui_element_x_node', 1);
...
INSERT INTO config_web_forms VALUES (1005, 'v_ui_hydrometer', 'SELECT * FROM v_rtc_hydrometer', 3);
INSERT INTO config_web_forms VALUES (13, 'v_ui_om_visit_x_node', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text as date FROM v_ui_om_visit_x_node', 1);
INSERT INTO config_web_forms VALUES (14, 'v_ui_om_visit_x_node', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text as date FROM v_ui_om_visit_x_node', 2);
INSERT INTO config_web_forms VALUES (15, 'v_ui_om_visit_x_node', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text as date FROM v_ui_om_visit_x_node', 3);
INSERT INTO config_web_forms VALUES (16, 'v_ui_om_visit_x_arc', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_arc', 1);
INSERT INTO config_web_forms VALUES (22, 'v_ui_om_visit_x_gully', 'SELECT visit_id, event_id AS sys_id, parameter_id, parameter_type, value as valor, descript, visit_start::date::text  as date FROM v_ui_om_visit_x_gully', 1);
INSERT INTO config_web_forms VALUES (1000, 'v_ui_hydrometer_x_connec', 'SELECT hydrometer_id as sys_id, hydrometer_customer_code as code,  name as state, hydrometer_category as category FROM v_rtc_hydrometer', 1);
INSERT INTO config_web_forms VALUES (1001, 'v_ui_hydrometer_x_connec', 'SELECT hydrometer_id as sys_id, hydrometer_customer_code as code,  name as state, hydrometer_category as category FROM v_rtc_hydrometer', 2);
INSERT INTO config_web_forms VALUES (1002, 'v_ui_hydrometer_x_connec', 'SELECT hydrometer_id as sys_id, hydrometer_customer_code as code,  name as state, hydrometer_category as category FROM v_rtc_hydrometer', 3);
INSERT INTO config_web_forms VALUES (1003, 'v_ui_hydrometer', 'SELECT * FROM v_rtc_hydrometer', 1);
INSERT INTO config_web_forms VALUES (1004, 'v_ui_hydrometer', 'SELECT * FROM v_rtc_hydrometer', 2);
