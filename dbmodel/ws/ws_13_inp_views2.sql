...
DROP VIEW IF EXISTS "v_inp_status_pump";
...
DROP VIEW IF EXISTS "v_inp_shortpipe"; 
...
DROP VIEW IF EXISTS "v_rpt_energy_usage";
...
DROP VIEW IF EXISTS "v_rpt_hydraulic_status";
...
DROP VIEW IF EXISTS "v_rpt_comp_energy_usage";
...
DROP VIEW IF EXISTS "v_rpt_comp_hydraulic_status";
