...
"head_1" numeric,
"press_1" numeric,
"other_1" varchar(100) COLLATE "default",
"time_1" varchar(100) COLLATE "default",
...
"head_2" numeric,
"press_2" numeric,
"other_2" varchar(100) COLLATE "default",
"time_2" varchar(100) COLLATE "default",
...
"other_1" varchar(100) COLLATE "default",
"time_1" varchar(100) COLLATE "default",
"status_1" varchar(16) COLLATE "default",
"elevation" numeric,
"demand" numeric,
"head" numeric,
"press" numeric,
...
"other_2" varchar(100) COLLATE "default",
"time_2" varchar(100) COLLATE "default",
"status_2" varchar(16) COLLATE "default",
...
ALTER TABLE "SCHEMA_NAME"."rpt_nodearcnode" ADD FOREIGN KEY ("result_id") REFERENCES "SCHEMA_NAME"."rpt_result_cat" ("result_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."rpt_arcnodearc" ADD FOREIGN KEY ("result_id") REFERENCES "SCHEMA_NAME"."rpt_result_cat" ("result_id") ON DELETE CASCADE ON UPDATE CASCADE;
