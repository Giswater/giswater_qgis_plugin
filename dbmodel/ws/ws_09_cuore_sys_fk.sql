...
ALTER TABLE "SCHEMA_NAME"."ext_cat_hydrometer" ADD FOREIGN KEY ("hydrometer_type") REFERENCES "SCHEMA_NAME"."connec_type" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."dma" ADD FOREIGN KEY ("presszonecat_id") REFERENCES "SCHEMA_NAME"."cat_press_zone" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
