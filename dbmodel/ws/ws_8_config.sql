...
CREATE TRIGGER arc_searchnodes_update BEFORE UPDATE ON "SCHEMA_NAME"."arc" FOR EACH ROW WHEN (((old.the_geom IS DISTINCT FROM new.the_geom) )) EXECUTE PROCEDURE "SCHEMA_NAME"."arc_searchnodes"();
