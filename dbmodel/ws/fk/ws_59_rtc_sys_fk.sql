...
ALTER TABLE "rtc_options" DROP CONSTRAINT IF EXISTS "rtc_options_period_id_fkey";
ALTER TABLE "rtc_options" DROP CONSTRAINT IF EXISTS "rtc_options_rtc_status_fkey";
ALTER TABLE "rtc_options" DROP CONSTRAINT IF EXISTS "rtc_options_coefficient_fkey";
...
ALTER TABLE "rtc_options" ADD CONSTRAINT "rtc_options_period_id_fkey" FOREIGN KEY ("period_id") REFERENCES "ext_cat_period" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "rtc_options" ADD CONSTRAINT "rtc_options_rtc_status_fkey" FOREIGN KEY ("rtc_status") REFERENCES "rtc_value_opti_status" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "rtc_options" ADD CONSTRAINT "rtc_options_coefficient_fkey" FOREIGN KEY ("coefficient") REFERENCES "rtc_value_opti_coef" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
