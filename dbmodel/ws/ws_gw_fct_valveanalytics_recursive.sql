-- Function: SCHEMA_NAME.gw_fct_valveanalytics_recursive(character varying)

-- DROP FUNCTION SCHEMA_NAME.gw_fct_valveanalytics_recursive(character varying);

CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_valveanalytics_recursive(node_id_arg character varying)
  RETURNS void AS
$BODY$
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION SCHEMA_NAME.gw_fct_valveanalytics_recursive(character varying)
  OWNER TO postgres;
