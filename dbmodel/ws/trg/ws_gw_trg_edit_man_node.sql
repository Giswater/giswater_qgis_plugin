...
-- Function: "ws".gw_trg_edit_man_node()

-- DROP FUNCTION "ws".gw_trg_edit_man_node();

CREATE OR REPLACE FUNCTION "ws".gw_trg_edit_man_node()
  RETURNS trigger AS
$BODY$
DECLARE 
    inp_table varchar;
...
-- INSERT
	...
	-- Verified
		...
		-- Municipality 
		IF (NEW.jt_muni_id IS NULL) THEN
			NEW.jt_muni_id := (SELECT "value" FROM config_param_user WHERE "parameter"='municipality_vdefault' AND "cur_user"="current_user"());
			IF (NEW.jt_muni_id IS NULL) THEN
				NEW.jt_muni_id := (SELECT muni_id FROM ext_municipality WHERE ST_DWithin(NEW.the_geom, ext_municipality.the_geom,0.001) LIMIT 1);
...
-- FEATURE INSERT      
	IF man_table='man_tank' THEN
		...
		buildercat_id, builtdate, enddate, ownercat_id, muni_id,streetaxis_id, streetaxis2_id, postcode, postnumber, postnumber2,descript, rotation,verified,undelete,label_x,label_y,label_rotation, expl_id, publish, inventory, the_geom, hemisphere, num_value) 
		...
		NEW.tk_streetaxis_id, NEW.tk_streetaxis2_id, NEW.tk_postcode,NEW.tk_postnumber,NEW.tk_postnumber2, NEW.tk_descript, NEW.tk_rotation, NEW.verified, NEW.undelete,NEW.tk_label_x,NEW.tk_label_y,NEW.tk_label_rotation, 
		...
		IF (rec.insert_double_geometry IS TRUE) THEN
				IF (NEW.tk_pol_id IS NULL) THEN
					...
					INSERT INTO polygon(pol_id,the_geom) VALUES (NEW.tk_pol_id,(SELECT ST_Envelope(ST_Buffer(node.the_geom,rec.buffer_value)) from "ws".node where node_id=NEW.node_id));
			ELSE
	...
	ELSIF man_table='man_tank_pol' THEN
		...
		IF (rec.insert_double_geometry IS TRUE) THEN
				...
				NEW.tk_soilcat_id, NEW.tk_function_type, NEW.tk_category_type, NEW.tk_fluid_type, NEW.tk_location_type,NEW.tk_workcat_id, NEW.tk_workcat_id_end, NEW.tk_buildercat_id, NEW.tk_builtdate, NEW.tk_enddate, NEW.tk_ownercat_id, NEW.tk_muni_id, 
				NEW.tk_streetaxis_id, NEW.tk_streetaxis2_id, NEW.tk_postcode,NEW.tk_postnumber,NEW.tk_postnumber2,NEW.tk_descript, NEW.tk_rotation, NEW.verified, NEW.undelete,NEW.tk_label_x,NEW.tk_label_y,NEW.tk_label_rotation, 
				NEW.expl_id, NEW.publish, NEW.inventory, (SELECT ST_Centroid(polygon.the_geom) FROM "ws".polygon where pol_id=NEW.tk_pol_id),  NEW.tk_hemisphere,NEW.tk_num_value);
	...
	ELSIF man_table='man_hydrant' THEN
		...
		INSERT INTO node (node_id, code, elevation, depth,  nodecat_id, epa_type, sector_id, state, state_type, annotation, observ,comment, dma_id, presszonecat_id, soilcat_id, function_type, category_type, fluid_type, location_type, workcat_id, workcat_id_end,
		buildercat_id, builtdate, enddate, ownercat_id, muni_id, streetaxis_id, streetaxis2_id,postcode, postnumber, postnumber2, descript, rotation,verified, the_geom, undelete,label_x,label_y,label_rotation,  expl_id, publish, inventory, hemisphere, num_value) 
		...
		NEW.hy_buildercat_id, NEW.hy_builtdate,NEW.hy_enddate, NEW.hy_ownercat_id, NEW.hy_muni_id, NEW.hy_streetaxis_id, NEW.hy_streetaxis2_id, NEW.hy_postcode, NEW.hy_postnumber, NEW.hy_postnumber2,NEW.hy_descript, NEW.hy_rotation, 
	...
	ELSIF man_table='man_junction' THEN
		...
		NEW.jt_workcat_id_end, NEW.jt_buildercat_id, NEW.jt_builtdate, NEW.jt_enddate, NEW.jt_ownercat_id, NEW.jt_muni_id, NEW.jt_streetaxis_id, NEW.jt_streetaxis2_id,NEW.jt_postcode,NEW.jt_postnumber, NEW.jt_postnumber2, NEW.jt_descript, 
	...
	ELSIF man_table='man_pump' THEN		
		...
		NEW.pm_builtdate, NEW.pm_enddate, NEW.pm_ownercat_id, NEW.pm_muni_id, NEW.pm_streetaxis_id, NEW.pm_streetaxis2_id, NEW.pm_postcode,NEW.pm_postnumber, NEW.pm_postnumber2, NEW.pm_descript, NEW.pm_rotation, NEW.verified, NEW.the_geom,NEW.undelete, 
	...
	ELSIF man_table='man_reduction' THEN
		...
		NEW.rd_buildercat_id, NEW.rd_builtdate, NEW.rd_enddate, NEW.rd_ownercat_id, NEW.rd_muni_id, NEW.rd_streetaxis_id, NEW.rd_streetaxis2_id,NEW.rd_postcode,NEW.rd_postnumber, NEW.rd_postnumber2, NEW.rd_descript, NEW.rd_rotation,
	...
	ELSIF man_table='man_valve' THEN	
		...
		NEW.vl_builtdate, NEW.vl_enddate, NEW.vl_ownercat_id, NEW.vl_muni_id, NEW.vl_streetaxis_id, NEW.vl_streetaxis2_id,NEW.vl_postcode,NEW.vl_postnumber,NEW.vl_postnumber2, NEW.vl_descript, NEW.vl_rotation, NEW.verified, NEW.the_geom, NEW.undelete,
	...
	ELSIF man_table='man_manhole' THEN	
		...
		NEW.mh_enddate, NEW.mh_ownercat_id, NEW.mh_muni_id, NEW.mh_streetaxis_id, NEW.mh_streetaxis2_id,NEW.mh_postcode,NEW.mh_postnumber,NEW.mh_postnumber2, NEW.mh_descript, NEW.mh_rotation, NEW.verified, NEW.the_geom, NEW.undelete,
	...
	ELSIF man_table='man_meter' THEN
		...
		NEW.mt_ownercat_id, NEW.mt_muni_id, NEW.mt_streetaxis_id, NEW.mt_streetaxis2_id, NEW.mt_postcode,NEW.mt_postnumber,NEW.mt_postnumber2,NEW.mt_descript, NEW.mt_rotation,NEW.verified, NEW.the_geom, NEW.undelete,NEW.mt_label_x,NEW.mt_label_y,
	...
	ELSIF man_table='man_source' THEN	
		...
		NEW.so_enddate, NEW.so_ownercat_id, NEW.so_muni_id, NEW.so_streetaxis_id, NEW.so_streetaxis2_id,NEW.so_postcode,NEW.so_postnumber,NEW.so_postnumber2, NEW.so_descript, NEW.so_rotation, NEW.verified, NEW.the_geom, NEW.undelete,
	...
	ELSIF man_table='man_waterwell' THEN
		...
		NEW.ww_ownercat_id, NEW.ww_muni_id, NEW.ww_streetaxis_id, NEW.ww_streetaxis2_id,NEW.ww_postcode,NEW.ww_postnumber,NEW.ww_postnumber2, NEW.ww_descript, NEW.ww_rotation, NEW.verified, NEW.the_geom,
	...
	ELSIF man_table='man_filter' THEN
		...
		NEW.fl_builtdate, NEW.fl_enddate, NEW.fl_ownercat_id, NEW.fl_muni_id, NEW.fl_streetaxis_id, NEW.fl_streetaxis2_id, NEW.fl_postcode,NEW.fl_postnumber,NEW.fl_postnumber2,NEW.fl_descript, NEW.fl_rotation, NEW.verified, 
	...
	ELSIF man_table='man_register' THEN
		...
		NEW.rg_builtdate, NEW.rg_enddate, NEW.rg_ownercat_id, NEW.rg_muni_id, NEW.rg_streetaxis_id,NEW.rg_postcode,NEW.rg_postnumber,NEW.rg_postnumber2, NEW.rg_streetaxis2_id, NEW.rg_descript, NEW.rg_rotation, NEW.verified, 
		...
		IF (rec.insert_double_geometry IS TRUE) THEN
				IF (NEW.rg_pol_id IS NULL) THEN
					...
					INSERT INTO polygon(pol_id,the_geom) VALUES (NEW.rg_pol_id,(SELECT ST_Envelope(ST_Buffer(node.the_geom,rec.buffer_value)) from "ws".node where node_id=NEW.node_id));
			ELSE
	...
	ELSIF man_table='man_register_pol' THEN
		...
		VALUES (NEW.node_id, NEW.rg_code, NEW.rg_elevation, NEW.rg_depth, NEW.nodecat_id, NEW.epa_type, NEW.sector_id,	NEW.state, NEW.state_type, NEW.rg_annotation, NEW.rg_observ,
		NEW.rg_comment, NEW.dma_id, NEW.presszonecat_id, NEW.rg_soilcat_id, NEW.rg_function_type, NEW.rg_category_type, NEW.rg_fluid_type, NEW.rg_location_type, NEW.rg_workcat_id, NEW.rg_workcat_id_end, NEW.rg_buildercat_id, 
		NEW.rg_builtdate, NEW.rg_enddate, NEW.rg_ownercat_id, NEW.rg_muni_id, NEW.rg_streetaxis_id, NEW.rg_streetaxis2_id,NEW.rg_postcode,NEW.rg_postnumber,NEW.rg_postnumber2, NEW.rg_descript, NEW.rg_rotation, NEW.verified, 
		(SELECT ST_Centroid(polygon.the_geom) FROM "ws".polygon where pol_id=NEW.rg_pol_id), NEW.undelete,NEW.rg_label_x,NEW.rg_label_y,NEW.rg_label_rotation, NEW.expl_id, NEW.publish, NEW.inventory, NEW.rg_hemisphere, NEW.rg_num_value);
	...
	ELSIF man_table='man_netwjoin' THEN
		...
		workcat_id_end, buildercat_id, builtdate, enddate, ownercat_id, muni_id, streetaxis_id, streetaxis2_id, postcode, postnumber, postnumber2,descript, rotation,verified, the_geom, undelete,label_x,label_y,label_rotation, expl_id, publish, inventory, hemisphere, num_value) 
		...
		NEW.nw_buildercat_id, NEW.nw_builtdate, NEW.nw_enddate, NEW.nw_ownercat_id, NEW.nw_muni_id, NEW.nw_streetaxis_id, NEW.nw_streetaxis2_id, NEW.nw_postcode,NEW.nw_postnumber,NEW.nw_postnumber2, NEW.nw_descript, NEW.nw_rotation, NEW.verified, 
	...
	ELSIF man_table='man_expansiontank' THEN
		...
		NEW.ex_buildercat_id, NEW.ex_builtdate, NEW.ex_enddate,  NEW.ex_ownercat_id, NEW.ex_muni_id, NEW.ex_streetaxis_id, NEW.ex_streetaxis2_id,NEW.ex_postcode,NEW.ex_postnumber,NEW.ex_postnumber2, NEW.ex_descript, NEW.ex_rotation, NEW.verified, 
	...
	ELSIF man_table='man_flexunion' THEN
		...
		NEW.fu_buildercat_id, NEW.fu_builtdate, NEW.fu_enddate,  NEW.fu_ownercat_id, NEW.fu_muni_id, NEW.fu_streetaxis_id, NEW.fu_streetaxis2_id, NEW.fu_postcode,NEW.fu_postnumber,NEW.fu_postnumber2,NEW.fu_descript, NEW.fu_rotation,
		...
		NEW.ne_workcat_id_end, NEW.ne_buildercat_id, NEW.ne_builtdate, NEW.ne_enddate, NEW.ne_ownercat_id, NEW.ne_muni_id, NEW.ne_streetaxis_id, NEW.ne_streetaxis2_id, 
		NEW.ne_postcode,NEW.ne_postnumber,NEW.ne_postnumber2,NEW.ne_descript, NEW.ne_rotation, NEW.verified, NEW.the_geom, NEW.undelete,NEW.ne_label_x,NEW.ne_label_y,NEW.ne_label_rotation, NEW.expl_id, NEW.publish, NEW.inventory, NEW.ne_hemisphere,
		NEW.ne_num_value);
		...
		NEW.ns_buildercat_id, NEW.ns_builtdate, NEW.ns_enddate, NEW.ns_ownercat_id, NEW.ns_muni_id, NEW.ns_streetaxis_id, NEW.ns_streetaxis2_id,NEW.ns_postcode,NEW.ns_postnumber,NEW.ns_postnumber2, NEW.ns_descript, NEW.ns_rotation, 
		...
		NEW.wt_buildercat_id, NEW.wt_builtdate, NEW.wt_enddate,  NEW.wt_ownercat_id, NEW.wt_muni_id, NEW.wt_streetaxis_id, NEW.wt_streetaxis2_id, NEW.wt_postcode,NEW.wt_postnumber,NEW.wt_postnumber2,NEW.wt_descript, NEW.wt_rotation,
...
-- MANAGEMENT UPDATE
    IF man_table ='man_junction' THEN
		...
		streetaxis2_id=NEW.jt_streetaxis2_id,postcode=NEW.jt_postcode,postnumber=NEW.jt_postnumber,postnumber2=NEW.jt_postnumber2, descript=NEW.jt_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.jt_label_x, 
	...
	ELSIF man_table ='man_tank' THEN
		...
		builtdate=NEW.tk_builtdate, enddate=NEW.tk_enddate, ownercat_id=NEW.tk_ownercat_id, muni_id=NEW.tk_muni_id, streetaxis_id=NEW.tk_streetaxis_id, streetaxis2_id=NEW.tk_streetaxis2_id,postcode=NEW.tk_postcode,
		postnumber=NEW.tk_postnumber,postnumber2=NEW.tk_postnumber2,descript=NEW.tk_descript, 
	...
	ELSIF man_table ='man_tank_pol' THEN
		...
		annotation=NEW.tk_annotation, "observ"=NEW."tk_observ", "comment"=NEW."tk_comment", dma_id=NEW.dma_id, presszonecat_id=NEW.presszonecat_id, soilcat_id=NEW.tk_soilcat_id, function_type=NEW.tk_function_type, 
		category_type=NEW.tk_category_type, fluid_type=NEW.tk_fluid_type, location_type=NEW.tk_location_type, workcat_id=NEW.tk_workcat_id, workcat_id_end=NEW.tk_workcat_id_end, buildercat_id=NEW.tk_buildercat_id, 
		builtdate=NEW.tk_builtdate, enddate=NEW.tk_enddate, ownercat_id=NEW.tk_ownercat_id, muni_id=NEW.tk_muni_id, streetaxis_id=NEW.tk_streetaxis_id, streetaxis2_id=NEW.tk_streetaxis2_id,
		postcode=NEW.tk_postcode,postnumber=NEW.tk_postnumber,postnumber2=NEW.tk_postnumber2,descript=NEW.tk_descript, 
		verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.tk_label_x, label_y=NEW.tk_label_y, label_rotation=NEW.tk_label_rotation,
		publish=NEW.publish, inventory=NEW.inventory, expl_id=NEW.expl_id, hemisphere=NEW.tk_hemisphere, num_value=NEW.tk_num_value
		WHERE node_id = OLD.node_id;
	...
	ELSIF man_table ='man_pump' THEN
		...
		builtdate=NEW.pm_builtdate,  enddate=NEW.pm_enddate, ownercat_id=NEW.pm_ownercat_id, muni_id=NEW.pm_muni_id, streetaxis_id=NEW.pm_streetaxis_id, streetaxis2_id=NEW.pm_streetaxis2_id, 
		postcode=NEW.pm_postcode, postnumber=NEW.pm_postnumber,postnumber2=NEW.pm_postnumber2,descript=NEW.pm_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.pm_label_x, label_y=NEW.pm_label_y,
	...
	ELSIF man_table ='man_manhole' THEN
		...
		streetaxis2_id=NEW.mh_streetaxis2_id,postcode=NEW.mh_postcode, postnumber=NEW.mh_postnumber,postnumber2=NEW.mh_postnumber2, descript=NEW.mh_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.mh_label_x, 
	...
	ELSIF man_table ='man_hydrant' THEN
		...
		streetaxis2_id=NEW.hy_streetaxis2_id, postcode=NEW.hy_postcode, postnumber=NEW.hy_postnumber,postnumber2=NEW.hy_postnumber2,descript=NEW.hy_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.hy_label_x, 
	...
	ELSIF man_table ='man_source' THEN
		...
		streetaxis2_id=NEW.so_streetaxis2_id,postcode=NEW.so_postcode, postnumber=NEW.so_postnumber,postnumber2=NEW.so_postnumber2, descript=NEW.so_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.so_label_x, 
	...
	ELSIF man_table ='man_meter' THEN
		...
		builtdate=NEW.mt_builtdate, enddate=NEW.mt_enddate,  ownercat_id=NEW.mt_ownercat_id, muni_id=NEW.mt_muni_id, streetaxis_id=NEW.mt_streetaxis_id, streetaxis2_id=NEW.mt_streetaxis2_id,
		postcode=NEW.mt_postcode, postnumber=NEW.mt_postnumber,postnumber2=NEW.mt_postnumber2,descript=NEW.mt_descript,
	...
	ELSIF man_table ='man_waterwell' THEN
		...
		muni_id=NEW.ww_muni_id, streetaxis_id=NEW.ww_streetaxis_id, streetaxis2_id=NEW.ww_streetaxis2_id,
		postcode=NEW.ww_postcode, postnumber=NEW.ww_postnumber,postnumber2=NEW.ww_postnumber2,descript=NEW.ww_descript,
	...
	ELSIF man_table ='man_reduction' THEN
		...
		streetaxis_id=NEW.rd_streetaxis_id, streetaxis2_id=NEW.rd_streetaxis2_id,postcode=NEW.rd_postcode, postnumber=NEW.rd_postnumber,postnumber2=NEW.rd_postnumber2,descript=NEW.rd_descript, verified=NEW.verified, 
	...
	ELSIF man_table ='man_valve' THEN
		...
		builtdate=NEW.vl_builtdate, enddate=NEW.vl_enddate,  ownercat_id=NEW.vl_ownercat_id, muni_id=NEW.vl_muni_id, streetaxis_id=NEW.vl_streetaxis_id, streetaxis2_id=NEW.vl_streetaxis2_id,
		postcode=NEW.vl_postcode, postnumber=NEW.vl_postnumber,postnumber2=NEW.vl_postnumber2,descript=NEW.vl_descript,
	...
	ELSIF man_table ='man_register' THEN
		...
		streetaxis2_id=NEW.rg_streetaxis2_id,postcode=NEW.rg_postcode, postnumber=NEW.rg_postnumber,postnumber2=NEW.rg_postnumber2, descript=NEW.rg_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.rg_label_x, 
	...
	ELSIF man_table ='man_netwjoin' THEN
		...
		streetaxis_id=NEW.nw_streetaxis_id, streetaxis2_id=NEW.nw_streetaxis2_id,postcode=NEW.nw_postcode, postnumber=NEW.nw_postnumber,postnumber2=NEW.nw_postnumber2, descript=NEW.nw_descript, verified=NEW.verified, undelete=NEW.undelete, 
	...
	ELSIF man_table ='man_expansiontank' THEN
		...
		streetaxis2_id=NEW.ex_streetaxis2_id, postcode=NEW.ex_postcode, postnumber=NEW.ex_postnumber,postnumber2=NEW.ex_postnumber2,descript=NEW.ex_descript, verified=NEW.verified, undelete=NEW.undelete, label_x=NEW.ex_label_x, 
	...
	ELSIF man_table ='man_flexunion' THEN
		...
		streetaxis_id=NEW.fu_streetaxis_id, streetaxis2_id=NEW.fu_streetaxis2_id,postcode=NEW.fu_postcode, postnumber=NEW.fu_postnumber,postnumber2=NEW.fu_postnumber2, descript=NEW.fu_descript, verified=NEW.verified, 
	...
	ELSIF man_table ='man_netelement' THEN
		...
		streetaxis_id=NEW.ne_streetaxis_id, streetaxis2_id=NEW.ne_streetaxis2_id,postcode=NEW.ne_postcode, postnumber=NEW.ne_postnumber,postnumber2=NEW.ne_postnumber2, descript=NEW.ne_descript, verified=NEW.verified, 
	...
	ELSIF man_table ='man_netsamplepoint' THEN
		...
		muni_id=NEW.ns_muni_id, streetaxis_id=NEW.ns_streetaxis_id, streetaxis2_id=NEW.ns_streetaxis2_id,postcode=NEW.ns_postcode, postnumber=NEW.ns_postnumber,postnumber2=NEW.ns_postnumber2, descript=NEW.ns_descript,
	...
	ELSIF man_table ='man_wtp' THEN		
		...
		UPDATE node
			...
			streetaxis_id=NEW.wt_streetaxis_id, streetaxis2_id=NEW.wt_streetaxis2_id, postcode=NEW.wt_postcode, postnumber=NEW.wt_postnumber,postnumber2=NEW.wt_postnumber2,descript=NEW.wt_descript, verified=NEW.verified, 
	...
	ELSIF man_table ='man_filter' THEN
		...
		UPDATE node
			...
			streetaxis_id=NEW.fl_streetaxis_id, streetaxis2_id=NEW.fl_streetaxis2_id, postcode=NEW.fl_postcode, postnumber=NEW.fl_postnumber,postnumber2=NEW.fl_postnumber2, descript=NEW.fl_descript,
...
DROP TRIGGER IF EXISTS gw_trg_edit_man_hydrant ON "ws".v_edit_man_hydrant;
CREATE TRIGGER gw_trg_edit_man_hydrant INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_hydrant FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_hydrant');

DROP TRIGGER IF EXISTS gw_trg_edit_man_pump ON "ws".v_edit_man_pump;
CREATE TRIGGER gw_trg_edit_man_pump INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_pump FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_pump');

DROP TRIGGER IF EXISTS gw_trg_edit_man_manhole ON "ws".v_edit_man_manhole;
CREATE TRIGGER gw_trg_edit_man_manhole INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_manhole FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_manhole');

DROP TRIGGER IF EXISTS gw_trg_edit_man_source ON "ws".v_edit_man_source;
CREATE TRIGGER gw_trg_edit_man_source INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_source FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_source');

DROP TRIGGER IF EXISTS gw_trg_edit_man_meter ON "ws".v_edit_man_meter;
CREATE TRIGGER gw_trg_edit_man_meter INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_meter FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_meter');

DROP TRIGGER IF EXISTS gw_trg_edit_man_tank ON "ws".v_edit_man_tank;
CREATE TRIGGER gw_trg_edit_man_tank INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_tank FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_tank');

DROP TRIGGER IF EXISTS gw_trg_edit_man_tank_pol ON "ws".v_edit_man_tank_pol;
CREATE TRIGGER gw_trg_edit_man_tank_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_tank_pol FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_tank_pol');

DROP TRIGGER IF EXISTS gw_trg_edit_man_junction ON "ws".v_edit_man_junction;
CREATE TRIGGER gw_trg_edit_man_junction INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_junction FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_junction');

DROP TRIGGER IF EXISTS gw_trg_edit_man_waterwell ON "ws".v_edit_man_waterwell;
CREATE TRIGGER gw_trg_edit_man_waterwell INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_waterwell FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_waterwell');

DROP TRIGGER IF EXISTS gw_trg_edit_man_reduction ON "ws".v_edit_man_reduction;
CREATE TRIGGER gw_trg_edit_man_reduction INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_reduction FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_reduction');

DROP TRIGGER IF EXISTS gw_trg_edit_man_valve ON "ws".v_edit_man_valve;
CREATE TRIGGER gw_trg_edit_man_valve INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_valve FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_valve');

DROP TRIGGER IF EXISTS gw_trg_edit_man_filter ON "ws".v_edit_man_filter;
CREATE TRIGGER gw_trg_edit_man_filter INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_filter FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_filter');

DROP TRIGGER IF EXISTS gw_trg_edit_man_register ON "ws".v_edit_man_register;
CREATE TRIGGER gw_trg_edit_man_register INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_register FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_register');

DROP TRIGGER IF EXISTS gw_trg_edit_man_register_pol ON "ws".v_edit_man_register_pol;
CREATE TRIGGER gw_trg_edit_man_register_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_register_pol FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_register_pol');

DROP TRIGGER IF EXISTS gw_trg_edit_man_netwjoin ON "ws".v_edit_man_netwjoin;
CREATE TRIGGER gw_trg_edit_man_netwjoin INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_netwjoin FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_netwjoin');

DROP TRIGGER IF EXISTS gw_trg_edit_man_expansiontank ON "ws".v_edit_man_expansiontank;
CREATE TRIGGER gw_trg_edit_man_expansiontank INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_expansiontank FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_expansiontank');

DROP TRIGGER IF EXISTS gw_trg_edit_man_flexunion ON "ws".v_edit_man_flexunion;
CREATE TRIGGER gw_trg_edit_man_flexunion INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_flexunion FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_flexunion');

DROP TRIGGER IF EXISTS gw_trg_edit_man_netsamplepoint ON "ws".v_edit_man_netsamplepoint;
CREATE TRIGGER gw_trg_edit_man_netsamplepoint INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_netsamplepoint FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_netsamplepoint');

DROP TRIGGER IF EXISTS gw_trg_edit_man_netelement ON "ws".v_edit_man_netelement;
CREATE TRIGGER gw_trg_edit_man_netelement INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_netelement FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_netelement');

DROP TRIGGER IF EXISTS gw_trg_edit_man_wtp ON "ws".v_edit_man_wtp;
CREATE TRIGGER gw_trg_edit_man_wtp INSTEAD OF INSERT OR DELETE OR UPDATE ON "ws".v_edit_man_wtp FOR EACH ROW EXECUTE PROCEDURE "ws".gw_trg_edit_man_node('man_wtp');
