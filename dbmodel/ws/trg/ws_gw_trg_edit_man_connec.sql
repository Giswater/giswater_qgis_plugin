    ...
    IF TG_OP = 'INSERT' THEN
 	...
 	--Exploitation ID
		...
		--Copy id to code field
		  ...
		  INSERT INTO connec (connec_id, code, elevation, "depth",connecat_id,  sector_id, customer_code, demand, "state", state_type, annotation, observ, "comment",dma_id, presszonecat_id, soilcat_id, function_type, category_type, fluid_type, location_type, 
		  ...
		  expl_id, publish, inventory,num_value, connec_length) 
		  VALUES (NEW.connec_id, NEW.greentap_code, NEW.greentap_elevation, NEW.greentap_depth, NEW.connecat_id, NEW.sector_id, NEW.greentap_customer_code,  NEW.greentap_demand, NEW."state", NEW.state_type, NEW.greentap_annotation, 
		  ...
		  expl_id_int, NEW.publish, NEW.inventory, NEW.greentap_num_value, NEW.greentap_connec_length);
		...
		--Copy id to code field
		  ...
		  workcat_id, workcat_id_end, buildercat_id, builtdate, enddate, ownercat_id, address_01, address_02, address_03, streetaxis_id, postnumber, descript, rotation,verified, the_geom, undelete,label_x,label_y,label_rotation, 
		  expl_id, publish, inventory,num_value, connec_length) 
		  VALUES (NEW.connec_id, NEW.fountain_code, NEW.fountain_elevation, NEW.fountain_depth, NEW.connecat_id, NEW.sector_id, NEW.fountain_customer_code, NEW.fountain_demand, NEW."state", NEW.state_type, NEW.fountain_annotation, 
		  ...
		  expl_id_int, NEW.publish, NEW.inventory, NEW.fountain_num_value, NEW.fountain_connec_length);
		...
		ELSIF man_table='man_fountain_pol' THEN
				...
				INSERT INTO connec(connec_id, code, elevation, "depth",connecat_id,  sector_id,customer_code, demand, "state", state_type, annotation, observ, "comment",dma_id, presszonecat_id, soilcat_id, function_type, category_type, fluid_type, location_type, 
				  ...
				  expl_id_int, NEW.publish, NEW.inventory, NEW.fountain_num_value, NEW.connec_length);
		...
		ELSIF man_table='man_tap' THEN
		  ...
		  INSERT INTO connec(connec_id, code, elevation, "depth",connecat_id,  sector_id, customer_code, demand, "state", state_type, annotation, observ, "comment",dma_id, presszonecat_id, soilcat_id, function_type, category_type, fluid_type, 
		  ...
		  expl_id, publish, inventory,num_value, connec_length) 
		  VALUES (NEW.connec_id, NEW.tap_code, NEW.tap_elevation, NEW.tap_depth, NEW.connecat_id, NEW.sector_id, NEW.tap_customer_code, NEW.tap_demand, NEW."state", NEW.state_type, NEW.tap_annotation, NEW.tap_observ, 
		  ...
		  NEW.verified, NEW.the_geom, NEW.undelete, NEW.tap_label_x,NEW.tap_label_y,NEW.tap_label_rotation, expl_id_int, NEW.publish, NEW.inventory, NEW.tap_num_value, NEW.connec_length);
		...
		--Copy id to code field
		  ...
		  location_type, workcat_id, workcat_id_end, buildercat_id, builtdate,enddate, ownercat_id, address_01, address_02, address_03, streetaxis_id, postnumber, descript,rotation,verified, the_geom,undelete, label_x,label_y,label_rotation,
		  expl_id, publish, inventory, num_value, connec_length) 
		  VALUES (NEW.connec_id, NEW.wjoin_code, NEW.wjoin_elevation, NEW.wjoin_depth, NEW.connecat_id, NEW.sector_id, NEW.wjoin_customer_code,  NEW.wjoin_demand, NEW."state", NEW.state_type, NEW.wjoin_annotation, NEW.wjoin_observ, 
		  ...
		  NEW.the_geom, NEW.undelete, NEW.wjoin_label_x,NEW.wjoin_label_y,NEW.wjoin_label_rotation, expl_id_int, NEW.publish, NEW.inventory, NEW.wjoin_num_value, NEW.connec_length); 
...
*/
        ...
        IF man_table ='man_greentap' THEN
			...
			demand=NEW.greentap_demand, "state"=NEW."state", state_type=NEW.state_type, annotation=NEW.greentap_annotation, observ=NEW.greentap_observ, "comment"=NEW.greentap_comment, rotation=NEW.greentap_rotation,dma_id=NEW.dma_id, presszonecat_id=NEW.presszonecat_id,
			...
			the_geom=NEW.the_geom, undelete=NEW.undelete, label_x=NEW.greentap_label_x,label_y=NEW.greentap_label_y, label_rotation=NEW.greentap_label_rotation,
			 publish=NEW.publish, inventory=NEW.inventory, expl_id=NEW.expl_id, num_value=NEW.greentap_num_value, connec_length=NEW.greentap_connec_length
        ...
        ELSIF man_table ='man_wjoin' THEN
			...
			demand=NEW.wjoin_demand, "state"=NEW."state", state_type=NEW.state_type, annotation=NEW.wjoin_annotation, observ=NEW.wjoin_observ, "comment"=NEW.wjoin_comment, rotation=NEW.wjoin_rotation,dma_id=NEW.dma_id, presszonecat_id=NEW.presszonecat_id,
			...
			streetaxis_id=NEW.wjoin_streetaxis_id, postnumber=NEW.wjoin_postnumber, descript=NEW.wjoin_descript, verified=NEW.verified, the_geom=NEW.the_geom, undelete=NEW.undelete, label_x=NEW.wjoin_label_x,label_y=NEW.wjoin_label_y, label_rotation=NEW.wjoin_label_rotation, publish=NEW.publish, inventory=NEW.inventory, expl_id=NEW.expl_id, num_value=NEW.wjoin_num_value, connec_length=NEW.wjoin_connec_length
			WHERE connec_id=OLD.connec_id;
		...
		ELSIF man_table ='man_tap' THEN
			UPDATE connec 
			SET connec_id=NEW.connec_id, code=NEW.tap_code, elevation=NEW.tap_elevation, "depth"=NEW.tap_depth, connecat_id=NEW.connecat_id, sector_id=NEW.sector_id, customer_code=NEW.tap_customer_code, demand=NEW.tap_demand, 
			...
			streetaxis_id=NEW.tap_streetaxis_id, postnumber=NEW.tap_postnumber, descript=NEW.tap_descript, verified=NEW.verified, the_geom=NEW.the_geom, undelete=NEW.undelete, label_x=NEW.tap_label_x,
			label_y=NEW.tap_label_y, label_rotation=NEW.tap_label_rotation, publish=NEW.publish, inventory=NEW.inventory, expl_id=NEW.expl_id, num_value=NEW.tap_num_value, connec_length=NEW.tap_connec_length
			WHERE connec_id=OLD.connec_id;
        ...
        ELSIF man_table ='man_fountain' THEN
			...
			demand=NEW.fountain_demand, "state"=NEW."state", state_type=NEW.state_type, annotation=NEW.fountain_annotation, observ=NEW.fountain_observ, "comment"=NEW.fountain_comment, rotation=NEW.fountain_rotation,dma_id=NEW.dma_id, 
		    ...
		    publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.fountain_enddate, expl_id=NEW.expl_id, num_value=NEW.fountain_num_value, connec_length=NEW.fountain_connec_length
			WHERE connec_id=OLD.connec_id;
        ...
        ELSIF man_table ='man_fountain_pol' THEN
            UPDATE connec 
			SET connec_id=NEW.connec_id, code=NEW.fountain_code, elevation=NEW.fountain_elevation, "depth"=NEW.fountain_depth, connecat_id=NEW.connecat_id, sector_id=NEW.sector_id, customer_code=NEW.fountain_customer_code, 
			demand=NEW.fountain_demand, "state"=NEW."state", state_type=NEW.state_type, annotation=NEW.fountain_annotation, observ=NEW.fountain_observ, "comment"=NEW.fountain_comment, rotation=NEW.fountain_rotation,dma_id=NEW.dma_id, presszonecat_id=NEW.presszonecat_id,
