...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
 	...
 	--Exploitation ID
		...
		--Copy id to code field
		  ...
		  NEW.greentap_buildercat_id, NEW.greentap_builtdate,NEW.greentap_ownercat_id, NEW.greentap_address_01, NEW.greentap_address_02, NEW.greentap_address_03, NEW.greentap_streetname, NEW.greentap_postnumber, 
		  ...
		  expl_id_int, NEW.publish, NEW.inventory, NEW.greentap_enddate );
		...
		--Copy id to code field
		  ...
		  NEW.fountain_buildercat_id, NEW.fountain_builtdate,NEW.fountain_ownercat_id, NEW.fountain_address_01, NEW.fountain_address_02, NEW.fountain_address_03, NEW.fountain_streetname, NEW.fountain_postnumber, 
		  ...
		  expl_id_int, NEW.publish, NEW.inventory, NEW.fountain_enddate);
		...
		ELSIF man_table='man_tap' THEN
		  ...
		  location_type, workcat_id, buildercat_id, builtdate,ownercat_id, address_01, address_02, address_03, streetaxis_id, postnumber,descript,link,verified, the_geom,undelete,workcat_id_end,label_x,label_y,label_rotation, 
		  expl_id, publish, inventory, enddate) 
		  ...
		  NEW.tap_ownercat_id, NEW.tap_address_01, NEW.tap_address_02, NEW.tap_address_03, NEW.tap_streetname, NEW.tap_postnumber, NEW.tap_descript, NEW.tap_link, NEW.verified, NEW.the_geom, NEW.undelete,NEW.tap_workcat_id_end,  NEW.tap_label_x,NEW.tap_label_y,NEW.tap_label_rotation, expl_id_int, NEW.publish, NEW.inventory, NEW.tap_enddate);
		...
		--Copy id to code field
		  ...
		  NEW.wjoin_builtdate,NEW.wjoin_ownercat_id, NEW.wjoin_address_01, NEW.wjoin_address_02, NEW.wjoin_address_03, NEW.wjoin_streetname, NEW.wjoin_postnumber, NEW.wjoin_descript, NEW.wjoin_link, NEW.verified, 
		  NEW.the_geom, NEW.undelete, NEW.wjoin_workcat_id_end,NEW.wjoin_label_x,NEW.wjoin_label_y,NEW.wjoin_label_rotation, expl_id_int, NEW.publish, NEW.inventory, NEW.wjoin_enddate); 
    ...
    -- UPDATE management values
        ...
        IF man_table ='man_greentap' THEN
			...
			buildercat_id=NEW.greentap_buildercat_id, builtdate=NEW.greentap_builtdate,ownercat_id=NEW.greentap_ownercat_id, address_01=NEW.greentap_address_01, address_02=NEW.greentap_address_02, 
			address_03=NEW.greentap_address_03, streetaxis_id=NEW.greentap_streetaxis_id, postnumber=NEW.greentap_postnumber, descript=NEW.greentap_descript, link=NEW.greentap_link, verified=NEW.verified, 
			the_geom=NEW.the_geom, undelete=NEW.undelete,workcat_id_end=NEW.greentap_workcat_id_end, label_x=NEW.greentap_label_x,label_y=NEW.greentap_label_y, label_rotation=NEW.greentap_label_rotation,
			 publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.greentap_enddate,expl_id=NEW.expl_id
        ...
        ELSIF man_table ='man_wjoin' THEN
			...
			buildercat_id=NEW.wjoin_buildercat_id, builtdate=NEW.wjoin_builtdate,ownercat_id=NEW.wjoin_ownercat_id, address_01=NEW.wjoin_address_01, address_02=NEW.wjoin_address_02, address_03=NEW.wjoin_address_03, 
			...
			enddate=NEW.wjoin_enddate, expl_id=NEW.expl_id
			WHERE connec_id=OLD.connec_id;
		...
		ELSIF man_table ='man_tap' THEN
			...
			ownercat_id=NEW.tap_ownercat_id, address_01=NEW.tap_address_01, address_02=NEW.tap_address_02, address_03=NEW.tap_address_03, streetaxis_id=NEW.tap_streetaxis_id, postnumber=NEW.tap_postnumber, descript=NEW.tap_descript, link=NEW.tap_link, verified=NEW.verified, the_geom=NEW.the_geom, undelete=NEW.undelete, workcat_id_end=NEW.tap_workcat_id_end,label_x=NEW.tap_label_x,
			label_y=NEW.tap_label_y, label_rotation=NEW.tap_label_rotation, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.tap_enddate, expl_id=NEW.expl_id
			WHERE connec_id=OLD.connec_id;
        ...
        ELSIF man_table ='man_fountain' THEN
		    ...
		    publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.fountain_enddate, expl_id=NEW.expl_id
			WHERE connec_id=OLD.connec_id;
