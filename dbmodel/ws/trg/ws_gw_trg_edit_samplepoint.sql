...
-- FEATURE INSERT      
				...
				INSERT INTO samplepoint (sample_id, code, lab_code, feature_id, featurecat_id, dma_id, presszonecat_id, "state", builtdate, enddate, workcat_id, workcat_id_end, rotation, muni_id, streetaxis_id, postnumber, streetaxis_add, place_name, cabinet, observations, the_geom, expl_id, verified)
				VALUES (NEW.sample_id, NEW.code, NEW.lab_code, NEW.feature_id, NEW.featurecat_id,  NEW.dma_id, NEW.presszonecat_id, NEW."state", NEW.builtdate, NEW.enddate, NEW.workcat_id, NEW.workcat_id_end, NEW.muni_id, NEW.streetaxis_id, NEW.postnumber, NEW.streetaxis_add,
...
-- UPDATE
    ...
    ELSIF TG_OP = 'UPDATE' THEN
			...
			UPDATE samplepoint 
			SET sample_id=NEW.sample_id,  code=NEW.code,lab_code=NEW.lab_code,  feature_id=NEW.feature_id, featurecat_id=NEW.featurecat_id, dma_id=NEW.dma_id, presszonecat_id=NEW.presszonecat_id,"state"=NEW."state", rotation=NEW.rotation, builtdate=NEW.builtdate, enddate=NEW.enddate,
