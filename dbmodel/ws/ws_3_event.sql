...
"state" varchar(16) COLLATE "default",
"observ" varchar (512) COLLATE "default",
"date" timestamp(6) DEFAULT now(),
...
ALTER TABLE "SCHEMA_NAME"."event_x_junction" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_tank" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_hydrant" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_pump" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_valve" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_filter" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_register" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_manhole" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "SCHEMA_NAME"."event_x_cover" ADD FOREIGN KEY ("state") REFERENCES "SCHEMA_NAME"."event_value" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
