  ...
  --Insert Catalog of visit
    INSERT INTO om_visit_cat (id, name, startdate, enddate) VALUES(1, 'Test', now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM() * 5)));
        ...
        LOOP
            ...
            --Insert visit
            INSERT INTO om_visit (visitcat_id, startdate, enddate, expl_id, cur_user, the_geom, status) VALUES(1, now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM() * 5)), rec_node.expl_id, 'demo_user', rec_node.the_geom, 4) RETURNING id INTO id_last;
	...
	FOR rec_arc IN SELECT * FROM arc WHERE state=1
        LOOP
            ...
            --Insert visit
            INSERT INTO om_visit (visitcat_id, startdate, enddate, expl_id, cur_user, status) VALUES(1, now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM() * 5)), rec_arc.expl_id, 'demo_user', 4) RETURNING id INTO id_last;
        ...
        LOOP
            ...
            --Insert visit
            INSERT INTO om_visit (visitcat_id, startdate, enddate, expl_id, cur_user, the_geom, status) VALUES(1, now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM() * 5)),  rec_connec.expl_id, 'demo_user', rec_connec.the_geom, 4) RETURNING id INTO id_last;
