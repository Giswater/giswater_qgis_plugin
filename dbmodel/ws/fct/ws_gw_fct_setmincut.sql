...
BEGIN
	...
	IF v_mincut_version = 6 THEN 
		-- NEW mincut version using pgrouting functions

		/*
			v_action: mincutNetwork, mincutValveUnaccess, mincutAccept, mincutCancel, mincutDelete
		*/
