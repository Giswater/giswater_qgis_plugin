-- Function: gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying)

-- DROP FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying);
...
--        Mincut fields
        ...
        json_array[5] := gw_fct_createcombojson('Assigned to', 'assigned_to', 'combo', 'string', '', v_state0, 'cat_users','id','name',mincut_data.assigned_to, 'WHERE (active = TRUE AND external=FALSE) OR (active IS NULL AND external=FALSE) OR (active IS NULL AND external IS NULL)');
...
--        Return defaults
        ...
        json_array[5] := gw_fct_createcombojson('Assignat a', 'assigned_to', 'combo', 'string', '', v_state0, 'cat_users','id','name',v_mincut_new_assigned, 'WHERE (active = TRUE AND external=FALSE) OR (active IS NULL AND external=FALSE) OR (active IS NULL AND external IS NULL)');
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying)
  OWNER TO bgeoadmin;
GRANT EXECUTE ON FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying) TO public;
GRANT EXECUTE ON FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying) TO bgeoadmin;
GRANT EXECUTE ON FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying) TO role_basic;
GRANT EXECUTE ON FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying) TO qgisserver;
GRANT EXECUTE ON FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying) TO test;
GRANT EXECUTE ON FUNCTION SCHEMA_NAME.gw_fct_getmincut(double precision, double precision, integer, integer, integer, character varying, character varying) TO role_admin;
