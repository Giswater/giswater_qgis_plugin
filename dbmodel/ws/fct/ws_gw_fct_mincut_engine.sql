    ...
    WHILE (array_length(stack, 1) > 0) LOOP
        ...
        IF node_id_arg IS NULL THEN
          EXECUTE 'SELECT gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
            "data":{"message":"3006", "function":"2306","debug_msg":null, "function_type":true}}$$);';
        END IF;
	    ...
	    SELECT COUNT(*) INTO controlValue FROM config_graph_inlet WHERE active IS TRUE AND  node_id = node_id_arg;
