...
BEGIN
	...
	CREATE TEMP TABLE temp_t_t_go2epa (LIKE SCHEMA_NAME.temp_go2epa INCLUDING ALL);


	RAISE NOTICE 'vnodetrimarcs 2 - insert node_1 (locate 0 & 1)';
	INSERT INTO temp_t_t_go2epa (arc_id, vnode_id, locate, elevation)
