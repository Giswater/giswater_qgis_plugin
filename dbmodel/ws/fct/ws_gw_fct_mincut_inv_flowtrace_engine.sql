...
DROP FUNCTION IF EXISTS ws.gw_fct_mincut_inverted_engine(character varying, integer);
CREATE OR REPLACE FUNCTION ws.gw_fct_mincut_inverted_engine(    node_id_arg character varying,    result_id_arg integer)
RETURNS void AS
$BODY$
DECLARE
