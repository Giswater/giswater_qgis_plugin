...
BEGIN
	...
	v_query_text = 'SELECT temp_t_arc.arc_id, temp_t_arc.node_1, the_geom, curve_id FROM temp_t_arc
			JOIN inp_pump a ON concat(node_id,''_n2a'')=code WHERE epa_type=''PUMP'' AND pump_type = ''HEADPUMP''';
	...
	LOOP
		...
		v_record.node_id = concat (reverse(substring(reverse(v_record.code),2)), '3');
		...
		v_record_a1.arc_id = v_record_a1.arc_id;
		v_record_a1.code = concat (v_record_a1.arc_id, '_4');
		...
		INSERT INTO temp_t_arc	(result_id, arc_id, code, node_1, node_2, arc_type, arccat_id, epa_type, sector_id, state, state_type, annotation, diameter, roughness, length, status, the_geom,
		expl_id, flw_code, addparam, dma_id, presszone_id, dqa_id, minsector_id)
		VALUES(v_record_a1.result_id, v_record_a1.arc_id, v_record_a1.code, v_record_a1.node_1, v_record_a1.node_2, v_record_a1.arc_type, v_record_a1.arccat_id, v_record_a1.epa_type, v_record_a1.sector_id,
		...
		v_record_a2.arc_id = v_record_a2.arc_id;
		v_record_a2.code = concat (v_record_a2.arc_id, '_5');
		...
		INSERT INTO temp_t_arc	(result_id, arc_id, code, node_1, node_2, arc_type, arccat_id, epa_type, sector_id, state, state_type, annotation, diameter, roughness, length, status, the_geom,
		expl_id, flw_code, addparam, dma_id, presszone_id, dqa_id, minsector_id)
		VALUES(v_record_a2.result_id, v_record_a2.arc_id, v_record_a2.code, v_record_a2.node_1, v_record_a2.node_2, v_record_a2.arc_type, v_record_a2.arccat_id, v_record_a2.epa_type, v_record_a2.sector_id,
	...
	v_query_text = 'SELECT temp_t_arc.arc_id, temp_t_arc.node_1, the_geom, curve_id FROM temp_t_arc
			JOIN inp_valve a ON concat(node_id,''_n2a'')=code WHERE epa_type=''VALVE'' AND valve_type = ''PSRV''';
	...
	LOOP
		...
		INSERT INTO temp_t_arc (result_id, arc_id, code, node_1, node_2, arc_type, arccat_id, epa_type, sector_id, state, state_type, annotation,
		...
		INSERT INTO temp_t_arc (result_id, arc_id, code, node_1, node_2, arc_type, arccat_id, epa_type, sector_id, state, state_type, annotation,
		diameter, roughness, length, status, the_geom, expl_id, flw_code, addparam, dma_id, presszone_id, dqa_id, minsector_id)
		VALUES(v_record_a2.result_id, v_record_a2.arc_id, v_record_a2.code, v_record_a2.node_1, v_record_a2.node_2, v_record_a2.arc_type, v_record_a2.arccat_id, v_record_a2.epa_type,
