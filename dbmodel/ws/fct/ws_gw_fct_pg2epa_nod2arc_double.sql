...
BEGIN
	...
	v_query_text = 'SELECT rpt_inp_arc.arc_id, rpt_inp_arc.node_1, the_geom, curve_id FROM rpt_inp_arc
	...
	LOOP
		...
		INSERT INTO rpt_inp_arc	(result_id, arc_id, node_1, node_2, arc_type, arccat_id, epa_type, sector_id, state, state_type, annotation, diameter, roughness, length, status, the_geom, expl_id, flw_code, addparam)
