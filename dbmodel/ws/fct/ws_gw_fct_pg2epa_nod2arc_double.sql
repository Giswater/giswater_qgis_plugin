...
BEGIN
	...
	LOOP
		...
		the_geom, expl_id, pattern_id, dma_id, presszone_id, dqa_id, minsector_id, builtdate, family)
		...
		v_record.pattern_id, v_record.dma_id, v_record.presszone_id, v_record.dqa_id, v_record.minsector_id, v_record.builtdate, v_record.family);
		...
		v_record_a1.addparam = concat('{"setting":0.01, "valve_type":"PRV"}');
		...
		expl_id, flw_code, addparam, dma_id, presszone_id, dqa_id, minsector_id, builtdate, family)
		...
		v_record_a1.expl_id, v_record_a1.flw_code, v_record_a1.addparam, v_record_a1.dma_id, v_record_a1.presszone_id, v_record_a1.dqa_id, v_record_a1.minsector_id, v_record_a1.builtdate, v_record_a1.family);
		...
		v_record_a2.expl_id, v_record_a2.flw_code, v_record_a2.addparam, v_record_a2.dma_id, v_record_a2.presszone_id, v_record_a2.dqa_id, v_record_a2.minsector_id, v_record_a2.builtdate, v_record_a2.family);
	...
	LOOP
		...
		pattern_id, dma_id, presszone_id, dqa_id, minsector_id, builtdate, family)
		...
		v_record.state_type, v_record.annotation, v_record.demand, v_record.the_geom, v_record.expl_id, v_record.pattern_id, v_record.dma_id, v_record.presszone_id, v_record.dqa_id, v_record.minsector_id, v_record.builtdate, v_record.family);
		...
		diameter, roughness, length, status, the_geom, expl_id, flw_code, addparam, dma_id, presszone_id, dqa_id, minsector_id, builtdate, family)
		VALUES(v_record_a1.result_id, v_record_a1.arc_id, v_record_a1.node_1, v_record_a1.node_2, v_record_a1.arc_type, v_record_a1.arccat_id, v_record_a1.epa_type, v_record_a1.sector_id,
		v_record_a1.state, v_record_a1.state_type, v_record_a1.annotation, v_record_a1.diameter, v_record_a1.roughness, v_record_a1.length, v_record_a1.status, v_record_a1.the_geom,
		v_record_a1.expl_id, v_record_a1.flw_code, v_record_a1.addparam, v_record_a1.dma_id, v_record_a1.presszone_id, v_record_a1.dqa_id, v_record_a1.minsector_id, v_record_a1.builtdate, v_record_a1.family);
		...
		v_record_a2.status, v_record_a2.the_geom, v_record_a2.expl_id, v_record_a2.flw_code, v_record_a2.addparam, v_record_a2.dma_id, v_record_a2.presszone_id, v_record_a2.dqa_id, v_record_a2.minsector_id, v_record_a2.builtdate, v_record_a2.family);
