...
BEGIN
	...
	IF v_count > 0 THEN
		...
		VALUES (v_fid, 3, '107', concat('ERROR: ',v_count,' node''s orphans with epa_type and state_type ready to work, will not exported because any arcs are connected. Take a look on temporal for details.'),v_count);
	ELSE
		INSERT INTO audit_check_data (fid, criticity, result_id,  error_message, fcount)
