...
BEGIN
    ...
    -- Clear tables
    DELETE FROM anl_ws_topological_consistency;
    DELETE FROM anl_ws_geometrical_consistency;

    -- Check number of connected pipes to node depending on node type
    INSERT INTO anl_ws_topological_consistency (node_id, node_type, num_arcs, the_geom)
   ...
   -- Check diameters
    INSERT INTO anl_ws_geometrical_consistency (node_id, node_type, node_dnom, num_arcs, arc_dnom1, arc_dnom2, the_geom)
    ...
    INSERT INTO anl_ws_geometrical_consistency (node_id, node_type, node_dnom, num_arcs, arc_dnom1, arc_dnom2, arc_dnom3, the_geom)
    ...
    INSERT INTO anl_ws_geometrical_consistency (node_id, node_type, node_dnom, num_arcs, arc_dnom1, arc_dnom2, arc_dnom3, arc_dnom4, the_geom)
