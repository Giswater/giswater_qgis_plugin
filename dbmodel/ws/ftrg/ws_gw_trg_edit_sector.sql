...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO sector (sector_id, name, descript, macrosector_id, the_geom, undelete, graphconfig, stylesheet, active, parent_id, pattern_id, avg_press, expl_id2)
		VALUES (NEW.sector_id, NEW.name, NEW.descript, NEW.macrosector_id, NEW.the_geom, NEW.undelete, 
		NEW.graphconfig::json, NEW.stylesheet::json, NEW.active, NEW.parent_id, NEW.pattern_id, NEW.avg_press, NEW.expl_id2);
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		lastupdate=now(), lastupdate_user = current_user, avg_press = NEW.avg_press, expl_id2 = NEW.expl_id2
