...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO sector (sector_id, name, muni_id, expl_id, descript, macrosector_id, the_geom, undelete, graphconfig, stylesheet, active, parent_id, pattern_id, avg_press)
		VALUES (NEW.sector_id, NEW.name, NEW.muni_id, NEW.expl_id, NEW.descript, NEW.macrosector_id, NEW.the_geom, NEW.undelete,
		NEW.graphconfig::json, NEW.stylesheet::json, NEW.active, NEW.parent_id, NEW.pattern_id, NEW.avg_press);

	ELSIF TG_OP = 'UPDATE' THEN

		UPDATE sector
		SET sector_id=NEW.sector_id, name=NEW.name, muni_id=NEW.muni_id, expl_id=NEW.expl_id, descript=NEW.descript, macrosector_id=NEW.macrosector_id, the_geom=NEW.the_geom,
