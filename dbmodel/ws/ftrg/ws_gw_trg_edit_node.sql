...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		om_state, conserv_state, access_type, placement_type, expl_id2, brand_id, model_id, serial_number, label_quadrant, streetname, streetname2, pavcat_id)
		...
		NEW.om_state, NEW.conserv_state, NEW.access_type, NEW.placement_type, NEW.expl_id2, NEW.brand_id, NEW.model_id, NEW.serial_number, NEW.label_quadrant, NEW.streetname, NEW.streetname2, NEW.pavcat_id);
	...
	-- static pressure
	  ...
	  IF (NEW.nodecat_id != OLD.nodecat_id) THEN
		...
		brand_id=NEW.brand_id, model_id=NEW.model_id, serial_number=NEW.serial_number, label_quadrant=NEW.label_quadrant, streetname = NEW.streetname, streetname2 = NEW.streetname2, pavcat_id = NEW.pavcat_id
