...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		om_state, conserv_state, access_type, placement_type, expl_id2, brand_id, model_id)
		...
		NEW.om_state, NEW.conserv_state, NEW.access_type, NEW.placement_type, NEW.expl_id2, NEW.brand_id, NEW.model_id);
	...
	-- static pressure
	  ...
	  IF (NEW.nodecat_id != OLD.nodecat_id) THEN
		...
		brand_id=NEW.brand_id, model_id=NEW.model_id
