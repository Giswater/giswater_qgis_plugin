...
BEGIN
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		stylesheet = NEW.stylesheet::json, avg_press=NEW.avg_press, macrodma_id = (SELECT macrodma_id FROM macrodma WHERE name = NEW.macrodma), lastupdate=now(), lastupdate_user = current_user
