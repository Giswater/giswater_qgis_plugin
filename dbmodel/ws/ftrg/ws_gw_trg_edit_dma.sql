...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		VALUES (NEW.dma_id, NEW.name, NEW.descript, v_mapzone_id, NEW.undelete, NEW.expl_id, NEW.pattern_id, NEW.link,
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		UPDATE dma
		SET dma_id=NEW.dma_id, name=NEW.name, descript=NEW.descript, undelete=NEW.undelete, macrodma_id=v_mapzone_id, expl_id=NEW.expl_id,
