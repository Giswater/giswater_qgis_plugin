...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO dma (dma_id, name, descript,  macrodma_id, the_geom, undelete, expl_id, pattern_id, link, minc, maxc, effc, graphconfig, stylesheet, active, avg_press, expl_id2)
		...
		NEW.maxc, NEW.effc, NEW.graphconfig::json, NEW.stylesheet::json, NEW.active, NEW.avg_press, NEW.expl_id2);
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		stylesheet = NEW.stylesheet::json, active=NEW.active, avg_press=NEW.avg_press, macrodma_id = NEW.macrodma_id, lastupdate=now(), lastupdate_user = current_user, expl_id2 = NEW.expl_id2
