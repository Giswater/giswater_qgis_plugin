...
BEGIN
	...
	-- Dma ID
		...
		the_geom, undelete, label_x,label_y,label_rotation, expl_id, publish, inventory,num_value, connec_length, arc_id, lastupdate, lastupdate_user, minsector_id, dqa_id, staticpressure) 
		...
		NEW.label_y,NEW.label_rotation,  NEW.expl_id, NEW.publish, NEW.inventory, NEW.num_value, NEW.connec_length, NEW.arc_id, now(), current_user, NEW.minsector_id, NEW.dqa_id, NEW.staticpressure);
