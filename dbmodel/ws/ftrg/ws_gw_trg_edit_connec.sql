...
BEGIN
	...
	-- Dma ID
		...
		expl_id, publish, inventory,num_value, connec_length, arc_id, lastupdate, lastupdate_user) 
        ...
        NEW.label_y,NEW.label_rotation,  NEW.expl_id, NEW.publish, NEW.inventory, NEW.num_value, NEW.connec_length, NEW.arc_id, now(), current_user);
