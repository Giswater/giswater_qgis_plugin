...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO dqa (dqa_id, name, expl_id, macrodqa_id, descript, undelete, the_geom, pattern_id, dqa_type, link, graphconfig, stylesheet,active, avg_press, expl_id2)
		...
		NEW.link, NEW.graphconfig::json, NEW.stylesheet::json, NEW.active, NEW.avg_press, NEW.expl_id2);
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		stylesheet = NEW.stylesheet::json, active=NEW.active, lastupdate=now(), lastupdate_user = current_user, avg_press = NEW.avg_press, expl_id2 = NEW.expl_id2
