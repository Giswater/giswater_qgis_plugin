...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO inp_dscenario_demand (feature_id, demand, pattern_id, demand_type, dscenario_id, feature_type) 
		VALUES (NEW.feature_id, NEW.demand, NEW.pattern_id, NEW.demand_type, NEW.dscenario_id, NEW.feature_type);
		RETURN NEW;
