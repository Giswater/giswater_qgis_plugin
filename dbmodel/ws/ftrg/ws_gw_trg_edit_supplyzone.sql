...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO supplyzone (supplyzone_id, name, descript, macrosector_id, supplyzone_type, graphconfig, stylesheet, parent_id, pattern_id, avg_press, link, muni_id, expl_id, lock_level)
