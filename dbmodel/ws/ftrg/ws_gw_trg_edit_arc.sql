...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		mincut_length, mincut_watervol, mincut_criticality, hydraulic_criticality, pipe_capacity, mincut_impact, mincut_affectation)
		VALUES (NEW.arc_id, NEW.result_id, NEW.flow_max, NEW.flow_min, NEW.flow_avg, NEW.vel_max, NEW.vel_min, NEW.vel_avg,
		NEW.tot_headloss_max, NEW.tot_headloss_min, NEW.mincut_connecs, NEW.mincut_hydrometers, NEW.mincut_length, NEW.mincut_watervol, NEW.mincut_criticality, NEW.hydraulic_criticality, NEW.pipe_capacity, NEW.mincut_impact, NEW.mincut_affectation);
    ...
    ELSIF TG_OP = 'UPDATE' THEN
		...
		mincut_impact = NEW.mincut_impact, mincut_affectation = NEW.mincut_affectation
		WHERE arc_id = OLD.arc_id;
