...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		-- FEATURE INSERT
		INSERT INTO arc (arc_id, code, datasource, arccat_id, epa_type, sector_id, "state", state_type, annotation, observ,"comment",custom_length,dma_id, presszone_id, soilcat_id, function_type, category_type, fluid_type, location_type,
					...
					adate, adescript, lastupdate, lastupdate_user, asset_id, pavcat_id, om_state, conserv_state, parent_id,expl_id2, brand_id, model_id, serial_number, label_quadrant, streetname, streetname2, lock_level)
					VALUES (NEW.arc_id, NEW.code, NEW.datasource, NEW.arccat_id, NEW.epa_type, NEW.sector_id, NEW."state", NEW.state_type, NEW.annotation, NEW.observ, NEW.comment, NEW.custom_length,NEW.dma_id,NEW. presszone_id,
					...
					NEW.parent_id, NEW.expl_id2, NEW.brand_id, NEW.model_id, NEW.serial_number, NEW.label_quadrant, NEW.streetname, NEW.streetname2, NEW.lock_level);
    ...
    ELSIF TG_OP = 'UPDATE' THEN
		...
		UPDATE arc
		SET code=NEW.code, datasource=NEW.datasource, arccat_id=NEW.arccat_id, epa_type=NEW.epa_type, sector_id=NEW.sector_id,  state_type=NEW.state_type, annotation= NEW.annotation, "observ"=NEW.observ,
				...
				label_quadrant=NEW.label_quadrant, streetname = NEW.streetname, streetname2 = NEW.streetname2, lock_level=NEW.lock_level
