...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO arc (arc_id, code, sys_code, datasource, arccat_id, epa_type, sector_id, "state", state_type, annotation, observ,"comment",custom_length,dma_id, dqa_id, presszone_id, soilcat_id, function_type, category_type, fluid_type, location_type,
					...
					adate, adescript, updated_at, updated_by, asset_id, pavcat_id, om_state, conserv_state, parent_id,expl_visibility, brand_id, model_id, serial_number, label_quadrant, lock_level, is_scadamap, uuid, supplyzone_id, omzone_id, minsector_id)
					...
					NEW.parent_id, NEW.expl_visibility, NEW.brand_id, NEW.model_id, NEW.serial_number, NEW.label_quadrant, NEW.lock_level, NEW.is_scadamap, NEW.uuid, COALESCE(NEW.supplyzone_id, 0), COALESCE(NEW.omzone_id, 0), COALESCE(NEW.minsector_id, 0));
