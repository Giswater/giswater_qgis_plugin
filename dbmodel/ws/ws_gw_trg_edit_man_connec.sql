...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
		...
		IF man_table='man_greentap' THEN
		  ...
		  workcat_id, buildercat_id, builtdate,ownercat_id, adress_01, adress_02, adress_03, streetaxis_id, postnumber, descript, link,verified, the_geom, workcat_id_end,label_x,label_y,label_rotation) 
		  VALUES (NEW.connec_id, NEW.greentap_elevation, NEW.greentap_depth, NEW.connecat_id, NEW.sector_id, NEW.greentap_code, NEW.greentap_n_hydrometer, NEW.greentap_demand, NEW.greentap_state, NEW.greentap_annotation, 
		  ...
		  NEW.greentap_descript, NEW.greentap_link, NEW.verified, NEW.the_geom,NEW.greentap_workcat_id_end,NEW.greentap_label_x,NEW.greentap_label_y,NEW.greentap_label_rotation);
		...
		ELSIF man_table='man_fountain' THEN
		  INSERT INTO connec(connec_id, elevation, "depth",connecat_id, sector_id, code, n_hydrometer, demand, "state", annotation, observ, "comment",rotation,dma_id, soilcat_id, category_type, fluid_type, location_type, 
		  workcat_id, buildercat_id, builtdate,ownercat_id, adress_01, adress_02, adress_03, streetaxis_id, postnumber, descript, link,verified, the_geom,workcat_id_end,label_x,label_y,label_rotation) 
		  VALUES (NEW.connec_id, NEW.fountain_elevation, NEW.fountain_depth, NEW.connecat_id, NEW.sector_id, NEW.fountain_code, NEW.fountain_n_hydrometer, NEW.fountain_demand, NEW.fountain_state, NEW.fountain_annotation, 
		  ...
		  NEW.fountain_descript, NEW.fountain_link, NEW.verified, NEW.the_geom,NEW.fountain_workcat_id_end,NEW.fountain_label_x,NEW.fountain_label_y,NEW.fountain_label_rotation);
		 
		 INSERT INTO man_fountain(connec_id, vmax, vtotal, container_number, pump_number, power, regulation_tank,name, connection, chlorinator) 
		 ...
		 NEW.fountain_connection, NEW.fountain_chlorinator);
		 
		ELSIF man_table='man_tap' THEN
		  INSERT INTO connec(connec_id, elevation, "depth",connecat_id, sector_id, code, n_hydrometer, demand, "state", annotation, observ, "comment",rotation,dma_id, soilcat_id, category_type, fluid_type, 
		  location_type, workcat_id, buildercat_id, builtdate,ownercat_id, adress_01, adress_02, adress_03, streetaxis_id, postnumber,descript,link,verified, the_geom,workcat_id_end,label_x,label_y,label_rotation) 
		  VALUES (NEW.connec_id, NEW.tap_elevation, NEW.tap_depth, NEW.connecat_id, NEW.sector_id, NEW.tap_code, NEW.tap_n_hydrometer, NEW.tap_demand, NEW.tap_state, NEW.tap_annotation, NEW.tap_observ, 
		  ...
		  NEW.tap_ownercat_id, NEW.tap_adress_01, NEW.tap_adress_02, NEW.tap_adress_03, NEW.tap_streetname, NEW.tap_postnumber, NEW.tap_descript, NEW.tap_link, NEW.verified, NEW.the_geom, NEW.tap_workcat_id_end,
		  NEW.tap_label_x,NEW.tap_label_y,NEW.tap_label_rotation);
		  ...
		  NEW.tap_drain_gully, NEW.tap_drain_distance, NEW.tap_arquitect_patrimony, NEW.tap_communication);
		  
		ELSIF man_table='man_wjoin' THEN  
		  INSERT INTO connec(connec_id, elevation, "depth",connecat_id, sector_id, code, n_hydrometer, demand, "state", annotation, observ, "comment",rotation, dma_id, soilcat_id, category_type, fluid_type, 
		  location_type, workcat_id, buildercat_id, builtdate,ownercat_id, adress_01, adress_02, adress_03, streetaxis_id, postnumber, descript, link,verified, the_geom,workcat_id_end,label_x,label_y,label_rotation) 
		  VALUES (NEW.connec_id, NEW.wjoin_elevation, NEW.wjoin_depth, NEW.connecat_id, NEW.sector_id, NEW.wjoin_code, NEW.wjoin_n_hydrometer, NEW.wjoin_demand, NEW.wjoin_state, NEW.wjoin_annotation, NEW.wjoin_observ, 
		  ...
		  NEW.the_geom, NEW.wjoin_workcat_id_end,NEW.wjoin_label_x,NEW.wjoin_label_y,NEW.wjoin_label_rotation); 
		 
		 INSERT INTO man_wjoin (connec_id, arc_id, length, top_floor, lead_verified, lead_facade) 
		 VALUES (NEW.connec_id, NEW.arc_id, NEW.wjoin_length, NEW.wjoin_top_floor, NEW.wjoin_lead_verified, NEW.wjoin_lead_facade);
	...
	ELSIF TG_OP = 'UPDATE' THEN
       ...
       -- UPDATE dma/sector
        ...
        IF man_table ='man_greentap' THEN
			UPDATE connec 
			SET connec_id=NEW.connec_id, elevation=NEW.greentap_elevation, "depth"=NEW.greentap_depth, connecat_id=NEW.connecat_id, sector_id=NEW.sector_id, code=NEW.greentap_code, n_hydrometer=NEW.greentap_n_hydrometer, 
			...
			adress_03=NEW.greentap_adress_03, streetaxis_id=NEW.greentap_streetname, postnumber=NEW.greentap_postnumber, descript=NEW.greentap_descript, link=NEW.greentap_link, verified=NEW.verified, 
			the_geom=NEW.the_geom, workcat_id_end=NEW.greentap_workcat_id_end, label_x=NEW.greentap_label_x,label_y=NEW.greentap_label_y, label_rotation=NEW.greentap_label_rotation
        ...
        ELSIF man_table ='man_wjoin' THEN
			UPDATE connec 
			SET connec_id=NEW.connec_id, elevation=NEW.wjoin_elevation, "depth"=NEW.wjoin_depth, connecat_id=NEW.connecat_id, sector_id=NEW.sector_id, code=NEW.wjoin_code, n_hydrometer=NEW.wjoin_n_hydrometer, 
			...
			streetaxis_id=NEW.wjoin_streetname, postnumber=NEW.wjoin_postnumber, descript=NEW.wjoin_descript, link=NEW.wjoin_link, verified=NEW.verified, the_geom=NEW.the_geom,workcat_id_end=NEW.wjoin_workcat_id_end,
			label_x=NEW.wjoin_label_x,label_y=NEW.wjoin_label_y, label_rotation=NEW.wjoin_label_rotation
			WHERE connec_id=OLD.connec_id;
		...
		ELSIF man_table ='man_tap' THEN
			UPDATE connec 
			SET connec_id=NEW.connec_id, elevation=NEW.tap_elevation, "depth"=NEW.tap_depth, connecat_id=NEW.connecat_id, sector_id=NEW.sector_id, code=NEW.tap_code, n_hydrometer=NEW.tap_n_hydrometer, demand=NEW.tap_demand, 
			...
			ownercat_id=NEW.tap_ownercat_id, adress_01=NEW.tap_adress_01, adress_02=NEW.tap_adress_02, adress_03=NEW.tap_adress_03, streetaxis_id=NEW.tap_streetname, postnumber=NEW.tap_postnumber, descript=NEW.tap_descript,
			link=NEW.tap_link, verified=NEW.verified, the_geom=NEW.the_geom, workcat_id_end=NEW.tap_workcat_id_end,label_x=NEW.tap_label_x,label_y=NEW.tap_label_y, label_rotation=NEW.tap_label_rotation
			WHERE connec_id=OLD.connec_id;
			...
			arquitect_patrimony=NEW.tap_arquitect_patrimony,communication=NEW.tap_communication
			WHERE connec_id=OLD.connec_id;
			
        ELSIF man_table ='man_fountain' THEN
            UPDATE connec 
			SET connec_id=NEW.connec_id, elevation=NEW.fountain_elevation, "depth"=NEW.fountain_depth, connecat_id=NEW.connecat_id, sector_id=NEW.sector_id, code=NEW.fountain_code, n_hydrometer=NEW.fountain_n_hydrometer,
			...
			adress_03=NEW.fountain_adress_03, streetaxis_id=NEW.fountain_streetname, postnumber=NEW.fountain_postnumber, descript=NEW.fountain_descript, link=NEW.fountain_link, verified=NEW.verified, 
			the_geom=NEW.the_geom,workcat_id_end=NEW.fountain_workcat_id_end, label_x=NEW.fountain_label_x,label_y=NEW.fountain_label_y, label_rotation=NEW.fountain_label_rotation
			WHERE connec_id=OLD.connec_id;
			...
			regulation_tank=NEW.fountain_regulation_tank,name=NEW.fountain_name,connection=NEW.fountain_connection,chlorinator=NEW.fountain_chlorinator
			WHERE connec_id=OLD.connec_id;
		END IF;
