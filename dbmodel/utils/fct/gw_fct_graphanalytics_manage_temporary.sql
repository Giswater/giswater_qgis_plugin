...
BEGIN
    ...
    IF v_action = 'CREATE' THEN
        ...
        CREATE TEMP TABLE IF NOT EXISTS temp_pgr_old_mapzone (
            mapzone_id INTEGER,
            macromapzone_id INTEGER DEFAULT 0,
            CONSTRAINT temp_pgr_old_mapzone_pkey PRIMARY KEY (mapzone_id)
        );
        CREATE INDEX IF NOT EXISTS temp_pgr_old_mapzone_macromapzone_id_idx ON temp_pgr_old_mapzone USING btree (macromapzone_id);
