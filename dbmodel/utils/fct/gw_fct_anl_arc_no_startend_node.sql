...
BEGIN
	...
	-- Reset values
    DELETE FROM anl_review_arc_x_node WHERE cur_user="current_user"() AND context='Arc without start-end nodes';
	...
	IF nodeRecord1 IS NULL 	THEN
		INSERT INTO anl_review_arc_x_node (arc_id, state, expl_id, context, the_geom, the_geom_p) 
