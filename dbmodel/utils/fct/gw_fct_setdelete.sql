...
BEGIN
	...
	IF upper(v_featuretype)='PSECTOR' THEN
		...
		ELSE
			...
			"data":{"message":"3116", "function":"2608","debug_msg":"'||v_id||'", "is_process":true}}$$)'
			INTO v_message;
		END IF;
		...
		*/
		...
		IF v_result IS NOT NULL THEN
			...
			IF v_tablename='om_visit_lot' THEN
				...
				IF v_count > 0 THEN
					EXECUTE 'SELECT gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
					"data":{"message":"3201", "function":"2608","debug_msg":"", "is_process":true}}$$);'INTO v_message2;
			...
			EXECUTE 'SELECT gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
			"data":{"message":"3114", "function":"2608","debug_msg":"", "is_process":true}}$$)'
			INTO v_message;
			EXECUTE v_querytext;
		ELSE
			EXECUTE 'SELECT gw_fct_getmessage($${"client":{"device":4, "infoType":1, "lang":"ES"},"feature":{},
			"data":{"message":"3116", "function":"2608","debug_msg":"", "is_process":true}}$$)'
			INTO v_message;
		END IF;
	END IF;
	-- Return
