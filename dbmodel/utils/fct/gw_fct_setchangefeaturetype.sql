...
BEGIN
	...
	IF v_category IS NULL THEN
		EXECUTE 'UPDATE '||v_feature_layer||' SET category_type=NULL WHERE '||v_feature_layer||'_id=v_feature_id;';
	END IF;
	...
	IF v_function IS NULL THEN
		EXECUTE 'UPDATE '||v_feature_layer||' SET function_type=NULL WHERE '||v_feature_layer||'_id=v_feature_id;';
	END IF;
	...
	IF v_fluid IS NULL THEN
		EXECUTE 'UPDATE '||v_feature_layer||' SET fluid_type=NULL WHERE '||v_feature_layer||'_id=v_feature_id;';
	END IF;
	...
	IF v_location IS NULL THEN
		EXECUTE 'UPDATE '||v_feature_layer||' SET location_type=NULL WHERE '||v_feature_layer||'_id=v_feature_id;';
	END IF;
