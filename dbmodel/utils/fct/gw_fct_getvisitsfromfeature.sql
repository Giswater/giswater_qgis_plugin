...
DROP FUNCTION IF EXISTS SCHEMA_NAME.gw_api_getvisitsfromfeature(varchar, varchar, in4, timestamp, timestamp);
CREATE OR REPLACE FUNCTION "SCHEMA_NAME"."gw_fct_getvisitsfromfeature"(element_type varchar, id varchar, device int4, visit_start timestamp, visit_end timestamp) 
