...
CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_get_new_search(p_data json)
  RETURNS json AS
$BODY$
...
SELECT SCHEMA_NAME.gw_fct_get_new_search($${"client":{"device": 5, "lang": "es_ES", "cur_user": "bgeo", "infoType": 1}, "form":{}, "feature":{}, "data":{"filterFields":{"searchText":{"filterSign":"", "value":""}}, "pageInfo":{}}}$$);
SELECT SCHEMA_NAME.gw_fct_get_new_search($${"client":{"device": 5, "lang": "es_ES", "cur_user": "bgeo", "infoType": 1}, "form":{}, "feature":{}, "data":{"filterFields":{"searchText":{"filterSign":"", "value":"calle"}}, "pageInfo":{}}}$$);
