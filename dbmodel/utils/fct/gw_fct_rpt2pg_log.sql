...
BEGIN
	...
	DELETE FROM anl_arc WHERE fid IN (3, 14, 39) AND cur_user=current_user;
	DELETE FROM anl_node WHERE fid IN (7, 14, 64, 66, 70, 71, 98) AND cur_user=current_user;

	-- select config values
	SELECT wsoftware, giswater  INTO v_project_type, v_version FROM version order by 1 desc limit 1 ;
	
	-- Header
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 4, concat('IMPORT RPT FILE LOG'));
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 4, '-------------------------------------------');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 4, concat('Result id: ', p_result));
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 4, concat('Imported by: ', current_user, ', on ', to_char(now(),'YYYY-MM-DD HH:MM:SS')));
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 4, '');

	-- basic statistics
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, 'BASIC STATISTICS');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '-----------------------');
	...
	IF v_project_type = 'WS' THEN
		...
		-- warnings
		INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '');
		INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, 'WARNINGS');
		INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '-----------------------');
		INSERT INTO audit_check_data (fid, result_id, criticity, error_message)
	...
	v_stats = (SELECT array_to_json(array_agg(error_message)) FROM audit_check_data WHERE result_id='stats' AND fid=14 AND cur_user=current_user);

	UPDATE rpt_cat_result SET stats = v_stats WHERE result_id=p_result;

	-- rpt file info
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, 'RPT FILE INFO');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '------------------');
	...
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, 'DETAILED USER INPUT OPTIONS');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message) VALUES (14, p_result, 1, '----------------------------------------');
	INSERT INTO audit_check_data (fid, result_id, criticity, error_message)
	...
	FROM (SELECT id, error_message as message FROM audit_check_data WHERE cur_user="current_user"() AND fid=14 order by criticity desc, id asc) row;
    ...
    'properties', to_jsonb(row) - 'the_geom'
  	...
  	FROM  anl_node WHERE cur_user="current_user"() AND  fid IN (7, 14, 64, 66, 70, 71, 98)) row) features;
    ...
    'properties', to_jsonb(row) - 'the_geom'
  	...
  	FROM  anl_arc WHERE cur_user="current_user"() AND fid IN (3, 14, 39)) row) features;
