...
--DROP FUNCTION IF EXISTS SCHEMA_NAME.gw_fct_node_replace(json);


CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_node_replace(p_data json)
RETURNS json AS

/*
SELECT SCHEMA_NAME.gw_fct_node_replace($${
