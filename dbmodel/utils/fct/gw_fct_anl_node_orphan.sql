...
DROP FUNCTION IF EXISTS "ws_sample".gw_fct_anl_node_orphan();
CREATE OR REPLACE FUNCTION "ws_sample".gw_fct_anl_node_orphan() 
RETURNS json AS 
$BODY$

/*EXAMPLE
SELECT ws_sample.gw_fct_anl_node_orphan()
*/
