...
DROP FUNCTION IF EXISTS SCHEMA_NAME.gw_api_getattributetable(p_data json);
CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_getattributetable(p_data json)  RETURNS json AS
$BODY$
