...
--  Search path
	...
	ELSIF csv2pgcat_id_aux=10 AND project_type_aux='WS' THEN
		SELECT gw_fct_utils_csv2pg_export_epainp(csv2pgcat_id_aux, label_aux) INTO v_return;
	...
	ELSIF csv2pgcat_id_aux=11 AND project_type_aux='WS' THEN
		SELECT gw_fct_utils_csv2pg_import_eparpt(csv2pgcat_id_aux, label_aux) INTO v_return;
	...
	ELSIF csv2pgcat_id_aux=12 AND project_type_aux='WS' THEN
		SELECT gw_fct_utils_csv2pg_import_epainp(csv2pgcat_id_aux, label_aux) INTO v_return;
