...
CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_trg_ui_doc()
  RETURNS trigger AS
$BODY$
DECLARE 
    doc_table varchar;
...
DROP TRIGGER IF EXISTS gw_trg_ui_elememt_x_connec ON "SCHEMA_NAME".v_ui_doc_x_connec;
CREATE TRIGGER gw_trg_ui_elememt_x_connec INSTEAD OF INSERT OR DELETE OR UPDATE ON "SCHEMA_NAME".v_ui_doc_x_connec
