...
JOIN node ON node.node_id = mo_visit_x_node.node_id
ORDER BY node_id;
...
JOIN om_visit_parameter ON om_visit_parameter.id=om_visit_event.parameter_id
JOIN arc ON arc.arc_id = mo_visit_x_arc.arc_id
ORDER BY arc_id;
...
JOIN om_visit_parameter ON om_visit_parameter.id=om_visit_event.parameter_id
JOIN connec ON connec.connec_id = mo_visit_x_connec.connec_id
ORDER BY connec_id;
