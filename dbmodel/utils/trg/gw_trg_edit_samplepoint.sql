...
-- FEATURE INSERT      
				...
				INSERT INTO samplepoint (sample_id, code, lab_code, feature_id, featurecat_id, dma_id, "state", builtdate, enddate, workcat_id, workcat_id_end, rotation, street1, street2, place_name, cabinet, observations, the_geom, expl_id, verified)
				VALUES (NEW.sample_id, NEW.code, NEW.lab_code, NEW.feature_id, NEW.featurecat_id,  NEW.dma_id, NEW."state", NEW.builtdate, NEW.enddate, NEW.workcat_id, NEW.workcat_id_end,  NEW.rotation, NEW.street1, NEW.street2, 
...
-- UPDATE
    ...
    ELSIF TG_OP = 'UPDATE' THEN
			...
			workcat_id=NEW.workcat_id, workcat_id_end=NEW.workcat_id_end, street1=NEW.street1, street2=NEW.street2, place_name=NEW.place_name, cabinet=NEW.cabinet, observations=NEW.observations, the_geom=NEW.the_geom, expl_id=NEW.expl_id, verified=NEW.verified
