...
-- FEATURE INSERT      
				...
				INSERT INTO element (element_id, code, elementcat_id, serial_number, "state", state_type, annotation, observ, "comment", function_type, category_type, location_type, workcat_id, workcat_id_end, buildercat_id, builtdate, enddate, ownercat_id, rotation, link, verified, the_geom, label_x, label_y, label_rotation, publish, inventory, undelete, expl_id, num_elements)
				VALUES (NEW.element_id, NEW.code, NEW.elementcat_id, NEW.serial_number, NEW."state", NEW.state_type, NEW.annotation, NEW.observ, NEW."comment", NEW.function_type, NEW.category_type, NEW.location_type, NEW.workcat_id, NEW.workcat_id_end, NEW.buildercat_id, NEW.builtdate, NEW.enddate, NEW.ownercat_id, NEW.rotation, NEW.link, NEW.verified, NEW.the_geom, NEW.label_x, NEW.label_y, NEW.label_rotation, NEW.publish, NEW.inventory, NEW.undelete, expl_id_int, NEW.num_elements);
