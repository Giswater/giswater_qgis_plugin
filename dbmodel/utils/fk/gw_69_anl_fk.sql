...
ALTER TABLE "anl_node" ADD CONSTRAINT "anl_node_fprocesscat_id_fkey" FOREIGN KEY ("fprocesscat_id")  REFERENCES "sys_fprocess_cat" ("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE "anl_arc" ADD CONSTRAINT "anl_arc_fprocesscat_id_fkey" FOREIGN KEY ("fprocesscat_id")  REFERENCES "sys_fprocess_cat" ("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE "anl_arc_x_node" ADD CONSTRAINT "anl_arc_x_node_node_id_fkey" FOREIGN KEY ("node_id") REFERENCES "node" ("node_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "anl_arc_x_node" ADD CONSTRAINT "anl_arc_x_node_fprocesscat_id_fkey" FOREIGN KEY ("fprocesscat_id")  REFERENCES "sys_fprocess_cat" ("id") ON UPDATE CASCADE ON DELETE RESTRICT;
