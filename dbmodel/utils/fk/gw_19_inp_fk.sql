...
ALTER TABLE inp_audit_data ADD CONSTRAINT inp_audit_data_result_id_fkey;
...
ALTER TABLE inp_audit_data ADD CONSTRAINT inp_audit_data_result_id_fkey FOREIGN KEY ("result_id") REFERENCES "rpt_cat_result" ("result_id") ON DELETE CASCADE ON UPDATE CASCADE;
