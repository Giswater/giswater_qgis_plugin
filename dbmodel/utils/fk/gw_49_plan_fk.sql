...
ALTER TABLE "plan_result_selector" DROP CONSTRAINT IF EXISTS "plan_result_selector_result_id_fkey";
ALTER TABLE "plan_result_selector" DROP CONSTRAINT IF EXISTS "plan_result_selector_unique";
