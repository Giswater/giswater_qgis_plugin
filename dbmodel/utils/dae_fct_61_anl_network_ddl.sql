...
DROP TABLE IF EXISTS "anl_arc_same_startend";
...
DROP TABLE IF EXISTS "anl_node_sink";
...
DROP TABLE IF EXISTS "anl_node_duplicated";
...
DROP TABLE IF EXISTS "anl_connec_duplicated";
