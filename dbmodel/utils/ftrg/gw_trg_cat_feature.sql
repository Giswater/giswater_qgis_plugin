		...
		ELSIF TG_OP = 'UPDATE' THEN
			...
			IF NEW.child_layer != OLD.child_layer or NEW.id != OLD.id THEN
				...
				IF NEW.child_layer != OLD.child_layer  AND NEW.child_layer IS NOT NULL THEN
					...
					--rename config_info_layer_x_type tableinfo_id and tableinfotype_id
					UPDATE config_info_layer_x_type SET tableinfo_id=v_viewname WHERE tableinfo_id=OLD.child_layer;
					UPDATE config_info_layer_x_type SET tableinfotype_id=v_viewname WHERE tableinfotype_id=OLD.child_layer;
				END IF;
