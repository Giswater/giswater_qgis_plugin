...
BEGIN
	...
	IF TG_OP = 'INSERT' OR TG_OP = 'UPDATE' THEN
		...
		IF v_feature_type = 'LINK' THEN
			...
			ELSE
				UPDATE link l SET epa_type = c.epa_type, is_operative = v.is_operative, expl_id2 = c.expl_id2, conneccat_id=c.connec_arccat_id, fluid_type = c.fluid_type, muni_id = c.muni_id
				FROM gully c
	...
	IF TG_OP = 'UPDATE' THEN
		...
		ELSIF v_feature_type = 'GULLY' THEN
			...
			UPDATE link SET epa_type = NEW.epa_type, is_operative = v.is_operative, expl_id2 = NEW.expl_id2, conneccat_id = NEW.connec_arccat_id, fluid_type = NEW.fluid_type, muni_id = NEW.muni_id
