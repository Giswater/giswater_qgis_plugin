...
INSERT INTO audit_cat_param_user VALUES ('cad_tools_base_layer_vdefault', NULL, NULL, 'role_edit', NULL, NULL, NULL, NULL);
INSERT INTO audit_cat_param_user VALUES ('dim_tooltip', NULL, NULL, 'role_edit', NULL, NULL, NULL, NULL);
INSERT INTO audit_cat_param_user VALUES ('psector_gexpenses_vdefault', NULL, NULL, 'role_master', NULL, NULL, NULL, NULL);
INSERT INTO audit_cat_param_user VALUES ('psector_measurement_vdefault', NULL, NULL, 'role_master', NULL, NULL, NULL, NULL);
...
INSERT INTO audit_cat_param_user VALUES ('pavementcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_pavement', 'id', NULL);
INSERT INTO audit_cat_param_user VALUES ('pipecat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_arc', 'id', NULL);
INSERT INTO audit_cat_param_user VALUES ('presszone_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_presszone', 'id', NULL);
...
INSERT INTO audit_cat_param_user VALUES ('wtpcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''WTP'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('expansiontankcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''EXPANTANK'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('filtercat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''FILTER'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('flexunioncat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''FLEXUNION'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('hydrantcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''HYDRANT'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('junctioncat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''JUNCTION'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('metercat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''METER'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('netelementcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''NETELEMENT'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('netsamplepointcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''NETSAMPLEPOINT'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('netwjoincat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''NETWJOIN'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('nodecat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', NULL);
INSERT INTO audit_cat_param_user VALUES ('pumpcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''PUMPCAT'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('registercat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''REGISTER'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('sourcecat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''SOURCE'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('tankcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''TANK'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('valvecat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_node', 'id', 'SELECT cat_node.id FROM cat_node JOIN node_type ON node_type.id=nodetype_id WHERE type=''VALVE'' AND cat_node.id=');
INSERT INTO audit_cat_param_user VALUES ('fountaincat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_connec', 'id', 'SELECT cat_connec.id FROM cat_connec JOIN connec_type ON connec_type.id=connectype_id WHERE type=''FOUNTAIN'' AND cat_connec.id=');
INSERT INTO audit_cat_param_user VALUES ('greentapcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_connec', 'id', 'SELECT cat_connec.id FROM cat_connec JOIN connec_type ON connec_type.id=connectype_id WHERE type=''GREETAP'' AND cat_connec.id=');
INSERT INTO audit_cat_param_user VALUES ('tapcat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_connec', 'id', 'SELECT cat_connec.id FROM cat_connec JOIN connec_type ON connec_type.id=connectype_id WHERE type=''TAP'' AND cat_connec.id=');
INSERT INTO audit_cat_param_user VALUES ('wjoincat_vdefault', NULL, NULL, 'role_edit', NULL, 'cat_connec', 'id', 'SELECT cat_connec.id FROM cat_connec JOIN connec_type ON connec_type.id=connectype_id WHERE type=''WJOIN'' AND cat_connec.id=');
INSERT INTO audit_cat_param_user VALUES ('statetype_end_vdefault', NULL, NULL, 'role_edit', NULL, 'value_state_type', 'id', 'SELECT id FROM value_state_type WHERE state=0 AND id::text=');
INSERT INTO audit_cat_param_user VALUES ('statetype_vdefault', NULL, NULL, 'role_edit', NULL, 'value_state_type', 'id', 'SELECT id FROM value_state_type WHERE state=1 AND id::text=');
