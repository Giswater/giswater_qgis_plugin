...
ALTER TABLE "om_visit_x_gully" ADD CONSTRAINT "om_visit_x_gully_visit_id_fkey" FOREIGN KEY ("gully_id") REFERENCES "gully" ("gully_id") ON DELETE CASCADE ON UPDATE CASCADE;
