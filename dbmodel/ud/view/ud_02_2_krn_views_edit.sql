...
node.muni_id AS junction_muni_id,
node.streetaxis_id AS junction_streetaxis_id,
...
node.muni_id AS outfall_muni_id,
node.streetaxis_id AS outfall_streetaxis_id,
...
concat(node_type.link_path,node.link) AS outfall_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS storage_muni_id,
node.streetaxis_id AS storage_streetaxis_id,
...
concat(node_type.link_path,node.link) AS storage_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS valve_muni_id,
node.streetaxis_id AS valve_streetaxis_id,
...
node.muni_id AS netinit_muni_id,
node.streetaxis_id AS netinit_streetaxis_id,
...
concat(node_type.link_path,node.link) AS netinit_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS manhole_muni_id,
node.streetaxis_id AS manhole_streetaxis_id,
...
node.muni_id AS wjump_muni_id,
node.streetaxis_id AS wjump_streetaxis_id,
...
concat(node_type.link_path,node.link) AS wjump_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS netgully_muni_id,
node.streetaxis_id AS netgully_streetaxis_id,
...
concat(node_type.link_path,node.link) AS netgully_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS chamber_muni_id,
node.streetaxis_id AS chamber_streetaxis_id,
...
concat(node_type.link_path,node.link) AS chamber_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS wwtp_muni_id,
node.streetaxis_id AS wwtp_streetaxis_id,
...
concat(node_type.link_path,node.link) AS wwtp_link,
node.verified,
node.the_geom,
node.undelete,
...
node.muni_id AS netelement_muni_id,
node.streetaxis_id AS netelement_streetaxis_id,
...
arc.muni_id AS conduit_muni_id,
arc.streetaxis_id AS conduit_streetaxis_id,
...
concat(arc_type.link_path,arc.link) AS conduit_link,
arc.verified,
arc.the_geom,
arc.undelete,
...
arc.muni_id AS siphon_muni_id,
arc.streetaxis_id AS siphon_streetaxis_id,
...
concat(arc_type.link_path,arc.link) AS siphon_link,
arc.verified,
arc.the_geom,
arc.undelete,
...
arc.muni_id AS waccel_muni_id,
arc.streetaxis_id AS waccel_streetaxis_id,
...
concat(arc_type.link_path,arc.link) AS waccel_link,
arc.verified,
arc.the_geom,
arc.undelete,
...
arc.muni_id AS varc_muni_id,
arc.streetaxis_id AS varc_streetaxis_id,
