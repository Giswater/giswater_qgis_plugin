...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        ...
        -- FEATURE INSERT
				...
				muni_id, streetaxis_id, postcode, streetaxis2_id, postnumber, postnumber2, descript, link, verified, the_geom, undelete,label_x,label_y, 
				...
				NEW.muni_id, NEW.streetaxis_id, NEW.postcode, NEW.streetaxis2_id, NEW.postnumber, NEW.postnumber2, NEW.descript, NEW.link, NEW.verified, NEW.the_geom,NEW.undelete,NEW.label_x,NEW.label_y, 
	...
	END IF;
		...
		postnumber=NEW.postnumber, postnumber2=NEW.postnumber2, descript=NEW.descript, link=NEW.link, verified=NEW.verified, undelete=NEW.undelete,label_x=NEW.label_x,label_y=NEW.label_y, label_rotation=NEW.label_rotation,
