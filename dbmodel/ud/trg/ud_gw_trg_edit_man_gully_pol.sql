...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO polygon (pol_id, pol_type, the_geom) VALUES (NEW.pol_id, 'GULLY', NEW.the_geom);
...
CREATE TRIGGER gw_trg_edit_man_gully_pol INSTEAD OF INSERT OR DELETE OR UPDATE ON "SCHEMA_NAME".v_edit_man_gully_pol FOR EACH ROW EXECUTE PROCEDURE "SCHEMA_NAME".gw_trg_edit_man_gully_pol();
