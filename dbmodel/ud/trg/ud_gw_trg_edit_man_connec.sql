...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO connec (connec_id, code, customer_code, top_elev, y1, y2,connecat_id, connec_type, sector_id, demand, "state",  state_type, connec_depth, connec_length, arc_id, annotation, "observ",
					...
					streetaxis2_id, streetaxis_id, postnumber, postnumber2, descript, rotation, link, verified, the_geom,  undelete, featurecat_id,feature_id,  label_x, label_y, label_rotation, accessibility,diagonal, 
		...
		VALUES (NEW.connec_id, NEW.code, NEW.customer_code, NEW.top_elev, NEW.y1, NEW.y2, NEW.connecat_id, NEW.connec_type, NEW.sector_id, NEW.demand,NEW."state", NEW.state_type, NEW.connec_depth, 
				...
				NEW.workcat_id, NEW.workcat_id_end, NEW.buildercat_id, NEW.builtdate, NEW.enddate, NEW.ownercat_id, NEW.muni_id, NEW.postcode, NEW.streetaxis2_id, NEW.streetaxis_id, NEW.postnumber, NEW.postnumber2,
    ...
    ELSIF TG_OP = 'UPDATE' THEN
 	...
 	END IF;
        ...
        SET  code=NEW.code, top_elev=NEW.top_elev, y1=NEW.y1, y2=NEW.y2, connecat_id=NEW.connecat_id, connec_type=NEW.connec_type, sector_id=NEW.sector_id, demand=NEW.demand,
            ...
            ownercat_id=NEW.ownercat_id, muni_id=NEW.muni_id, postcode=NEW.postcode, streetaxis2_id=NEW.streetaxis2_id, streetaxis_id=NEW.streetaxis_id, postnumber=NEW.postnumber, postnumber2=NEW.postnumber2, descript=NEW.descript,
