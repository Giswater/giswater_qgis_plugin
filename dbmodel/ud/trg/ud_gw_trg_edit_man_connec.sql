...
BEGIN
	...
	--Exploitation ID
        ...
        INSERT INTO connec (connec_id, top_elev, "ymax",connecat_id, sector_id,code, n_hydrometer, demand, "state", annotation, "observ", "comment", rotation, dma_id, soilcat_id, category_type, fluid_type, location_type,
								workcat_id, buildercat_id, builtdate, ownercat_id, address_01,address_02,address_03, streetaxis_id, postnumber, descript, link, verified, the_geom, workcat_id_end, y1, y2, undelete, featurecat_id,
								feature_id, private_connecat_id, label_x, label_y, label_rotation, accessibility,diagonal, connec_type,expl_id, publish, inventory, enddate, uncertain)
		VALUES (NEW.connec_id, NEW.top_elev, NEW."ymax", NEW.connecat_id, NEW.sector_id, NEW.code, NEW.n_hydrometer,NEW.demand,NEW."state", NEW.annotation, NEW."observ", NEW."comment", NEW.rotation,
                                ...
                                NEW.ownercat_id, NEW.address_01, NEW.address_02, NEW.address_03, NEW.streetaxis_id, NEW.postnumber, NEW.descript, NEW.link, NEW.verified, NEW.the_geom, 
								...
								NEW.connec_type, expl_id_int, NEW.publish, NEW.inventory, NEW.enddate, NEW.uncertain);
