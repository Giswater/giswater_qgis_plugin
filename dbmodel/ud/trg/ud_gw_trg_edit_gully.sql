...
BEGIN
 ...
 IF gully_geometry = 'gully' THEN
        INSERT INTO gully (gully_id, top_elev, "ymax",sandbox, matcat_id, gratecat_id, units, groove, arccat_id, siphon, arc_id, sector_id, "state",annotation, "observ", "comment", rotation,dma_id, 
					soilcat_id, category_type, fluid_type, location_type, workcat_id, buildercat_id, builtdate,ownercat_id, address_01, address_02, address_03, descript, link, verified, the_geom, workcat_id_end,
					undelete,featurecat_id, feature_id,label_x, label_y,label_rotation, code, expl_id, publish, inventory, enddate, streetaxis_id, postnumber,  connec_length, connec_depth, uncertain)
                    ...
                    NEW.ownercat_id, NEW.address_01, NEW.address_02, NEW.address_03, NEW.descript, NEW.link, NEW.verified, NEW.the_geom, NEW.workcat_id_end,NEW.undelete,NEW.featurecat_id,
					NEW.feature_id,NEW.label_x, NEW.label_y,NEW.label_rotation, NEW.code, expl_id_int , NEW.publish, NEW.inventory, NEW.enddate, NEW.streetaxis_id, NEW.postnumber, NEW.connec_length, NEW.connec_depth, NEW.uncertain);
        ...
        INSERT INTO gully (gully_id, top_elev, "ymax",sandbox, matcat_id, gratecat_id, units, groove, arccat_id, siphon, arc_id,sector_id, "state", annotation, "observ", "comment", rotation,
                    dma_id, soilcat_id, category_type, fluid_type, location_type, workcat_id, buildercat_id, builtdate,ownercat_id, address_01, address_02, address_03, descript, link, verified, the_geom_pol, workcat_id_end,undelete,featurecat_id, feature_id,label_x, label_y,label_rotation, code, expl_id, publish, inventory, enddate, streetaxis_id, postnumber, uncertain)
					VALUES (NEW.gully_id, NEW.top_elev, NEW."ymax",NEW.sandbox, NEW.matcat_id, NEW.gratecat_id, NEW.units, NEW.groove, NEW.arccat_id, NEW.siphon, NEW.arc_id, NEW.sector_id, NEW."state", 
					NEW.annotation, NEW."observ", NEW."comment", NEW.rotation, NEW.dma_id, NEW.soilcat_id, NEW.category_type, NEW.fluid_type, NEW.location_type, NEW.workcat_id, NEW.buildercat_id, NEW.builtdate, 
                    NEW.ownercat_id, NEW.address_01, NEW.address_02, NEW.address_03, NEW.descript, NEW.link, NEW.verified, NEW.the_geom, NEW.workcat_id_end,NEW.undelete, NEW.featurecat_id, NEW.feature_id,
					NEW.label_x, NEW.label_y,NEW.label_rotation,  NEW.code, expl_id_int, NEW.publish, NEW.inventory, NEW.enddate, NEW.streetaxis_id, NEW.postnumber, NEW.uncertain);
        END IF;     
    ...
    ELSIF TG_OP = 'UPDATE' THEN
       ...
       -- UPDATE values
		IF gully_geometry = 'gully' THEN
			...
			enddate=NEW.enddate, streetaxis_id=NEW.streetaxis_id, postnumber=NEW.postnumber,  connec_length=NEW.connec_length, connec_depth=NEW.connec_depth, expl_id=NEW.expl_id, uncertain=NEW.uncertain
