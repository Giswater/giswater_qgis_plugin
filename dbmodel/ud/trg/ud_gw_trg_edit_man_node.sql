...
BEGIN
	...
	--Exploitation ID
		...
		--Copy id to code field
			...
			VALUES (NEW.node_id,NEW.junction_top_elev,NEW.junction_ymax,NEW.junction_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.junction_annotation,NEW.junction_observ,
			...
			NEW.junction_ownercat_id,NEW.junction_address_01,NEW.junction_address_02,NEW.junction_address_03,NEW.junction_descript,NEW.junction_est_top_elev,NEW.junction_est_ymax,NEW.junction_rotation,NEW.junction_link,
			...
			NEW.junction_code, expl_id_int, NEW.publish, NEW.inventory, NEW.junction_enddate, NEW.uncertain, NEW.junction_xyz_date, NEW.unconnected);	
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.outfall_top_elev,NEW.outfall_ymax,NEW.outfall_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.outfall_annotation,NEW.outfall_observ,
			...
			NEW.outfall_ownercat_id,NEW.outfall_address_01,NEW.outfall_address_02,NEW.outfall_address_03,NEW.outfall_descript,NEW.outfall_est_top_elev,NEW.outfall_est_ymax,NEW.outfall_rotation,NEW.outfall_link,
			...
			NEW.outfall_code, expl_id_int, NEW.publish, NEW.inventory, NEW.outfall_enddate, NEW.uncertain, NEW.outfall_xyz_date, NEW.unconnected);

			INSERT INTO man_outfall (node_id,outfall_name) VALUES (NEW.node_id,NEW.outfall_name);
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.valve_top_elev,NEW.valve_ymax,NEW.valve_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.valve_annotation,NEW.valve_observ,NEW.valve_comment,NEW.dma_id, NEW.valve_soilcat_id,NEW.valve_category_type,NEW.valve_fluid_type,NEW.valve_location_type,NEW.valve_workcat_id,NEW.valve_buildercat_id,NEW.valve_builtdate,NEW.valve_ownercat_id,NEW.valve_address_01,
			NEW.valve_address_02,NEW.valve_address_03,NEW.valve_descript,NEW.valve_est_top_elev,NEW.valve_est_ymax,NEW.valve_rotation,NEW.valve_link,NEW.verified,NEW.valve_workcat_id_end,NEW.undelete,NEW.valve_label_x,
			NEW.valve_label_y,NEW.valve_label_rotation,NEW.the_geom, NEW.valve_code, expl_id_int, NEW.publish, NEW.inventory, NEW.valve_enddate, 
			NEW.uncertain, NEW.valve_xyz_date, NEW.unconnected);

			INSERT INTO man_valve (node_id,valve_name) VALUES (NEW.node_id,NEW.valve_name);	
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.storage_top_elev,NEW.storage_ymax,NEW.storage_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.storage_annotation,NEW.storage_observ,
			...
			NEW.storage_ownercat_id,NEW.storage_address_01,NEW.storage_address_02,NEW.storage_address_03,NEW.storage_descript,NEW.storage_est_top_elev,NEW.storage_est_ymax,NEW.storage_rotation,NEW.storage_link,
			...
			NEW.storage_code, expl_id_int, NEW.publish, NEW.inventory, NEW.storage_enddate, NEW.uncertain, NEW.storage_xyz_date, NEW.unconnected);
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.netgully_top_elev,NEW.netgully_ymax,NEW.netgully_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.netgully_annotation,NEW.netgully_observ,
			...
			NEW.netgully_ownercat_id,NEW.netgully_address_01,NEW.netgully_address_02,NEW.netgully_address_03,NEW.netgully_descript,NEW.netgully_est_top_elev,NEW.netgully_est_ymax,NEW.netgully_rotation,NEW.netgully_link,
			...
			NEW.netgully_code, expl_id_int, NEW.publish, NEW.inventory, NEW.netgully_enddate, NEW.uncertain, NEW.netgully_xyz_date, NEW.unconnected);
			...
			IF (rec.insert_double_geometry IS TRUE) THEN
				...
				INSERT INTO man_netgully (node_id,pol_id) VALUES(NEW.node_id, NEW.pol_id);
				INSERT INTO polygon(pol_id,the_geom) VALUES (NEW.pol_id,(SELECT ST_Envelope(ST_Buffer(node.the_geom,rec.buffer_value)) from "SCHEMA_NAME".node where node_id=NEW.node_id));
		...
		--Copy id to code field
			...
			INSERT INTO node (node_id,top_elev,ymax,sander,node_type,nodecat_id,epa_type,sector_id,"state",annotation,observ,"comment",dma_id,soilcat_id,category_type,fluid_type,location_type,workcat_id,buildercat_id,
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected)
			VALUES (NEW.node_id,NEW.storage_top_elev,NEW.storage_ymax,NEW.storage_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.storage_annotation,NEW.storage_observ,
			NEW.storage_comment,NEW.dma_id,NEW.storage_soilcat_id,NEW.storage_category_type,NEW.storage_fluid_type,NEW.storage_location_type,NEW.storage_workcat_id,NEW.storage_buildercat_id,NEW.storage_builtdate,
			NEW.storage_ownercat_id,NEW.storage_address_01,NEW.storage_address_02,NEW.storage_address_03,NEW.storage_descript,NEW.storage_est_top_elev,NEW.storage_est_ymax,NEW.storage_rotation,NEW.storage_link,NEW.verified,NEW.storage_workcat_id_end,NEW.undelete,NEW.storage_label_x,NEW.storage_label_y,NEW.storage_label_rotation, 
			NEW.storage_code, expl_id_int, NEW.publish, NEW.inventory, NEW.storage_enddate, NEW.uncertain, NEW.storage_xyz_date, NEW.unconnected);
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.chamber_top_elev,NEW.chamber_ymax,NEW.chamber_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.chamber_annotation,NEW.chamber_observ,
			...
			NEW.chamber_ownercat_id,NEW.chamber_address_01,NEW.chamber_address_02,NEW.chamber_address_03,NEW.chamber_descript,NEW.chamber_est_top_elev,NEW.chamber_est_ymax,NEW.chamber_rotation,NEW.chamber_link,NEW.verified, NEW.chamber_workcat_id_end,NEW.undelete,NEW.chamber_label_x,NEW.chamber_label_y,NEW.chamber_label_rotation,NEW.the_geom, 
			NEW.chamber_code,expl_id_int, NEW.publish, NEW.inventory, NEW.chamber_enddate, NEW.uncertain, NEW.chamber_xyz_date, NEW.unconnected);
			...
			IF (rec.insert_double_geometry IS TRUE) THEN
				...
				INSERT INTO man_chamber (node_id,pol_id,total_volume,total_height,total_length,total_width, chamber_name, inlet, bottom_channel, accessibility) 
				VALUES (NEW.node_id,NEW.pol_id,NEW.chamber_total_volume, NEW.chamber_total_height,NEW.chamber_total_length,NEW.chamber_total_width,NEW.chamber_name,
				NEW.chamber_inlet, NEW.chamber_bottom_channel, NEW.chamber_accessibility);
				INSERT INTO polygon(pol_id,the_geom) VALUES (NEW.pol_id,(SELECT ST_Envelope(ST_Buffer(node.the_geom,rec.buffer_value)) from "SCHEMA_NAME".node where node_id=NEW.node_id));
			
			ELSE
				INSERT INTO man_chamber (node_id,pol_id,total_volume,total_height,total_length,total_width,chamber_name, inlet, bottom_channel, accessibility) 
				VALUES (NEW.node_id,NEW.pol_id,NEW.chamber_total_volume, NEW.chamber_total_height,NEW.chamber_total_length,NEW.chamber_total_width,
		...
		--Copy id to code field
			...
			VALUES (NEW.node_id,NEW.chamber_top_elev,NEW.chamber_ymax,NEW.chamber_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.chamber_annotation,NEW.chamber_observ,
			NEW.chamber_comment,NEW.dma_id,NEW.chamber_soilcat_id,NEW.chamber_category_type,NEW.chamber_fluid_type,NEW.chamber_location_type,NEW.chamber_workcat_id,NEW.chamber_buildercat_id,NEW.chamber_builtdate,
			NEW.chamber_ownercat_id,NEW.chamber_address_01,NEW.chamber_address_02,NEW.chamber_address_03,NEW.chamber_descript,NEW.chamber_est_top_elev,NEW.chamber_est_ymax,NEW.chamber_rotation,NEW.chamber_link,
			...
			IF (rec.insert_double_geometry IS TRUE) THEN
				...
				INSERT INTO man_chamber (node_id,pol_id,total_volume,total_height,total_length,total_width,chamber_name) VALUES (NEW.node_id,NEW.pol_id,NEW.chamber_total_volume,
		...
		ELSIF man_table='man_manhole' THEN
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.manhole_top_elev,NEW.manhole_ymax,NEW.manhole_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.manhole_annotation,NEW.manhole_observ,
			...
			NEW.manhole_ownercat_id,NEW.manhole_address_01,NEW.manhole_address_02,NEW.manhole_address_03,NEW.manhole_descript,NEW.manhole_est_top_elev,NEW.manhole_est_ymax,NEW.manhole_rotation,NEW.manhole_link,
			...
			NEW.manhole_code, expl_id_int, NEW.publish, NEW.inventory, NEW.manhole_enddate, NEW.uncertain, NEW.manhole_xyz_date, NEW.unconnected);

			INSERT INTO man_manhole (node_id,sander_depth,prot_surface, inlet, bottom_channel, accessibility) 
		...
		ELSIF man_table='man_netinit' THEN
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.netinit_top_elev,NEW.netinit_ymax,NEW.netinit_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.netinit_annotation,NEW.netinit_observ,
			...
			NEW.netinit_ownercat_id,NEW.netinit_address_01,NEW.netinit_address_02,NEW.netinit_address_03,NEW.netinit_descript,NEW.netinit_est_top_elev,NEW.netinit_est_ymax,NEW.netinit_rotation,NEW.netinit_link,
			...
			NEW.netinit_code, expl_id_int, NEW.publish, NEW.inventory, NEW.netinit_enddate, NEW.uncertain, NEW.netinit_xyz_date, NEW.unconnected); 

			INSERT INTO man_netinit (node_id,mheight,mlength,mwidth,netinit_name, inlet, bottom_channel, accessibility) 
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.wjump_top_elev,NEW.wjump_ymax,NEW.wjump_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.wjump_annotation,NEW.wjump_observ,NEW.wjump_comment,
			...
			NEW.wjump_address_01,NEW.wjump_address_02,NEW.wjump_address_03,NEW.wjump_descript,NEW.wjump_est_top_elev,NEW.wjump_est_ymax,NEW.wjump_rotation,NEW.wjump_link,NEW.verified,NEW.wjump_workcat_id_end,NEW.undelete,NEW.wjump_label_x,NEW.wjump_label_y,NEW.wjump_label_rotation,NEW.the_geom,
			NEW.wjump_code, expl_id_int, NEW.publish, NEW.inventory, NEW.wjump_enddate, NEW.uncertain, NEW.wjump_xyz_date, NEW.unconnected);

			INSERT INTO man_wjump (node_id,mheight,mlength,mwidth,sander_length,sander_depth,security_bar,steps,prot_surface,wjump_name) VALUES (NEW.node_id,NEW.wjump_mheight,
		...
		--Copy id to code field
			...
			builtdate,ownercat_id,	address_01,address_02,address_03,descript,est_top_elev,est_ymax,rotation,link,verified,workcat_id_end,undelete,label_x,label_y,label_rotation,the_geom,
			code, expl_id, publish, inventory, enddate, uncertain, xyz_date, unconnected) 
			VALUES (NEW.node_id,NEW.wwtp_top_elev,NEW.wwtp_ymax,NEW.wwtp_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.wwtp_annotation,NEW.wwtp_observ,NEW.wwtp_comment,NEW.dma_id, NEW.wwtp_soilcat_id,NEW.wwtp_category_type,NEW.wwtp_fluid_type,NEW.wwtp_location_type,NEW.wwtp_workcat_id,NEW.wwtp_buildercat_id,NEW.wwtp_builtdate,
			NEW.wwtp_ownercat_id,NEW.wwtp_address_01,NEW.wwtp_address_02, NEW.wwtp_address_03,NEW.wwtp_descript,NEW.wwtp_est_top_elev,NEW.wwtp_est_ymax,NEW.wwtp_rotation,NEW.wwtp_link,
			NEW.verified,NEW.wwtp_workcat_id_end,NEW.undelete,NEW.wwtp_label_x,NEW.wwtp_label_y,NEW.wwtp_label_rotation,NEW.the_geom,
			NEW.wwtp_code, expl_id_int, NEW.publish, NEW.inventory, NEW.wwtp_enddate, NEW.uncertain, NEW.wwtp_xyz_date, NEW.unconnected);
			...
			IF (rec.insert_double_geometry IS TRUE) THEN
				...
				INSERT INTO man_wwtp (node_id,pol_id,wwtp_name) VALUES (NEW.node_id,NEW.pol_id,NEW.wwtp_name);
				INSERT INTO polygon(pol_id,the_geom) VALUES (NEW.pol_id,(SELECT ST_Envelope(ST_Buffer(node.the_geom,rec.buffer_value)) from "SCHEMA_NAME".node where node_id=NEW.node_id));
			
			ELSE
				INSERT INTO man_wwtp (node_id,wwtp_name) VALUES (NEW.node_id,NEW.wwtp_name);
			END IF;	
		...
		ELSIF man_table='man_wwtp_pol' THEN
			...
			VALUES (NEW.node_id,NEW.wwtp_top_elev,NEW.wwtp_ymax,NEW.wwtp_sander,NEW.node_type,NEW.nodecat_id,NEW.epa_type,NEW.sector_id,NEW.state,NEW.wwtp_annotation,NEW.wwtp_observ,NEW.wwtp_comment,NEW.dma_id, 	NEW.wwtp_soilcat_id,NEW.wwtp_category_type,NEW.wwtp_fluid_type,NEW.wwtp_location_type,NEW.wwtp_workcat_id,NEW.wwtp_buildercat_id,NEW.wwtp_builtdate,
			NEW.wwtp_ownercat_id,NEW.wwtp_address_01,NEW.wwtp_address_02, 	NEW.wwtp_address_03,NEW.wwtp_descript,NEW.wwtp_est_top_elev,NEW.wwtp_est_ymax,NEW.wwtp_rotation,NEW.wwtp_link,
			NEW.verified,NEW.wwtp_workcat_id_end,NEW.undelete,NEW.wwtp_label_x,NEW.wwtp_label_y, NEW.wwtp_label_rotation, NEW.wwtp_code,expl_id_int, NEW.publish, NEW.inventory, NEW.wwtp_enddate, 
			NEW.uncertain, NEW.wwtp_xyz_date, NEW.unconnected);
 ...
 */
    ...
    -- UPDATE management values
		...
		IF man_table ='man_junction' THEN
			...
			sector_id=NEW.sector_id, "state"=NEW.state, annotation=NEW.junction_annotation, "observ"=NEW.junction_observ, "comment"=NEW.junction_comment, dma_id=NEW.dma_id, soilcat_id=NEW.junction_soilcat_id, 
			...
			code=NEW.junction_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.junction_enddate, uncertain=NEW.uncertain, xyz_date=NEW.junction_xyz_date, 
		...
		ELSIF man_table='man_netgully' THEN
			...
			"state"=NEW.state, annotation=NEW.netgully_annotation, "observ"=NEW.netgully_observ, "comment"=NEW.netgully_comment, dma_id=NEW.dma_id, soilcat_id=NEW.netgully_soilcat_id, 
			...
			builtdate=NEW.netgully_builtdate,ownercat_id=NEW.netgully_ownercat_id, address_01=NEW.netgully_address_01,address_02=NEW.netgully_address_02, address_03=NEW.netgully_address_03, descript=NEW.netgully_descript,
			...
			code=NEW.netgully_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.netgully_enddate, uncertain=NEW.uncertain, xyz_date=NEW.netgully_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_netgully_pol' THEN
			...
			"state"=NEW.state, annotation=NEW.netgully_annotation, "observ"=NEW.netgully_observ, "comment"=NEW.netgully_comment, dma_id=NEW.dma_id, soilcat_id=NEW.netgully_soilcat_id,
			category_type=NEW.netgully_category_type,fluid_type=NEW.netgully_fluid_type, location_type=NEW.netgully_location_type, workcat_id=NEW.netgully_workcat_id, buildercat_id=NEW.netgully_buildercat_id, 
			builtdate=NEW.netgully_builtdate,ownercat_id=NEW.netgully_ownercat_id, address_01=NEW.netgully_address_01,address_02=NEW.netgully_address_02, address_03=NEW.netgully_address_03, 
		...
		ELSIF man_table='man_outfall' THEN
			...
			"state"=NEW.state, annotation=NEW.outfall_annotation, "observ"=NEW.outfall_observ, "comment"=NEW.outfall_comment, dma_id=NEW.dma_id, soilcat_id=NEW.outfall_soilcat_id, 
			...
			builtdate=NEW.outfall_builtdate,ownercat_id=NEW.outfall_ownercat_id, address_01=NEW.outfall_address_01,address_02=NEW.outfall_address_02, address_03=NEW.outfall_address_03, 
			...
			code=NEW.outfall_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.outfall_enddate, uncertain=NEW.uncertain, xyz_date=NEW.outfall_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_storage' THEN
			...
			builtdate=NEW.storage_builtdate,ownercat_id=NEW.storage_ownercat_id, address_01=NEW.storage_address_01,address_02=NEW.storage_address_02, address_03=NEW.storage_address_03, descript=NEW.storage_descript,
			...
			code=NEW.storage_code,  publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.storage_enddate, uncertain=NEW.uncertain, xyz_date=NEW.storage_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_storage_pol' THEN
			...
			UPDATE node 
			SET node_id=NEW.node_id, top_elev=NEW.storage_top_elev, ymax=NEW.storage_ymax, sander=NEW.storage_sander, node_type=NEW.node_type, nodecat_id=NEW.nodecat_id, epa_type=NEW.epa_type, sector_id=NEW.sector_id, 
			"state"=NEW.state, annotation=NEW.storage_annotation, "observ"=NEW.storage_observ, "comment"=NEW.storage_comment, dma_id=NEW.dma_id, soilcat_id=NEW.storage_soilcat_id, 
			category_type=NEW.storage_category_type,fluid_type=NEW.storage_fluid_type, location_type=NEW.storage_location_type, workcat_id=NEW.storage_workcat_id, buildercat_id=NEW.storage_buildercat_id, 
			builtdate=NEW.storage_builtdate,ownercat_id=NEW.storage_ownercat_id, address_01=NEW.storage_address_01,address_02=NEW.storage_address_02, address_03=NEW.storage_address_03, descript=NEW.storage_descript,
			est_top_elev=NEW.storage_est_top_elev, est_ymax=NEW.storage_est_ymax, rotation=NEW.storage_rotation, link=NEW.storage_link, verified=NEW.verified, workcat_id_end=NEW.storage_workcat_id_end,
		...
		ELSIF man_table='man_valve' THEN
			...
			code=NEW.valve_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.valve_enddate, uncertain=NEW.uncertain, xyz_date=NEW.valve_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_chamber' THEN
			...
			"state"=NEW.state, annotation=NEW.chamber_annotation, "observ"=NEW.chamber_observ, "comment"=NEW.chamber_comment, dma_id=NEW.dma_id, soilcat_id=NEW.chamber_soilcat_id, 
			...
			builtdate=NEW.chamber_builtdate,ownercat_id=NEW.chamber_ownercat_id, address_01=NEW.chamber_address_01,address_02=NEW.chamber_address_02, address_03=NEW.chamber_address_03, descript=NEW.chamber_descript,
			...
			code=NEW.chamber_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.chamber_enddate, uncertain=NEW.uncertain, xyz_date=NEW.chamber_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_chamber_pol' THEN
			...
			IF (NEW.pol_id IS NULL) THEN
				UPDATE man_chamber SET node_id=NEW.node_id, pol_id=NEW.pol_id,total_volume=NEW.chamber_total_volume,total_height=NEW.chamber_total_height,
		...
		ELSIF man_table='man_manhole' THEN
			...
			sector_id=NEW.sector_id, "state"=NEW.state, annotation=NEW.manhole_annotation, "observ"=NEW.manhole_observ, "comment"=NEW.manhole_comment, dma_id=NEW.dma_id, soilcat_id=NEW.manhole_soilcat_id, 
			...
			code=NEW.manhole_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.manhole_enddate, uncertain=NEW.uncertain, xyz_date=NEW.manhole_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_netinit' THEN
			...
			"state"=NEW.state, annotation=NEW.netinit_annotation, "observ"=NEW.netinit_observ, "comment"=NEW.netinit_comment, dma_id=NEW.dma_id, soilcat_id=NEW.netinit_soilcat_id, 
			...
			builtdate=NEW.netinit_builtdate,ownercat_id=NEW.netinit_ownercat_id, address_01=NEW.netinit_address_01,address_02=NEW.netinit_address_02, address_03=NEW.netinit_address_03, descript=NEW.netinit_descript,
			...
			code=NEW.netinit_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.netinit_enddate, uncertain=NEW.uncertain, xyz_date=NEW.netinit_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_wjump' THEN
			...
			"state"=NEW.state, annotation=NEW.wjump_annotation, "observ"=NEW.wjump_observ, "comment"=NEW.wjump_comment, dma_id=NEW.dma_id, soilcat_id=NEW.wjump_soilcat_id, category_type=NEW.wjump_category_type,
			...
			address_01=NEW.wjump_address_01,address_02=NEW.wjump_address_02, address_03=NEW.wjump_address_03, descript=NEW.wjump_descript,est_top_elev=NEW.wjump_est_top_elev, est_ymax=NEW.wjump_est_ymax,
			...
			code=NEW.wjump_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.wjump_enddate, uncertain=NEW.uncertain, xyz_date=NEW.wjump_xyz_date, 
			unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
		...
		ELSIF man_table='man_wwtp' THEN
			...
			"state"=NEW.state, annotation=NEW.wwtp_annotation, "observ"=NEW.wwtp_observ, "comment"=NEW.wwtp_comment, dma_id=NEW.dma_id, soilcat_id=NEW.wwtp_soilcat_id, category_type=NEW.wwtp_category_type,
			...
			address_01=NEW.wwtp_address_01,address_02=NEW.wwtp_address_02, address_03=NEW.wwtp_address_03, descript=NEW.wwtp_descript,est_top_elev=NEW.wwtp_est_top_elev, est_ymax=NEW.wwtp_est_ymax, 
			...
			label_rotation=NEW.wwtp_label_rotation, the_geom=NEW.the_geom, code=NEW.wwtp_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.wwtp_enddate, 
		...
		ELSIF man_table='man_wwtp_pol' THEN
			...
			address_01=NEW.wwtp_address_01,address_02=NEW.wwtp_address_02, address_03=NEW.wwtp_address_03, descript=NEW.wwtp_descript,est_top_elev=NEW.wwtp_est_top_elev, est_ymax=NEW.wwtp_est_ymax, 
			rotation=NEW.wwtp_rotation, 	link=NEW.wwtp_link, verified=NEW.verified, workcat_id_end=NEW.wwtp_workcat_id_end, undelete=NEW.undelete, label_x=NEW.wwtp_label_x, label_y=NEW.wwtp_label_y,
			label_rotation=NEW.wwtp_label_rotation, code=NEW.wwtp_code, publish=NEW.publish, inventory=NEW.inventory, enddate=NEW.wwtp_enddate, 
			uncertain=NEW.uncertain, xyz_date=NEW.wwtp_xyz_date, unconnected=NEW.unconnected, expl_id=NEW.expl_id
			WHERE node_id = OLD.node_id;
