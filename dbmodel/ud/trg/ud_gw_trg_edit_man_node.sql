    ...
    IF TG_OP = 'INSERT' THEN
		...
		--Copy id to code field
			...
			INSERT INTO node (node_id, code, top_elev, custom_top_elev, ymax, custom_ymax, elev, custom_elev, node_type,nodecat_id,epa_type,sector_id,"state", state_type, annotation,observ,"comment",
				...
				NEW.muni_id, NEW.streetaxis_id, NEW.postcode,NEW.streetaxis2_id,NEW.postnumber,NEW.postnumber2,
		...
		ELSIF man_table='man_netgully' THEN
			...
			IF (rec.insert_double_geometry IS TRUE) THEN
				...
				NEW.groove, NEW.siphon, NEW.postnumber );
		...
		ELSIF man_table='man_netgully_pol' THEN
			...
			IF (rec.insert_double_geometry IS TRUE) THEN
				...
				INSERT INTO man_netgully (node_id,pol_id, sander_depth, gratecat_id, units, groove, siphon, postnumber ) VALUES(NEW.node_id, NEW.pol_id, NEW.sander_depth, NEW.gratecat_id, NEW.units, 
				NEW.groove, NEW.siphon, NEW.postnumber );
				INSERT INTO polygon(pol_id,the_geom) VALUES (NEW.pol_id,NEW.the_geom);
