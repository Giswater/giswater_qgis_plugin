...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
		...
		IF gully_geometry = 'gully' THEN
			...
			enddate=NEW.enddate, streetaxis_id=NEW.streetaxis_id, postnumber=NEW.postnumber,  connec_length=NEW.connec_length, connec_depth=NEW.connec_depth, expl_id=expl_id, uncertain=NEW.uncertain
