...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		IF v_matfromcat THEN
			...
			lastupdate, lastupdate_user, asset_id, drainzone_id, expl_id2, adate, adescript, plot_code, placement_type)
    ...
    ELSIF TG_OP = 'UPDATE' THEN
		...
		IF v_matfromcat THEN
			...
			plot_code=NEW.plot_code, placement_type=NEW.placement_type
