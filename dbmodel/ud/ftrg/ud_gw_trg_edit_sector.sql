...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		INSERT INTO sector (sector_id, name, descript, macrosector_id, the_geom, undelete, active, parent_id, stylesheet, avg_press, expl_id2)
		VALUES (NEW.sector_id, NEW.name, NEW.descript, NEW.macrosector_id, NEW.the_geom, NEW.undelete, NEW.active, NEW.parent_id, NEW.stylesheet, NEW.avg_press, NEW.expl_id2);
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		undelete=NEW.undelete, active=NEW.active, lastupdate=now(), lastupdate_user = current_user, stylesheet=NEW.stylesheet, avg_press = NEW.avg_press, expl_id2 = NEW.expl_id2
