...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		IF v_matfromcat THEN
			...
			hydraulic_capacity, meandering, conserv_state, om_state, last_visitdate, negativeoffset, drainzone_outfall, dwfzone_outfall)
			...
			NEW.registration_date, NEW.hydraulic_capacity, NEW.meandering, NEW.conserv_state, NEW.om_state, NEW.last_visitdate, NEW.negativeoffset, NEW.drainzone_outfall, NEW.dwfzone_outfall);
		ELSE
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		IF v_matfromcat THEN
			...
			meandering=NEW.meandering, conserv_state=NEW.conserv_state, om_state=NEW.om_state, last_visitdate=NEW.last_visitdate, negativeoffset=NEW.negativeoffset, drainzone_outfall=NEW.drainzone_outfall, dwfzone_outfall=NEW.dwfzone_outfall
