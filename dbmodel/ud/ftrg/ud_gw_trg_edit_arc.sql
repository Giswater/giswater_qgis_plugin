...
BEGIN
	...
	IF TG_OP = 'INSERT' THEN
		...
		IF v_matfromcat THEN
			...
			drainzone_id, parent_id, expl_id2, adate, adescript, placement_type, visitability, label_quadrant)
			...
			NEW.drainzone_id, NEW.parent_id, NEW.expl_id2, NEW.adate, NEW.adescript, NEW.placement_type, NEW.visitability, NEW.label_quadrant);
		ELSE
			...
			NEW.asset_id, NEW.pavcat_id, NEW.drainzone_id, NEW.parent_id, NEW.expl_id2, NEW.adate, NEW.adescript, NEW.placement_type, NEW.visitability, NEW.label_quadrant);
		END IF;
	...
	ELSIF TG_OP = 'UPDATE' THEN
		...
		IF v_matfromcat THEN
			...
			asset_id=NEW.asset_id, pavcat_id=NEW.pavcat_id, drainzone_id=NEW.drainzone_id, parent_id=NEW.parent_id, expl_id2=NEW.expl_id2, adate=NEW.adate, adescript=NEW.adescript, placement_type=NEW.placement_type,
			visitability=NEW.visitability, label_quadrant=NEW.label_quadrant
