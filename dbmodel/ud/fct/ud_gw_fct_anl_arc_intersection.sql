...
BEGIN
    ...
    -- Reset values
    DELETE FROM anl_review_arc WHERE cur_user="current_user"() AND context='Arc intersection';
    
	-- Computing process
    INSERT INTO anl_review_arc (arc_id, expl_id, context, arc_id_aux, the_geom_p)
