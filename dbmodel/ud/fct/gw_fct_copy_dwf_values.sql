...
CREATE OR REPLACE FUNCTION "SCHEMA_NAME".gw_fct_copy_dwf_values(p_data json) 
RETURNS json AS 
$BODY$

/*EXAMPLE
SELECT SCHEMA_NAME.gw_fct_copy_dwf_values($${"client":{"device":4, "infoType":1, "lang":"ES"}, "data":{"source":1, "target":2}}$$)
