...
DROP FUNCTION IF EXISTS SCHEMA_NAME.gw_fct_import_inp_dwf(json);
...
BEGIN
	...
	LOOP
		IF rec_csv.csv1 IS NOT NULL THEN -- to control those null rows because user has a bad structured csv file (common last lines)
				...
				VALUES (rec_csv.csv1, rec_csv.csv2, rec_csv.csv3, rec_csv.csv4, rec_csv.csv5, rec_csv.csv6, rec_csv.csv7)));
