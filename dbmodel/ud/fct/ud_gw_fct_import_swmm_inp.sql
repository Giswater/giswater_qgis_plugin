...
"feature":{}, "data":{"parameters":{"createSubcGeom":false, "debugMode":True}}}$$)
...
BEGIN
	...
	IF v_debugmode IS NOT TRUE THEN
		...
		IF v_status = 'Accepted' THEN
			...
			INSERT INTO config_param_user (parameter, value, cur_user) VALUES ('inp_options_dwfscenario_current', '1', current_user);
