...
CREATE OR REPLACE FUNCTION ud_sample.gw_fct_utils_csv2pg_export_swmm_inp(p_result_id character varying,  p_path text)
RETURNS void AS
$BODY$

/*EXAMPLE
SELECT ud_sample.gw_fct_utils_csv2pg_export_swmm_inp('result_1', 'D:\dades\test_ud.inp')
*/
