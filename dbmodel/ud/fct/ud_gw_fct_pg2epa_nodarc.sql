...
result_id
millorar les taules rpt_inp_arc 6 rpt_inp_node. Fer-les més petites, només amb la informació que ens fa falta
Modificar les claus foraneas de les taules de resultats, cap a rpt_inp_arc_ rpt_inp_node
