...
JOIN rpt_arcflow_sum ON (((rpt_arcflow_sum.arc_id)::text = (arc.arc_id)::text) AND ((arc.arc_id)::text = (rpt_arcflow_sum.arc_id)::text))
WHERE ((rpt_arcflow_sum.result_id)::text = (rpt_selector_compare.result_id)::text)
...
FROM rpt_selector_compare, rpt_arcpolload_sum
JOIN arc ON (((rpt_arcpolload_sum.arc_id)::text = (arc.arc_id)::text))
WHERE ((rpt_selector_compare.result_id)::text = (rpt_arcpolload_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare,rpt_condsurcharge_sum
JOIN arc ON ((arc.arc_id)::text = (rpt_condsurcharge_sum.arc_id)::text)
WHERE (((rpt_selector_compare.result_id)::text = (rpt_condsurcharge_sum.result_id)::text) AND ((rpt_selector_compare.result_id)::text = (rpt_condsurcharge_sum.result_id)::text))
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_continuity_errors, rpt_selector_compare 
WHERE ((rpt_continuity_errors.result_id)::text = (rpt_selector_compare.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_critical_elements 
JOIN rpt_selector_compare ON ((rpt_critical_elements.result_id)::text = (rpt_selector_compare.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_flowclass_sum.result_id)::text = (rpt_selector_compare.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_flowrouting_cont.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_groundwater_cont.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE((rpt_selector_compare.result_id)::text = (rpt_continuity_errors.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_high_flowinest_ind.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_instability_index.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare, rpt_lidperformance_sum
JOIN subcatchment ON ((rpt_lidperformance_sum.subc_id)::text = (subcatchment.subc_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_lidperformance_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare, rpt_nodedepth_sum
JOIN node ON ((rpt_nodedepth_sum.node_id)::text = (node.node_id)::text)
WHERE (((rpt_nodedepth_sum.result_id)::text = (rpt_selector_compare.result_id)::text) AND ((rpt_selector_compare.result_id)::text = (rpt_nodedepth_sum.result_id)::text))
AND rpt_selector_compare.cur_user="current_user"()::text;
...
JOIN rpt_nodeflooding_sum ON ((rpt_nodeflooding_sum.node_id)::text = (node.node_id)::text)
WHERE ((rpt_nodeflooding_sum.result_id)::text = (rpt_selector_compare.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare, rpt_nodeinflow_sum
JOIN node ON ((rpt_nodeinflow_sum.node_id)::text = (node.node_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_nodeinflow_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare, rpt_nodesurcharge_sum
JOIN node ON ((rpt_nodesurcharge_sum.node_id)::text = (node.node_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_nodesurcharge_sum.result_id)::text) 
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare,rpt_outfallflow_sum
JOIN node ON ((node.node_id)::text = (rpt_outfallflow_sum.node_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_outfallflow_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare,rpt_outfallload_sum
JOIN node ON ((node.node_id)::text = (rpt_outfallload_sum.node_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_outfallload_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare, rpt_pumping_sum
JOIN arc ON ((arc.arc_id)::text = (rpt_pumping_sum.arc_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_pumping_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_qualrouting_cont, rpt_selector_compare
WHERE ((rpt_selector_compare.result_id)::text = (rpt_qualrouting_cont.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_rainfall_dep, rpt_selector_compare
WHERE ((rpt_selector_compare.result_id)::text = (rpt_rainfall_dep.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_routing_timestep.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_runoff_qual.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_runoff_quant.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare, rpt_storagevol_sum 
JOIN node ON ((node.node_id)::text = (rpt_storagevol_sum.node_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_storagevol_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare,rpt_subcathrunoff_sum
JOIN subcatchment ON ((rpt_subcathrunoff_sum.subc_id)::text = (subcatchment.subc_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_subcathrunoff_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
FROM rpt_selector_compare,rpt_subcatchwashoff_sum 
JOIN subcatchment ON ((rpt_subcatchwashoff_sum.subc_id)::text = (subcatchment.subc_id)::text)
WHERE ((rpt_selector_compare.result_id)::text = (rpt_subcatchwashoff_sum.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;
...
WHERE ((rpt_selector_compare.result_id)::text = (rpt_timestep_critelem.result_id)::text)
AND rpt_selector_compare.cur_user="current_user"()::text;