...
ALTER TABLE ONLY "db_cat_table_x_column" ADD CONSTRAINT "db_cat_table_x_column_db_cat_table_fkey" FOREIGN KEY ("table_id") REFERENCES db_cat_table("id") ON UPDATE CASCADE ON DELETE RESTRICT;
