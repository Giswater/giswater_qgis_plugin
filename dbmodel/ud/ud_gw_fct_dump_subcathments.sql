...
-- Function: "sample_ud".gw_dump_subcatchments()

CREATE OR REPLACE FUNCTION "sample_ud".gw_dump_subcatchments() RETURNS SETOF character varying LANGUAGE plpgsql AS $$
DECLARE
