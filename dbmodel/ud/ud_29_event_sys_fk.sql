...
ALTER TABLE "event_x_gully" ADD FOREIGN KEY ("event_id") REFERENCES "event" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "event_x_gully" ADD FOREIGN KEY ("gully_id") REFERENCES "gully" ("gully_id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "event_x_gully" ADD FOREIGN KEY ("parameter_id") REFERENCES "event_parameter" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "event_x_gully" ADD FOREIGN KEY ("position_id") REFERENCES "event_position" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
