...
--ALTER TABLE "cat_arc_shape" ADD CONSTRAINT "cat_arc_shape_curve_id_fkey" FOREIGN KEY ("curve_id") REFERENCES "inp_curve" ("curve_id") ON DELETE CASCADE ON UPDATE CASCADE;
