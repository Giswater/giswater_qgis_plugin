...
ALTER TABLE "gully" ADD CONSTRAINT "gully_conneccat_id_fkey" FOREIGN KEY ("connec_arccat_id") REFERENCES "cat_connec" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "gully" ADD CONSTRAINT "gully_category_type_fkey" FOREIGN KEY ("category_type", "feature_type") REFERENCES "man_type_category" ("category_type", "feature_type") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "gully" ADD CONSTRAINT "gully_function_type_fkey" FOREIGN KEY ("function_type", "feature_type") REFERENCES "man_type_function" ("function_type", "feature_type") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "gully" ADD CONSTRAINT "gully_fluid_type_fkey" FOREIGN KEY ("fluid_type", "feature_type") REFERENCES "man_type_fluid" ("fluid_type", "feature_type") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "gully" ADD CONSTRAINT "gully_location_type_fkey" FOREIGN KEY ("location_type", "feature_type") REFERENCES "man_type_location" ("location_type", "feature_type") ON DELETE RESTRICT ON UPDATE CASCADE;
