...
ALTER TABLE SCHEMA_NAME.sys_feature_cat ADD CONSTRAINT sys_feature_cat_check CHECK (id IN ('CHAMBER','CONDUIT','CONNEC','GULLY','JUNCTION','MANHOLE','NETELEMENT','NETGULLY','NETINIT','OUTFALL','SIPHON','STORAGE','VALVE','VARC','WACCEL','WJUMP','WWTP','ELEMENT'));
