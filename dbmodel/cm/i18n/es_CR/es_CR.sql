...
FROM (
    ...
    ('graph_check', 'generic', 'check_project_cm', 'Comprobar datos del grafo:', 'Comprobar los datos del gráfico:'),
    ('plan_check', 'generic', 'check_project_cm', 'Comprobar datos de planificación:', 'Comprobar los datos de planificación:'),
    ('admin_check', 'generic', 'check_project_cm', 'Comprobar datos de administración:', 'Comprobar los datos de administración:'),
    ('om_check', 'generic', 'check_project_cm', 'Comprobar datos om:', 'Comprobar datos operacionales:'),
    ('Info:', 'generic', 'check_project_cm', NULL, NULL),
    ('epa_check', 'generic', 'check_project_cm', 'Comprobar datos EPA:', 'Comprobar los datos de la EPA:'),
