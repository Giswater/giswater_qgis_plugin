...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_visit_lot', 'Table with all lots that took place', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_visit_lot_x_arc', 'Table of arcs related to lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_visit_lot_x_connec', 'Table of connecs related to lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_visit_lot_x_node', 'Table of nodes related to lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_visit_class_x_wo', 'Table that relates workorders with visitclass', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_visit_lot_x_user', 'Table that saves information about works made by a user in relation to one lot', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ext_cat_vehicle', 'External catalog of vehicles', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_team_x_vehicle', 'Relation between teams and their vehicles', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_vehicle_x_parameters', 'Relation between vehicles and their parameters', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('om_team_x_visitclass', 'Relation between teams and visitclass', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('v_visit_lot_user', 'Lot user view', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;

INSERT INTO PARENT_SCHEMA.sys_table VALUES ('v_ui_om_visit_lot', 'User interface view for lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ve_lot_x_node', 'View that relates nodes and lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ve_lot_x_arc', 'View that relates arcs and lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ve_lot_x_connec', 'View that relates connecs and lots', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('v_ui_om_vehicle_x_parameters', 'User interface view of the realtion between vehicles and their parameters', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('v_om_team_x_visitclass', 'View with the relation between teams and visitclass', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('v_ext_cat_vehicle', 'Editable view for ext_cat_vehicle', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('v_om_lot_x_user', 'View with the information aobut works made by a user in relation to one lot', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'lot_plugin') ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ve_lot_x_arc_web', 'View to publish arcs related to lots on web', 'role_om', 0) ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ve_lot_x_node_web', 'View to publish nodes related to lots on web', 'role_om', 0) ON CONFLICT (id) DO NOTHING;
INSERT INTO PARENT_SCHEMA.sys_table VALUES ('ve_lot_x_connec_web', 'View to publish connecs related to lots on web', 'role_om', 0) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_function VALUES (2912, 'gw_fct_setvehicleload', 'lot_manage', 'function', 'json', 'json', 'Function to set loads of vehicles (vehicle management)', 'role_om', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_function VALUES (2840, 'gw_trg_edit_cat_vehicle', 'utils', 'trigger function', NULL, NULL, 'Makes editable v_ext_cat_vehicle', 'role_om', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.sys_function VALUES (2844, 'gw_trg_edit_team_x_vehicle', 'utils', 'trigger function', NULL, NULL, 'Makes editable v_om_team_x_vehicle', 'role_om', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.config_typevalue VALUES ('widgetfunction_typevalue', 'set_vehicle_load', 'set_vehicle_load', 'gwSetVehicleLoad')
...
UPDATE SCHEMA_NAME.config_visit_class_x_workorder SET active = TRUE;
...
/*config_form_list*/
INSERT INTO PARENT_SCHEMA.config_form_list VALUES ('om_visit_lot', 'SELECT a.id AS sys_id, ''om_visit_lot'' as sys_listname, ''id'' as sys_idname, a.id AS lot_id, c.idval AS visitclass_id, t.idval AS status FROM om_visit_lot a 
...
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('visit_manager', 'form_visit', 'tab_none', 'lot_id', 'lyt_data_1', 5, 'text', 'combo', 'Lot', NULL, NULL, false, false, true, false, false, 'SELECT u.id, concat( u.id, '' | '',u.visitclass_id,'' | '',u.status) as idval FROM v_ui_om_visit_lot u JOIN ud.om_visit_lot USING (id) 
...
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_visit_lot', 'form_list_header', 'tab_none', 'team_id', 'lyt_data_1', 1, 'text', 'combo', 'Team', NULL, NULL, false, false, false, false, false, 'SELECT id, idval FROM cat_team', NULL, NULL, NULL, NULL, NULL, '{"setMultiline":false}', NULL, NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_visit_lot', 'form_list_header', 'tab_none', 'limit', 'lyt_data_1', 2, 'integer', 'text', 'Limit', NULL, NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, '{"vdefault":15}', NULL, NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_visit_lot', 'form_list_footer', 'tab_none', 'createlot', 'lyt_data_1', 3, NULL, 'button', 'CREATE NEW LOT', NULL, NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, '{"setMultiline":false}', '{"functionName": "get_lot"}', NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
...
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_vehicle_x_parameters', 'form_list_header', 'tab_none', 'team_id', 'lyt_data_1', 1, 'text', 'combo', 'Team', NULL, NULL, false, true, false, false, false, 'SELECT id, idval FROM cat_team', NULL, NULL, NULL, NULL, NULL, '{"setMultiline":false}', NULL, NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_vehicle_x_parameters', 'form_list_header', 'tab_none', 'vehicle_id', 'lyt_data_1', 2, 'text', 'combo', 'Vehicle', NULL, NULL, false, false, true, false, false, 'SELECT DISTINCT(ext_cat_vehicle .id), idval FROM ext_cat_vehicle 
JOIN om_team_x_vehicle ON  om_team_x_vehicle.vehicle_id = ext_cat_vehicle.id
JOIN om_visit_lot_x_user USING (team_id)
WHERE ext_cat_vehicle.id IS NOT NULL AND user_id = current_user', NULL, NULL, 'team_id', ' AND team_id', NULL, '{"setMultiline":false}', NULL, NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_vehicle_x_parameters', 'form_list_header', 'tab_none', 'load', 'lyt_data_1', 3, 'text', 'text', 'Load', NULL, NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, '{"setMultiline":false}', NULL, NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
INSERT INTO PARENT_SCHEMA.config_form_fields VALUES ('om_vehicle_x_parameters', 'form_list_footer', 'tab_none', 'acceptbutton', 'lyt_data_3', 1, NULL, 'button', 'Accept', NULL, NULL, false, false, true, false, false, NULL, NULL, NULL, NULL, NULL, NULL, '{"setMultiline":false}', '{"functionName": "set_vehicle_load"}', NULL, false) ON CONFLICT (formname, formtype, columnname, tabname) DO NOTHING;
...
ALTER TABLE SCHEMA_NAME.ext_cat_vehicle ALTER COLUMN id set default nextval('ext_cat_vehicle_id_seq');
