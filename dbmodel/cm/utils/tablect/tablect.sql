...
REFERENCES PARENT_SCHEMA.config_visit_class (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT;
...
REFERENCES PARENT_SCHEMA.config_visit_class (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE;
