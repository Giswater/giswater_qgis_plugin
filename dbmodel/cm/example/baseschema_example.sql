...
(9, '11111111A', 'o1_field1', 'o1_field1', 'o1_field1', 'o1 field 1', 4, true);

-- Team: o1 field 2
INSERT INTO cat_user (user_id, code, loginname, username, fullname, descript, team_id, active) VALUES
(10,  '46283910L', 'ngallart',  'ngallart',  'Nuria Gallart Costa',  'o1 field 2', 5, true),
(11, '57201894W', 'omartin',   'omartin',   'Oscar Martin Serra',   'o1 field 2', 5, true),
(12, '22222222B', 'o1_field2', 'o1_field2', 'o1_field2', 'o1 field 2', 5, true);

-- Team: o2 field 1
INSERT INTO cat_user (user_id, code, loginname, username, fullname, descript, team_id, active) VALUES
(13, '68391740T', 'iramos',    'iramos',    'Ines Ramos Vega',      'o2 field 1', 6, true),
(14, '78291034X', 'pablo',     'pablo',     'Pablo Nuñez Bravo',    'o2 field 1', 6, true),
(15, '33333333C', 'o2_field1', 'o2_field1', 'o2_field1', 'o2 field 1', 6, true);

-- Team: o2 field 2
INSERT INTO cat_user (user_id, code, loginname, username, fullname, descript, team_id, active) VALUES
(16, '84023910S', 'cgil',      'cgil',      'Carla Gil Torras',     'o2 field 2', 7, true),
(17, '92034185M', 'rbueno',    'rbueno',    'Raul Bueno Soler',     'o2 field 2', 7, true),
(18, '44444444D', 'o2_field2', 'o2_field2', 'o2_field2', 'o2 field 2', 7, true);

-- Easy user for test in local
INSERT INTO cat_user (user_id, code, loginname, username, fullname, descript, team_id, active) VALUES
(19, '92034185M', 'postgres', 'postgres', 'Postgres', 'o2 field 2', 1, true);
