...
/*
SELECT gw_fct_create_logreturn_cm($${"data":{"parameters":{"type":"info"}}}$$);
SELECT gw_fct_create_logreturn_cm($${"data":{"parameters":{"type":"point"}}}$$);
SELECT gw_fct_create_logreturn_cm($${"data":{"parameters":{"type":"line"}}}$$);
SELECT gw_fct_create_logreturn_cm($${"data":{"parameters":{"type":"polygon"}}}$$);
*/
...
ALTER FUNCTION SCHEMA_NAME.gw_fct_create_logreturn_cm(json) OWNER TO postgres;
GRANT ALL ON FUNCTION SCHEMA_NAME.gw_fct_create_logreturn_cm(json) TO public;
GRANT ALL ON FUNCTION SCHEMA_NAME.gw_fct_create_logreturn_cm(json) TO postgres;
GRANT ALL ON FUNCTION SCHEMA_NAME.gw_fct_create_logreturn_cm(json) TO role_basic;
