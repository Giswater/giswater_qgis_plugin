CREATE OR REPLACE FUNCTION "SCHEMA_NAME"."gw_fct_getevent"(event_id int8, arc_id varchar) RETURNS pg_catalog.json AS $BODY$
DECLARE
...
--    Get form data
    form_data := gw_fct_geteventform(event_data.parameter_id, arc_id);
