...
INSERT INTO ext_workorder_type VALUES ('VINSP', 'Valve Inspection', NULL);
...
INSERT INTO config_visit_class VALUES (7, 'Connec Incident', NULL, true, false, true, 'CONNEC', 'role_om', 2, '{"offlineDefault":"true"}', 'visit_connec_incid', 've_visit_connec_incid', 'v_ui_visit_connec_incid');
INSERT INTO config_visit_class VALUES (8, 'Generic Incident', NULL, true, false, true, NULL, 'role_om', 2, '{"offlineDefault":"true"}', 'visit_incident', 've_visit_incident', 'v_ui_visit_incident');
INSERT INTO config_visit_class VALUES (9, 'Inspection Valves', NULL, true, false, true, 'NODE', 'role_om', 1, '{"offlineDefault":"true", "sysType":"VALVE"}', 'visit_valve_insp', 've_visit_valve_insp', 'v_ui_visit_valve_insp');

UPDATE config_visit_class SET param_options='{"offlineDefault":"true"}' WHERE id IN (2, 5, 6);
...
INSERT INTO config_visit_class_x_workorder VALUES (9, 'VINSP');
...
INSERT INTO config_visit_parameter VALUES ('clean_valve', NULL, 'INSPECTION', 'NODE', 'TEXT', NULL, 'Clean valve', 'event_standard', NULL, TRUE, NULL, TRUE);
INSERT INTO config_visit_parameter VALUES ('defect_valve', NULL, 'INSPECTION', 'NODE', 'TEXT', NULL, 'Defect on valve', 'event_standard', NULL, TRUE, NULL, TRUE);
INSERT INTO config_visit_parameter VALUES ('manipulate_valve', NULL, 'INSPECTION', 'NODE', 'TEXT', NULL, 'Manipulate valve', 'event_standard', NULL, TRUE, NULL, TRUE);
INSERT INTO config_visit_parameter VALUES ('observ_valve', NULL, 'INSPECTION', 'NODE', 'TEXT', NULL, 'Observ on valve', 'event_standard', NULL, TRUE, NULL, TRUE);
...
INSERT INTO config_visit_class_x_parameter VALUES (8, 'incident_location');
INSERT INTO config_visit_class_x_parameter VALUES (8, 'photo');
INSERT INTO config_visit_class_x_parameter VALUES (9, 'clean_valve');
INSERT INTO config_visit_class_x_parameter VALUES (9, 'defect_valve');
INSERT INTO config_visit_class_x_parameter VALUES (9, 'manipulate_valve');
INSERT INTO config_visit_class_x_parameter VALUES (9, 'observ_valve');
INSERT INTO config_visit_class_x_parameter VALUES (9, 'photo');
...
INSERT INTO om_team_x_visitclass (team_id, visitclass_id) VALUES (1, 9) ON CONFLICT (team_id, visitclass_id) DO NOTHING;
 ...
 SELECT om_visit_x_connec.visit_id,
   ...
   FROM om_visit
     ...
     LEFT JOIN ( SELECT ct.visit_id,
      ...
      JOIN SCHEMA_NAME.config_visit_class on config_visit_class.id=om_visit.class_id
...
INSERT INTO sys_table VALUES ('ve_visit_connec_incid', 'View related to specific visit class', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- ve_visit_valve_insp
INSERT INTO sys_table VALUES ('ve_visit_valve_insp', 'View related to specific visit class', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
 ...
 SELECT om_visit_x_node.visit_id,
   ...
   FROM om_visit
     ...
     LEFT JOIN ( SELECT ct.visit_id,
      ...
      FROM SCHEMA_NAME.om_visit JOIN SCHEMA_NAME.om_visit_event ON om_visit.id= om_visit_event.visit_id 
      JOIN SCHEMA_NAME.config_visit_class on config_visit_class.id=om_visit.class_id
      where config_visit_class.ismultievent = TRUE AND config_visit_class.id=9 ORDER  BY 1,2'::text, ' VALUES (''defect_valve''),(''clean_valve''),(''manipulate_valve''),(''observ_valve''), (''photo'')'::text) ct(visit_id integer, param_1 text, param_2 text, param_3 boolean, param_4 text, param_5 boolean)) a ON a.visit_id = om_visit.id
     LEFT JOIN om_typevalue d ON d.id::text = a.param_1 AND d.typevalue = 'visit_defect'::text
     LEFT JOIN om_typevalue c ON c.id::text = a.param_2 AND c.typevalue = 'visit_cleaned'::text
...
--ve_visit_connec_incid
INSERT INTO config_form_fields VALUES ('visit_connec_incid', 'form_visit', 'class_id', 1,  NULL, 'combo', 'Visit class:', NULL, NULL, NULL, true, false, false, false, 'SELECT id, idval FROM config_visit_class WHERE id=7', NULL, NULL, NULL, NULL, 'get_visit', NULL, NULL, NULL, 'lyt_data_1', NULL, false);
...
INSERT INTO config_form_fields VALUES ('visit_connec_incid', 'form_visit', 'incident_type', 5, NULL, 'combo', 'Incident:', NULL, NULL, NULL, false, false, true, false, 'SELECT id, idval FROM om_typevalue WHERE typevalue=''incident_type''', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'lyt_data_1', NULL, false);
...
INSERT INTO config_form_fields VALUES ('visit_connec_incid', 'form_visit', 'status', 7, NULL, 'combo', 'Status:', NULL, NULL, NULL, false, false, true, false, 'SELECT id, idval FROM om_typevalue WHERE typevalue=''visit_status'' AND id::integer IN (2,3,4)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'lyt_data_1', NULL, false);
...
--ve_visit_valve_insp
INSERT INTO config_form_fields VALUES ('visit_valve_insp', 'form_visit', 'class_id', 1,  NULL, 'combo', 'Visit class:', NULL, NULL, NULL, true, false, false, false, 'SELECT id, idval FROM config_visit_class WHERE id=9', NULL, NULL, NULL, NULL, 'get_visit', NULL, NULL, NULL, 'lyt_data_1', NULL, false);
...
INSERT INTO config_form_fields VALUES ('visit_valve_insp', 'form_visit', 'defect_valve', 6, NULL, 'combo', 'Defects:', NULL, NULL, NULL, false, false, true, false, 'SELECT id, idval FROM om_typevalue WHERE typevalue=''visit_defect''', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'lyt_data_1', NULL, false);
INSERT INTO config_form_fields VALUES ('visit_valve_insp', 'form_visit', 'clean_valve', 7, NULL, 'combo', 'Clean:', NULL, NULL, NULL, false, false, true, false, 'SELECT id, idval FROM om_typevalue WHERE typevalue=''visit_cleaned''', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'lyt_data_1', NULL, false);
...
INSERT INTO config_form_fields VALUES ('visit_valve_insp', 'form_visit', 'status', 10, NULL, 'combo', 'Status:', NULL, NULL, NULL, false, false, true, false, 'SELECT id, idval FROM om_typevalue WHERE typevalue=''visit_status'' AND id::integer IN (2,3,4)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'lyt_data_1', NULL, false);
...
INSERT INTO sys_table VALUES ('v_ui_visit_connec_incid', 'User interface view related to specific visit class', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO sys_table VALUES ('v_ui_visit_valve_insp', 'User interface view related to specific visit class', 'role_om', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
