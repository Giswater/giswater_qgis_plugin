...
DROP TRIGGER IF EXISTS gw_trg_update_workcat_geom ON "SCHEMA_NAME".gully;
CREATE TRIGGER gw_trg_update_workcat_geom AFTER INSERT OR UPDATE OF the_geom, workcat_id, workcat_id_end OR DELETE
ON SCHEMA_NAME.gully FOR EACH ROW EXECUTE PROCEDURE SCHEMA_NAME.gw_trg_update_workcat_geom();
