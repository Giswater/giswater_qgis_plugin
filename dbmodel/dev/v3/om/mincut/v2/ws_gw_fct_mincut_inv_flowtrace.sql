		...
		LOOP
			...
			*/
			...
			query_text:= 'SELECT * FROM pgr_dijkstra( 
				...
				JOIN SCHEMA_NAME.exploitation ON ve_arc.expl_id=exploitation.expl_id 
				LEFT JOIN (
					SELECT arc_id, true as closed FROM SCHEMA_NAME.ve_arc JOIN SCHEMA_NAME.exploitation ON ve_arc.expl_id=exploitation.expl_id
					WHERE 
