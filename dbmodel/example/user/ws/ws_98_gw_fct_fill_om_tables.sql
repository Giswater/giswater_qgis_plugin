  ...
  --Insert Catalog of visit
   ...
   --ARCS
    ...
    LOOP
        ...
        VALUES(rec_arc.arc_id, 1, now(), now(), 'postgres', rec_arc.expl_id, 1, 1, 2, 'No other problems', False);
    END LOOP;
   ...
   --CONNECS
    ...
    LOOP
        ...
        VALUES(rec_connec.connec_id, 1, now(), now(), 'postgres', rec_connec.expl_id, 2, 1, 2, 'No other problems', False);
    END LOOP;       
    ...
    LOOP    
        ...
        VALUES(rec_node.node_id, 1, now(), now(), 'postgres', rec_node.expl_id, 3, 1, 1, 4, 1, 'No other problems', False);
    END LOOP;
    ...
    LOOP
        ...
        VALUES(rec_node.node_id, 1, now(), now(), 'postgres', rec_node.expl_id, 4, 1, 6, 'Minor loss of water', False);
    END LOOP;    
