...
INSERT INTO man_addfields_parameter (param_name, cat_feature_id, is_mandatory, datatype_id, field_length, num_decimals, default_value, form_label,
widgettype_id,orderby, active, iseditable) 
VALUES ('staticpressure', 'PIPE', true, 'integer', NULL, NULL, '{"fprocesscat_id":"47"}', 'as', 'QTextEdit', 3 , true, false);

INSERT INTO man_addfields_parameter (param_name, cat_feature_id, is_mandatory, datatype_id, field_length, num_decimals, default_value, form_label,
widgettype_id,orderby, active, iseditable) 
VALUES ('staticpressure', 'JUNCTION', true, 'integer', NULL, NULL, '{"fprocesscat_id":"47"}', 'AS', 'QTextEdit', 3 , true, false);
