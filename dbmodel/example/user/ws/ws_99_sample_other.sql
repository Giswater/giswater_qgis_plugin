...
-- 19/02/2025
UPDATE config_form_fields SET formname='generic', formtype='psector', tabname='tab_general', columnname='descript', layoutname='lyt_general_2', layoutorder=13, "datatype"='text', widgettype='textarea', "label"='Descript:', tooltip='Descript', placeholder=NULL, ismandatory=false, isparent=false, iseditable=true, isautoupdate=false, isfilter=false, dv_querytext=NULL, dv_orderby_id=NULL, dv_isnullvalue=NULL, dv_parent_id=NULL, dv_querytext_filterc=NULL, stylesheet=NULL, widgetcontrols='{"setMultiline":false}'::json, widgetfunction=NULL, linkedobject=NULL, hidden=false, web_layoutorder=4 WHERE formname='generic' AND formtype='psector' AND tabname='tab_general' AND columnname='descript' AND layoutname='lyt_general_2' AND layoutorder=13 AND "datatype"='text' AND widgettype='textarea' AND "label"='Descript:' AND tooltip='Descript' AND placeholder IS NULL AND ismandatory=false AND isparent=false AND iseditable=true AND isautoupdate=false AND isfilter=false AND dv_querytext IS NULL AND dv_orderby_id IS NULL AND dv_isnullvalue IS NULL AND dv_parent_id IS NULL;
UPDATE config_form_fields SET formname='generic', formtype='psector', tabname='tab_general', columnname='expl_id', layoutname='lyt_general_2', layoutorder=33, "datatype"='string', widgettype='combo', "label"='Exploitation:', tooltip='Exploitation', placeholder=NULL, ismandatory=false, isparent=false, iseditable=true, isautoupdate=false, isfilter=false, dv_querytext='SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id != 0', dv_orderby_id=NULL, dv_isnullvalue=NULL, dv_parent_id=NULL, dv_querytext_filterc=NULL, stylesheet='{"label":"color:red; font-weight:bold"}'::json, widgetcontrols='{"setMultiline":false}'::json, widgetfunction=NULL, linkedobject=NULL, hidden=false, web_layoutorder=0 WHERE formname='generic' AND formtype='psector' AND tabname='tab_general' AND columnname='expl_id' AND layoutname='lyt_general_2' AND layoutorder=33 AND "datatype"='string' AND widgettype='combo' AND "label"='Exploitation:' AND tooltip='Exploitation' AND placeholder IS NULL AND ismandatory=false AND isparent=false AND iseditable=true AND isautoupdate=false AND isfilter=false AND dv_querytext='SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id != 0' AND dv_orderby_id IS NULL AND dv_isnullvalue IS NULL AND dv_parent_id IS NULL;
UPDATE config_form_fields SET formname='generic', formtype='psector', tabname='tab_general', columnname='observ', layoutname='lyt_general_2', layoutorder=15, "datatype"='text', widgettype='textarea', "label"='Observation', tooltip='Observation', placeholder=NULL, ismandatory=false, isparent=false, iseditable=true, isautoupdate=false, isfilter=false, dv_querytext=NULL, dv_orderby_id=NULL, dv_isnullvalue=NULL, dv_parent_id=NULL, dv_querytext_filterc=NULL, stylesheet=NULL, widgetcontrols='{"setMultiline":false}'::json, widgetfunction=NULL, linkedobject=NULL, hidden=false, web_layoutorder=4 WHERE formname='generic' AND formtype='psector' AND tabname='tab_general' AND columnname='observ' AND layoutname='lyt_general_2' AND layoutorder=15 AND "datatype"='text' AND widgettype='textarea' AND "label"='Observation' AND tooltip='Observation' AND placeholder IS NULL AND ismandatory=false AND isparent=false AND iseditable=true AND isautoupdate=false AND isfilter=false AND dv_querytext IS NULL AND dv_orderby_id IS NULL AND dv_isnullvalue IS NULL AND dv_parent_id IS NULL;
