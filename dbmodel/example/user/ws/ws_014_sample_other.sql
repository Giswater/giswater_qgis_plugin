...
UPDATE config_form_fields SET layoutorder =1 , layoutname ='lyt_bot_2' WHERE columnname ='sector_id' AND (formname not in ('ve_link'));;
...
UPDATE config_form_fields SET  hidden = true where columnname = 'feature_id' AND (formname not in ('ve_link'));;
...
UPDATE config_form_fields SET layoutname = 'lyt_bot_1' where columnname ='state' AND (formname not in ('ve_link','v_edit_dimensions','mincut_manager'));
UPDATE config_form_fields SET layoutname = 'lyt_bot_1' where columnname ='state_type';
UPDATE config_form_fields SET layoutname = 'lyt_bot_1' where columnname ='sector_id' AND (formname not in ('ve_link','v_edit_dimensions'));
UPDATE config_form_fields SET layoutname = 'lyt_data_1',layoutorder = 997 where columnname ='hemisphere';
--UPDATE config_form_fields SET layoutorder = 2 where columnname ='dma_id' AND (formname not in ('ve_link','v_edit_dimensions'));
...
UPDATE config_form_fields SET layoutname = 'lyt_data_2', layoutorder = 33 where columnname ='expl_id' AND (formname not in ('ve_link','v_edit_dimensions'));
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=7 WHERE formname='v_ui_sector' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=7 WHERE formname='v_ui_dma' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=6 WHERE formname='v_ui_presszone' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=7 WHERE formname='v_ui_dqa' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=7 WHERE formname='v_ui_supplyzone' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=5 WHERE formname='v_ui_macrodma' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
UPDATE config_form_fields SET layoutname='lyt_data_1', layoutorder=5 WHERE formname='v_ui_macrosector' AND formtype='form_feature' AND columnname='lock_level' AND tabname='tab_none';
...
-- update datasource to ve_arc, ve_arc, ve_connec, ve_connec and ve_element
UPDATE config_form_fields SET "datatype"='integer', widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''value_datasource''', dv_orderby_id=true, dv_isnullvalue=true, dv_querytext_filterc=NULL WHERE formname='ve_arc' AND formtype='form_feature' AND columnname='datasource' AND tabname='tab_data';
...
UPDATE config_form_fields SET "datatype"='integer', widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''value_datasource''', dv_orderby_id=true, dv_isnullvalue=true, dv_querytext_filterc=NULL WHERE formname='ve_connec' AND formtype='form_feature' AND columnname='datasource' AND tabname='tab_data';
...
WHERE (formname='ve_arc' OR formname ILIKE 've_arc_%' OR formname='ve_connec' OR formname ILIKE 've_connec_%' OR formname='ve_node' OR formname ILIKE 've_node_%' OR formname='v_edit_element' OR formname ILIKE 've_element_%' )
...
-- 21/02/2025
UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_valve_connectiontype''', dv_isnullvalue=True WHERE formname ILIKE 've_node%_valve' AND formtype='form_feature' AND columnname='connection_type' AND tabname='tab_data';

UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_tank_shape''', dv_isnullvalue=False WHERE formname ILIKE 've_node%_tank' AND formtype='form_feature' AND columnname='shape' AND tabname='tab_data';

UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_tank_fencetype''', dv_isnullvalue=True WHERE formname ILIKE 've_node%_tank' AND formtype='form_feature' AND columnname='fence_type' AND tabname='tab_data';

UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_netelement_fencetype''', dv_isnullvalue=False WHERE formname ILIKE 've_node%_netelement' AND formtype='form_feature' AND columnname='fence_type' AND tabname='tab_data';

UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_hydrant_hydranttype''', dv_isnullvalue=True WHERE formname ILIKE 've_node%_hydrant' AND formtype='form_feature' AND columnname='hydrant_type' AND tabname='tab_data';

UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_source_sourcetype''', dv_isnullvalue=false WHERE formname ILIKE 've_node%_source' AND formtype='form_feature' AND columnname='source_type' AND tabname='tab_data';

UPDATE config_form_fields SET widgettype='combo', dv_querytext='SELECT id, idval FROM edit_typevalue WHERE typevalue = ''man_source_aquifertype''', dv_isnullvalue=false WHERE formname ILIKE 've_node%_source' AND formtype='form_feature' AND columnname='aquifer_type' AND tabname='tab_data';
