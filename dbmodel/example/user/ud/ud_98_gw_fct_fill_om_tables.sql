...
BEGIN
	...
	INSERT INTO om_visit_cat (id, name, startdate, enddate) VALUES(1, 'Test', now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM() * 100)));
        ...
        LOOP
            ...
            --Insert visit
            INSERT INTO om_visit (visitcat_id, startdate, enddate, expl_id, user_name, the_geom, status) VALUES(1, now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM()*5)), 
            rec_node.expl_id, 'demo_user', rec_node.the_geom, 4) RETURNING id INTO id_last;
            ...
            LOOP
                ...
                VALUES(id_last, id_event_last, now(), 'https://www.giswater.org/wp-content/uploads/2016/10/GW-logo.png','demo image', ROUND(RANDOM()*360));
                INSERT INTO om_visit_event_photo (visit_id, event_id, tstamp, value, text, compass) 
                VALUES(id_last, id_event_last, now(), 'http://www.bgeo.es/wp-content/uploads/2015/06/10414886_1538811266370453_9195211735246399786_n.png','demo image', ROUND(RANDOM()*360));
                INSERT INTO om_visit_event_photo (visit_id, event_id, tstamp, value, text, compass) 
                VALUES(id_last, id_event_last, now(), 'https://i.vimeocdn.com/portrait/6775150_600x600','demo image', ROUND(RANDOM()*360));
	...
	c1=c1+1;
        RAISE NOTICE'c1 % c2 %', c1, c2;
            ...
            --Insert visit
            INSERT INTO om_visit (visitcat_id, startdate, enddate, expl_id, user_name, status) VALUES(1, now(), (now()+'1hour'::INTERVAL * ROUND(RANDOM() * 5)), 
            rec_arc.expl_id, 'demo_user', 4) RETURNING id INTO id_last;
            INSERT INTO om_visit_x_arc (visit_id, arc_id) VALUES(id_last::int8, rec_arc.arc_id);
