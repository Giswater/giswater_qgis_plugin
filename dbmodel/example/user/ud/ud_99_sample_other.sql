...
UPDATE config_form_fields SET layoutname = 'lyt_data_2', layoutorder = 33 where columnname ='expl_id' AND (formname not in ('v_edit_dimensions','v_edit_link','v_edit_inp_subcatchment','v_edit_raingage')) AND formname not like '%ve_elem_%';
