...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'image1', 2, 'bytea', 'image', NULL,
NULL, NULL, NULL, false, false, true, NULL, 'SELECT row_to_json(res) FROM (SELECT encode(image, ''base64'') AS image FROM config_api_images WHERE id=1) res;',
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'visit_id', 3, 'double', 'text', 'Visit id:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'arc_id', 4, 'double', 'text', 'Arc_id:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'lot_id', 5, 'integer', 'combo', 'Lot id:',
NULL, NULL, NULL, false, false, true, NULL, 'SELECT id , id as idval FROM om_visit_lot WHERE active IS TRUE',
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'ext_code', 6, 'string', 'text', 'Code:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'arc_rehabit_1', 7, 'string', 'text', 'Rehabit 1:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'arc_rehabit_2', 8, 'string', 'text', 'Rehabit 2:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'status', 11, 'integer', 'combo', 'Status:',
NULL, NULL, NULL, false, false, true, NULL, 'SELECT DISTINCT (id) AS id,  idval  AS idval FROM om_typevalue WHERE id IS NOT NULL AND typevalue=''visit_cat_status'' ',
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'divider', 12, NULL, 'formDivider', NULL,
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'acceptbutton', 1, NULL, 'button', 'Accept',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('ve_visit_arc_rehabit', 'visit', 'backbutton', 2, NULL, 'button', 'Back',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_9', NULL, FALSE);
...
NULL, NULL, NULL, false, false, true, NULL, 'SELECT id, idval FROM om_visit_class WHERE feature_type=''GULLY'' AND  active IS TRUE AND sys_role_id IN (SELECT rolname FROM pg_roles WHERE  pg_has_role( current_user, oid, ''member''))',
NULL, NULL, NULL, NULL, 
'gwGetVisit' ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'visit_id', 2, 'double', 'text', 'Visit id:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'gully_id', 3, 'double', 'text', 'Gully id:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'clean_gully', 4, 'text', 'combo', 'Cleaned:',
NULL, NULL, NULL, false, false, true, NULL, 'SELECT id, idval FROM om_typevalue WHERE typevalue = ''visit_cleaned'' ',
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'smells_gully', 5, 'boolean', 'check', 'Smells:',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'image1', 6, 'bytea', 'image', NULL,
NULL, NULL, NULL, false, false, true, NULL, 'SELECT row_to_json(res) FROM (SELECT encode(image, ''base64'') AS image FROM config_api_images WHERE id=1) res;',
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_1', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'acceptbutton', 1, NULL, 'button', 'Accept',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_9', NULL, FALSE);
...
dv_orderby_id, dv_isnullvalue, dv_parent_id, dv_querytext_filterc, 
widgetfunction, linkedaction, stylesheet, listfilterparam, layoutname, widgetcontrols, hidden) 
VALUES ('visit_gully_insp', 'visit', 'backbutton', 2, NULL, 'button', 'Back',
NULL, NULL, NULL, false, false, true, NULL, NULL,
NULL, NULL, NULL, NULL, 
NULL ,NULL, NULL, NULL, 'data_9', NULL, FALSE);
