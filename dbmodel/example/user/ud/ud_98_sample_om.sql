...
INSERT INTO om_visit_class VALUES (9, 'Rehabilitation arc', NULL, true, false, true, null, 'role_om');

INSERT INTO om_visit_parameter VALUES ('arc_rehabit_1', NULL, 'REHABIT', 'ARC', 'TEXT', NULL, 'Rehabilitation arc parameter 1', 'event_ud_arc_rehabit', 'a');
INSERT INTO om_visit_parameter VALUES ('arc_rehabit_2', NULL, 'REHABIT', 'ARC', 'TEXT', NULL, 'Rehabilitation arc parameter 2', 'event_ud_arc_rehabit', 'b');
...
INSERT INTO om_visit_parameter VALUES ('clean_gully', NULL, 'INSPECTION', 'GULLY', 'TEXT', NULL, 'Clean of gully', 'event_standard', 'defaultvalue',FALSE, 'gully_cln_exec');
INSERT INTO om_visit_parameter VALUES ('smells_gully', NULL, 'INSPECTION', 'GULLY', 'TEXT', NULL, 'Smells of gully', 'event_standard', 'defaultvalue', FALSE, 'smells_gully');
...
INSERT INTO config_api_visit_x_featuretable VALUES ('v_edit_gully', 8);
INSERT INTO config_api_visit_x_featuretable VALUES ('v_edit_arc', 9);
 ...
 SELECT om_visit_x_gully.id,
   ...
   FROM om_visit
     ...
     LEFT JOIN ( SELECT ct.visit_id,
      ...
      JOIN om_visit_class on om_visit_class.id=om_visit.class_id
      JOIN om_visit_class_x_parameter on om_visit_class_x_parameter.parameter_id=om_visit_event.parameter_id 
      where om_visit_class.ismultievent = TRUE ORDER  BY 1,2'::text, ' VALUES (''clean_connec''),(''smells_gully'')'::text) ct(visit_id integer, param_1 text, param_2 text)) a 
     ON a.visit_id = om_visit.id
  WHERE om_visit_class.ismultievent = true;
...
INSERT INTO config_api_form_fields VALUES (7, 've_visit_arc_rehabit', 'visit', 'class_id', 1, 1, true, 'integer', 'combo', 'Visit type:', NULL, NULL, NULL, NULL, NULL, true, NULL, true, NULL, 'SELECT id, idval FROM om_visit_class WHERE feature_type=''ARC'' AND  active IS TRUE AND sys_role_id IN (SELECT rolname FROM pg_roles WHERE  pg_has_role( current_user, oid, ''member''))', NULL, NULL, NULL, NULL, 'gwGetVisit', NULL, true, NULL, true, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (8, 've_visit_arc_rehabit', 'visit', 'backbutton', 9, 2, true, NULL, 'button', 'Back', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, 'backButtonClicked', NULL, NULL, NULL, NULL, NULL, NULL, 'data_9', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (9, 've_visit_arc_rehabit', 'visit', 'enddate', 1, 11, true, 'date', 'datepickertime', 'End date:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (11, 've_visit_arc_rehabit', 'visit', 'image1', 1, 2, true, 'bytea', 'image', NULL, NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, 'SELECT row_to_json(res) FROM (SELECT encode(image, ''base64'') AS image FROM config_api_images WHERE id=1) res;', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (12, 've_visit_arc_rehabit', 'visit', 'ext_code', 1, 6, true, 'string', 'text', 'Code:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (13, 've_visit_arc_rehabit', 'visit', 'arc_id', 1, 4, true, 'double', 'text', 'Arc_id', NULL, NULL, NULL, 12, 0, false, NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (14, 've_visit_arc_rehabit', 'visit', 'startdate', 1, 10, true, 'date', 'datepickertime', 'Start date:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (15, 've_visit_arc_rehabit', 'visit', 'acceptbutton', 9, 1, true, NULL, 'button', 'Accept', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, 'gwSetVisit', NULL, NULL, NULL, NULL, NULL, NULL, 'data_9', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (16, 've_visit_arc_rehabit', 'visit', 'visit_id', 1, 3, true, 'double', 'text', 'Visit id:', NULL, NULL, NULL, 12, 0, false, NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (17, 've_visit_arc_rehabit', 'visit', 'divider', 1, 10, true, NULL, 'formDivider', NULL, NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (18, 've_visit_arc_rehabit', 'visit', 'lot_id', 1, 5, true, 'integer', 'combo', 'Lot id:', NULL, NULL, NULL, NULL, NULL, true, NULL, false, NULL, 'SELECT id , idval FROM om_visit_lot WHERE active IS TRUE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (19, 've_visit_arc_rehabit', 'visit', 'status', 1, 12, true, 'integer', 'combo', 'Status:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, 'SELECT DISTINCT (id) AS id,  idval  AS idval FROM om_typevalue WHERE id IS NOT NULL AND typevalue=''visit_cat_status'' ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (5, 've_visit_arc_rehabit', 'visit', 'arc_rehabit_2', 1, 8, true, 'string', 'text', 'Rehabit 2:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
INSERT INTO config_api_form_fields VALUES (10, 've_visit_arc_rehabit', 'visit', 'arc_rehabit_1', 1, 7, true, 'string', 'text', 'Rehabit 1:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'data_1', NULL, NULL);
...
INSERT INTO config_api_form_fields VALUES (31, 'visit_emb_insp', 'visit', 'gully_id', 1, 3, true, 'double', 'text', 'Connec id', NULL, NULL, NULL, 12, 0, false, NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO config_api_form_fields VALUES (32, 'visit_emb_insp', 'visit', 'clean_gully', 1, 4, true, NULL, 'combo', 'Netejat:', NULL, NULL, NULL, 12, 2, false, NULL, true, NULL, 'SELECT id, idval FROM om_typevalue WHERE typevalue = ''visit_cleaned'' ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO config_api_form_fields VALUES (33, 'visit_emb_insp', 'visit', 'smells_gully', 1, 5, true, 'string', 'text', 'Olors:', NULL, NULL, NULL, NULL, NULL, false, NULL, true, NULL, 'SELECT id, idval FROM om_typevalue WHERE typevalue = ''visit_cleaned'' ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO config_api_form_fields VALUES (28, 'visit_emb_insp', 'visit', 'class_id', 1, 1, true, NULL, 'combo', 'Tipus visita:', NULL, NULL, NULL, NULL, NULL, true, NULL, true, NULL, 'SELECT id, idval FROM om_visit_class WHERE feature_type=''GULLY'' AND  active IS TRUE AND sys_role_id IN (SELECT rolname FROM pg_roles WHERE  pg_has_role( current_user, oid, ''member''))', NULL, NULL, NULL, NULL, NULL, NULL, true, NULL, true, NULL, NULL, NULL, NULL, NULL);
