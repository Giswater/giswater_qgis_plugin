...
INSERT INTO value_result_type VALUES ('SELECTION', 'SELECCIÓN');

INSERT INTO value_status VALUES ('CANCELED', 'CANCELADO');
INSERT INTO value_status VALUES ('ON PLANNING', 'EN PLANIFICACIÓN');
INSERT INTO value_status VALUES ('FINISHED', 'FINALIZADO');

UPDATE config_engine_def SET label = 'Roturas reales' WHERE parameter = 'rleak_1' AND method = 'WM';
UPDATE config_engine_def SET label = 'Roturas reales' WHERE parameter = 'rleak_2' AND method = 'WM';
UPDATE config_engine_def SET label = 'Probabilidad de falla' WHERE parameter = 'mleak_1' AND method = 'WM';
UPDATE config_engine_def SET label = 'Probabilidad de falla' WHERE parameter = 'mleak_2' AND method = 'WM';
UPDATE config_engine_def SET label = 'Longevidad' WHERE parameter = 'longevity_1' AND method = 'WM';
UPDATE config_engine_def SET label = 'Longevidad' WHERE parameter = 'longevity_2' AND method = 'WM';
UPDATE config_engine_def SET label = 'Caudal circulante' WHERE parameter = 'flow_1' AND method = 'WM';
UPDATE config_engine_def SET label = 'Caudal circulante' WHERE parameter = 'flow_2' AND method = 'WM';
UPDATE config_engine_def SET label = 'ANC' WHERE parameter = 'nrw_1' AND method = 'WM';
UPDATE config_engine_def SET label = 'ANC' WHERE parameter = 'nrw_2' AND method = 'WM';
...
UPDATE config_engine_def SET label = 'Normativo' WHERE parameter = 'compliance_1' AND method = 'WM';
UPDATE config_engine_def SET label = 'Normativo' WHERE parameter = 'compliance_2' AND method = 'WM';
UPDATE config_engine_def SET label = 'Coeficiente de tasa de rotura' WHERE parameter = 'bratemain0' AND method = 'SH';
UPDATE config_engine_def SET label = 'Tasa de descuento (%)' WHERE parameter = 'drate' AND method = 'SH';
UPDATE config_engine_def SET label = 'Peso de año esperado' WHERE parameter = 'expected_year' AND method = 'SH';
UPDATE config_engine_def SET label = 'Peso de normativo' WHERE parameter = 'compliance' AND method = 'SH';
UPDATE config_engine_def SET label = 'Peso de estratégico' WHERE parameter = 'strategic' AND method = 'SH';
UPDATE config_engine_def SET descript = 'Peso en matriz final por factores estratégicos' WHERE parameter = 'strategic' AND method = 'SH';
UPDATE config_engine_def SET descript = 'Peso en matriz final por año de renovación' WHERE parameter = 'expected_year' AND method = 'SH';
UPDATE config_engine_def SET descript = 'Peso en matriz final por cumplimiento normativo' WHERE parameter = 'compliance' AND method = 'SH';
UPDATE config_engine_def SET descript = 'Tasa de crecimiento de fugas en tuberías' WHERE parameter = 'bratemain0' AND method = 'SH';
UPDATE config_engine_def SET descript = 'Tasa de actualización real de precios (discount rate). Tiene en cuenta el aumento de precios descontando la inflación.' WHERE parameter = 'drate' AND method = 'SH';
...
UPDATE config_form_tableview SET alias = 'Coste reparación acometida' WHERE objectname = 'config_catalog_def' AND columnname = 'cost_repserv';
...
UPDATE config_form_tableview SET alias = 'Descripción' WHERE objectname = 'config_engine_def' AND columnname = 'alias';
