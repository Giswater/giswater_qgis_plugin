...
CREATE TRIGGER gw_trg_link_connecrotation_update  AFTER INSERT OR UPDATE OF the_geom  ON "SCHEMA_NAME".link  FOR EACH ROW  EXECUTE PROCEDURE "SCHEMA_NAME".gw_trg_link_connecrotation_update();