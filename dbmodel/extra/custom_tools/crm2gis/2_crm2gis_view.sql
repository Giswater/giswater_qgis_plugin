...
CREATE OR REPLACE VIEW ws.v_ui_hydrometer AS 
 SELECT v_rtc_hydrometer.hydrometer_id AS sys_hydrometer_id,
    ...
    v_rtc_hydrometer.codi_finca AS "Codi finca:",
    v_rtc_hydrometer.num_comptador AS "Núm. comptador:",
    v_rtc_hydrometer.state AS "Estat:",
    v_rtc_hydrometer.expl_name AS "Explotació:"
    v_rtc_hydrometer.titular AS "Titular:",
   ...
   FROM ws.v_rtc_hydrometer;
   
   
GRANT SELECT ON TABLE ws.v_ui_hydrometer TO role_basic;
GRANT SELECT ON TABLE ws.v_ui_hydrometer TO role_edit;
GRANT SELECT ON TABLE ws.v_ui_hydrometer TO role_om;
GRANT SELECT ON TABLE ws.v_ui_hydrometer TO role_epa;
GRANT SELECT ON TABLE ws.v_ui_hydrometer TO role_master;
GRANT SELECT ON TABLE ws.v_ui_hydrometer TO role_admin;
