...
INSERT INTO config_form_fields (formname,formtype,tabname,columnname,layoutname,layoutorder,"datatype",widgettype,"label",tooltip,placeholder,ismandatory,isparent,iseditable,isautoupdate,isfilter,dv_querytext,dv_orderby_id,dv_isnullvalue,dv_parent_id,dv_querytext_filterc,stylesheet,widgetcontrols,widgetfunction,linkedobject,hidden,web_layoutorder) VALUES
	 ('v_edit_link','form_feature','tab_data','dqa_id','lyt_bot_1',1,'integer','text','Dqa','dqa_id',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ...
	 ('v_edit_link','form_feature','tab_data','sector_id','lyt_data_1',8,'integer','combo','Sector ID','sector_id  - Sector identifier.',NULL,false,false,false,false,NULL,'SELECT sector_id as id, name as idval FROM sector WHERE sector_id IS NOT NULL',true,false,NULL,NULL,'{"label":"color:blue; font-weight:bold;"}','{"setMultiline": false, "valueRelation":{"nullValue":false, "layer": "v_edit_sector", "activated": true, "keyColumn": "sector_id", "valueColumn": "name", "filterExpression": null}}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','dma_id','lyt_data_1',9,'integer','combo','Dma ID','Dma ID',NULL,false,false,false,false,NULL,'SELECT dma_id as id, name as idval FROM dma WHERE dma_id = 0 UNION SELECT dma_id as id, name as idval FROM dma WHERE dma_id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "valueRelation":{"nullValue":false, "layer": "v_edit_dma", "activated": true, "keyColumn": "dma_id", "valueColumn": "name", "filterExpression": null}}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','presszone_id','lyt_data_1',10,'integer','text','Presszone','presszone_id',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','minsector_id','lyt_data_1',11,'integer','text','minsector_id','minsector_id',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','fluid_type','lyt_data_1',12,'string','text','fluid_type','fluid_type',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','gis_length','lyt_data_1',13,'double','text','Gis length','Gis length',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','sector_name','lyt_data_1',14,'string','text','sector_name','sector_name',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','dma_name','lyt_data_1',15,'string','text','dma_name','dma_name',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','dqa_name','lyt_data_1',16,'string','text','dqa_name','dqa_name',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','presszone_name','lyt_data_1',17,'string','text','presszone_name','presszone_name',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','macrosector_id','lyt_data_1',18,'integer','combo','Macrosector id','Macrosector id',NULL,false,false,false,false,NULL,'SELECT macrosector_id as id, name as idval FROM macrosector WHERE macrosector_id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','macrodma_id','lyt_data_1',19,'integer','text','Macrodma ID','Macrodma ID',NULL,false,false,false,false,NULL,'SELECT macrodma_id as id, name as idval FROM macrodma WHERE macrodma_id IS NOT NULL',NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','macrodqa_id','lyt_data_1',20,'integer','text','macrodqa_id','macrodqa_id',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','epa_type','lyt_data_1',21,'string','text','epa_type','epa_type',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','is_operative','lyt_data_1',22,'boolean','check','is_operative','is_operative',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ...
	 ('v_edit_link','form_feature','tab_data','workcat_id','lyt_data_1',24,'string','typeahead','Workcat ID','workcat_id - Related to the catalog of work files (cat_work). File that registers the element',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_work WHERE id IS NOT NULL AND active IS TRUE ',NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,'action_workcat',false,NULL),
	 ('v_edit_link','form_feature','tab_data','workcat_id_end','lyt_data_1',25,'string','typeahead','Workcat ID end','workcat_id_end - ID of the  end of construction work.','Only when state is obsolete',false,false,true,false,NULL,'SELECT id, id as idval FROM cat_work WHERE id IS NOT NULL AND active IS TRUE ',NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','builtdate','lyt_data_1',26,'date','datetime','Builtdate:','builtdate - Date the element was added. In insertion of new elements the date of the day is shown',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','enddate','lyt_data_1',27,'date','datetime','Enddate','enddate - End date of the element. It will only be filled in if the element is in a deregistration state.',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','uncertain','lyt_data_1',28,'boolean','check','Uncertain','uncertain - To set if the element''s location is uncertain',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('v_edit_link','form_feature','tab_data','top_elev1','lyt_data_1',29,'integer','text','Top Elev 1','top_elev1',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','depth1','lyt_data_1',30,'integer','text','Depth1','depth1',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','elevation1','lyt_data_1',31,'integer','text','Elevation1','elevation1',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','top_elev2','lyt_data_1',32,'integer','text','Top elev 2','top_elev2',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','depth2','lyt_data_1',33,'integer','text','Depth2','depth2',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','elevation2','lyt_data_1',34,'integer','text','Elevation2','elevation2',NULL,false,false,false,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ...
	 ('v_edit_link','form_feature','tab_data','comment','lyt_data_1',36,'string','text','Comment','Comment',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','num_value','lyt_data_1',37,'double','text','Num Value','Num Value',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','descript','lyt_data_3',1,'string','text','Descript','Descript',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','annotation','lyt_data_3',2,'string','text','Annotation','annotation - Annotations related to link. Additional information',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','observ','lyt_data_3',3,'string','text','Observ','Observ',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
	 ('v_edit_link','form_feature','tab_data','link','lyt_data_3',4,'string','hyperlink','Link','Link',NULL,false,false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,NULL),
