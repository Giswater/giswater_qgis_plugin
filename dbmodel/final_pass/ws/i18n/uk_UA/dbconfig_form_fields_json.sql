...
UPDATE config_form_fields AS t SET widgetcontrols = v.text::json FROM (
    ...
    ('btn_accept', 'mincut', 'form_mincut', 'tab_mincut', '{"text": "Прийняти"}'),
    ('btn_apply', 'mincut', 'form_mincut', 'tab_mincut', '{"text": "Застосувати"}'),
    ('btn_cancel', 'mincut', 'form_mincut', 'tab_mincut', '{"text": "Скасувати"}'),
    ('btn_end', 'mincut', 'form_mincut', 'tab_mincut', '{"text": "Кінець"}'),
    ('btn_start', 'mincut', 'form_mincut', 'tab_mincut', '{"text": "Початок"}'),
    ('cancel', 'mincut_manager', 'form_mincut', 'tab_none', '{"text": "Закрити", "saveValue": false}'),
    ('cancel_mincut', 'mincut_manager', 'form_mincut', 'tab_none', '{"text": "Скасувати mincut", "saveValue": false, "onContextMenu": "Cancel mincut"}'),
    ('delete', 'mincut_manager', 'form_mincut', 'tab_none', '{"text": "Видалити mincut", "saveValue": false, "onContextMenu": "Delete mincut"}')
