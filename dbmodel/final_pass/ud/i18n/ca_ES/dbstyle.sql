...
<qgis labelsEnabled="0" version="3.40.8-Bratislava" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{4134ea89-8b48-46ac-8a3d-b0847733e30d}">
      <rule key="{75138ec7-4c1d-4368-bdd4-96db18a460d0}" label="OBSOLET" filter="state = 0 OR (state=1 and p_state=0)" symbol="0"/>
      <rule key="{6088b14d-8a83-4586-a9a0-c774d674bbce}" label="OPERATIVA" filter="state = 1 AND (p_state&lt;>0 or p_state is null)" symbol="1"/>
      <rule key="{2968ab80-f16f-442f-afbc-b2b8f71864e3}" label="PLANIFICAT" filter="state = 2" symbol="2"/>
      <rule key="{9f77ea61-3fb4-4654-942c-2ef19d8ce21d}" label="(dibuix)" filter="ELSE" symbol="3"/>
    </rules>
    <symbols>
...
<qgis labelsEnabled="0" version="3.40.8-Bratislava" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{4134ea89-8b48-46ac-8a3d-b0847733e30d}">
      <rule key="{75138ec7-4c1d-4368-bdd4-96db18a460d0}" label="OBSOLET" filter="state = 0" symbol="0"/>
      <rule key="{6088b14d-8a83-4586-a9a0-c774d674bbce}" label="OPERATIVA" filter="state = 1 AND (p_state&lt;>0 or p_state is null)" symbol="1"/>
      <rule key="{2968ab80-f16f-442f-afbc-b2b8f71864e3}" label="PLANIFICAT" filter="state = 2" symbol="2"/>
      <rule key="{9a47325e-1c67-436a-af26-2a78ff9c0a13}" label="EXCURSIÓ" filter="state = 1 AND p_state = 0" symbol="3"/>
      <rule key="{9f77ea61-3fb4-4654-942c-2ef19d8ce21d}" label="(dibuix)" filter="ELSE" symbol="4"/>
    </rules>
    <symbols>
      <symbol is_animated="0" force_rhr="0" frame_rate="10" name="0" type="line" alpha="1" clip_to_extent="1">
        <data_defined_properties>
