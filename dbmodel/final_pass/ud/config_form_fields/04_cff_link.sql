...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ...
	 ('ve_link','form_feature','tab_data','fluid_type','lyt_data_1',9,'string','combo','Fluid type:','Fluid_type',NULL,true,false,true,false,NULL,'SELECT fluid_type as id, fluid_type as idval FROM man_type_fluid WHERE ((featurecat_id is null AND ''LINK''=ANY(feature_type)) ) AND active IS TRUE ',NULL,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,14),
