...
class TmBasic(TmParentAction):
    ...
    def open_incident_planning(self, action):
        ...
        qt_tools.setCalendarDate(self.dlg_incident_planning, self.dlg_incident_planning.incident_date, self.incident_date)
        ...
        qt_tools.setWidgetText(self.dlg_incident_planning, self.dlg_incident_planning.incident_comment, self.incident_comment)
        qt_tools.setWidgetText(self.dlg_incident_planning, self.dlg_incident_planning.process_user, self.controller.get_current_user())
    ...
    def enable_widget_x_qtable(self, qtable, widget, column_name):
        ...
        if selected_list:
            ...
            # Set enabled
            qt_tools.setWidgetEnabled(self.dlg_incident_manager, widget, result)
