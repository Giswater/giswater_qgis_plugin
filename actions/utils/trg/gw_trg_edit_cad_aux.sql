...
ON SCHEMA_NAME.v_edit_cad_auxcircle  FOR EACH ROW  EXECUTE PROCEDURE SCHEMA_NAME.gw_trg_edit_cad_aux('circle');

DROP TRIGGER IF EXISTS gw_trg_edit_cad_aux ON "SCHEMA_NAME".v_edit_cad_auxpoint;
CREATE TRIGGER gw_trg_edit_cad_aux  INSTEAD OF INSERT OR UPDATE OR DELETE
ON SCHEMA_NAME.v_edit_cad_auxpoint  FOR EACH ROW  EXECUTE PROCEDURE SCHEMA_NAME.gw_trg_edit_cad_aux('point');
