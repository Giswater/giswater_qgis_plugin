...
class ArcDialog(ParentDialog):   
    ...
    def get_doc_user(self):
        ...
        if (self.cat_doc_type_value != 'null' ):
            expr = QgsExpression ('"arc_id" ='+ self.arc_id_selected+'AND "user" = \'' +self.doc_user_value + '\' AND "doccat_id" = \'' +self.cat_doc_type_value + '\'') 
        ...
        if ((self.cat_doc_type_value !='null')&(self.doc_tag_value != 'null')):
            expr = QgsExpression ('"arc_id" ='+ self.arc_id_selected+'AND "user" = \'' +self.doc_user_value + '\' AND "doccat_id" = \'' +self.cat_doc_type_value + '\' AND "tagcat_id" = \'' +self.doc_tag_value + '\'')  
        
        # If combobox doc_user is returned to 'null'
        if (self.doc_user_value == 'null'): 
            # If ComboBox doc_user and ComboBox cat_doc_type are selected
            if (self.cat_doc_type_value != 'null' ):
                expr = QgsExpression ('"arc_id" ='+ self.arc_id_selected+'AND "doccat_id" = \'' +self.cat_doc_type_value + '\'') 
            ...
            # If ComboBox doc_user and ComboBox cat_doc_type and ComboBox doc_tag are selected
            if ((self.cat_doc_type_value !='null')&(self.doc_tag_value != 'null')):
                expr = QgsExpression ('"arc_id" ='+ self.arc_id_selected+'AND "doccat_id" = \'' +self.cat_doc_type_value + '\' AND "tagcat_id" = \'' +self.doc_tag_value + '\'')  
            if((self.cat_doc_type_value =='null')&(self.doc_tag_value == 'null')):  
